...
export const RECIPES_DETAILED: RecipeDetailed[] = [
    ...
    },
    {
        ...
        title: "Hanoi Grilled Pork Vermicelli",
        subtitle: "Bún Chả Hà Nội",
        shortDescription: "Smoky chargrilled pork patties and belly slices in a tangy warm dipping broth, served with cool rice vermicelli, fresh herbs, and pickled vegetables — Hanoi's defining lunch.",
        description: "Bún chả is the soul of Hanoi at noon. Walk down any narrow alley in the Old Quarter between 11am and 2pm and you'll smell it before you see it — pork fat dripping onto charcoal, smoke curling up through bamboo screens, the unmistakable aroma of caramelizing fish sauce and garlic.\n\nUnlike most Vietnamese soups where everything arrives in one bowl, bún chả is deconstructed: a small bowl of warm, golden dipping broth (nước chấm) with grilled pork patties and slices of pork belly bobbing in it, alongside a separate platter of cold rice vermicelli, a heaped basket of herbs and lettuce, and pickled green papaya for crunch. You assemble each bite yourself.\n\nThe dish became internationally famous in May 2016 when Anthony Bourdain brought President Barack Obama to a humble bún chả shop on Lê Văn Hưu street. The plastic stools, the cold Hanoi beer, the hands-on eating — it was Vietnam at its most honest. This recipe takes about 90 minutes total, with most of that being marination time.",
        storySnippet: "In Hanoi, bún chả is strictly a lunch dish. Locals will look at you sideways if you order it for dinner. The charcoal grills are fired up at dawn, the patties are made by hand throughout the morning, and by 2pm the shops simply close.",
        image: "/images/recipes/bunchahanoi.jpg",
        imageAlt: "Hanoi-style grilled pork bún chả with vermicelli noodles, fresh herbs, and warm dipping broth",
        prepTime: "30 min",
        cookTime: "25 min",
        ...
        ingredients: [
            {
                section: "For the pork patties (chả viên)",
                items: [
                    { amount: "400 g (14 oz)", name: "Ground pork (20% fat)", nameVi: "Thịt heo xay", note: "shoulder is ideal" },
                    { amount: "3 medium", name: "Shallots, finely minced", nameVi: "Hành tím" },
                    { amount: "4 cloves", name: "Garlic, finely minced", nameVi: "Tỏi" },
                    { amount: "2 tbsp", name: "Fish sauce", nameVi: "Nước mắm", note: "Phú Quốc 40°N preferred" },
                    { amount: "1 tbsp", name: "Oyster sauce", nameVi: "Dầu hào" },
                    { amount: "1 tbsp", name: "Brown sugar", nameVi: "Đường nâu" },
                    { amount: "1 tbsp", name: "Honey", nameVi: "Mật ong", note: "for caramelization" },
                    { amount: "1 tsp", name: "Black pepper, freshly ground", nameVi: "Tiêu đen" },
                    { amount: "1 tbsp", name: "Vegetable oil", nameVi: "Dầu ăn" }
                ]
            },
            {
                section: "For the pork belly slices (chả miếng)",
                items: [
                    { amount: "300 g (10 oz)", name: "Pork belly, skin removed", nameVi: "Ba chỉ heo", note: "sliced 4mm thick" },
                    { amount: "1.5 tbsp", name: "Fish sauce", nameVi: "Nước mắm" },
                    { amount: "1 tbsp", name: "Brown sugar", nameVi: "Đường nâu" },
                    { amount: "3 cloves", name: "Garlic, minced", nameVi: "Tỏi" },
                    { amount: "0.5 tsp", name: "Black pepper", nameVi: "Tiêu" }
                ]
            },
            {
                section: "For the dipping broth (nước chấm)",
                items: [
                    { amount: "300 ml (1.25 cups)", name: "Warm water", nameVi: "Nước ấm" },
                    { amount: "4 tbsp", name: "Fish sauce", nameVi: "Nước mắm" },
                    { amount: "3 tbsp", name: "Sugar", nameVi: "Đường" },
                    { amount: "2 tbsp", name: "Rice vinegar", nameVi: "Giấm gạo" },
                    { amount: "1 tbsp", name: "Lime juice", nameVi: "Nước cốt chanh" },
                    { amount: "2 cloves", name: "Garlic, finely minced", nameVi: "Tỏi" },
                    { amount: "1-2", name: "Bird's eye chili, sliced", nameVi: "Ớt hiểm", note: "to taste" }
                ]
            },
            {
                section: "For the pickled vegetables (đồ chua)",
                items: [
                    { amount: "150 g", name: "Green papaya, julienned", nameVi: "Đu đủ xanh", note: "or daikon if unavailable" },
                    { amount: "1 medium", name: "Carrot, julienned", nameVi: "Cà rốt" },
                    { amount: "1 tsp", name: "Salt", nameVi: "Muối" },
                    { amount: "2 tbsp", name: "Sugar", nameVi: "Đường" },
                    { amount: "3 tbsp", name: "Rice vinegar", nameVi: "Giấm gạo" }
                ]
            },
            {
                section: "To serve",
                items: [
                    { amount: "500 g (1.1 lb)", name: "Fresh rice vermicelli (bún)", nameVi: "Bún tươi", note: "or 250g dried" },
                    { amount: "1 head", name: "Lettuce leaves", nameVi: "Xà lách" },
                    { amount: "1 small bunch", name: "Fresh perilla leaves", nameVi: "Lá tía tô" },
                    { amount: "1 small bunch", name: "Fresh mint leaves", nameVi: "Húng lủi" },
                    { amount: "1 small bunch", name: "Fresh Vietnamese coriander", nameVi: "Rau răm" },
                    { amount: "100 g", name: "Bean sprouts", nameVi: "Giá đỗ", note: "optional" }
                ]
            }
        ],
        instructions: [
            {
                step: 1,
                title: "Marinate the pork (1 hour minimum)",
                description: "In one bowl, combine ground pork with shallots, garlic, fish sauce, oyster sauce, brown sugar, honey, black pepper, and vegetable oil. Mix in one direction with your hand for 2-3 minutes until the meat becomes sticky and tacky — this is what makes the patties hold together on the grill. In a second bowl, marinate the pork belly slices with fish sauce, brown sugar, garlic, and pepper. Cover both and refrigerate for at least 1 hour, ideally 3 hours.",
                duration: "1 hr",
                tip: "Mixing in ONE direction is a Vietnamese chef's secret. It aligns the proteins and creates the bouncy texture authentic chả viên needs."
            },
            {
                step: 2,
                title: "Make the pickled vegetables",
                description: "Toss julienned green papaya and carrot with salt and let sit 10 minutes — this draws out water and keeps the pickle crunchy. Squeeze gently and rinse. Mix with sugar and rice vinegar, then refrigerate. They need at least 30 minutes to develop flavor but can be made a day ahead.",
                duration: "15 min",
                tip: "Green papaya is traditional but if you can't find it, daikon radish works beautifully. Don't use ripe papaya — it's too sweet and soft."
            },
            {
                step: 3,
                title: "Prepare the dipping broth",
                description: "In a small saucepan, dissolve sugar in warm water. Remove from heat. Add fish sauce, rice vinegar, and lime juice. Taste — it should be balanced: salty from fish sauce, sweet, slightly tart, with a clean finish. Adjust as needed. Set aside; you'll add fresh garlic and chili at serving time.",
                duration: "5 min",
                tip: "The Hanoi version is mild and slightly sweet. The Saigon version is darker and more intense. Adjust to your taste."
            },
            {
                step: 4,
                title: "Form the patties",
                description: "Lightly oil your hands. Take about 35g of marinated ground pork and shape into flat patties about 6cm wide and 1cm thick. You should get 12-16 patties. Place on a parchment-lined tray. The thinner the patty, the more caramelized edges you'll get on the grill.",
                duration: "10 min"
            },
            {
                step: 5,
                title: "Grill the meat (the soul of the dish)",
                description: "Heat charcoal grill to medium-high, or preheat oven broiler to 240°C (465°F) with rack 15cm from element. Grill patties first for 3-4 minutes per side until deeply caramelized — you want char marks. Grill pork belly for 4-5 minutes per side until edges are crispy and lacquered. Both should be slightly charred but juicy inside.",
                duration: "12 min",
                tip: "Charcoal is non-negotiable for authentic flavor. If using broiler, brush with reserved marinade halfway through for that lacquered look."
            },
            {
                step: 6,
                title: "Cook the noodles",
                description: "If using fresh bún, simply blanch in boiling water for 30 seconds, drain, and rinse with cold water. If dried, follow package directions (usually 4-5 min in boiling water), then rinse cold to stop cooking. Drain WELL — wet noodles dilute the dipping broth.",
                duration: "5 min"
            },
            {
                step: 7,
                title: "Assemble and serve",
                description: "Warm the dipping broth gently (do not boil). Add fresh minced garlic and sliced chili. Divide grilled patties and pork belly between 4 small bowls and ladle warm broth over them — the meat should bob in the broth. Add a generous spoonful of pickled vegetables to each bowl. Serve alongside vermicelli, lettuce, and the herb platter. To eat: tear lettuce, top with vermicelli and herbs, dip into the broth bowl, take a bite of meat with each mouthful.",
                duration: "5 min",
                tip: "The dipping broth should be WARM, not hot — too much heat kills the herbs and makes the dish heavy."
            }
        ],
