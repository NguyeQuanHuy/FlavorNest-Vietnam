...
export const BREAKFAST_RECIPES: BreakfastRecipe[] = [
  ...
  { slug: 'banh-cuon', title: 'Steamed Rice Rolls', subtitle: 'Bánh Cuốn', image: '/images/recipes/banh-cuon.jpg', region: 'Northern', difficulty: 'Medium', time: '45 min', rating: '4.8', reviews: 167, cal: 290, tag: 'Popular', tagColor: '#D97706', description: "Translucent sheets of steamed rice batter rolled around seasoned minced pork and wood ear mushrooms.", tags: ['Rice Flour', 'Pork', 'Steamed', 'Heritage'], category: 'Breakfast' },
  { slug: 'chao-long', title: 'Pork Congee', subtitle: 'Cháo Lòng', image: '/images/recipes/chao-long.jpg', region: 'Southern', difficulty: 'Easy', time: '1.5 hrs', rating: '4.6', reviews: 98, cal: 340, tag: 'Comfort Food', tagColor: '#7C3AED', description: "Silky rice porridge with pork offal in a ginger-scented broth — Saigon's ultimate restorative breakfast.", tags: ['Rice', 'Pork', 'Slow Cook', 'Comfort'], category: 'Breakfast' },
  { slug: 'banh-trang-tron', title: 'Rice Paper Salad', subtitle: 'Bánh Tráng Trộn', image: '/images/recipes/banh-trang-tron.jpg', region: 'Southern', difficulty: 'Easy', time: '20 min', rating: '4.7', reviews: 212, cal: 220, tag: 'Street Snack', tagColor: '#BE185D', description: "Rice paper tossed with quail eggs, dried shrimp, green mango and a fiery-tangy tamarind dressing.", tags: ['Rice Paper', 'Vegetarian', 'Tangy', 'Quick'], category: 'Breakfast' },
]
