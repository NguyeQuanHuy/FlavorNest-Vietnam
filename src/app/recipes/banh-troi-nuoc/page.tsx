...
const recipe: RecipeData = {
    ...
    baseServings: 20,
    heroImage:
        'https://images.unsplash.com/photo-1607301406259-dfb186e15de8?auto=format&fit=crop&w=1600&q=85',
    intro:
        'Bánh trôi nước is one of Vietnam\'s oldest desserts, eaten on the Cold Food Festival (Tết Hàn Thực) on the third day of the third lunar month. The name means "floating cake" — the dumplings are done when they rise to the surface of boiling water. Inside each smooth white ball is a small cube of raw palm sugar that melts during cooking into a dark, caramel pool. They are served in a ginger-scented syrup and finished with toasted sesame seeds and shredded coconut. Simple, ancient, and perfect.',
    ingredientSections: [
        {
            title: 'Dough',
            items: [
        ...
        },
        {
            title: 'Filling',
            items: [
                { amount: 80, unit: 'g', name: 'palm sugar (đường thốt nốt)', note: 'or dark brown sugar, cut into 20 small cubes' },
            ],
        },
        {
            title: 'Ginger syrup',
    ...
    steps: [
        {
            ...
            description:
                'Combine water, sugar, and ginger slices in a small saucepan. Bring to a boil, stir to dissolve sugar, then simmer for 10 minutes until lightly fragrant. Remove from heat and set aside — the syrup will continue absorbing ginger flavour as it cools.',
        },
        {
            title: 'Make the dough',
            description:
                'Combine glutinous rice flour and salt in a bowl. Add warm water gradually, mixing with your hands until a smooth, pliable dough forms — soft like an earlobe, not sticky. Add water or flour a teaspoon at a time to adjust. Cover with a damp cloth and rest for 10 minutes.',
        ...
        },
        {
            ...
            description:
                'Divide dough into 20 equal portions (about 18g each). Flatten each into a disc. Place one palm sugar cube in the centre, gather edges, and pinch firmly to seal with no cracks. Roll between palms into a smooth, round ball.',
