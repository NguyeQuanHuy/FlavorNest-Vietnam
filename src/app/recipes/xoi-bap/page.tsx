...
const recipe: RecipeData = {
    slug: 'xoi-bap',
    title: 'Xôi B?p (Sticky Rice with Corn)',
    ...
    intro: `Xôi b?p is the sticky rice of the Mekong Delta and southern Vietnam — made with fresh corn kernels instead of the mung bean or black bean of northern versions. The corn adds sweetness and a slight crunch that is completely its own. The rice and corn are soaked together, then steamed in coconut milk that perfumes every grain, producing a sticky rice that is simultaneously savory and sweet, rich and light. The finishing elements are what make it: a drizzle of thick salted coconut cream that the diner stirs through before eating, crispy fried shallots that add crunch, and shallot oil that adds aromatic depth. Xôi b?p is eaten in the morning from street stalls in Saigon and the delta provinces, served on a square of banana leaf and eaten with a small plastic spoon before the heat of the day arrives. Made at home, it is a complete breakfast or a side dish that outperforms everything you expect from sticky rice and corn.`,
    ingredientSections: [
        {
            title: 'Sticky rice and corn',
            items: [
                { amount: 400, unit: 'g', name: 'glutinous rice (g?o n?p)', note: 'soaked in cold water minimum 4 hours — overnight preferred' },
                { amount: 2, name: 'fresh corn cobs', note: 'kernels stripped — about 250g kernels. Fresh corn only; canned produces wrong texture.' },
                { amount: 200, unit: 'ml', name: 'coconut milk (nu?c c?t d?a)', note: 'full-fat — added to steaming water to perfume the rice' },
        ...
        {
            title: 'Salted coconut cream (nu?c c?t)',
            items: [
                { amount: 200, unit: 'ml', name: 'coconut cream (nu?c c?t d?a)', note: 'the thick first press — more concentrated than coconut milk' },
