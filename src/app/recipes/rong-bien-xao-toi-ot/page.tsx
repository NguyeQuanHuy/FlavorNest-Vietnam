...
const recipe: RecipeData = {
    ...
    title: 'Rong Biển Xào Tỏi Ớt (Seaweed Stir-Fried with Garlic and Chili)',
    ...
    steps: [
        {
            ...
            tip: 'Fresh coastal seaweed for rong biển xào tỏi ớt produces a noticeably brighter, more immediately marine result than rehydrated dried wakame — the specific flavour compounds in fresh seaweed that degrade during drying are fully present, producing a stir-fry that smells and tastes more specifically of the sea. When fresh seaweed is available, use it. When it is not, dried wakame is an excellent substitute that produces a different but equally valid result.',
        },
        {
            ...
            tip: 'Sliced rather than minced garlic for rong biển xào tỏi ớt is the technique that produces visible golden garlic pieces throughout the finished dish — a visual element as well as a flavour element. Minced garlic distributes more evenly but is less visually dramatic; sliced garlic produces golden pieces that are encountered individually in each mouthful.',
        },
        {
        ...
        },
        {
            ...
            description: 'Add spring onion pieces and sesame oil off the heat. Toss once. Transfer to a serving plate immediately. Scatter toasted sesame seeds over the surface. The finished rong biển xào tỏi ớt: glistening green-brown seaweed with visible golden garlic slices and red chili pieces throughout, the sesame seeds scattered over, steam rising. Serve with steamed rice and lime wedges. Eat immediately — stir-fried seaweed at its best within 5 minutes of the wok.',
            tip: 'Rong biển xào tỏi ớt eaten immediately from the wok — when the garlic is still sizzling slightly in the sesame oil and the seaweed is at its peak temperature — is significantly better than the same dish 10 minutes later when the seaweed has released additional moisture and softened. This is consistently a serve-immediately-eat-immediately preparation. The Vietnamese coastal restaurants that do this best have the wok visible from the dining area and serve the dish within 60 seconds of leaving the fire.',
        },
    ],
};
