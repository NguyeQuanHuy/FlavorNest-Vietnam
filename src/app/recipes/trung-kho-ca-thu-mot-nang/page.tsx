...
const recipe: RecipeData = {
    ...
    title: 'Tr?ng Kho Cá Thu M?t N?ng Phú Yên (Braised Eggs with One-Sun Dried Mackerel)',
    subtitle: 'Hard-boiled eggs and pieces of one-sun dried Spanish mackerel braised together in dark caramel, m?m nhi, galangal, and lemongrass until both absorb the concentrated sauce — the Phú Yên kho that combines the province\'s most emblematic dried fish with the egg preparation that makes every drop of sauce worth spooning over rice.',
    ...
    intro: `Tr?ng kho cá thu m?t n?ng is the braised egg and dried mackerel preparation of Phú Yên — a kho dish that combines tr?ng kho (braised eggs in caramel and fish sauce, one of the most universally eaten kho preparations in Vietnamese home cooking) with cá thu m?t n?ng (one-sun dried Spanish mackerel, the fish cousin of bò m?t n?ng that is the most emblematic preserved food of the province). The combination is not arbitrary. Dried mackerel in kho sauce undergoes a transformation similar to what happens to it when grilled: the salt and oil that were concentrated during the one-day drying process caramelize further in the kho sauce, producing a fish piece that is dark, intensely flavored throughout, and carries the specific richness of the dried fish fat through the reduced sauce into the braising liquid. The eggs, placed in the kho alongside the fish, absorb this enriched sauce through their porous whites and develop the specific deep-brown exterior and savory-sweet interior that characterize kho eggs in general — but with the additional dimension of the dried mackerel fat and the m?m nhi that the sauce has been built from. The galangal and lemongrass in the braising liquid are the Phú Yên additions that distinguish this from a standard tr?ng kho — the same three-aromatic foundation used in ?ch kho s? ri?ng and other provincial braised preparations, applied here to a combination that the rest of Vietnam typically prepares without these aromatics. The result is a kho where every element — the egg, the fish, and the sauce itself — carries the specific character of the province in every spoonful.`,
    ingredientSections: [
        {
            title: 'Main proteins',
            items: [
                ...
                { amount: 300, unit: 'g', name: 'cá thu m?t n?ng (one-sun dried Spanish mackerel)', note: 'cut into 5cm sections. If unavailable: lightly salt-dried fresh mackerel, or substitute fresh mackerel with an additional tablespoon of fish sauce in the braising liquid.' },
            ],
        },
        {
            title: 'Kho base',
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: 'm?m nhi (Phú Yên first-press fish sauce)', note: 'the defining seasoning — the dried fish already carries salt, so taste before adding more' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Heat oil and sugar in a clay pot or heavy pot over medium heat until the sugar melts and reaches a deep amber — nearly the darkest possible caramel without burning. Add 2 tablespoons of water carefully. Swirl until dissolved. The caramel for tr?ng kho cá thu should be very dark — the dried mackerel and the egg white both absorb color from the caramel, and a pale caramel produces a flat-looking, flat-tasting kho.',
        ...
        },
        {
            ...
            tip: 'Searing the dried mackerel in the caramel before adding the braising liquid is the technique that layers the caramelization — the fish already has one layer from the sun-drying process; this second caramelization in the kho pot adds a second layer. Two-stage caramelization is what gives cá thu m?t n?ng kho its specific depth versus fresh mackerel kho.',
        },
        {
            title: 'Add eggs and braising liquid — 30-35 minutes',
            description: 'Place the scored hard-boiled eggs in the pot alongside the fish. Pour m?m nhi, dark soy, sugar, coconut water, and water around the sides. Taste the liquid — it should be savory and slightly sweet, accounting for the salt already in the dried fish. Bring to a boil, reduce to the lowest simmer. Braise uncovered for 30-35 minutes, turning the eggs gently every 10 minutes to ensure even coloring and sauce absorption on all sides.',
            tip: 'Turning the eggs every 10 minutes in tr?ng kho is the technique that produces evenly colored, evenly flavored kho eggs rather than eggs that are dark on the bottom and pale on top. Each turn exposes a different surface to the concentrated sauce pooling at the bottom of the pot.',
        },
        {
            ...
            tip: 'The sauce from tr?ng kho cá thu m?t n?ng is the most complex kho sauce in the Phú Yên recipe collection — it carries the dried mackerel fat, the m?m nhi depth, the coconut water sweetness, the caramel bitterness, and the galangal-lemongrass warmth simultaneously. Spoon it generously over rice before the first bite. It is the reason the dish exists.',
        },
    ],
};
