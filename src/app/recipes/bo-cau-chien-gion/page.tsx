...
const recipe: RecipeData = {
    ...
    title: 'B? Câu Chiên Giòn (Crispy Deep-Fried Pigeon)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'portions', name: 'steamed jasmine rice', note: 'or eat without rice as a main nh?u dish' },
            ],
        },
    ],
    steps: [
        {
            ...
            tip: 'The combined marination and air-drying sequence for b? câu chiên giòn — marinate for flavor penetration, then air-dry for skin drying — is the same two-phase preparation as for b? câu quay m?t ong. The only difference is the cooking method that follows. The preparation logic is identical because the goal is the same: flavor throughout the flesh, crackling skin at the surface.',
        },
        {
            ...
            tip: 'The blanching step for b? câu chiên giòn serves the same purpose as blanching for b? câu h?m thu?c b?c — removing the surface impurities that produce murky or bitter flavors during cooking. For a braised preparation the difference is obvious in the broth; for a fried preparation the difference is more subtle but present in the background character of the skin and the rendered fat.',
        },
        {
