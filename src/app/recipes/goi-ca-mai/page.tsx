...
const recipe: RecipeData = {
    ...
    subtitle: `Gỏi Cá Mai — Phan Thiết's raw silver whiting cured in lime juice, dressed with toasted sesame, roasted peanuts, and fresh herbs.`,
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '45 min',
    rating: 4.9,
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 3, name: `bird's eye chili (ớt hiểm), minced` },
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: `roasted peanuts (đậu phộng rang)`, note: `crushed coarsely — not powder` },
                ...
                { amount: 1, name: `bunch Vietnamese coriander (rau răm)`, note: `leaves only — stems discarded` },
                { amount: 1, name: `bunch mint (húng lủi)`, note: `optional but traditional in Phan Thiết` },
        ...
        },
        {
            title: `To serve`,
            items: [
                { amount: 10, name: `sheets rice cracker (bánh tráng nướng)`, note: `grilled or toasted — for scooping` },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `The 15-minute window is the most critical technical detail in gỏi cá mai and the one most home recipes get wrong. Phan Thiết vendors who make this daily cure for precisely 12–15 minutes based on fillet thickness. Thin slices (3mm): 12 minutes. Thicker slices (5mm): 15–18 minutes. Check by pressing — perfectly cured fish yields slightly and springs back. Overcured fish is rigid.`,
        },
        {
        ...
        {
            title: `Eat the Phan Thiết way`,
            description: `Break a piece of grilled rice cracker and use it as a scoop — pick up a portion of dressed fish with herbs and peanuts. Eat in one bite. In Phan Thiết, the cracker is the utensil; chopsticks are secondary. Squeeze a wedge of lime over the plate halfway through eating when the first lime's brightness has faded into the dish. A cold beer or a glass of iced green tea is the standard accompaniment. Do not let the dish sit — gỏi cá mai is a dish of the first ten minutes after plating.`,
        },
    ],
};
