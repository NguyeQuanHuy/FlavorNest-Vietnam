...
const recipe: RecipeData = {
    ...
    subtitle: `?c ?ng Nu?ng Tiêu Xanh — Live razor clams grilled in the shell with fresh green peppercorns, butter, and lemongrass.`,
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '30 min',
    rating: 4.9,
    ...
    intro: `?c ?ng (razor clams, Solen strictus) are long, cylindrical bivalves found in the sandy tidal flats of the southern Vietnamese coast — most abundantly around Phú Qu?c, Kiên Giang, and the Cà Mau peninsula. They live buried vertically in wet sand, filter-feeding at high tide, retreating deeper as the water recedes. A skilled fisherman can spot the keyhole-shaped opening they leave in the sand and pull them out in one clean motion before they dig back down.\n\nNu?ng tiêu xanh — grilled with fresh green peppercorns — is the preparation that made ?c ?ng famous outside its home province. Fresh green peppercorns (not dried, not brined) are crushed and mixed with butter, minced lemongrass, garlic, and a splash of fish sauce, then spooned into the open shell as the clam grills over charcoal. The butter carries the pepper oil into the clam's natural brine as it heats; the shell becomes a self-contained cooking vessel. The result is simultaneously briny, aromatic, sharp, and rich — four flavours in a single bite that lasts about four seconds.\n\nThe dish is street food in Phú Qu?c night market, beach restaurant food in Vung Tàu, and the dish that converts people who claim not to enjoy shellfish. The green pepper — fresh, not dried — is what makes it. Dried black pepper produces a completely different and inferior result. This recipe is written for fresh green peppercorns; if unavailable, brined green peppercorns (drained and rinsed) are the only acceptable substitute.`,
    ingredientSections: [
        {
            title: `The clams`,
            items: [
                { amount: 1, unit: 'kg', name: `live razor clams (?c ?ng)`, note: `shells closed or closing when tapped — open and unresponsive ones are dead, discard` },
                { amount: 1, unit: 'tbsp', name: `coarse salt` },
                { amount: 1, unit: 'L', name: `cold water`, note: `for purging sand — 30 min soak` },
            ],
        },
        {
            title: `Green pepper butter (tiêu xanh bo)`,
            items: [
                { amount: 40, unit: 'g', name: `fresh green peppercorns (tiêu xanh tuoi)`, note: `stripped from stem — substitute: brined green peppercorns, drained and rinsed` },
                ...
                { amount: 2, unit: 'tsp', name: `fish sauce (nu?c m?m)` },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `In Phú Qu?c night market, ?c ?ng nu?ng tiêu xanh is eaten standing at the grill, shell in one hand, bread in the other, lime squeezed directly into the shell before the first bite. The lime juice cuts through the butter and brightens the green pepper. Do not skip the squeeze.`,
        },
    ],
};
