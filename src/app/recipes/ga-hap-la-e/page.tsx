...
const recipe: RecipeData = {
    slug: 'ga-hap-la-e',
    title: 'Gà H?p Lá É (Steamed Chicken with Litsea Leaves)',
    ...
    ingredientSections: [
        ...
        {
            title: 'Lá é dipping sauce (mu?i lá é)',
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Chop the chicken Vietnamese-style through the bone with a cleaver, or carve into portions. Arrange on a plate. Scatter sliced spring onion and a few fresh lá é leaves over the top. Serve the dipping sauce in small individual dishes alongside. To eat: take a piece of chicken, dip into the mu?i lá é, eat with steamed rice. The aromatic dipping sauce is the bridge between the subtly perfumed chicken and the clean steamed rice.',
