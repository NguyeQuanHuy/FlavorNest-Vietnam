...
const recipe: RecipeData = {
    ...
    subtitle: '?c huong s?t phô mai — béo ng?y, dai giòn, thèm không ng?ng.',
    ...
    ingredientSections: [
        {
            title: '?c huong',
            items: [
                { amount: 700, unit: 'g', name: 'fresh babylon whelks (?c huong)', note: 'scrubbed clean; soak in salted water 30 min to purge sand' },
