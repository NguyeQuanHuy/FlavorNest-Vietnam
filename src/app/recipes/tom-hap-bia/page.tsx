...
const recipe: RecipeData = {
    slug: 'tom-hap-bia',
    title: 'Tôm Hấp Bia (Beer-Steamed Shrimp)',
    subtitle: 'Live or very fresh shrimp steamed over Vietnamese beer with lemongrass and ginger until just pink — eaten whole, shell and all, with muối tiêu chanh. The simplest and most satisfying way to eat fresh shrimp in Vietnam.',
    ...
    intro: `Tôm hấp bia is the Vietnamese coastal dish that requires the least technique and the best ingredient. Beer, lemongrass, ginger, and the freshest shrimp available — that is the complete list. The beer produces steam that is slightly more aromatic than water, the lemongrass adds a citrus perfume, and the shrimp cook in 4-5 minutes to a sweetness that no other method replicates. The shells are eaten with the shrimp in the Vietnamese style — the shell adds flavor and a slight crunch, and the head, when present, contains the most concentrated shrimp flavor of all. The dipping sauce is the salt-pepper-lime mixture (muối tiêu chanh) that appears throughout Vietnamese coastal cooking: simple, direct, and precisely calibrated to the sweetness of fresh shrimp. Tôm hấp bia is beach food, market food, late-night food. It is what you order at a seafood restaurant in Nha Trang or Phú Quốc when the shrimp are good and you want to taste exactly what they are.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
                { amount: 800, unit: 'g', name: 'fresh shrimp, whole (tôm tươi)', note: 'heads on, shells on — live if possible. Size: medium to large (16-20 count per 500g). Freshness is the only variable that matters.' },
            ],
        },
        {
            title: 'Steaming bath',
        ...
        {
            title: 'Muối tiêu chanh (salt-pepper-lime)',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch fresh herbs', note: 'Vietnamese coriander (rau răm) preferred' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Never pre-mix the muối tiêu chanh into a sauce. The separate elements — dry salt, dry pepper, wet lime — create a different experience from a pre-mixed dip. The contrast between the dry and wet is part of the technique.',
        },
        {
