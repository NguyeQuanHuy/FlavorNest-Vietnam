...
const recipe: RecipeData = {
    ...
    title: 'Cá N?c Kho Thom (Braised Mackerel Scad with Pineapple)',
    ...
    intro: `Cá n?c kho thom is the fish kho of the central Vietnamese coast — the everyday braise that appears on family tables from Ðà N?ng to Phú Yên wherever cá n?c (mackerel scad) is landed, which is everywhere and constantly, because cá n?c is one of the most abundant and affordable fish in the Vietnamese ocean. The pairing with thom (pineapple — the southern and central word for what northerners call d?a) is not decorative: the pineapple's acidity and enzymes work on the oily, firm-fleshed mackerel during the braise, cutting the richness while its sugars melt into the caramelized fish sauce to produce a glaze that is simultaneously sweet, sour, salty, and deep. The technique is classic kho: a caramel (nu?c màu) made first, fish arranged in a single layer in a clay pot, pineapple and aromatics layered over, then a patient braise during which the liquid reduces by more than half and the flavor drives into the fish. Like all kho, cá n?c kho thom follows the rule that Vietnamese cooks state as fact: it is better the next day, after a night in the refrigerator lets the glaze set into the flesh completely. A pot made on Sunday feeds a family with rice through Tuesday, the fish firming and deepening with each reheat. This is the dish to learn if you want to understand why Vietnamese home cooking is built around kho.`,
    ingredientSections: [
        {
            title: 'Fish',
            items: [
                { amount: 700, unit: 'g', name: 'fresh mackerel scad (cá n?c)', note: '5-6 whole fish, cleaned and gutted, heads on or off. Substitute: small mackerel, sardines, or horse mackerel — any small oily fish.' },
        ...
        },
        {
            ...
            items: [
                { amount: 300, unit: 'g', name: 'fresh pineapple (thom)', note: 'about half a pineapple — cut into wedges 1.5cm thick. Fresh only; canned pineapple is too sweet and collapses in the braise.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 250, unit: 'ml', name: 'water or coconut water', note: 'coconut water (nu?c d?a) is the central-southern touch — adds gentle sweetness and gloss' },
