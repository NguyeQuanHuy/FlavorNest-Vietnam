...
const recipe: RecipeData = {
    slug: 'my-tron',
    title: 'Mỳ Trộn (Vietnamese Dry Mixed Noodles)',
    ...
    intro: `Mỳ trộn — mixed noodles, dry noodles, noodles without soup — is the preparation that challenges the assumption that Vietnamese noodle dishes need broth. The technique is the opposite of soup: instead of a generous ladle of liquid, the noodles are tossed in a concentrated base of fish sauce, rendered lard or shallot oil, garlic, and a small amount of the cooking broth to prevent drying. Everything that would have gone into the soup is concentrated into the sauce that coats each strand. The result is more intensely flavored than the soup version — every bite carries the full seasoning without dilution. Mỳ trộn is particularly associated with Vietnamese Chinese cooking, popular in Saigon's Cholon district and throughout the south, where the technique of dry-tossed noodles came from the Cantonese tradition of wonton noodles. The toppings vary: minced pork, sliced char siu, wontons, or simply a soft-boiled egg with herbs. The base technique — the tossing sauce — is what this recipe teaches.`,
    ingredientSections: [
        {
            title: 'Noodles',
            items: [
                { amount: 400, unit: 'g', name: 'fresh egg noodles (mỳ trứng)', note: 'thin, round — Chinese-style egg noodles from Asian grocery. Dried wonton noodles are an acceptable substitute.' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                { amount: 300, unit: 'g', name: 'minced pork (thịt heo bằm)', note: '20% fat content — lean pork produces dry, crumbly topping' },
    ...
    steps: [
        ...
        {
            title: 'Boil the eggs',
            description: 'Bring water to a full boil. Lower eggs carefully into the water. Cook for exactly 7 minutes. Transfer to ice water immediately for 5 minutes. Peel and halve. The yolk should be jammy — set at the edges, slightly soft in the center. This is the correct texture for mỳ trộn.',
            tip: 'The 7-minute egg is the mỳ trộn standard. Fully hard-boiled eggs are too dry against the rich noodle sauce. Soft-boiled (6 minutes) is too runny and makes the noodles wet.',
        },
        {
