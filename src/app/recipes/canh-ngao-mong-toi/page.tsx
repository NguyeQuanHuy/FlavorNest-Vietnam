...
const recipe: RecipeData = {
    ...
    title: 'Canh Ngao M?ng Toi (Clam and Malabar Spinach Soup)',
    subtitle: 'A Vietnamese summer soup of clams opened in white wine and ginger, their briny liquor forming the broth, with m?ng toi — Malabar spinach — added at the last moment for its silky, slightly mucilaginous texture. Ready in 20 minutes.',
    ...
    intro: `Canh ngao m?ng toi is a Vietnamese summer soup built on the principle that the best broths are the ones you do not have to make separately — the clams make their own. When live clams open over heat, they release a liquor that is simultaneously salty, sweet, and oceanic — a natural stock that no home cook can replicate by other means. The technique is fast and requires almost no cooking skill: the clams open in minutes, their liquid becomes the broth, and the m?ng toi (Malabar spinach, also called rau m?ng toi) is added only at the end because it wilts in under two minutes and its particular quality — the slightly mucilaginous, silky texture that thickens the broth slightly — is lost if cooked longer. The result is a soup that tastes far more complex than its 25-minute preparation suggests. Canh ngao m?ng toi is a hot-weather soup — light, briny, slightly cooling from the Malabar spinach — eaten at the midday meal throughout the summer months in northern and central Vietnam.`,
    ingredientSections: [
        {
            title: 'Main',
            items: [
                ...
                { amount: 200, unit: 'g', name: 'm?ng toi (Malabar spinach / rau m?ng toi)', note: 'leaves and tender stems. Vietnamese or Asian grocery. Substitute: regular spinach (different texture, similar concept).' },
    ...
    steps: [
        ...
        {
            title: 'Add m?ng toi at the last moment',
            description: 'Bring the seasoned broth to a full boil. Add the m?ng toi leaves and tender stems. Stir once. Cook for exactly 90 seconds — no more. The leaves wilt, release their slightly viscous character into the broth, and turn a deep green. Overcooked m?ng toi becomes slimy rather than silky and loses its color. Remove from heat immediately.',
            tip: 'M?ng toi releases a natural mucilage that slightly thickens the broth — this is a quality, not a flaw. It is what makes this soup different from a plain clam broth and gives it body without any starch.',
        },
        {
            title: 'Serve immediately',
            description: 'Ladle the soup into bowls, distributing the clams evenly. Scatter sliced spring onion, cilantro, and fresh chili over the top. Serve with lime wedges and steamed rice alongside. Canh ngao m?ng toi must be served and eaten immediately — the m?ng toi continues to soften from residual heat and the clams toughen if kept warm for more than a few minutes.',
