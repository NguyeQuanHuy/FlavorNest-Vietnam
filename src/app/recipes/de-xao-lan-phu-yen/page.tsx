...
const recipe: RecipeData = {
    ...
    title: 'Dê Xào Lăn Phú Yên (Phú Yên Rolled Goat Stir-Fry)',
    subtitle: 'Goat pieces stir-fried and rolled in a wok with lemongrass, galangal, mắm nhĩ, and roasted peanuts until each piece is caramelized and coated in a dry, fragrant paste that clings — the xào lăn technique where the sauce reduces completely and the aromatics become the crust.',
    ...
    intro: `Dê xào lăn is the central Vietnamese rolled stir-fry applied to goat — a preparation where xào means to stir-fry and lăn means to roll or tumble, describing the specific motion of tossing the meat continuously in the wok until the liquid marinade has evaporated completely and the aromatic paste has caramelized onto every surface in a dry, fragrant crust. The xào lăn technique is specific to central Vietnamese cooking and appears with pork, chicken, and goat — but the goat version is considered the most complete expression of the method because goat's dense, slightly gamey flesh responds to the long, dry wok treatment better than more delicate proteins. The Phú Yên version of dê xào lăn uses mắm nhĩ — the province's first-press premium fish sauce — in the marinade and in the wok sauce, which produces a caramelization that ordinary fish sauce cannot approach. The mắm nhĩ's higher concentration of amino acids and its natural sweetness caramelize at a lower temperature than standard fish sauce and produce a crust that is darker, more complex, and more aromatic. The galangal in the marinade is more prominent than in other provincial versions — Phú Yên uses galangal the way the rest of Vietnam uses ginger, generously and without restraint, and in xào lăn it provides the specific warm-piney character that defines the dish's personality. Roasted peanuts ground into the finishing paste are the element that creates the dry, slightly crunchy coating that distinguishes xào lăn from a sauced stir-fry — the peanut powder absorbs the last of the wok moisture and adheres to the caramelized meat surface, producing a texture that is simultaneously dry and intensely flavored.`,
    ingredientSections: [
        {
            title: 'Goat',
            items: [
                { amount: 700, unit: 'g', name: 'bone-in goat pieces (dê chặt miếng)', note: 'rib, shoulder, and neck — 4-5cm pieces. Bone-in essential for xào lăn — the bone conducts heat and provides the collagen that helps the paste adhere.' },
            ],
        },
        {
            title: 'Marinade',
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'mắm nhĩ (Phú Yên first-press fish sauce)', note: 'the defining seasoning — not substitutable for this dish' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1.5, unit: 'tbsp', name: 'mắm nhĩ', note: 'additional — added to the wok during cooking' },
                { amount: 0.5, unit: 'tsp', name: 'sugar' },
                { amount: 4, unit: 'tbsp', name: 'neutral oil' },
            ],
        },
        {
            title: 'Finishing — the xào lăn crust',
            items: [
    ...
    steps: [
        {
            ...
            description: 'Combine the goat pieces with lemongrass paste, galangal paste, garlic, shallots, mắm nhĩ, sugar, turmeric, black pepper, and sesame oil. Work the marinade thoroughly into every surface and between the bone and meat. Marinate for minimum 1 hour at room temperature, or up to 6 hours refrigerated. The galangal needs time to penetrate the dense goat flesh — 1 hour produces a noticeable difference versus 15 minutes.',
            tip: 'The xào lăn technique requires a well-marinated meat because the final dish has no sauce to compensate for under-seasoned meat. Every piece must carry the galangal-lemongrass character throughout — not just on the surface. Longer marination always produces a better result here.',
        },
        {
            ...
            tip: 'The initial sear without touching is what produces the caramelized crust that is the foundation of xào lăn. The marinade on the meat surface caramelizes in contact with the hot oil and forms a layer that the subsequent wok-rolling cannot achieve. Do not stir during this stage.',
        },
        {
            title: 'Build the wok paste and return the goat',
            description: 'In the same wok with remaining oil, fry extra lemongrass, garlic, and both types of chili for 45 seconds until golden and the wok smells explosively of lemongrass. Return the seared goat pieces. Add the additional mắm nhĩ and sugar — it will sizzle and immediately begin to caramelize on the hot surfaces. Begin the lăn motion: toss and roll the goat continuously, turning every piece, ensuring every surface contacts the hot wok.',
            tip: 'The lăn rolling motion is the technique that gives the dish its name and its texture. Continuous, firm tossing that tumbles each piece against the hot wok surface caramelizes the mắm nhĩ paste onto the meat in layers. Gentle stirring produces a steamed result; vigorous rolling produces the dry, caramelized crust.',
        },
        {
            title: 'The long rolling — 15-20 minutes',
            description: 'Continue the xào lăn rolling over medium-high heat for 15-20 minutes total. The key transitions to watch: at 5 minutes the liquid from the marinade is evaporating; at 10 minutes the surface should be dry and the caramelization deepening; at 15 minutes the paste should be clinging to the meat surface in a dry, slightly sticky crust. If the wok dries too quickly before the goat is cooked through, add 2 tablespoons of water and continue rolling. The goat is done when a chopstick passes through the thickest piece without resistance.',
            tip: 'The 15-20 minute rolling time for goat is significantly longer than for pork or chicken xào lăn — goat is denser and takes longer to cook through. The extended time also allows more layers of caramelization to build on the surface. This is the discipline of dê xào lăn: patience with the rolling.',
        },
        {
            title: 'Add the peanut crust — final minute',
            description: 'When the goat is fully cooked and the caramelized paste is dry and fragrant, reduce heat to medium. Add the finely ground roasted peanuts and toasted sesame seeds. Roll and toss for 60 seconds — the peanut powder absorbs the last of the wok moisture and adheres to the caramelized goat surface, creating the specific dry, slightly crunchy coating of xào lăn. Grind black pepper generously and toss once more.',
