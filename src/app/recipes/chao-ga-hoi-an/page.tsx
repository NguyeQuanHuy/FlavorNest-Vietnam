...
const recipe: RecipeData = {
    slug: 'chao-ga-hoi-an',
    title: 'Cháo Gà H?i An (H?i An Chicken Rice Porridge)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 1, name: 'lemongrass stalk', note: 'bruised — the H?i An addition' },
        ...
        },
        {
            ...
            items: [
                { amount: 30, unit: 'g', name: 'fresh ginger', note: 'peeled and finely julienned — the defining topping of H?i An cháo gà' },
    ...
    steps: [
        ...
        {
            title: 'Toast the rice — the H?i An technique',
        ...
        },
        {
            ...
            tip: 'The correct texture of H?i An cháo gà is thicker than Cantonese congee but thinner than northern Vietnamese cháo. It should coat the spoon and flow slowly. If too thick, add hot water or broth. If too thin, simmer uncovered for longer.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The freshly ground black pepper is the flavor that defines cháo gà H?i An above any other version of chicken porridge. It should be visible on the surface. Use a peppermill at the table, not pre-ground pepper. This single ingredient is the difference between a good bowl and the bowl people remember.',
        },
    ],
};
