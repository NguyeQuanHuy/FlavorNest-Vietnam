...
const recipe: RecipeData = {
    slug: 'ga-nau-ruou',
    title: 'Gà N?u Ru?u (Chicken Braised in Rice Wine)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Ru?u braise',
            items: [
                { amount: 500, unit: 'ml', name: 'ru?u d? (Vietnamese rice spirit)', note: '40-45% ABV — available at Vietnamese liquor stores. Substitute: soju, Chinese baijiu, or any clean rice spirit. Do not use sake — too mild.' },
    ...
    steps: [
        {
            ...
            tip: 'The sear is what separates gà n?u ru?u that tastes deep and complex from one that tastes merely alcoholic. The Maillard reaction on the chicken surface creates compounds that persist through the braise and give the sauce its character.',
        },
        {
        ...
        },
        {
            ...
            description: 'Return the seared chicken to the pot. Pour the ru?u d? over the chicken — it should sizzle on contact with the hot aromatics. If using a gas flame, be aware that the alcohol may briefly ignite when it hits the hot pot — this is normal and subsides in seconds as the pot is removed from the flame. Add fish sauce and sugar. Bring to a full boil.',
        ...
        },
        {
            ...
            tip: 'The final reduction is what makes gà n?u ru?u a finished dish rather than a braise in progress. The sauce at serving should be concentrated enough to cling to the chicken pieces and pool attractively on the plate beneath — not flow freely.',
        },
        {
