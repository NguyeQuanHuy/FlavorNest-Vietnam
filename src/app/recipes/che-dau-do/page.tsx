...
const recipe: RecipeData = {
    slug: 'che-dau-do',
    title: 'Chè Ð?u Ð? (Vietnamese Red Bean Sweet Soup)',
    ...
    intro: `Chè is the Vietnamese category of sweet soups and puddings — a range of desserts that Western food culture has no direct equivalent for. They are not soups in the savory sense, not puddings in the thick Western sense, but something specifically Vietnamese: a liquid dessert, lightly sweet, often warm, eaten from a glass or bowl with a spoon. Chè d?u d? — red bean sweet soup — is one of the most fundamental. Small red beans (adzuki or Vietnamese d?u d?) cooked until completely tender in water, sweetened with rock sugar, fragrant with pandan, finished with coconut cream. It is eaten warm in winter, cold in summer, and in between throughout the year. The flavor is clean and mild — Vietnamese desserts are never aggressively sweet, and chè d?u d? exemplifies this restraint. The pleasure is in the texture of the perfectly cooked beans, the fragrance of pandan, and the richness that the coconut cream adds without overwhelming.`,
    ingredientSections: [
        {
            title: 'Red bean soup',
            items: [
                { amount: 300, unit: 'g', name: 'small red beans (d?u d? / adzuki beans)', note: 'soaked overnight in cold water' },
                { amount: 1.5, unit: 'L', name: 'water' },
                { amount: 120, unit: 'g', name: 'rock sugar (du?ng phèn)', note: 'adjust to taste — Vietnamese chè is subtly sweet, not aggressively so' },
        ...
        },
        {
            ...
            items: [
                { amount: 200, unit: 'ml', name: 'coconut cream (nu?c c?t d?a)', note: 'full-fat, not coconut milk — the thick first press' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Ladle warm chè d?u d? into glasses or bowls. Spoon salted coconut cream over the top — it will float on the surface and slowly sink as you eat, mixing naturally. Serve warm for winter; refrigerate the soup and cream separately for 2 hours and serve cold for summer. Do not mix the coconut cream into the soup — it is spooned over the top at the table and mixed by the diner.',
            tip: 'Cold chè d?u d? over crushed ice is the version eaten from street vendors in southern Vietnam — add a few tablespoons of crushed ice for the authentic summer experience.',
        },
    ],
};
