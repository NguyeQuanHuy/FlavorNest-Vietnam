...
const recipe: RecipeData = {
    ...
    subtitle: `Cá Kèo Nu?ng — Mekong mangrove mudskipper grilled over charcoal, eaten whole with m?m nêm and raw vegetables.`,
    ...
    intro: `Cá kèo (Pseudapocryptes elongatus) is a mudskipper — a small, elongated fish that lives in the tidal mudflats and mangrove channels of Cà Mau, B?c Liêu, and the southern Mekong Delta coast. It breathes air through its skin, moves across mud on its pectoral fins, and is one of the most ecologically specific ingredients in Vietnamese cooking: it can only be caught from the mangrove zone, only at low tide, and only by fishermen who know the exact channels where it congregates.\n\nThe preparation is deliberately minimal. Cá kèo nu?ng is grilled whole over charcoal — no marinade, no sauce on the fish itself — until the skin blisters and chars and the flesh inside steams in its own moisture. The fish is eaten whole: skin, bones, head. The bones are soft enough to chew. The skin, slightly bitter from the mangrove diet, is considered the best part by locals.\n\nThe critical accompaniment is m?m nêm — a pungent fermented anchovy dipping sauce thinned with pineapple juice and seasoned with lemongrass and chili. Without m?m nêm, cá kèo nu?ng is incomplete. The sauce is not a condiment; it is the second half of the dish. Eaten with raw vegetables, rice paper, and herbs, this is the meal that southern fishermen eat at the edge of the water before the tide comes back in.`,
    ingredientSections: [
        {
            title: `The fish`,
            items: [
        ...
        {
            title: `M?m nêm dipping sauce (non-negotiable)`,
            items: [
                { amount: 4, unit: 'tbsp', name: `m?m nêm (fermented anchovy paste)`, note: `Bà Li?t or Thu?n Phát brand from Vietnamese grocer` },
                ...
                { amount: 4, name: `bird's eye chili (?t hi?m), minced` },
    ...
    steps: [
        ...
        },
        {
            ...
            description: `Serve fish whole on a plate — do not fillet. Each person tears pieces directly from the fish with chopsticks, wraps in a lettuce leaf or softened rice paper with herbs and cucumber, and dips the entire wrap briefly into m?m nêm sauce. The skin is eaten with the flesh. The head is cracked for the small amount of cheek meat inside. Nothing is wasted. The rice is eaten between wraps to balance the salt of the sauce.`,
            tip: `The correct wrapping order in Cà Mau: lettuce leaf first as the base, then rau ram and mint, then fish piece with skin, then a sliver of green banana if using, then fold and dip. The banana's astringency cuts through the fermented sauce and resets the palate for the next bite.`,
        },
    ],
};
