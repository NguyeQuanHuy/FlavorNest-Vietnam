...
const recipe: RecipeData = {
    ...
    title: 'B? Câu Nu?ng Mu?i ?t (Charcoal-Grilled Pigeon with Chili Salt)',
    ...
    intro: `B? câu nu?ng mu?i ?t is the charcoal-grilled pigeon of central and southern Vietnamese cooking — a preparation that applies the direct fire philosophy to the richest and darkest-fleshed of the commonly eaten Vietnamese birds, with results that are specifically different from grilled chicken or quail. Pigeon's high myoglobin content — the iron-rich protein responsible for its deep purple-brown raw color — produces a flesh that responds to charcoal heat in a specific way: the exterior caramelizes and chars more dramatically than chicken, the fat renders more slowly and more completely, and the smoke from the dripping fat produces a perfuming effect that is more concentrated than with leaner birds. The mu?i ?t marinade — lemongrass, chili, garlic, fish sauce, and the classic Vietnamese chili-salt paste — is the preparation that provides the aromatic complexity that grilled pigeon's own character supports rather than requiring. The pigeon's specific mineral depth and its fat richness carry the lemongrass-chili character in a more integrated way than chicken would — the aromatics do not sit on the surface but become part of the flesh character during the 3-hour marination and the subsequent charcoal cooking. The grilling time for pigeon — 25-30 minutes over moderate charcoal — is significantly longer than for quail and proportionally longer than for chicken of similar weight, reflecting the specific density of pigeon muscle fiber and the need for the fat to render completely before the skin can crisp. A pigeon pulled from the grill before the fat has fully rendered has soft, slightly greasy skin and a slightly raw taste at the thigh joint; a pigeon grilled the full time has rendered, crackling skin and a specific depth of flavor that the shorter cooking cannot produce. Mu?i tiêu chanh is the dipping condiment — coarse salt, black pepper, and fresh lime — that most clearly serves the charcoal pigeon because it provides the mineral brightness that the dark, fatty flesh needs without competing with the specific character of the bird.`,
    ingredientSections: [
        {
            title: 'Pigeon',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch Vietnamese balm (rau kinh gi?i)', note: 'essential alongside grilled pigeon' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The two-zone fire for b? câu nu?ng is essential — not a suggestion. Pigeon fat at a high rendering rate produces flare-ups that can char the exterior completely in seconds while the interior remains undercooked. The indirect zone is the management tool that allows the long, slow rendering the dish requires.',
        },
        {
        ...
        },
        {
            ...
            description: 'Chop the grilled pigeon through the bone into serving pieces with a heavy cleaver. The Vietnamese balm (rau kinh gi?i) alongside charcoal pigeon is the herb pairing that most specifically complements the dark, smoky, slightly mineral character of the bird — its menthol-lemon note is more compatible with pigeon than the milder rau ram or mint. Arrange the chopped pieces on a plate. Serve with mu?i tiêu chanh, all the herbs, cucumber, lime, and rice.',
            tip: 'Vietnamese balm as the primary herb for grilled pigeon is the specific knowledge that separates Vietnamese cooks who grew up eating b? câu nu?ng from those who did not. Every grilled bird in the Vietnamese repertoire has a specific herb pairing: quail with rau ram, chicken with rau ram and mint, duck with perilla, pigeon with rau kinh gi?i. The herb pairing is not interchangeable.',
        },
    ],
};
