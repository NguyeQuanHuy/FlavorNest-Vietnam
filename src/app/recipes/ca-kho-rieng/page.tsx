...
const recipe: RecipeData = {
    slug: 'ca-kho-rieng',
    title: 'Cá Kho Ri?ng (Fish Braised with Galangal)',
    ...
    intro: `Cá kho ri?ng is the galangal-braised fish of northern Vietnam — a kho preparation that is as specifically northern as cá tr?m kho c?n and that demonstrates the fundamental aromatic difference between northern and southern Vietnamese kho cooking. In the south, ginger (g?ng) is the dominant kho aromatic — appearing in cá trê kho t?, v?t kho g?ng, and the fish kho preparations of the Mekong Delta in the starring role. In the north, galangal (ri?ng) holds this position — a rhizome that is related to ginger but produces a significantly different aromatic character: warmer, more complex, with a specific piney-citrus note that ginger does not have and that pairs with freshwater fish in a way that makes cá kho ri?ng taste both more intensely spiced and more specifically northern than any southern kho preparation. Ri?ng — fresh galangal, Alpinia galanga — has been used in northern Vietnamese cooking for centuries, appearing in the five-spice mixture of the north (which differs from the southern version in its galangal content), in the marinades for northern grilled meats, and most prominently in the kho preparations of the Red River Delta. The quantity used in cá kho ri?ng is the quantity that marks the cook as northern: 80-100g of fresh galangal for 700-800g of fish, sliced thicker than for southern preparations so that each piece remains identifiable in the finished kho rather than dissolving into the sauce. The galangal in the finished dish is eaten as a food in itself rather than discarded — the long braising time softens it to a yielding, intensely flavored piece that is the most prized element of the bowl for those who grew up eating cá kho ri?ng.`,
    ingredientSections: [
        {
            title: 'Fish',
            items: [
                { amount: 700, unit: 'g', name: 'freshwater fish sections', note: 'cá tr?m, cá chép, or cá rô phi — bone-in sections 5-6cm. Score each section once.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 90, unit: 'g', name: 'fresh galangal (ri?ng tuoi)', note: 'peeled and sliced 3-4mm thick — thick enough to remain identifiable in the finished kho. This is the starring ingredient.' },
                ...
                { amount: 1, unit: 'tsp', name: 'fermented shrimp paste (m?m tôm)', note: 'small amount — the northern umami addition that southern kho does not use' },
            ],
        },
        {
    ...
    steps: [
        {
            ...
            description: 'Combine fish sections with fish sauce, turmeric, and black pepper. Toss to coat. Marinate 20 minutes. The turmeric in cá kho ri?ng provides a golden base that works visually and aromatically with the galangal — both have warm, slightly earthy characters that reinforce each other. The turmeric gold beneath the dark caramel produces the specific appearance of northern fish kho that is different from the uniform dark brown of southern versions.',
        ...
        },
        {
            ...
            tip: 'The galangal pieces in the finished cá kho ri?ng — soft, dark with absorbed caramel, intensely flavored throughout — are eaten and prized rather than discarded. This is the northern understanding of galangal in kho: not an aromatic to be removed but a vegetable-condiment to be consumed. In the south, galangal matchsticks in kho are often thinner and more fully dissolved; in the north, the thick slices remain identifiable and are the most anticipated pieces in the pot.',
        },
        {
            title: 'Finish and serve',
            description: 'Add shredded kaffir lime leaves, sliced spring onion, and freshly ground black pepper. The finished cá kho ri?ng: dark, thick sauce coating the fish and the galangal pieces equally, the piney-citrus fragrance of the galangal still present through the caramel depth. Serve from the clay pot with plain hot rice. The galangal pieces should be distributed to each bowl alongside the fish — they are not garnish but an equal component of the dish.',
            tip: 'Serving the galangal pieces equally with the fish sections is the northern table manner for cá kho ri?ng that most clearly expresses the dish\'s philosophy. The galangal is not extracted before service; it is an equal component. A bowl of cá kho ri?ng that contains only fish and no galangal is an incomplete bowl.',
        },
    ],
};
