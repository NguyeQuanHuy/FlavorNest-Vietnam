...
const recipe: RecipeData = {
    ...
    title: 'B? Câu Quay M?t Ong (Honey-Roasted Pigeon)',
    subtitle: 'Pigeon marinated in five-spice, Shaoxing wine, and soy sauce then lacquered with multiple layers of honey glaze and roasted until the skin turns deep mahogany and shatters — the Vietnamese-Cantonese roasted pigeon of Ch? L?n that achieves in a home oven what Cantonese restaurants produce with professional rotisseries.',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'Shaoxing wine (ru?u Thi?u Hung)' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The first honey glaze application before the moderate-heat roasting phase provides the base caramelization layer — the foundation that subsequent glaze applications build on. Without this first layer, the skin never develops the depth of color that b? câu quay m?t ong requires.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The skin shattering at the cleaver contact is the confirmation of a correctly roasted b? câu quay m?t ong — the same confirmation as for v?t nu?ng chao. If the skin is intact when cut but does not shatter, the air-drying was insufficient or the blast phase too short. Still delicious — but the specific lacquered-shattering quality that defines the preparation is a matter of technique, not of taste.',
        },
    ],
};
