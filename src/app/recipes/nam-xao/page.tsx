...
const recipe: RecipeData = {
    slug: 'nam-xao',
    title: 'N?m Xào (Vietnamese Stir-Fried Mushrooms)',
    ...
    intro: `N?m xào is the Vietnamese stir-fried mushroom dish that works because of one principle: mushrooms contain more natural umami than almost any other vegetable, and stir-frying at high heat concentrates that umami by evaporating the water they release. A mushroom dropped into a cold pan releases liquid and steams — it becomes pale, waterlogged, and flavorless. The same mushroom dropped into a smoking hot wok without crowding hits the hot metal surface, the moisture evaporates immediately, and the natural sugars and glutamates caramelize into a golden crust. The Vietnamese version adds oyster sauce (itself intensely umami), garlic, a touch of butter for richness, and spring onion at the end for freshness. The result tastes more savory and satisfying than the ingredients would suggest. Vietnamese cooks use whatever mushrooms are available and in season — king oyster (n?m dùi gà), oyster (n?m sò), shiitake (n?m huong), enoki (n?m kim châm), and wood ear (m?c nhi) are all common. The technique is the same regardless of the mushroom; only the timing changes slightly.`,
    ingredientSections: [
        {
            title: 'Mushrooms',
            items: [
                { amount: 500, unit: 'g', name: 'mixed fresh mushrooms', note: 'any combination: king oyster (n?m dùi gà), oyster (n?m sò), shiitake (n?m huong), button. Tear large mushrooms by hand rather than cutting — the torn surface caramelizes better.' },
                { amount: 100, unit: 'g', name: 'enoki mushrooms (n?m kim châm)', note: 'added at the end — they cook in 30 seconds' },
            ],
        },
        {
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a plate immediately. Drizzle a few drops of sesame oil over the top. Scatter fresh chili. Serve with steamed rice. N?m xào is best eaten within 5 minutes of cooking — mushrooms release moisture as they sit and the caramelized crust softens. This is a dish that waits for nobody.',
