...
const recipe: RecipeData = {
    ...
    subtitle: `Bánh Bò Th?t N?t — An Giang's Khmer steamed rice cake, risen with toddy palm sugar and coconut milk into a golden honeycomb crumb.`,
    category: 'DESSERT',
    difficulty: 'Medium',
    totalTime: '4 hrs',
    rating: 4.9,
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 200, unit: 'g', name: `toddy palm sugar (du?ng th?t n?t)`, note: `grated or broken — sold in round cakes at Asian grocers; do not substitute` },
        ...
        },
        {
            ...
            items: [
                { amount: 400, unit: 'ml', name: `fresh coconut milk (nu?c c?t d?a)`, note: `full-fat, room temperature — cold coconut milk inhibits fermentation` },
                { amount: 150, unit: 'ml', name: `warm water`, note: `40°C — warm enough to dissolve sugar, not hot enough to kill yeast` },
                { amount: 7, unit: 'g', name: `instant dry yeast (men n?)`, note: `1 standard sachet — activates the honeycomb rise` },
                { amount: 1, unit: 'tsp', name: `sugar`, note: `to feed the yeast during proofing` },
                { amount: 2, unit: 'tbsp', name: `fresh toddy palm sap (nu?c th?t n?t tuoi)`, note: `optional — if available near Khmer community in Germany; adds authentic fermented depth` },
            ],
        },
        {
            title: `For steaming`,
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `Ðu?ng th?t n?t varies in hardness between brands. Some cakes need grating on a box grater; others break apart easily. The dissolved syrup should smell of caramel and faintly of smoke — this is the characteristic toddy palm note that makes the cake identifiable from across a room.`,
        },
        {
        ...
        },
        {
            ...
            description: `Bánh bò th?t n?t is served at room temperature, never hot. The texture firms slightly as it cools — the bounce and chew that define the cake only develop fully once cooled. Serve whole or sliced into wedges. In An Giang, it is eaten plain as an afternoon snack with hot tea, or alongside chè (sweet soup) as a dessert combination. The palm sugar flavour deepens over the first 2 hours after steaming — the cake eaten the next morning is better than the cake eaten immediately.`,
