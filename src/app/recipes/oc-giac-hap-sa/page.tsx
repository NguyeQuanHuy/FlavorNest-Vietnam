...
const recipe: RecipeData = {
    slug: 'oc-giac-hap-sa',
    title: '?c Giác H?p S? (Turban Snails Steamed with Lemongrass)',
    subtitle: 'Large turban snails from the rocky coastal waters of central Vietnam steamed over lemongrass, ginger, and beer until the shells turn iridescent and the flesh inside is firm, sweet, and slightly briny — eaten with the curved Vietnamese snail pick and mu?i tiêu chanh, the most honest preparation for the finest marine snail in the country.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '25 min',
    rating: 4.9,
    ...
    intro: `?c giác is the turban snail — Turbo marmoratus and related species — the large, heavy-shelled marine snail that lives on rocky subtidal reefs along the central Vietnamese coastline, from Qu?ng Nam through Phú Yên to Khánh Hòa. It is the largest and most prized of all the ?c (snail) species eaten in Vietnam: the shell can reach 15cm in diameter, the meat inside is substantial, and the flavor is more complex and more distinctly marine than the freshwater snails that dominate the northern and Mekong Delta menus. ?c giác is a coastal snail — it is available only where the sea is clean, the reefs are intact, and the fishing boats go out to the rocky areas rather than the sandy shallows. In markets along the Phú Yên coast, at the seafood restaurants of Ðà N?ng, and at the rocky-shore food stalls of Nha Trang, ?c giác is sold live, by weight, and priced at a premium that reflects both its size and its scarcity. The h?p s? preparation — steaming over lemongrass and beer — is the dominant cooking method because it is the one that preserves the snail's natural briny sweetness without adding flavors that compete with it. The beer steam carries the lemongrass aromatic into the shells while the snail cooks in its own moisture, and the result is a turban snail that tastes clearly of the reef it came from with the specific citrus-grass note of lemongrass as a background accent. The mu?i tiêu chanh served alongside is calibrated to the specifically marine character of ?c giác — more lime, less pepper than the version served with freshwater snails — because ?c giác needs brightness more than heat to complete it.`,
    ingredientSections: [
        {
            title: 'Turban snails',
            items: [
                { amount: 1.5, unit: 'kg', name: 'live turban snails (?c giác)', note: 'alive and active — available at coastal Vietnamese seafood markets and some Asian specialty markets. Weight includes heavy shells. If unavailable: large abalone, large periwinkles, or any large live marine snail.' },
        ...
        {
            title: 'Mu?i tiêu chanh (calibrated for marine snails)',
            items: [
                { amount: 1.5, unit: 'tsp', name: 'flaky sea salt', note: 'flaky rather than coarse — better texture against the large snail pieces' },
                { amount: 1, unit: 'tsp', name: 'freshly ground black pepper', note: 'slightly less than usual — ?c giác needs lime more than pepper' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The two-can beer bath for turban snails reflects the difference in shell thickness between ?c giác and the lighter shells of gh? or tôm. The heavy turban shell absorbs and conducts heat more slowly — more steam volume compensates by maintaining the steaming environment for longer without the liquid running low.',
        },
        {
        ...
        {
            title: 'Make the marine mu?i tiêu chanh',
            description: 'Combine flaky sea salt with freshly ground black pepper on individual small plates — slightly less pepper than for freshwater snails. Squeeze generous amounts of lime at the table — more lime than for any other mu?i tiêu chanh preparation. The lime is the primary condiment for ?c giác: its brightness amplifies the marine sweetness of the snail in a way that pepper heat does not. Add minced chili if desired.',
            tip: 'The ratio adjustment — more lime, less pepper — for ?c giác mu?i tiêu chanh reflects the difference between marine and freshwater snail flavors. Freshwater snails benefit from more pepper to counter their earthier character. Marine snails need more lime to amplify their briny sweetness. The condiment calibration is the acknowledgment of this difference.',
        },
        {
            title: 'Extract with the curved pick and eat',
            description: 'Scatter shredded kaffir lime leaves and sliced spring onion over the plate of steamed snails. Serve with the mu?i tiêu chanh, rau ram, finger bowls, and curved snail picks. To extract: remove the operculum first with the pick. Insert the pick into the shell at the angle of the spiral and rotate slightly — following the helix of the shell interior. The snail meat comes out in a spiral piece. The innermost part of the spiral, the darkest section, is the viscera — eaten by some, discarded by others. Dip the extracted meat in the lime-squeezed mu?i tiêu chanh. Eat with rau ram.',
