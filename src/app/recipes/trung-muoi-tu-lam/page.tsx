...
const recipe: RecipeData = {
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The 30-day room temperature cure is the standard for Vietnamese trứng muối. At cooler temperatures (below 18°C), extend to 35-40 days. At warmer temperatures (above 28°C), check at 25 days — the cure may be complete earlier. Test at the 25-day mark by cracking one egg: the yolk should be firm and deep orange throughout.',
        },
        {
        ...
        },
        {
            ...
            description: 'Remove the cured eggs from the brine. Rinse each shell. To use in bánh nướng Trung Thu or other baked preparations: separate the yolk from the white by cracking the egg, rinsing the yolk under water, and patting dry. Brush the yolk lightly with sesame oil and bake at 150°C for 5 minutes before using as a filling — this firms the yolk further and reduces any sulfur character. To eat alongside rice or congee: hard-boil the whole salted egg (12 minutes), cool, peel, halve. The yolk will be deep orange and slightly sandy at the center.',
            tip: 'The pre-baking of salted egg yolks before using in bánh nướng is the step that most home recipes omit and that makes the difference between a yolk that runs into the surrounding paste (not pre-baked) and a yolk that holds its shape and provides a distinct golden sphere in the cut mooncake (pre-baked). Five minutes at 150°C is sufficient.',
        },
        {
