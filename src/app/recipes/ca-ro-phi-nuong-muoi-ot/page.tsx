...
const recipe: RecipeData = {
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: 'm?m nêm (fermented anchovy paste)', note: 'thinned with 2 tbsp pineapple juice + 1 tsp sugar + 1 tbsp water + minced garlic and chili' },
                { amount: 3, unit: 'tbsp', name: 'fish sauce', note: 'for nu?c m?m g?ng alternative' },
                { amount: 2, unit: 'tbsp', name: 'lime juice', note: 'for nu?c m?m g?ng' },
                { amount: 25, unit: 'g', name: 'fresh ginger', note: 'microplane-grated — for nu?c m?m g?ng' },
                { amount: 1, unit: 'tsp', name: 'sugar', note: 'for nu?c m?m g?ng' },
                { amount: 3, unit: 'tbsp', name: 'water', note: 'for nu?c m?m g?ng' },
            ],
        },
        {
    ...
    steps: [
        {
            ...
            tip: 'The 1-hour minimum marination for cá rô phi nu?ng is longer than the 20 minutes needed for frying the same fish because the lower heat of charcoal grilling means the paste does more of the flavoring work. In deep-frying, the oil seals the paste character into the surface instantly; in charcoal grilling, the paste caramelizes gradually over 20-25 minutes and the initial marination penetration is what produces flavor throughout the flesh.',
        },
        {
        ...
        },
        {
            ...
            description: 'For m?m nêm: combine with pineapple juice, sugar, water, and minced garlic and chili. For nu?c m?m g?ng: combine fish sauce, lime juice, grated ginger, sugar, and water. Both sauces suit charcoal tilapia — serve one or both. The m?m nêm provides pungent contrast to the mild, smoky fish; the nu?c m?m g?ng provides clean brightness. At a family dinner, serving both allows each diner to choose.',
            tip: 'Serving both dipping sauces is the practical approach for a family dinner with charcoal tilapia because preferences diverge sharply between m?m nêm (strongly flavored, acquired-taste) and nu?c m?m g?ng (clean, universally accessible). Making both takes 5 minutes and produces a table where no one is excluded from the meal by condiment preference.',
        },
        {
