...
const recipe: RecipeData = {
    ...
    subtitle: 'Glutinous rice soaked in lye water until translucent and amber, wrapped in bamboo leaves and boiled until the rice becomes uniquely dense, chewy, and slightly alkaline — eaten with honey or palm sugar syrup. The Tết dumpling that tastes like no other rice preparation on earth.',
    category: 'DESSERT',
    difficulty: 'Hard',
    totalTime: '12 hr',
    rating: 4.9,
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 150, unit: 'g', name: 'split yellow mung beans (đậu xanh)', note: 'soaked 2 hours, steamed until soft, mixed with 1 tbsp sugar and pinch of salt. Optional — many versions are plain rice only.' },
            ],
        },
        {
            title: 'Serving syrups',
            items: [
                { amount: 4, unit: 'tbsp', name: 'honey (mật ong)', note: 'the classic accompaniment — drizzled generously over the sliced dumpling' },
                { amount: 100, unit: 'g', name: 'palm sugar (đường thốt nốt)', note: 'melted with 3 tbsp water into a syrup — the alternative to honey, preferred in southern Vietnam' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'Food-grade lye water (nước tro tàu) is sold specifically for bánh tro and mooncake production. The small bottles labeled "alkaline solution" or "lye water" at Vietnamese grocery stores are what you need. Never use industrial lye.',
        },
        {
