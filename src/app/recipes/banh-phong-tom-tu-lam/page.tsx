...
const recipe: RecipeData = {
    ...
    title: 'Bánh Ph?ng Tôm T? Làm (Homemade Shrimp Crackers)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 250, unit: 'g', name: 'tapioca starch (b?t nang)', note: 'the primary starch — produces the characteristic airy expansion when fried' },
                { amount: 50, unit: 'g', name: 'glutinous rice flour (b?t n?p)', note: 'small amount — adds cohesion and a slight chewiness to the expanded cracker' },
