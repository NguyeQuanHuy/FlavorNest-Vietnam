...
const recipe: RecipeData = {
    slug: 'mien-xao-cua',
    title: 'Mi?n Xào Cua (Glass Noodles Stir-Fried with Crab)',
    ...
    intro: `Mi?n xào cua is the glass noodle stir-fry of northern Vietnam — a dish that occupies an important place in the everyday cooking of Hanoi and the Red River Delta, where cua d?ng (freshwater field crabs) have been a primary protein source for generations and glass noodles (mi?n, made from mung bean or canna starch) provide the vehicle that stretches a modest amount of crab meat into a full meal. The glass noodle is the ideal ingredient for this purpose: it absorbs the wok heat and the crab-seasoned oil during stir-frying to become slightly translucent and golden at the edges, with a texture that is simultaneously silky and slightly chewy, carrying the flavor of the seasoning throughout rather than merely as a coating. The crab in mi?n xào cua is typically freshwater crab from the delta fields — picked and mixed with egg in the northern tradition, so that the crab meat is never in distinct pieces but distributed throughout the noodle in small fragments that flavor every strand. The wood ear mushrooms provide the contrasting dark texture that makes the dish visually interesting and texturally complete. Mi?n xào cua is a practical dish — faster and simpler than most Vietnamese noodle preparations, achievable on any weeknight with ingredients that keep well — and a genuinely delicious one, with the specific quality that glass noodles stir-fried in a properly hot wok possess: slightly caramelized, glossy, clinging to the wok seasoning in a way that rice or wheat noodles do not.`,
    ingredientSections: [
        {
            title: 'Glass noodles',
            items: [
                { amount: 200, unit: 'g', name: 'dried glass noodles (mi?n)', note: 'mung bean glass noodles preferred — thicker than cellophane noodles, better for wok stir-frying. Soak in cold water for 20 minutes until pliable, drain, and cut into 10cm lengths with scissors.' },
            ],
        },
        {
            title: 'Crab and egg',
            items: [
                { amount: 250, unit: 'g', name: 'fresh crab meat (th?t cua)', note: 'picked from freshwater field crabs or any fresh crab. Canned crab meat works but produces a noticeably milder result. If using whole cua d?ng: pound and strain as for cháo cua d?ng — the crab extract method produces richer flavor than picked meat alone.' },
                { amount: 3, name: 'eggs', note: 'beaten and mixed with the crab meat — this combination is specific to northern Vietnamese mi?n xào cua' },
        ...
        },
        {
            ...
            items: [
                { amount: 30, unit: 'g', name: 'dried wood ear mushrooms (m?c nhi)', note: 'soaked 20 minutes in warm water, drained, tough stems removed, julienned into thin strips — the essential texture contrast' },
                { amount: 30, unit: 'g', name: 'dried shiitake mushrooms (n?m dông cô)', note: 'soaked 20 minutes, drained, stems removed, thinly sliced — adds depth' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The crab-egg combination is the specific northern Vietnamese approach to mi?n xào cua. Southern Vietnamese versions often use distinct crab pieces. The northern approach distributes the crab more completely through the dish and makes a smaller quantity of crab go further.',
        },
        {
