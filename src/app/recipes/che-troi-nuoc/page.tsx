...
const recipe: RecipeData = {
    ...
    intro: `Chè trôi nu?c is a traditional Vietnamese dessert made of glutinous rice balls filled with mung bean, served in warm ginger syrup and topped with coconut milk.
