...
const recipe: RecipeData = {
    ...
    title: 'G?i Cu?n Bánh Ph?ng Tôm (Fresh Rolls Wrapped in Shrimp Crackers)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 200, unit: 'g', name: 'pork belly (ba ch?)', note: 'boiled 30 minutes, cooled, sliced 5mm thin' },
        ...
        {
            title: 'Peanut dipping sauce (tuong hoisin d?u ph?ng)',
            items: [
                { amount: 3, unit: 'tbsp', name: 'hoisin sauce' },
                { amount: 2, unit: 'tbsp', name: 'peanut butter', note: 'smooth — combined with hoisin for the classic g?i cu?n dipping sauce' },
    ...
    steps: [
        {
            ...
            tip: 'The pork belly for g?i cu?n bánh ph?ng tôm should be cooled to room temperature or refrigerated before slicing — cold pork slices more cleanly and holds its shape better on the cracker. Warm pork compresses and tears when placed on the cracker surface.',
        },
        {
            ...
            tip: 'The peanut-hoisin sauce for g?i cu?n is the dipping sauce that most specifically complements the shrimp cracker wrapper — the peanut richness and the hoisin sweetness amplify the shrimp character of the cracker in a way that the lighter nu?c ch?m does not. Serve both sauces if possible and let each diner choose.',
        },
        {
        ...
        },
        {
            ...
            description: 'OPEN-FACE METHOD: Place the flat fried cracker on a small plate. Layer lettuce, vermicelli, cucumber, and bean sprouts across the center. Place 2-3 shrimp halves cut-side up. Add pork belly slices, rau ram, and mint. Eat immediately by picking up the cracker with both hands and biting from one end — the cracker shatters with the first bite. CONE METHOD: Gently curve the warm cracker into a cone shape, hold with one hand, fill the cone with the filling components, and eat from the open end.',
        ...
        },
        {
            ...
            description: 'G?i cu?n bánh ph?ng tôm must be eaten immediately after assembly — within 60 seconds of the filling being placed on the cracker. The moisture from the vegetables and the weight of the filling will begin softening the cracker after 60-90 seconds, and the specific shattering quality that makes this preparation different from rice paper g?i cu?n will be lost. Assemble one at a time, eat immediately, assemble the next. This is the fastest-eating g?i cu?n in the collection — and one of the most satisfying.',
            tip: 'The comparison between eating g?i cu?n bánh ph?ng tôm and eating the same filling in rice paper demonstrates what wrapper texture does to an eating experience. The rice paper version is meditative and gradual — each bite yields gently and the flavors arrive in sequence. The shrimp cracker version is immediate and complete — the cracker shatters, all the filling arrives at once, and the shrimp-cracker flavor combines with the herbs and shrimp and pork in one sudden complete mouthful. Both are correct. They are different meals from the same ingredients.',
        },
    ],
};
