...
const recipe: RecipeData = {
    ...
    title: 'Tôm Rang Muối Tiêu (Salt and Pepper Shrimp)',
    ...
    intro: `Tôm rang muối tiêu is the Vietnamese salt and pepper shrimp — the preparation that most completely demonstrates what heat does to a shrimp shell. A raw shrimp shell is tough, chewy, and inedible. A shell that has been deep-fried at 180°C for three minutes is thin, crisp, and shatters between the teeth like a cracker — and carries the concentrated flavor of the seasoning crust that coats it. The Vietnamese rang muối technique — dry-roasting in a seasoned salt mixture — is applied after the initial deep-frying, so that the already-crispy shells receive a second layer of caramelization as the salt, pepper, garlic, and aromatics toast in the dry wok heat. The result is shrimp with a crust that is simultaneously the shell itself, made crispy, and the seasoning mixture fused onto its surface. Tôm rang muối tiêu is the beer food that Vietnamese coastal restaurants serve by the kilogram at long communal tables on warm evenings — the kind of dish where you eat with your fingers, the pile of empty shells grows steadily on the newspaper-covered table, and the conversation and cold lager and the fragrance of the lemongrass in the seasoning are equally important. It requires no tools, no utensils, and almost no preparation beyond the frying and the seasoning — the entire active cooking time is under 10 minutes. The patience required is for the oil to reach the correct temperature and for the wok to reach the correct heat for the rang muối step. Both matter more than any technique.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
                { amount: 800, unit: 'g', name: 'fresh shrimp, whole (tôm tươi)', note: 'medium size — 30-40 count per 500g. Shell-on, head-on. The shell must be thin enough to eat after frying — very large shrimp have shells too thick to become fully edible. Fresh is essential; frozen works but produces slightly softer shells.' },
                { amount: 500, unit: 'ml', name: 'neutral oil', note: 'for deep frying' },
            ],
        },
        {
            title: 'Rang muối seasoning',
            items: [
                ...
                { amount: 3, unit: 'tbsp', name: 'neutral oil', note: 'for the rang muối wok step' },
            ],
        },
        {
            title: 'To serve',
            items: [
                ...
                { amount: 1, name: 'bunch rau răm', note: 'to eat between shrimp' },
            ],
        },
    ],
    steps: [
        {
            ...
            tip: 'The only preparation is rinsing, trimming the rostrum, and thorough drying. Any additional preparation — peeling, deveining extensively, removing heads — works against the dish. The whole shrimp, shell and head intact, is what makes tôm rang muối tiêu what it is.',
        },
        {
        ...
        {
            title: 'Prepare the rang muối mixture',
            description: 'Combine salt, black pepper, and sugar in a small bowl — mix well. Have the finely minced lemongrass, sliced garlic, shredded kaffir lime leaves, and sliced chili ready and separate. The rang muối step moves quickly and everything must be prepared before the wok goes on the heat.',
            tip: 'The lemongrass for tôm rang muối must be minced to an almost-paste consistency — large fibrous pieces do not caramelize properly in the dry wok and remain raw-tasting against the seasoned shrimp. Pound in a mortar first if needed.',
        },
        {
            title: 'Rang muối — the dry wok technique',
