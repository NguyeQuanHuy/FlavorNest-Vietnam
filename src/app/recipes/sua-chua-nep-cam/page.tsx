...
const recipe: RecipeData = {
    ...
    intro:
        'S?a chua n?p c?m is Hanoi\'s most elegant street dessert — a small glass of homemade yoghurt topped with warm, wine-dark sticky rice cooked in coconut milk. The contrast between cold tangy yoghurt and warm fragrant rice is one of those combinations that feels inevitable once you taste it. The black glutinous rice (n?p c?m) turns a deep burgundy-purple when cooked, bleeding beautifully into the white yoghurt beneath. It is slow food — the yoghurt needs hours to set — but almost entirely hands-off.',
    ingredientSections: [
        {
            title: 'Homemade yoghurt (s?a chua)',
            items: [
        ...
        {
            title: 'Black sticky rice (n?p c?m)',
            items: [
