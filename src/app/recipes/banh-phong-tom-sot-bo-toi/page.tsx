...
const recipe: RecipeData = {
    ...
    title: 'Bánh Ph?ng Tôm S?t Bo T?i Parmesan (Shrimp Crackers with Garlic Butter and Parmesan)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tsp', name: 'dried chili flakes (?t khô)', note: 'the heat note that balances the butter richness' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The lime juice squeezed at the very end of bánh ph?ng tôm s?t bo t?i is the element that prevents the butter-parmesan combination from tasting heavy or one-dimensional. The same logic applies here as in the butter-garlic oyster preparation: the acid brightens the richness and makes the snack feel complete rather than merely indulgent.',
        },
        {
