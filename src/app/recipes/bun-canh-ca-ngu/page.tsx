...
const recipe: RecipeData = {
    ...
    title: 'Bún Canh Cá Ng? (Tuna Noodle Soup)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 400, unit: 'g', name: 'fresh tuna loin (cá ng? d?i duong)', note: 'sashimi-grade preferred — sliced 5-6mm thin against the grain. The hot broth cooks the slices in the bowl. If not comfortable with rare tuna: briefly sear each slice in a hot pan 30 seconds per side before serving.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'fermented shrimp paste (m?m ru?c)', note: 'Phú Yên style — served alongside for those who want it' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            description: 'Hold halved shallots and halved onion cut-side down over a gas flame with tongs until deeply blackened — about 4 minutes each. Alternatively, broil cut-side up at maximum heat for 6-8 minutes. The char adds sweetness and depth to the tuna broth in the same way it functions in ph?. Lightly scrape off the most aggressively burnt exterior — a little char is correct, bitter black is too much.',
        ...
        },
        {
            ...
            tip: 'A well-made bún canh cá ng? broth should taste complete on its own — rich enough to drink as a soup. If it tastes thin or watery, it needs more simmering time or more bones in the original batch.',
        },
        {
        ...
        },
        {
            ...
            description: 'Blanch bún noodles in boiling water 30 seconds, drain, divide among deep bowls. Arrange raw or briefly seared tuna slices over the noodles. Ladle the boiling hot broth generously over the tuna — the heat of the broth cooks the thin slices to medium-rare in 30-60 seconds. Drizzle shallot oil over each bowl. Top with spring onion, dill, rau ram, and crispy fried shallots. Serve immediately with bean sprouts, lime, chili, and m?m ru?c on the side.',
