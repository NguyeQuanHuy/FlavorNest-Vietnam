...
const recipe: RecipeData = {
    ...
    title: 'Bánh Tráng Trứng Nướng (Grilled Rice Paper with Egg)',
    subtitle: 'The Đà Lạt street food that became a national obsession — a crispy rice paper base grilled over charcoal, cracked egg spread across the surface, topped with spring onion oil, dried shrimp, and chili sauce, folded in half and eaten in two bites.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '20 min',
    rating: 4.9,
    ...
    intro: `Bánh tráng trứng nướng is the dish that demonstrates the Vietnamese genius for transforming simple ingredients into something irresistible. A single sheet of dried rice paper. One egg. Spring onion oil. Dried shrimp. Chili sauce. Grilled over charcoal until the rice paper crackles and the egg sets in a thin, lacy layer across the surface. Folded in half, handed over, eaten immediately in the mountain cool of Đà Lạt where the dish originated. It has since spread to every city in Vietnam — sold from carts, from market stalls, from the back of motorcycles at night markets. The ingredients cost almost nothing. The technique requires three minutes. The result is one of the most addictive things in Vietnamese street food. This recipe gives two methods: the correct charcoal method, and a home griddle method that produces a very good approximation.`,
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tbsp', name: 'scallion oil (dầu hành)', note: 'made from hot oil poured over sliced spring onion — see step 2' },
                { amount: 1, unit: 'tsp', name: 'dried shrimp (tôm khô)', note: 'small, orange-pink, pre-soaked 10 min in water then drained' },
                { amount: 1, unit: 'tsp', name: 'Vietnamese chili sauce (tương ớt)', note: 'or sriracha — the finishing heat' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'When the egg is fully set and the bottom of the rice paper is crisp and beginning to show golden brown patches, fold the rice paper in half using a spatula or tongs — toppings facing inward, crispy rice paper on the outside. The heat will finish pressing the toppings into the egg. Serve immediately on a small plate or wrapped in paper. Eat in two bites while still hot — bánh tráng trứng nướng exists only in the present tense.',
