...
const recipe: RecipeData = {
    slug: 'oc-mo-xao-me',
    title: '?c M? Xào Me (Periwinkle Snails Stir-Fried with Tamarind)',
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Palm sugar for ?c m? xào me produces a darker, more caramel-forward tamarind sauce than white sugar. The palm sugar\'s specific flavor compounds caramelize differently in the wok heat and produce a sauce color — deep mahogany — that white sugar does not achieve. If palm sugar is unavailable, dark brown sugar is the closest substitute.',
        },
        {
            title: 'Stir-fry aromatics until golden',
            description: 'Heat wok over maximum heat until smoking. Add oil. Add sliced garlic and shallots — fry for 45-60 seconds until golden at the edges. The garlic slices should be golden-to-slightly-charred at the edges — for ?c m? xào me specifically this slight char is intentional and adds a bitter note that balances the sweet tamarind. Add minced bird\'s eye chili and fry 20 seconds.',
        ...
        },
        {
            ...
            tip: 'The visual endpoint of ?c m? xào me: each small snail should be individually glazed in the dark tamarind-palm sugar sauce, visibly glistening, with no excess sauce pooling at the bottom of the wok. The snails should look like small dark lacquered spheres — uniform and glossy. This is the correct result.',
        },
        {
