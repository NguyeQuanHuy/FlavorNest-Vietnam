...
const recipe: RecipeData = {
    ...
    title: 'M?c Nh?i Th?t H?p G?ng (Stuffed Squid Steamed with Ginger)',
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The cross-section of m?c nh?i th?t h?p when cut into rounds is the visual that makes this preparation one of the most elegant in the Vietnamese seafood collection — the clean white circle of squid surrounding the darker, textured filling is naturally beautiful and requires no garnishing beyond the cilantro and ginger julienne already on the plate.',
        },
    ],
};
