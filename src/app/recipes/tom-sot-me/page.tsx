...
const recipe: RecipeData = {
    slug: 'tom-sot-me',
    title: 'Tôm S?t Me (Shrimp in Tamarind Sauce)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2.5, unit: 'tbsp', name: 'palm sugar (du?ng th?t n?t)', note: 'or brown sugar. Palm sugar has a deeper, more caramel note that suits tamarind specifically.' },
    ...
    steps: [
        {
            ...
            tip: 'Tamarind paste varies significantly by brand in both sourness and sweetness. Always taste before using and calibrate — the best tôm s?t me is balanced, not aggressively sour.',
        },
        {
        ...
        },
        {
            ...
            description: 'Transfer immediately to a serving plate. Scatter spring onion, sliced chili, cilantro, and crushed peanuts if using over the top. Serve with lime wedges and steamed jasmine rice. The sauce that drips from the glazed shrimp onto the rice is the secondary pleasure of the dish — spoon it over the rice deliberately. Tôm s?t me must be eaten hot — the tamarind glaze sets as it cools and the shrimp continue cooking from residual heat if left on the plate.',
            tip: 'Serve within 5 minutes of finishing. The glaze is at its best — sticky, glossy, fragrant — in the first few minutes off the heat. Left to cool, it firms and loses the dynamic quality that makes tôm s?t me great.',
        },
    ],
};
