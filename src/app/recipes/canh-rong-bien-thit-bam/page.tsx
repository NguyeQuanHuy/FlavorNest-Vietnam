...
const recipe: RecipeData = {
    ...
    title: 'Canh Rong Biển Thịt Băm (Seaweed Soup with Minced Pork)',
    ...
    intro: `Canh rong biển thịt băm is the seaweed and minced pork soup of northern Vietnamese home cooking — a preparation that has been part of the Hà Nội weekday dinner table for generations and that achieves something rare in Vietnamese cooking: a dish that is simultaneously extremely simple, extremely nutritious, and extremely specific in its flavor character. The dish belongs to the category of Vietnamese canh (clear soups) that appear alongside the main kho or stir-fry dishes at a Vietnamese family meal — lighter in texture and lower in seasoning than the main dishes, providing the liquid element and the contrast of clarity against the richness of the other preparations. What makes canh rong biển thịt băm specifically northern is its restraint: where Mekong canh chua achieves complexity through multiple souring agents, herbs, and vegetables, canh rong biển thịt băm achieves its character through simplicity — the specific mineral-oceanic flavor of rehydrated wakame seaweed against the clean savory depth of a simple pork broth, seasoned with nothing more than fish sauce, white pepper, and a small amount of ginger. Rong biển (seaweed, specifically dried wakame, Undaria pinnatifida) arrived in Vietnamese cooking through the Chinese-Vietnamese culinary exchange and has been used in northern Vietnamese soups and tonics for over a century. Its specific character — simultaneously mineral, slightly oceanic, and mildly sweet in its own specific way — makes it the ideal ingredient for a clear soup that needs depth without heaviness. The minced pork in canh rong biển is formed into small, loose meatballs rather than crumbled — the specific technique that keeps the pork in distinct pieces in the clear broth rather than clouding it. The tofu provides the protein complement that makes the soup substantial enough for a full meal component, and its neutral, silky character provides the textural contrast to the slightly chewy, marine-flavored seaweed.`,
    ingredientSections: [
        {
            title: 'Seaweed',
            items: [
                { amount: 30, unit: 'g', name: 'dried wakame seaweed (rong biển khô)', note: 'soaked in cold water for 10 minutes until fully rehydrated — expands to approximately 200g. Drain and squeeze gently. Cut any very large pieces into smaller sections.' },
            ],
        },
        {
            title: 'Minced pork meatballs',
            items: [
                { amount: 200, unit: 'g', name: 'minced pork (thịt heo băm)', note: '20% fat — the fat keeps the meatballs tender in the clear broth' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 200, unit: 'g', name: 'soft or silken tofu (đậu phụ)', note: 'cut into 2cm cubes — added near the end' },
