...
const recipe: RecipeData = {
    ...
    title: 'Ghẹ Rang Muối Ớt Sả (Phú Yên Salt and Pepper Flower Crab)',
    ...
    intro: `Ghẹ rang muối ớt sả is the Phú Yên version of salt and pepper crab — specific to the province because it uses ghẹ (flower crab, Portunus pelagicus) rather than mud crab, and because the seasoning paste uses four lemongrass stalks in the proportion established throughout Phú Yên seafood cooking. The flower crab is the ideal crab for rang muối precisely because of its shell: thinner and lighter than mud crab, the flower crab shell can be fried to a genuine crunch in 3-4 minutes at 180°C, producing a shell that — in the thin sections covering the legs and the body edges — shatters between the teeth like a very thin cracker and contributes the caramelized salt-lemongrass paste flavor directly to the eating experience. The thicker sections of the shell (the main carapace) do not become fully edible but develop a fragrant char from the deep-frying and the subsequent wok toss that perfumes the flesh beneath. The rang muối technique applied to flower crab is faster than for mud crab — the thinner shell reaches crunchy in less time, the smaller pieces cook through faster, and the entire dish from wok to plate takes under 10 minutes once the frying is done. This speed is part of what makes ghẹ rang muối ớt sả a practical restaurant and home dish — it can be ordered, prepared, and on the table while the first drinks are still cold. The eating is manual, fragrant, and slightly messy in the way that the best Vietnamese beer food always is.`,
    ingredientSections: [
        {
            title: 'Flower crabs',
            items: [
                { amount: 1.2, unit: 'kg', name: 'live flower crabs (ghẹ / blue swimmer crabs)', note: '3-4 crabs at 300-400g each. Live for best flavor and texture. The thinner shell of flower crab is what makes this preparation work — do not substitute mud crab, which has shells too thick to crisp in this timeframe.' },
                { amount: 60, unit: 'g', name: 'cornstarch', note: 'for dusting before frying' },
                { amount: 600, unit: 'ml', name: 'neutral oil', note: 'for deep frying' },
            ],
        },
        {
            title: 'Phú Yên rang muối paste',
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a large flat plate in a single layer — never pile, which softens the crispy shells with trapped steam. Scatter spring onion, rau răm, and extra shredded kaffir lime leaf. Serve with the muối lá é on individual plates, lime wedges, and cold beer. Eat immediately — the flower crab shell begins softening from the moisture of the flesh within 8-10 minutes of plating.',
            tip: 'Ghẹ rang muối ớt sả is one of the dishes that most demands immediate eating — the thin flower crab shell that was the dish\'s great advantage (it crisps easily) is also its great vulnerability (it softens easily). Plate and eat within 8 minutes. No exceptions.',
        },
    ],
};
