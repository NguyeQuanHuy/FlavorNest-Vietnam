...
const recipe: RecipeData = {
    slug: 'nem-cho-huyen',
    title: `Chợ Huyện Fermented Pork Sausage`,
    subtitle: `Nem Chợ Huyện — Bình Định's most prized nem chua, fermented in banana leaf with a ratio of lean pork to pork skin that no other province replicates.`,
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '96 hrs',
    rating: 4.9,
    ...
    intro: `Chợ Huyện is a market town in Phù Cát district, Bình Định province — unremarkable in every respect except one: it produces what many Central Vietnamese consider the finest nem chua in the country. Nem chợ huyện has been made here for over a century, and the reputation is specific enough that locals from Quy Nhơn drive forty minutes to buy it fresh from the market rather than purchasing the Quy Nhơn versions sold closer to home.\n\nNem chua is Vietnam's most widely made fermented pork sausage — a mixture of minced lean pork and pounded pork skin, seasoned with fish sauce, garlic, and sugar, wrapped in banana leaf with a layer of fresh chili and garlic pressed against the meat surface, and left to ferment at room temperature until pleasantly sour. What distinguishes nem chợ huyện is the skin-to-meat ratio (higher skin content than most regions, giving a more gelatinous texture), the inclusion of toasted rice powder as a secondary fermentation medium alongside the natural pork lactobacillus, and the use of fresh fig leaves (lá sung) as the innermost wrapping layer — a Bình Định-specific detail that adds a faint tannin note to the finished sausage.\n\nNem chua is eaten raw — the fermentation is the cooking. It is one of the few raw pork preparations in Vietnamese cuisine, and the lactic acid environment that develops during curing renders the meat safe and the flavour complex. This recipe documents the chợ huyện method with the fig leaf layer and toasted rice powder inclusion.`,
    ingredientSections: [
        {
            title: `Pork mixture`,
            items: [
                { amount: 500, unit: 'g', name: `lean pork (thịt nạc heo)`, note: `pork leg preferred — very fresh, chilled but not frozen` },
                ...
                { amount: 2, unit: 'tbsp', name: `fish sauce (nước mắm)`, note: `40°N — Phú Quốc or equivalent` },
                { amount: 1.5, unit: 'tbsp', name: `sugar` },
                { amount: 1, unit: 'tsp', name: `salt` },
                { amount: 1, unit: 'tsp', name: `black pepper, coarsely ground` },
                { amount: 1.5, unit: 'tbsp', name: `toasted rice powder (thính gạo)`, note: `dry-toasted until golden, ground coarse — the Bình Định addition` },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 4, name: `fresh red chili (ớt sừng), sliced thin` },
        ...
        },
        {
            ...
            items: [
                { amount: 20, name: `fresh fig leaves (lá sung)`, note: `the Bình Định distinction — substitute: perilla leaves if fig leaves unavailable` },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `Keep the mixture cold throughout. If the pork begins to warm from handling, return to the refrigerator for 10 minutes before continuing. Warm fat in the mixture will separate during fermentation and produce a greasy surface rather than the clean, glossy exterior nem chợ huyện is known for.`,
        },
        {
        ...
        },
        {
            ...
            description: `Remove nem from the refrigerator 20 minutes before serving. Unwrap at the table — peel back the banana leaf, then the fig leaf, to reveal the finished nem with its garlic and chili crust embedded in the surface. Eat whole in one or two bites, or wrap in perilla or rau răm with a piece of broken sesame rice cracker. In Bình Định, nem chợ huyện is eaten as a standalone snack with beer, or as part of a cold plate alongside tré and chả lụa at the start of a meal. A slice of fresh garlic and a sliver of chili eaten with each nem is the local way — the heat of the chili amplifies the sourness.`,
            tip: `Nem chợ huyện keeps in the refrigerator for 5–7 days after fermentation is complete. The sourness intensifies daily in cold storage. Day 3 to 4 after completion is the flavour peak. Beyond day 7 the acid becomes unpleasant and the texture softens.`,
        },
    ],
};
