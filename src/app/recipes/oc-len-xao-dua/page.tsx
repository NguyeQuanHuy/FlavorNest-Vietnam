...
const recipe: RecipeData = {
    slug: 'oc-len-xao-dua',
    title: '?c Len Xào D?a (Mud Creeper Snails Stir-Fried with Coconut Milk)',
    subtitle: 'Small mud creeper snails from the mangrove waterways of C?n Gi? and Cà Mau stir-fried with lemongrass and ginger then finished with fresh coconut milk until the sauce reduces to a fragrant, slightly sweet coconut glaze that fills every shell — eaten by sucking the snail from the shell with a specific technique that coastal Vietnamese children learn before they learn to use chopsticks.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '45 min',
    rating: 4.9,
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 3, name: 'bird\'s eye chilies', note: 'minced — ?c len xào d?a should have clear heat' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bowl warm water with lime', note: 'finger bowl — ?c len is eaten with fingers' },
    ...
    steps: [
        {
            ...
            tip: 'The 2-hour purging for mud creeper snails is longer than for sea snails because they live in organic-rich mangrove mud that contains more sediment than open-water habitats. Insufficiently purged ?c len taste muddy and gritty — the most common complaint about the dish. The purging is the preparation that makes the difference between good and excellent ?c len.',
        },
        {
