...
const RECIPES: Recipe[] = [
    ...
    },
    {
        ...
        subtitle: 'Canh Rau Ngót Th?t Bam',
    ...
    },
    {
        ...
        subtitle: 'Th?t Bò Xào B?p C?i Cà R?t',
    ...
    },
    {
        ...
        subtitle: 'Bánh Ph? Xào Th?t Heo',
        image: '/images/recipes/pho-xao-thit-heo.jpg',
        region: 'Southern', difficulty: 'Easy', time: '25 mins',
        rating: '4.5', reviews: 66, cal: 430, tag: 'Quick Wok Bowl', tagColor: '#F59E0B',
        description: "Soft rice noodles tossed in a hot wok with sliced pork, garlic, and soy sauce until slightly smoky at the edges. A simple street-style dish where chewy noodles meet savory pork in a comforting, fast-fried rhythm.",
        tags: ['Pork', 'Noodles', 'Stir-fry', 'Quick'],
    },
    {
        slug: 'canh-bau-thit-vien',
        title: 'Bottle Gourd Meatball Soup',
        subtitle: 'Canh B?u Th?t Viên',
        ...
        description: "A light, clear broth with soft bottle gourd slices and tender pork meatballs. The soup is naturally sweet and refreshing, with a gentle texture that feels soothing and easy on the palate.",
        tags: ['Pork', 'Soup', 'Vegetable', 'Light'],
    },
    {
        ...
        description: "Pork ribs simmered until tender in a tangy broth of pickled mustard greens. The soup carries a bright sourness balanced by rich pork depth, creating a warming bowl that awakens the appetite.",
        tags: ['Pork', 'Soup', 'Sour', 'Greens'],
    },
    {
        slug: 'thit-rim-tom',
        title: 'Caramel Pork & Shrimp Simmer',
        subtitle: 'Th?t Rim Tôm',
        image: '/images/recipes/thit-rim-tom.jpg',
        region: 'Southern', difficulty: 'Medium', time: '45 mins',
        rating: '4.7', reviews: 82, cal: 520, tag: 'Sea & Land', tagColor: '#F97316',
        description: "Pork belly slowly caramelized in fish sauce and sugar, then tossed with fresh shrimp until glossy and rich. A sweet-salty harmony where land meets sea in a single bubbling pan.",
        tags: ['Pork', 'Shrimp', 'Braised', 'Savory Sweet'],
    },
    {
        slug: 'canh-khoai-mo',
        ...
        description: "A silky purple yam soup with a naturally thick, velvety texture. Often cooked with minced pork or shrimp, it carries a gentle sweetness and comforting, earthy aroma.",
        tags: ['Yam', 'Soup', 'Vegetable', 'Creamy'],
    },
    {
        slug: 'com-chien-cua',
        title: 'Crab Fried Rice',
        subtitle: 'Com Chiên Cua',
        image: '/images/recipes/com-chien-cua.jpg',
        region: 'Southern', difficulty: 'Easy', time: '25 mins',
        rating: '4.8', reviews: 110, cal: 640, tag: 'Golden Wok Rice', tagColor: '#F59E0B',
        description: "Fragrant rice stir-fried with fresh crab meat, egg, and scallions until each grain turns golden and slightly crispy. A rich seafood aroma that feels both simple and luxurious.",
        tags: ['Crab', 'Rice', 'Fried', 'Seafood'],
    },
    {
        slug: 'canh-su-su-tom',
        title: 'Chayote & Shrimp Soup',
        subtitle: 'Canh Su Su N?u Tôm',
        image: '/images/recipes/canh-su-su-tom.jpg',
        region: 'Southern', difficulty: 'Easy', time: '30 mins',
        rating: '4.6', reviews: 57, cal: 210, tag: 'Clear Freshness', tagColor: '#22C55E',
        description: "A light, clear broth with tender chayote and sweet shrimp. The soup is refreshing and naturally sweet, perfect for balancing richer dishes on the table.",
        tags: ['Shrimp', 'Vegetable', 'Soup', 'Light'],
    },
    {
        slug: 'muc-xao',
        ...
        description: "Fresh squid quickly stir-fried over high heat with garlic, onions, and vegetables, keeping a crunchy bite and ocean sweetness. Fast, smoky, and slightly spicy.",
        tags: ['Squid', 'Seafood', 'Stir-fry', 'Quick'],
    },
    {
        slug: 'chao-tom',
    ...
    },
    {
        ...
        subtitle: 'Canh Bí Ð? N?u Th?t B?m',
        ...
        <main style={{ minHeight: '100vh', background: '#FAFAF7', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
            <style>{`
                ...
                * { box-sizing: border-box; }
                .md-grid { grid-template-columns: repeat(auto-fill, minmax(330px, 1fr)); }
                @media (max-width: 768px) {
                  .md-grid { grid-template-columns: 1fr 1fr !important; gap: 6px !important; }
                  .md-card-img { height: 140px !important; }
            ...
            <section style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 24px 96px' }}>
                <AnimatePresence mode="wait">
                    <motion.div key={`${diff}-${region}`}
                        className="md-grid" style={{ display: 'grid', gap: 18 }}>
                ...
                {filtered.length > PER_PAGE && (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 48, position: 'sticky', bottom: 24, zIndex: 30 }}>     <div style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(12px)', padding: '10px 16px', borderRadius: 100, boxShadow: '0 4px 24px rgba(75,46,26,0.12)', border: '1px solid rgba(75,46,26,0.08)' }}>
                        <button
