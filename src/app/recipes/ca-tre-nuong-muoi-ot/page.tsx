...
const recipe: RecipeData = {
    ...
    title: 'Cá Trê Nu?ng Mu?i ?t (Charcoal-Grilled Catfish with Chili Salt)',
    subtitle: 'Whole catfish scored and coated in a lemongrass-chili-salt paste then grilled slowly over charcoal until the skin renders and crisps — the fat dripping onto the coals and producing the flare-up smoke that perfumes the flesh, served with m?m nêm or nu?c m?m g?ng and an abundance of fresh herbs.',
    ...
    ingredientSections: [
        ...
        {
            title: 'M?m nêm dipping sauce',
            items: [
                { amount: 3, unit: 'tbsp', name: 'm?m nêm (fermented anchovy paste)', note: 'the traditional dipping sauce for grilled catfish in southern Vietnam' },
                { amount: 2, unit: 'tbsp', name: 'fresh pineapple juice or pineapple pieces', note: 'pounded — thinned with pineapple rather than lime for m?m nêm' },
                { amount: 1, unit: 'tsp', name: 'sugar' },
    ...
    steps: [
        {
            ...
            tip: 'The overnight marination for cá trê nu?ng mu?i ?t produces a noticeably deeper-flavored result than the minimum 1-hour marination. The lemongrass paste has 8-12 hours to soften the fish surface proteins and penetrate through the score lines to the flesh beneath. This depth of marinade penetration is visible when the fish is sliced — the flesh near the score lines is golden-tinted from the turmeric and seasoned throughout.',
        },
        {
            title: 'Prepare m?m nêm sauce',
            description: 'Combine m?m nêm with pineapple juice or pounded pineapple pieces, sugar, garlic, and chili. Add warm water to reach a thick but pourable dipping consistency. M?m nêm is traditionally thinned with pineapple rather than lime — the pineapple\'s sweetness balances the intense fermented paste character in a way that lime\'s sharp acidity does not. The finished sauce should be fragrant, pungent, slightly sweet, and complex — not merely salty.',
            tip: 'M?m nêm for grilled catfish is served at a less diluted concentration than for other preparations — the fatty, smoky catfish can carry the intensity of the fermented paste that would overwhelm a lighter protein. If new to m?m nêm, start with the dipping sauce at half the given quantity and dilute with additional pineapple juice to tolerance.',
        },
        {
