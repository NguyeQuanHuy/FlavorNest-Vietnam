...
const recipe: RecipeData = {
    ...
    subtitle: 'Ð?u ph? chiên m?m t?i — vàng giòn, th?m m?m, don gi?n mà nghi?n.',
    category: 'VEGETARIAN',
    difficulty: 'Easy',
    totalTime: '25 min',
    rating: 4.8,
    ...
    ingredientSections: [
        {
            title: 'Ð?u ph?',
            items: [
                { amount: 400, unit: 'g', name: 'firm tofu (d?u ph? c?ng)', note: 'not silken — needs to hold its shape during frying' },
