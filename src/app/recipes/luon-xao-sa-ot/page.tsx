...
const recipe: RecipeData = {
    slug: 'luon-xao-sa-ot',
    title: 'Lươn Xào Sả Ớt (Eel Stir-Fried with Lemongrass and Chili)',
    subtitle: 'Fresh rice paddy eel pieces coated in turmeric and stir-fried at maximum wok heat with lemongrass, galangal, garlic, and fresh chili until the exterior caramelizes and the kitchen smells of the specific combination that makes lươn xào sả ớt one of the most addictive nhậu dishes in central and southern Vietnam.',
    ...
    intro: `Lươn xào sả ớt is the stir-fried eel preparation that appears on nhậu menus and family dinner tables across central and southern Vietnam — a dish where the specific combination of fresh rice paddy eel, lemongrass, galangal, and chili produces something more than its ingredients separately: a caramelized, intensely fragrant wok dish where the eel's naturally sweet, slightly mineral flesh takes on the dry, aromatic character of the xào technique and the lemongrass-galangal paste coats every surface in a golden crust. Lươn đồng — the rice paddy eel, Monopterus albus — is the specific freshwater eel of Vietnamese cooking, different from the larger saltwater or freshwater eels of Japanese, European, or Chinese cooking in its smaller size (30-60cm), its boneless eating quality (the bones are too small and soft to require removal in smaller specimens), and its specific sweetness from the rice paddy and canal habitat of the Mekong Delta and the central Vietnamese plains. The cleaning and preparation of lươn is the most demanding step in the preparation — the eel must be cleaned of its slippery coating using salt or ash before cutting, a process that requires either confidence or patience and that is the reason many Vietnamese home cooks prefer to buy pre-cleaned eel from the market rather than starting from live. Once cleaned and cut into 5-7cm sections, the eel is marinated with turmeric — which simultaneously reduces the muddy freshwater character and provides the golden color — and then stir-fried with the maximum lemongrass and galangal aromatics that the wok can hold and that will caramelize onto the eel surface during the brief, high-heat cooking period.`,
    ingredientSections: [
        {
            title: 'Eel',
            items: [
                { amount: 600, unit: 'g', name: 'fresh rice paddy eel (lươn đồng), cleaned', note: 'cut into 5-7cm sections. To clean live eel: rub firmly with coarse salt to remove the slippery coating, rinse thoroughly, cut. Pre-cleaned eel from Asian markets is acceptable.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 30, unit: 'g', name: 'fresh galangal (riềng)', note: 'minced to paste — the aromatic that makes this specifically central Vietnamese' },
                { amount: 5, name: 'garlic cloves', note: 'minced' },
                { amount: 4, name: 'shallots', note: 'minced' },
                { amount: 4, name: 'bird\'s eye chilies', note: 'minced — lươn xào sả ớt should be genuinely spicy' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The 90-second frying of the lemongrass-galangal paste at maximum heat before the eel returns is the step that most defines the final flavor of lươn xào sả ớt. Under-cooked aromatics produce a harsh, raw-smelling dish. Properly caramelized aromatics produce the specific golden, complex fragrance that makes this preparation one of the most aromatic wok dishes in Vietnamese cooking.',
        },
        {
            ...
            tip: 'The 5-6 minute tossing time for lươn xào is longer than for lighter proteins because eel is dense and needs the extended wok time to cook completely through. Test at 5 minutes by pressing the thickest piece — it should feel firm throughout with no soft center. The interior should be white and set, not translucent.',
        },
        {
            title: 'Add finishing elements and serve',
            description: 'Add shredded kaffir lime leaves, spring onion pieces, and sesame oil. Toss once more. Grind black pepper over the surface. Transfer to a serving plate — the lươn xào should show: golden-caramelized eel pieces coated in the aromatic paste, the lemongrass-galangal crust visible on each surface, the kaffir lime shreds and spring onion green throughout. Serve with rau răm, mint, lime wedges, sliced chili, and steamed rice.',
            tip: 'Lươn xào sả ớt eaten immediately from the wok — when the eel is still sizzling and the lemongrass aromatics at their most volatile — is the best version of the dish. The fragrance of hot lemongrass-galangal on freshly cooked eel is the sensory experience the preparation is designed to produce. Cooled lươn xào is good; hot lươn xào is what the dish is.',
        },
    ],
};
