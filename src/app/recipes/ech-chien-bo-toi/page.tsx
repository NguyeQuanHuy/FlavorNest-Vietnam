...
const recipe: RecipeData = {
    ...
    title: '?ch Chiên Bo T?i (Crispy Fried Frog with Garlic Butter)',
    subtitle: 'Frog legs coated in seasoned rice flour and deep-fried until the coating shatters and the flesh inside stays juicy — tossed immediately in a wok with caramelized garlic, chili, and butter until the crispy surface is glazed in the sauce without losing its crunch. The southern Vietnamese nh?u frog dish.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '40 min',
    rating: 4.9,
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 80, unit: 'g', name: 'rice flour (b?t g?o)', note: 'produces crispier coating than wheat flour' },
                { amount: 20, unit: 'g', name: 'cornstarch (b?t b?p)', note: 'adds extra crispiness and helps the coating shatter' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch rau ram', note: 'eaten alongside' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a serving plate in a single layer — piling traps steam and softens the crust within minutes. Scatter spring onion, cilantro, and freshly ground black pepper. Serve immediately with lime wedges and rau ram. Eat while hot — ?ch chiên bo t?i loses its defining texture within 8-10 minutes of plating. The eating: pick up a leg by the bone, bite through the garlic-butter-glazed crispy coating to the white, juicy flesh inside. Dip in the residual butter-garlic sauce pooled on the plate.',
