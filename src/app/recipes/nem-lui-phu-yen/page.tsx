...
const recipe: RecipeData = {
    ...
    title: 'Nem L?i Phú Yên (Phú Yên Lemongrass Pork Skewers)',
    ...
    intro: `Nem l?i is the lemongrass pork skewer of central Vietnam — a preparation shared by Phú Yên, Bình Ð?nh, Qu?ng Nam, and Ðà N?ng, each province claiming its own version as the definitive one. The Phú Yên version — nem l?i Tuy Hòa specifically — is characterized by three things that distinguish it from its neighbors: the pork mixture includes a higher proportion of pork fat than the Ðà N?ng version, producing a richer, juicier result after grilling; the dipping sauce (tuong ch?m) is made with toasted peanuts, sesame, and hoisin in a proportion specific to Phú Yên; and the fresh accompaniments include green star fruit (kh? xanh) sliced thin alongside the usual green banana and cucumber — a combination that provides an additional sour note against the rich grilled pork. L?i means the act of threading onto a skewer, and in nem l?i the skewer is a fresh lemongrass stalk — not a bamboo stick, not a metal skewer. The fresh lemongrass does two things simultaneously: it holds the pork in place during grilling, and it releases its aromatic oils into the pork from the inside as the heat builds, so that the meat is perfumed throughout rather than merely on the surface. Grilled over charcoal until the pork caramelizes and the lemongrass stalk blackens and chars below the meat — the charred lemongrass end releasing its final burst of fragrance as it burns — nem l?i Phú Yên is a dish that requires the hands to assemble at the table and rewards the effort completely.`,
    ingredientSections: [
        {
            title: 'Pork mixture',
            items: [
                { amount: 500, unit: 'g', name: 'minced pork (th?t heo b?m)', note: '30% fat content — the higher fat percentage is specific to Phú Yên nem l?i and is what keeps the skewer juicy after charcoal grilling' },
                { amount: 100, unit: 'g', name: 'pork fat (m? heo)', note: 'finely minced separately then combined — the extra fat layer is the Phú Yên addition' },
        ...
        {
            title: 'Phú Yên peanut dipping sauce (tuong d?u ph?ng)',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, name: 'green bananas (chu?i chát)', note: 'peeled and thinly sliced — the characteristic astringency is part of the dish' },
                { amount: 2, name: 'green star fruit (kh? xanh)', note: 'thinly sliced — the Phú Yên addition that provides extra sourness. Substitute: green mango or sour green apple.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The Phú Yên peanut sauce has more peanut and sesame than the Ðà N?ng or Hu? versions — it is thicker, nuttier, and more substantial. The ground sesame alongside the peanut is the specific Phú Yên character. Do not substitute with store-bought peanut sauce — the flavor difference is significant.',
        },
        {
            title: 'Grill over charcoal until caramelized',
            description: 'Build a medium-hot charcoal fire. Grill the nem l?i skewers, turning every 2-3 minutes, for 12-15 minutes total. The pork should caramelize to a deep golden-brown with slight char at the edges. The lemongrass stalk below the pork will char and blacken during grilling — this is correct and desired: the charring stalk releases its final burst of lemongrass fragrance directly into the meat. The skewer is done when the pork is firm throughout, deeply colored, and the lemongrass oil has clearly perfumed the meat.',
            tip: 'The charring of the lemongrass base during grilling is not a failure — it is the moment the dish becomes itself. The burning lemongrass oils released in the final minutes of cooking are what produce the specific perfumed-charcoal character of nem l?i that cannot be replicated in an oven or grill pan.',
        },
        {
            title: 'Assemble at the table — the Phú Yên way',
            description: 'Serve the nem l?i skewers immediately from the grill to the table, still on their lemongrass skewers. Arrange all wrapping ingredients. To eat: dampen a rice paper sheet, place cucumber, green banana, green star fruit, and herbs on the lower third. Pull the pork off the lemongrass skewer directly onto the rice paper. Roll loosely. Dip the entire roll into the Phú Yên peanut sauce. The combination of caramelized lemongrass pork, astringent green banana, sour star fruit, fresh herbs, and nutty-sweet dipping sauce is the complete experience.',
            tip: 'The green banana and star fruit are not optional in the Phú Yên version. The astringency of green banana and the clean sourness of green star fruit are what make this version distinct from all other nem l?i preparations. Without them the wrap is merely sweet and rich; with them it achieves the balance that central Vietnamese food specifically targets.',
        },
    ],
};
