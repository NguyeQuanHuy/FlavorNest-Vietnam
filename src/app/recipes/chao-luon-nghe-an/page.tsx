...
const recipe: RecipeData = {
    ...
    title: 'Cháo Luon Ngh? An (Ngh? An Eel Rice Porridge)',
    subtitle: 'Rice porridge made from eel bone stock — golden from fresh turmeric — topped with eel pieces stir-fried with lemongrass, galangal, and fresh turmeric until caramelized and fragrant, finished with crispy fried shallots, fresh ginger julienne, and rau ram. The most celebrated regional congee in Vietnamese cooking.',
    ...
    intro: `Cháo luon Ngh? An is the eel porridge that Vietnamese people across the country acknowledge as one of the finest regional congees in the national repertoire — a dish so specifically identified with Ngh? An province (the central coastal province that is also the birthplace of H? Chí Minh) that eating it anywhere other than at the small rice-porridge shops of Vinh city or the street stalls of the coastal districts produces a specifically different experience, even when the recipe is followed exactly. The reason for this is the luon (eel) itself: the rice paddy eels (Monopterus albus) of the Ngh? An plain and its network of irrigation canals are considered by Vietnamese food culture to produce a sweeter, more specifically flavored flesh than the same species from other regions, a quality attributed to the specific mineral content of the water and the particular feed available in the flooded rice fields of the province. Whether or not this regional difference is detectable to all palates, the preparation itself is specific and demanding: the eel bones, head, and trimmings are simmered into a stock that is then used to cook the rice porridge; the eel flesh is separately stir-fried with lemongrass, galangal, and fresh turmeric in a hot wok until caramelized and fragrant; and the finished porridge receives the eel, crispy fried shallots, fresh ginger julienne, and rau ram simultaneously at service. The golden color that runs through the entire preparation — the porridge, the eel, the crispy shallots — comes from the fresh turmeric that is used throughout, and it is this golden quality that makes cháo luon Ngh? An visually as distinctive as it is flavorful. The shops in Vinh that serve nothing else open at 6am and are sold out by 10am, seven days a week, every week of the year.`,
    ingredientSections: [
        {
            title: 'Eel and stock',
            items: [
                { amount: 800, unit: 'g', name: 'fresh rice paddy eel (luon d?ng)', note: 'cleaned and cut into 5cm sections — or ask the fishmonger to clean them. The bones, head, and trimmings go into the stock. Substitute: freshwater eel from Asian markets, cleaned and sectioned.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 30, unit: 'g', name: 'fresh galangal', note: 'minced — the essential Ngh? An aromatic' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)', note: 'leaves only — very generous Ngh? An quantity' },
    ...
    steps: [
        {
            ...
            tip: 'The eel bone stock is the element that makes cháo luon Ngh? An a specifically eel dish rather than a dish with eel on top. The porridge made with this stock carries the eel character through every grain of rice. Porridge made with water and topped with eel produces two separate elements; porridge made with eel stock topped with eel produces a unified bowl.',
        },
        {
        ...
        {
            title: 'Assemble the Ngh? An way',
            description: 'Ladle the golden porridge into deep bowls — generous, hot. Place a portion of stir-fried eel in the center. Drizzle shallot-infused oil over the surface. Add julienned ginger — more than seems necessary. Scatter rau ram leaves generously — in Vinh, the rau ram quantity is what surprises visitors most. Add sliced spring onion and crispy fried shallots. Grind white pepper. Squeeze lime at the table.',
            tip: 'The rau ram quantity in cháo luon Ngh? An served at the shops in Vinh is almost equal in volume to the porridge itself — a full handful of leaves per bowl, not the token garnish that most recipes specify. The peppery, slightly citrusy rau ram provides the specific counterpoint to the rich, golden eel and porridge that makes the bowl complete. Do not restrain the rau ram.',
        },
        {
            title: 'Eat in sequence',
            description: 'Stir the bowl before the first spoonful — the shallot oil, eel juices, and lime should distribute through the porridge. The first spoonful should contain porridge, eel, ginger, and rau ram together — this combination establishes the complete bowl character. Eat steadily, adding lime and chili to taste with each spoonful. The eel pieces are eaten alongside the porridge rather than before or after. The bowl is finished when the last of the shallot oil and eel juices have been incorporated into the remaining porridge.',
            tip: 'Cháo luon Ngh? An eaten slowly over 15-20 minutes is a different experience from the same bowl eaten quickly. The eel juices continue releasing into the porridge as the meal progresses, and the rau ram wilts slightly and melds into the surrounding flavors. The last few spoonfuls of the bowl — when the eel has enriched the porridge and the herbs have softened — are often better than the first.',
        },
    ],
};
