...
const recipe: RecipeData = {
    ...
    title: 'Cua Hu?nh Ð? H?p Bia (Phú Yên Slipper Lobster Steamed with Beer)',
    subtitle: 'The rarest seafood of Phú Yên — cua hu?nh d?, the royal slipper lobster found only in the deep waters off the central Vietnamese coast — steamed over Vietnamese beer with lemongrass and ginger, served with the mu?i lá é that is its only worthy accompaniment.',
    ...
    intro: `Cua hu?nh d? is the Vietnamese name for Thenus orientalis — the slipper lobster, also called the Balmain bug in Australia and the moreton bay bug in Queensland — a crustacean that looks like a flattened lobster, has two broad antennae instead of the spiny projections of a true lobster, and is found in the deeper waters off the central Vietnamese coast from Phú Yên south to Bình Thu?n. The name hu?nh d? means emperor — a name that reflects the historical prestige of this crustacean and its reputation as the finest eating seafood of the central Vietnamese deep sea. Cua hu?nh d? commands the highest price at the Phú Yên fish market precisely because the flesh — concentrated in the broad tail, with smaller amounts in the head section — is unlike any other crustacean: sweet and dense like lobster tail, with a specific mineral-ocean depth that deep-water crustaceans develop and shallow-water species do not. The correct preparation for cua hu?nh d? is the simplest one: steaming over beer and lemongrass for exactly 8-10 minutes, which cooks the flesh through without robbing it of the moisture that makes it extraordinary. Any sauce applied during or after cooking competes with the flavor of the flesh — the only accompaniment worth serving is mu?i lá é, the pounded litsea leaf salt of Phú Yên, which provides the aromatic counterpoint that completes the experience without obscuring it. Cua hu?nh d? h?p bia is a seasonal dish, available in Phú Yên markets from around April to August when the deep-sea fishing boats bring in their catches, and it is a dish to be made when you find a good source rather than planned weeks in advance.`,
    ingredientSections: [
        {
            title: 'Slipper lobster',
            items: [
                { amount: 800, unit: 'g', name: 'fresh slipper lobster (cua hu?nh d? / Thenus orientalis)', note: 'live or very recently caught — 2-4 pieces depending on size. Available at Vietnamese specialty seafood markets. Substitute: Balmain bugs or Moreton Bay bugs (same species) from Australian fish markets, or scampi tails as a last resort.' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 4, name: 'lemongrass stalks', note: 'bruised and cut — essential aromatic for cua hu?nh d? specifically' },
        ...
        {
            title: 'Mu?i lá é (the only accompaniment worth serving)',
            items: [
                { amount: 25, unit: 'g', name: 'fresh lá é leaves (litsea cubeba)', note: 'the Phú Yên herb that appears alongside every premium seafood in the province. Substitute: 8 kaffir lime leaves + 8 rau ram leaves — different but the closest approximation.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Combine beer, water, bruised lemongrass, smashed ginger, torn kaffir lime leaves, and salt in the steamer base. Bring to a vigorous full boil. The steam must be intensely fragrant before the slipper lobsters go in — this is even more important for cua hu?nh d? than for other crustaceans because the delicate deep-sea flesh absorbs the steaming aromatics more readily than shallow-water species.',
            tip: 'The lemongrass for cua hu?nh d? steaming should be extra-bruised — pound the stalks firmly with the back of a knife before cutting them. The more aromatic oil released into the steaming liquid, the more the steam carries into the delicate flesh.',
        },
        {
            ...
            tip: 'Cua hu?nh d? flesh is more delicate than mud crab and overcooks faster. The flesh should be just set — firm when pressed but not tight or rubbery. Pull at the first sign of complete opaqueness throughout. One minute past correct doneness is noticeable in the texture.',
        },
        {
            ...
            tip: 'For cua hu?nh d? specifically, the mu?i lá é should be slightly more salt-forward than when used with chicken — the richness of the deep-sea crustacean flesh needs a more assertive salt note to balance it. Add a small extra pinch of salt to the pounded mixture.',
        },
        {
            title: 'Plate with restraint — this ingredient needs nothing',
            description: 'Transfer the steamed slipper lobsters to a plate. Scatter shredded kaffir lime leaves and spring onion over the top — minimally, not the generous piling used for other preparations. Arrange the fresh lá é leaves alongside. Serve the mu?i lá é in individual small plates with lime wedges. The presentation should be clean and uncluttered — cua hu?nh d? needs no garnish beyond the herbs and the dipping salt.',
