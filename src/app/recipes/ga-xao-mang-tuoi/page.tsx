...
const recipe: RecipeData = {
    ...
    title: 'Gà Xào Măng Tươi (Chicken Stir-Fry with Fresh Bamboo Shoots)',
    ...
    intro: `Gà xào măng tươi is the dish of Phú Yên's inland — the mountainous western half of the province where Sơn Hòa, Sông Hinh, and Sơn Tây districts border the Central Highlands, and where bamboo grows in dense stands along every hillside stream. Fresh bamboo shoots (măng tươi) appear in the markets of these districts from the beginning of the rainy season in May through August, harvested at dawn when the tips are still tightly closed and the flesh is at its most tender and juicy. The shoots have a flavor that is simultaneously earthy and slightly bitter, with a moisture content that releases into the wok during stir-frying and creates a natural braising liquid that no added stock can replicate. Paired with free-range mountain chicken — gà thả vườn, leaner and more intensely flavored than commercial chicken from the coast — the bamboo's bitterness and the chicken's richness reach an equilibrium that makes each ingredient taste more completely itself. The lemongrass in the stir-fry carries the aromatic thread that connects both. The fish sauce caramelization provides depth. The fresh herbs — specifically rau răm and the wild herb variants available in the highland markets — provide the bright finish that lifts the earthy bamboo. Gà xào măng tươi is practical highland cooking: a dish made from what grows on the hillside and what runs in the yard, cooked in a wok over wood fire in the way mountain communities have cooked for generations, without the refinements of the coast.`,
    ingredientSections: [
        {
            title: 'Chicken',
            items: [
        ...
        },
        {
            ...
            items: [
                { amount: 400, unit: 'g', name: 'fresh bamboo shoots (măng tươi)', note: 'peeled to the tender white inner layers, sliced 5mm thick. Must be blanched before stir-frying — see step 2. Substitute: canned bamboo shoots (drained and rinsed) — the flavor is significantly milder but the technique is the same.' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'bunch Vietnamese coriander (rau răm)', note: 'leaves only — essential, used in quantity' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Remove from heat. Add the spring onion pieces, rau răm leaves, and perilla. Toss briefly — the residual heat wilts the herbs slightly while preserving their freshness. Transfer to a serving plate. Scatter cilantro and sliced chili. Serve immediately with steamed rice and lime wedges. The herbs in gà xào măng tươi are structural — they should be present throughout the dish in quantity, not decoratively scattered on top.',
            tip: 'The herbs are added off-heat to preserve both their color and their aromatic oils. Herbs stir-fried in the wok at high heat lose their brightness within 30 seconds. Off-heat addition preserves the green color and the volatile compounds that make rau răm taste of itself.',
        },
    ],
};
