...
const recipe: RecipeData = {
    ...
    subtitle: `Bún S?a — Nha Trang's coastal noodle soup with cured jellyfish, clear pork and shrimp broth, and a mandatory plate of raw herbs.`,
    ...
    ingredientSections: [
        ...
        },
        {
            title: `Noodles`,
            items: [
                { amount: 500, unit: 'g', name: `fresh rice vermicelli (bún tuoi)`, note: `or 250g dried, soaked and blanched 30 seconds` },
            ],
        },
        {
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `The clarity of the broth is important in bún s?a because the jellyfish is nearly transparent — a murky broth makes the entire bowl look dull. Maintain the lowest possible heat throughout. Never let the broth boil after the initial skim.`,
        },
        {
