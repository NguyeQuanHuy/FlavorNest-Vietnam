...
const recipe: RecipeData = {
    ...
    subtitle: 'B?p bò ngâm m?m — dai giòn, d?m m?m, thái lát m?ng an mãi không chán.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '5 hrs',
    rating: 4.9,
    ...
    ingredientSections: [
        {
            title: 'B?p bò',
            items: [
                { amount: 1, unit: 'kg', name: 'beef shank (b?p bò)', note: 'whole piece, sinew on — do not trim; the sinew becomes the gelatin that gives the characteristic texture' },
        ...
        },
        {
            title: 'Nu?c ngâm m?m',
            items: [
                { amount: 200, unit: 'ml', name: 'premium fish sauce (nu?c m?m)', note: 'Phu Quoc 40 degrees or Chin-su — the quality of the fish sauce is the dish' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 20, unit: 'g', name: 'fresh Vietnamese coriander (rau ram)', note: 'leaves only' },
