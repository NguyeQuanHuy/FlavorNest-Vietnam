...
const recipe: RecipeData = {
    ...
    title: 'Mực Nướng Kèm Bánh Phồng Tôm (Charcoal Squid with Tableside Fried Shrimp Crackers)',
    ...
    intro: `Mực nướng kèm bánh phồng tôm is the charcoal squid preparation served with tableside fried shrimp crackers — a restaurant and street food presentation that has become one of the most entertaining dining experiences at Vietnamese seafood restaurants along the coast from Đà Nẵng to Vũng Tàu. The preparation separates into two elements that are cooked in different ways and served together: the grilled squid, prepared in the kitchen over hardwood charcoal with the standard lemongrass-chili-fish sauce marinade that characterizes central Vietnamese grilled seafood; and the shrimp crackers, brought to the table raw and dried alongside a small tabletop gas burner and a pot of hot oil, which each diner uses to fry their own crackers individually throughout the meal — each cracker dropped into the hot oil, expanding dramatically in 3-5 seconds, and eaten immediately while the grilled squid provides the primary protein alongside. The tableside frying element is what makes this preparation specifically memorable: the visual of the cracker expanding in the hot oil at the table, the sound of the sizzle, and the instant gratification of eating a cracker within 10 seconds of frying it are the theatrical elements that Vietnamese street food and restaurant culture understands as part of the eating experience rather than mere efficiency. Mực (squid) is the specific protein that pairs most naturally with bánh phồng tôm in this format because the squid's specific sweet, marine character complements the shrimp character of the crackers — they are different expressions of the same coastal seafood flavor palette, and eating them together produces the specific synergy of related flavors amplifying each other rather than competing.`,
    ingredientSections: [
        {
            title: 'Squid',
            items: [
                { amount: 800, unit: 'g', name: 'fresh whole squid (mực tươi)', note: 'medium size — 15-20cm body length. Cleaned but left whole: body tube intact, tentacles attached. Score the body tube in a crosshatch pattern before marinating.' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                { amount: 40, name: 'dried shrimp crackers (bánh phồng tôm khô)', note: 'medium to large size — approximately 10 per diner. Kept in a small basket at the table.' },
