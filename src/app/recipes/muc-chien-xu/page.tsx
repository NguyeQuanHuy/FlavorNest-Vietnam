...
const recipe: RecipeData = {
    ...
    subtitle: 'Mực chiên xù — vàng giòn xù xì, ngọt thịt, chấm tương ớt là hết.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '30 min',
    rating: 4.9,
...
The technique is the classic three-stage dredge — flour, egg, breadcrumb — but the Vietnamese version adds a layer of seasoning at each stage that builds flavour into the crust itself rather than relying entirely on the dipping sauce. White pepper in the flour. Fish sauce in the egg wash. Toasted breadcrumbs that are coarser than Japanese panko, giving a more irregular, craggy surface that traps more oil and produces more crunch per bite. The squid is cut thick enough to stay juicy but thin enough to cook through before the crust overcooks. Eaten immediately from the pan with tương ớt — Vietnamese chilli sauce — or a squeeze of lime and salt, it is one of the most satisfying things the Vietnamese kitchen produces.`,
    ingredientSections: [
        {
            title: 'Mực',
            items: [
                { amount: 500, unit: 'g', name: 'fresh squid (mực ống)', note: 'cleaned, tubes cut into 1.5cm rings; tentacles kept whole or halved if large' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 150, unit: 'g', name: 'breadcrumbs (vụn bánh mì)', note: 'coarse breadcrumbs preferred over fine; panko works well' },
        ...
        },
        {
            title: 'Chấm & garnish',
            items: [
                { amount: 4, unit: 'tbsp', name: 'Vietnamese chilli sauce (tương ớt)', note: 'Cholimex or Chin-su brand' },
                ...
                { amount: 1, unit: 'tsp', name: 'salt', note: 'mixed with chilli powder and lime for muối ớt chanh dipping' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Arrange the fried squid on a plate lined with paper, scattered with sliced spring onion. Serve within 3 minutes of frying — the crust begins to soften as steam from the hot squid works outward. Place tương ớt, lime wedges, and muối ớt chanh alongside. For a richer dip, mix tương ớt with mayonnaise in equal parts.',
        },
    ],
};
