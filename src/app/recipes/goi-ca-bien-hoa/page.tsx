...
const recipe: RecipeData = {
    ...
    subtitle: `G?i Cá Biên Hòa — Ð?ng Nai's river fish cured in rice vinegar, dressed with roasted peanuts, sesame, fresh herbs, and a fish sauce built on the river itself.`,
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '50 min',
    rating: 4.9,
    ...
    intro: `Biên Hòa sits on the Ð?ng Nai River — the longest river entirely within Vietnam's borders, running from the Central Highlands through Lâm Ð?ng, Bình Phu?c, Ð?ng Nai, and into the sea east of Saigon. The river has fed Biên Hòa since the first Nguy?n lords settled the region in the seventeenth century, and g?i cá Biên Hòa is the dish most directly of that river — a raw fish salad made from freshwater fish caught in the Ð?ng Nai, cured briefly in rice vinegar rather than lime juice, dressed with toasted sesame, crushed peanuts, fried shallots, and a specific set of herbs that includes the river-growing rau ram and the highland-origin lá l?t, and eaten with grilled rice crackers that are made locally from Ð?ng Nai rice.\n\nWhat distinguishes g?i cá Biên Hòa from the coastal ceviche-style preparations further south (g?i cá mai Phan Thi?t, g?i cá trích Phú Qu?c) is the vinegar cure rather than the lime cure — rice vinegar works more slowly and more gently than citric acid, producing a texture that is less dramatically changed by the acid and a flavour that retains more of the fish's own character. The fish is partially rather than fully cured: the exterior turns opaque and firms, but the interior retains a slight translucency. This is deliberate. G?i cá Biên Hòa is not a fully acid-cooked preparation — it is a raw fish salad in which the acid is a seasoning agent rather than a cooking method.\n\nThe freshwater fish used in Biên Hòa is traditionally cá he (Barbonymus gonionotus — the silver barb), cá mè (silver carp), or cá chép (common carp). All three are firm-fleshed, relatively low in the parasitic risk associated with some other freshwater species, and abundant in the Ð?ng Nai. This recipe uses cá he as the primary reference but gives substitutions for the European kitchen.`,
    ingredientSections: [
        {
            title: `The fish`,
            items: [
    ...
    steps: [
        ...
        {
            title: `Prepare the lá l?t`,
            description: `Wash lá l?t leaves and pat dry. Stack 3-4 leaves together and roll into a cylinder, then slice across into thin ribbons 2-3mm wide — this chiffonade releases the leaf's aromatic oil without bruising it. Lá l?t has a complex aroma: peppery, faintly anise-like, with a slight bitterness that is entirely different from any other Vietnamese herb. It is the element that makes g?i cá Biên Hòa identifiable from other Vietnamese raw fish salads. If lá l?t is unavailable in Germany — check Vietnamese grocers, particularly Dong Xuan Center which stocks it seasonally — substitute with a small amount of Thai basil and fresh green peppercorn leaves, which approximates the peppery-anise note.`,
            tip: `Lá l?t (Piper sarmentosum) is the same plant family as black pepper and betel leaf. Its flavour is more complex than both — it has the heat structure of pepper without the sharpness, and the herbaceous quality of betel without the astringency. In Biên Hòa, it grows along the river banks and in home gardens throughout Ð?ng Nai province. The combination of rau ram (Vietnamese coriander) and lá l?t is specifically the Biên Hòa herb signature — rau ram appears in raw fish salads everywhere, but lá l?t in this context is Ð?ng Nai.`,
        },
        {
            title: `Dress and assemble`,
            description: `Pour dressing over drained cured fish and toss gently to coat. Add half the rau ram leaves, lá l?t chiffonade, mint, spring onion, and shredded green mango. Toss once more. Transfer to a wide serving plate. Scatter crushed peanuts, toasted sesame, and fried shallots over the top in that order — peanuts first as the largest element, sesame second, fried shallots last as the finest. Lay remaining herb leaves on top without tossing. Scatter sliced red chili for colour. If using dried shrimp powder, dust lightly over the entire surface as the final step.`,
