...
const recipe: RecipeData = {
    slug: 'ba-chi-quay',
    title: 'Ba Chỉ Quay (Vietnamese Crispy Pork Belly)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Dipping sauce',
            items: [
                { amount: 3, unit: 'tbsp', name: 'hoisin sauce', note: 'the classic ba chỉ quay dipping sauce base' },
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: 'nước chấm', note: 'standard fish sauce dipping sauce — served alongside the hoisin for contrast' },
