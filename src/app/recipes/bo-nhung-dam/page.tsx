...
const recipe: RecipeData = {
    slug: 'bo-nhung-dam',
    title: 'Bò Nhúng Dấm (Vietnamese Beef in Vinegar Fondue)',
    ...
    intro: `Bò nhúng dấm is the southern Vietnamese beef fondue that is fundamentally a social occasion — a pot of simmering coconut vinegar and lemongrass at the center of the table, plates of raw thinly sliced beef, a mountain of fresh herbs and vegetables, rice paper, rice vermicelli, and a dipping sauce of mắm nêm (fermented anchovy paste) that is specific to this dish. The cooking is done at the table by the diners: each person picks up a slice of beef with chopsticks, swirls it in the hot acidulated broth for 10-15 seconds until it turns from red to pale pink, then assembles their own wrap. The coconut vinegar (giấm dừa) is the defining ingredient — the acidity cooks the beef through contact rather than heat alone, and the coconut note from the vinegar gives the broth a tropical sweetness that the European fondue tradition has no equivalent for. The wrapping is elaborate: a sheet of dampened rice paper laid on the hand, rice vermicelli placed first, then the dipped beef, then slices of green mango or green banana, fresh herbs (the plate here is extensive — rau răm, perilla, mint, culantro, mustard leaf), and sometimes a thin slice of pickled shallot. The whole assembly is rolled loosely and dipped entirely into the mắm nêm sauce. Bò nhúng dấm is a weekend dish, a celebration dish, a dish eaten slowly over two hours with cold beer and good company.`,
    ingredientSections: [
        {
            title: 'Vinegar broth (lẩu dấm)',
            items: [
                { amount: 500, unit: 'ml', name: 'coconut vinegar (giấm dừa)', note: 'the defining ingredient — mild, slightly sweet, tropical acidity. Available at Vietnamese grocers. Substitute: 300ml rice vinegar + 200ml coconut water for a close approximation.' },
        ...
        },
        {
            title: 'Beef',
            items: [
                { amount: 600, unit: 'g', name: 'beef sirloin or eye fillet (thịt bò)', note: 'sliced paper-thin — 2-3mm maximum. Freeze for 30 minutes before slicing for cleaner cuts. Or ask the butcher to slice for shabu-shabu.' },
        ...
        {
            title: 'Mắm nêm dipping sauce (essential)',
            items: [
                { amount: 4, unit: 'tbsp', name: 'fermented anchovy paste (mắm nêm)', note: 'the defining dipping sauce for bò nhúng dấm — cannot be substituted with fish sauce. Available at Vietnamese grocers.' },
                { amount: 2, unit: 'tbsp', name: 'fresh pineapple', note: 'finely minced or blended — adds sweetness and breaks down the mắm nêm intensity' },
                { amount: 2, unit: 'tbsp', name: 'fresh lime juice' },
                { amount: 1, unit: 'tbsp', name: 'sugar' },
                { amount: 2, name: 'garlic cloves', note: 'minced' },
                { amount: 2, name: 'bird\'s eye chilies', note: 'minced — mắm nêm sauce is traditionally quite spicy' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'head butter lettuce or mustard leaf (cải xanh)', note: 'leaves separated' },
                { amount: 1, name: 'bunch rau răm (Vietnamese coriander)' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Paper-thin slicing is the technique that makes bò nhúng dấm work. Thick slices take too long in the broth, overcooking the outside before the inside is done. 2-3mm slices cook completely in 10-15 seconds of contact with the simmering vinegar.',
        },
        {
            title: 'Make the mắm nêm dipping sauce',
            description: 'Blend or finely mince the fresh pineapple until nearly smooth. In a bowl, combine mắm nêm with pineapple, lime juice, sugar, and water. Stir to combine — the pineapple\'s natural bromelain enzyme begins breaking down the mắm nêm, mellowing its intensity. Add minced garlic and chili. Stir in crushed peanuts. Taste: the sauce should be funky, sweet-sour, spicy, and deeply savory. It is an aggressive sauce intentionally — small amounts transform the wrap completely.',
            tip: 'Mắm nêm sauce made 30 minutes before serving is noticeably better than freshly made — the pineapple has time to work on the fermented paste and the garlic mellows. Make it first, before preparing anything else.',
        },
        {
            title: 'Prepare the table',
            description: 'Set the portable burner or hot pot at the center of the table with the vinegar broth simmering. Arrange the raw beef slices on a plate nearby. Set out all the wrapping ingredients: dampened rice paper sheets on a flat plate, blanched vermicelli, julienned green mango and cucumber, all fresh herbs in separate clusters, bean sprouts, and lettuce leaves. Place individual small bowls of mắm nêm sauce and lime wedges at each place setting. The table should look abundant — this is a communal feast.',
        ...
        },
        {
            ...
            description: 'Dampen a sheet of rice paper briefly in water until just pliable. Lay on a flat surface or on the hand. Place a small amount of vermicelli in the center. Add the dipped beef slice while still hot. Add slices of green mango, cucumber, bean sprouts, and 3-4 different fresh herbs. Roll loosely from the bottom, fold the sides in, continue rolling. The wrap should be soft, generous, and slightly loose. Dip the entire wrap into the mắm nêm sauce. Eat in one or two bites.',
            tip: 'The wrap must be eaten immediately after assembling — the hot beef wilts the herbs and softens the rice paper. Assemble one wrap at a time, eat it, then assemble the next. This is the correct rhythm of bò nhúng dấm.',
        },
    ],
};
