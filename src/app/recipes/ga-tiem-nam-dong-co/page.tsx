...
const recipe: RecipeData = {
    ...
    title: 'Gà Ti?m N?m Ðông Cô (Slow-Braised Chicken with Shiitake)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 25, unit: 'g', name: 'dried shiitake mushrooms (n?m dông cô)', note: 'soaked in 300ml warm water for 30 minutes — reserve the soaking liquid. Squeeze excess water from mushrooms before using.' },
                { amount: 80, unit: 'g', name: 'fresh lotus seeds (h?t sen)', note: 'embryo removed. Dried (soaked 2 hours) also works.' },
                { amount: 2, unit: 'tbsp', name: 'goji berries (k? t?)', note: 'soaked 10 minutes, drained' },
                { amount: 6, name: 'red dates (táo d?)', note: 'pitted — adds sweetness' },
                { amount: 20, unit: 'g', name: 'dried wood ear mushrooms (m?c nhi)', note: 'soaked 20 minutes, drained, large pieces quartered — adds contrasting texture' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 100, unit: 'ml', name: 'Shaoxing wine (ru?u Thi?u Hung)', note: 'the Chinese rice wine essential to this preparation — not Shaoxing cooking wine with salt, but drinking-grade Shaoxing' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Return the chicken to the pot. Pour the strained mushroom soaking liquid over and around the chicken. Add oyster sauce, fish sauce, soy sauce, and sugar. Add lotus seeds, goji berries, and red dates. The liquid should come about halfway up the chicken — this is ti?m style, not a submerged braise. Bring to a gentle boil.',
            tip: 'The liquid level is deliberate — ti?m cooking is a steam-and-braise where the lower half cooks in liquid and the upper half cooks in the steam trapped under the lid. This produces a more concentrated result than full submersion.',
        },
        {
