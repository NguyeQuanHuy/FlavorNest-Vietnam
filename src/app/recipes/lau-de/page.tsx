...
const recipe: RecipeData = {
    slug: 'lau-de',
    title: 'L?u Dê (Vietnamese Goat Hot Pot)',
    ...
    intro: `L?u dê is the Vietnamese goat hot pot — the communal, table-centered preparation that transforms goat from a challenging ingredient into a celebratory social experience. The l?u format — a pot of aromatic broth kept bubbling at the center of the table while diners cook their own meat and vegetables at their own pace — is specifically suited to goat because it allows each piece of meat to be cooked exactly to the diner's preference (a few seconds for paper-thin slices that barely change from raw, a minute for thicker pieces that cook through completely) and because the broth, which has been developing complexity for hours before it reaches the table, transfers its aromatic depth to each piece as it passes through. The broth for l?u dê is built on goat bones simmered with lemongrass, galangal, dried turmeric, and annatto — the same aromatic foundation as the Central Vietnamese goat dishes it is related to — but with the addition of fresh coconut water in the final stage that gives the Mekong Delta version its specific mild sweetness, and fresh pineapple rings that add gentle acidity and help tenderize the thin-sliced raw goat the moment it enters the hot liquid. L?u dê is eaten over an extended period — never rushed, always with beer or rice wine alongside, the broth replenished as it reduces, new vegetables added as previous ones are consumed, the conversation expanding alongside the meal. The goat bones simmered all morning produce a broth that deepens with each hour, and by the end of the meal the liquid has absorbed not just the bones and aromatics but also the flavors of everything that has passed through it. The last ladleful of broth, poured over plain rice at the end of a l?u dê session, is the meal's most complex moment.`,
    ingredientSections: [
        {
            title: 'Goat bone broth',
            items: [
                { amount: 1, unit: 'kg', name: 'goat bones (xuong dê)', note: 'neck bones, rib bones — blanched and rinsed' },
        ...
        },
        {
            ...
            items: [
                { amount: 600, unit: 'g', name: 'goat leg or loin (th?t dê thái m?ng)', note: 'sliced paper-thin — freeze 20 minutes before slicing for cleaner cuts. Arrange on plates for the table.' },
                { amount: 200, unit: 'g', name: 'goat tripe (lòng dê)', note: 'cleaned and blanched, sliced thin — optional but traditional in Ninh Bình style l?u dê' },
            ],
        },
        {
            title: 'Vegetables and noodles for the pot',
            items: [
                { amount: 200, unit: 'g', name: 'water spinach (rau mu?ng)', note: 'cut into 5cm pieces' },
                { amount: 100, unit: 'g', name: 'banana blossom (b?p chu?i)', note: 'finely shredded' },
                { amount: 200, unit: 'g', name: 'bean sprouts (giá)' },
                { amount: 150, unit: 'g', name: 'fresh shiitake mushrooms', note: 'halved' },
                { amount: 100, unit: 'g', name: 'tofu (d?u hu)', note: 'cut into cubes — absorbs the goat broth magnificently' },
                { amount: 400, unit: 'g', name: 'fresh rice vermicelli (bún tuoi)', note: 'served alongside to add to the pot' },
            ],
        },
        {
            title: 'Dipping sauce',
            items: [
                { amount: 4, unit: 'tbsp', name: 'fermented shrimp paste (m?m tôm)', note: 'thinned with lime juice — as for dê thui' },
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'bunch Vietnamese balm (rau kinh gi?i)', note: 'essential for goat' },
    ...
    steps: [
        {
            ...
            tip: 'The goat bone broth for l?u dê requires the full 1.5 hours to develop enough depth to carry the meal — thin broth produces a l?u where each ingredient tastes of itself with a faint goat background. A properly simmered broth produces a l?u where every ingredient is transformed by passing through it.',
        },
        {
            ...
            tip: 'Having two types of goat at a l?u dê table — the pre-cooked braised slices and the raw thin slices — gives diners both the depth of slow-braised goat and the freshness of just-cooked raw slices. This is the full goat l?u experience.',
        },
        {
        ...
        },
        {
            ...
            description: 'Combine m?m tôm with lime juice gradually — the paste lightens and froths slightly. Add sugar, minced chili, and garlic. Thin with a small amount of warm water if too thick. The sauce for l?u dê should be slightly thinner than for dê thui — it needs to cling to the briefly cooked thin meat slices without overwhelming them. Divide into individual small bowls — one per diner.',
            tip: 'Each diner having their own dipping bowl rather than sharing a communal bowl is important for l?u dê — the hot broth dripping from each piece of just-cooked goat dilutes the dipping sauce quickly, and individual bowls allow each person to refresh or adjust their sauce throughout the meal.',
        },
        {
            title: 'Bring to the table and cook communally',
            description: 'Transfer the hot broth to a clay pot or fondue pot with a tabletop burner. Add the pineapple rings directly to the bubbling broth. Arrange all plates of raw goat, vegetables, tofu, noodles, and the herb plate around the central pot. The eating begins: each diner takes a slice of raw goat, swishes it briefly through the bubbling broth (10 seconds for paper-thin, 30 seconds for slightly thicker), removes with chopsticks, and dips in the m?m tôm sauce. Vegetables and noodles go into the pot and cook for 1-2 minutes.',
        ...
        },
        {
            ...
            description: 'As the l?u winds down and most of the meat and vegetables have been eaten, ladle the remaining broth — now deeply flavored from everything that has cooked in it — into bowls over plain steamed rice. This final bowl is the most complex thing at the table: the goat bone depth, the lemongrass and galangal fragrance, the coconut water sweetness, the pineapple acidity, and the flavor of every piece of goat and vegetable that passed through it. It should be eaten slowly, appreciatively, as the meal\'s conclusion.',
            tip: 'Never discard the broth at the end of a l?u dê. The final broth over rice is the tradition that closes the meal properly. In Vietnamese households, the person who suggests ending without drinking the remaining broth over rice is gently corrected. The broth is the last course.',
        },
    ],
};
