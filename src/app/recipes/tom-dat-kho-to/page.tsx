...
const recipe: RecipeData = {
    slug: 'tom-dat-kho-to',
    title: 'Tôm Đất Kho Tộ (Mekong Field Shrimp Braised in Clay Pot)',
    ...
    intro: `Tôm đất kho tộ is the clay pot braised shrimp of the Mekong Delta — a kho preparation that takes the same technique used for thịt kho tàu (pork belly kho) and cá kho tộ (fish kho) and applies it to tôm đất, the small field shrimp of the delta's rice paddies and waterways. The name tôm đất — earth shrimp or ground shrimp — distinguishes them from sea shrimp (tôm biển) and freshwater prawns (tôm càng): they are the shrimp of the land itself, of the flooded fields and irrigation canals that crisscross the delta, harvested by women with hand nets at dusk when the shrimp come out to feed. They are small, never longer than 5cm, and their smallness is their virtue: when braised in a clay pot with young coconut water and palm sugar, every individual shrimp absorbs the kho sauce completely — not just on the surface but throughout the flesh and shell — producing a result where the shell itself has become part of the seasoning rather than a barrier to it. The clay pot (tộ) is essential: its porous walls allow slight evaporation that concentrates the coconut-palm sugar sauce more efficiently than a metal pot, and the even, gentle heat prevents the caramel from scorching at the edges before the center has reduced. Tôm đất kho tộ is the dish eaten with white rice at the noon meal throughout the delta — the small shrimp placed over the rice, the dark sauce soaking downward, the sweetness of the coconut water and palm sugar and the savory depth of the fish sauce in perfect equilibrium.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
                { amount: 500, unit: 'g', name: 'tôm đất (freshwater field shrimp)', note: 'small, whole, shell-on. Fresh from Vietnamese markets during season. Substitute: small marine shrimp (50+ count per 500g) — the flavor differs but the kho technique is the same.' },
        ...
        },
        {
            ...
            items: [
                { amount: 250, unit: 'ml', name: 'young coconut water (nước dừa tươi)', note: 'from a young green coconut, or fresh-packaged without additives. The natural sweetness is what makes Mekong kho different from northern kho.' },
                { amount: 2, unit: 'tbsp', name: 'palm sugar (đường thốt nốt)', note: 'the Mekong Delta sweetener — darker, more complex, slightly caramel-adjacent. Substitute: brown sugar. Never white sugar.' },
                { amount: 3, unit: 'tbsp', name: 'fish sauce' },
                { amount: 1, unit: 'tbsp', name: 'sugar', note: 'in addition to palm sugar — for the caramel (nước màu)' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Remove from heat. Scatter sliced spring onion and freshly ground black pepper directly into the clay pot. Bring the pot to the table — the retained heat keeps the kho warm throughout the meal. Serve with generous steamed jasmine rice. The correct way to eat tôm đất kho tộ: spoon the shrimp and the dark sauce over the rice. The sauce soaking into the rice beneath the small shrimp is the complete Mekong Delta meal.',
            tip: 'Tôm đất kho tộ improves significantly on the second day — the shrimp absorb more of the sauce during refrigeration and the flavor deepens. Reheat gently over low heat with a tablespoon of water. Day-two kho is what Mekong Delta families consider the better version.',
        },
    ],
};
