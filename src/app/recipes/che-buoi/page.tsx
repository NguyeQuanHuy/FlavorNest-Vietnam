    ...
    steps: [
        {
            ...
            description:
                'Peel the pomelo and remove all yellow skin. Tear the white pith into small irregular pieces roughly 1–2 cm. Soak in cold water for 30 minutes, then squeeze out all water firmly. Repeat soaking and squeezing 3 times — this removes the bitterness. After the final squeeze, the pith should taste faintly bitter but not unpleasant.',
        ...
        },
        {
            ...
            description:
                'Squeeze the pith completely dry one final time. Toss with sugar and salt, then coat thoroughly in tapioca starch until every piece is well covered. Shake off any excess.',
        },
        {
            title: 'Blanch the pearls',
            description:
                'Bring a large pot of water to a rolling boil. Drop in the coated pith pieces and cook for 3–4 minutes until the tapioca coating turns completely translucent. Remove with a slotted spoon and transfer immediately to a bowl of cold water to stop cooking.',
