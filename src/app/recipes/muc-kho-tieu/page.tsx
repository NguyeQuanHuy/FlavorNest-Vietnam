...
const recipe: RecipeData = {
    slug: 'muc-kho-tieu',
    title: 'M?c Kho Tiêu (Squid Braised with Black Pepper)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 40, unit: 'g', name: 'old ginger (g?ng già)', note: 'cut into matchsticks' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice', note: 'plain and hot — the only accompaniment m?c kho tiêu needs' },
    ...
    steps: [
        {
            ...
            description: 'Combine squid rings and tentacles with fish sauce, turmeric, and 1 teaspoon of coarsely ground black pepper. Toss and leave 10 minutes. This is the first of three pepper applications in m?c kho tiêu — the marinade pepper seasons the squid from the surface before braising begins. Unlike the meticulous drying required for stir-fried squid, the squid for kho does not need to be completely dry — the braising liquid will provide the cooking environment.',
            tip: 'The three-stage black pepper application in m?c kho tiêu — marinade, braising liquid, finishing — produces a layered pepper character where each application provides a different dimension: the marinade pepper is absorbed and slightly mellowed; the braising pepper concentrates in the reduced sauce; the finishing pepper is sharp and immediate. Together they produce more complex pepper character than a single large addition would.',
        },
        {
            title: 'Build the dark caramel',
            description: 'In a clay pot or heavy pot, heat oil and sugar over medium heat. Cook to a very dark amber — the darkest possible without burning. Add 2 tablespoons of water carefully. Swirl until dissolved. For m?c kho tiêu specifically, the very dark caramel is essential — the mild, slightly sweet squid needs a robust caramel base to provide the bittersweet counterpoint that makes the dish complex rather than simply sweet-peppery.',
            tip: 'Squid kho requires a darker caramel than pork kho because the squid contributes less intrinsic flavor richness than pork and the caramel must compensate. A pale caramel in m?c kho tiêu produces a flat, slightly sweet result; a dark caramel produces the depth that makes the squid taste fully of itself and of the kho technique simultaneously.',
        },
        {
