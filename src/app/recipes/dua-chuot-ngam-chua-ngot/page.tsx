...
const recipe: RecipeData = {
    ...
    title: 'Dua Chu?t Ngâm Chua Ng?t (Vietnamese Sweet and Sour Pickled Cucumber)',
    ...
    intro: `Dua chu?t ngâm chua ng?t — sweet and sour pickled cucumber — is one of the most useful preparations in Vietnamese home cooking. It serves as the refreshing side dish alongside rich grilled meats like su?n nu?ng and bò nu?ng, as a palate cleanser between courses, as a component in bánh mì, and as the vegetable that makes any rice and protein combination feel complete. The quick-pickling method (unlike the fermented d? chua that takes days) requires only 30 minutes in the pickling liquid to produce a cucumber that is bright, crunchy, and carrying the sweet-sour-sharp flavor that is its purpose. The addition of garlic and chili to the pickling liquid is the Vietnamese element — plain vinegar-sugar pickles exist everywhere; the garlic and bird's eye chili make this specifically Vietnamese. Fresh ginger can be added to the pickling liquid for a warmer note. Sesame seeds scattered before serving add texture. The pickle keeps refrigerated for up to 5 days, improving slightly each day as the flavors develop.`,
    ingredientSections: [
        {
            title: 'Cucumber',
            items: [
                { amount: 4, name: 'medium cucumbers (dua chu?t)', note: 'Lebanese or Persian cucumbers preferred — thinner skin, fewer seeds, crisper flesh. Regular cucumbers work but remove the seeds.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Serve alongside: su?n nu?ng (the classic pairing), bò nu?ng, com t?m, bánh mì, or any Vietnamese grilled dish. The acidity and crunch of the pickle cuts through the richness of grilled meats in the same way that pickled daikon functions in bánh mì.',
        },
    ],
};
