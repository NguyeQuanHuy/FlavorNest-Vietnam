...
const recipe: RecipeData = {
    ...
    title: 'Ốc Bươu Xào Sả Ớt (Golden Apple Snails Stir-Fried with Lemongrass and Chili)',
    subtitle: 'Large freshwater golden apple snails from the rice paddies and canals of the Mekong Delta and central Vietnam stir-fried in a smoking wok with lemongrass, garlic, and fresh chili until fragrant — the nhậu dish that requires both a toothpick and technique, and rewards both generously.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '40 min',
    rating: 4.8,
    ...
    intro: `Ốc bươu xào sả ớt is the stir-fried golden apple snail — one of the most consumed freshwater mollusks in Vietnam and one of the most important nhậu dishes in the country's beer-food repertoire. Ốc bươu (Pomacea canaliculata, the golden apple snail) arrived in Vietnam in the 1980s as a potential aquaculture species and escaped into the rice paddies, where it became simultaneously an agricultural pest and a beloved street food ingredient — a reversal of fortunes unique in Vietnamese culinary history. The snail is large by freshwater mollusk standards, with a shell 4-6cm across, a sweet, firm, slightly chewy flesh, and enough volume in each snail to constitute a satisfying bite rather than the delicate single mouthful of smaller species. Xào sả ớt — stir-fried with lemongrass and chili — is the preparation that dominates the Vietnamese ốc bươu menu because the combination of the lemongrass-chili heat with the sweet, slightly muddy character of freshwater snail produces an equilibrium that neither element achieves alone. The lemongrass's citrus-grass volatiles cut through the freshwater character of the snail; the chili provides the heat that the neutral snail flesh absorbs and carries through each bite; the garlic provides the savory foundation. The technique is fast — maximum wok heat, continuous motion, 5-6 minutes total from aromatics to plate — because ốc bươu flesh that overcooks becomes rubbery and the lemongrass aromatics cook off quickly at wok temperatures. The eating is communal and slightly competitive, with diners using toothpicks to extract the snail meat from its shell in the way that only practice produces.`,
    ingredientSections: [
        {
            title: 'Snails',
            items: [
                { amount: 1.2, unit: 'kg', name: 'fresh ốc bươu (golden apple snails)', note: 'alive — available at Vietnamese and Asian markets. Purge in salted water for 2-3 hours before cooking. Scrub shells under running water.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, name: 'bird\'s eye chilies', note: 'minced — ốc bươu xào sả ớt should be genuinely spicy' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 8, name: 'toothpicks', note: 'one per diner plus spares — essential tool for ốc bươu' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The water added around the wok edge for ốc bươu creates steam that carries the seasoning into the shells from above (through the broken tip) and from below (through the shell opening) simultaneously. This steam penetration is what produces seasoned snail meat rather than seasoning that stays on the shell exterior.',
        },
        {
            ...
            tip: 'The 2-minute covered steam phase for ốc bươu is the step that guarantees the snail meat is fully cooked without drying out from extended open wok time. Golden apple snails that are under-cooked have a slimy texture; correctly cooked snails are firm but yielding. The steam guarantees the correct result.',
        },
        {
            title: 'Plate and demonstrate the toothpick technique',
            description: 'Transfer to a serving plate. Make the dipping salt and squeeze lime over individual plates at the table. To eat: hold the shell opening to the lips, attempt to suck the snail out — it should come with moderate suction. If it does not come, insert a toothpick through the broken tip, hook the meat and gently guide it toward the opening while sucking simultaneously. The snail comes out in one spiral piece. Dip in the muối tiêu chanh. Eat with rau răm between bites.',
            tip: 'The combined suction-and-toothpick technique is the skill that separates experienced ốc bươu eaters from those who abandon the shells in frustration. The toothpick does not pull the snail out — it guides it. The suction does not extract the snail alone — it creates the pressure differential. Together, they work. Separately, they do not.',
        },
    ],
};
