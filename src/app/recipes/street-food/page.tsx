...
const RECIPES: Recipe[] = [
    {
        ...
        description: "The sandwich that conquered the world from a Saigon sidewalk. Shatteringly crisp baguette, smoky lemongrass pork, silky pâté, pickled daikon, fresh cucumber and coriander. Twenty thousand d?ng. Extraordinary.",
    ...
    },
    {
        ...
        description: "Born in the misty highlands of Ðà L?t — a crispy rice paper base grilled over charcoal, topped with egg, spring onion, dried shrimp and chilli sauce. Vietnam's answer to pizza, and arguably better.",
