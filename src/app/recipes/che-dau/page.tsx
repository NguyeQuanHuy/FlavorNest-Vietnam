    ...
    ingredientSections: [
        {
            title: 'Bean soup',
            items: [
                { amount: 200, unit: 'g', name: 'split mung beans', note: 'soaked 1 hr' },
                { amount: 800, unit: 'ml', name: 'water' },
                { amount: 3, name: 'pandan leaves', note: 'tied in a knot' },
                { amount: 80, unit: 'g', name: 'rock sugar', note: 'or caster sugar' },
    ...
    steps: [
        {
            ...
            description: 'Drain soaked mung beans and combine with water and pandan leaves in a saucepan. Bring to a boil, skim off any foam, then reduce to a gentle simmer. Cook uncovered for 30 to 35 minutes until beans are completely soft and beginning to break down at the edges.',
        ...
        },
        {
            ...
            description: 'Remove pandan leaves. Add rock sugar and salt, stirring until fully dissolved. Taste and adjust. Simmer for a further 5 minutes. The consistency should be soupy but with body.',
        },
        {
            title: 'Make the coconut topping',
            description: 'Warm coconut cream, sugar, and salt in a small saucepan over low heat. Stir in the tapioca starch slurry and cook for 2 to 3 minutes, stirring constantly, until slightly thickened and glossy.',
            tip: 'The tapioca starch gives the coconut topping a silky body that floats on the bean soup rather than sinking in.',
        },
        {
            title: 'Serve',
            description: 'Ladle warm bean soup into bowls. Spoon coconut cream topping over the surface. Do not stir. Serve warm in cool weather, or over crushed ice in summer.',
        },
    ],
};
