...
const recipe: RecipeData = {
    ...
    title: 'Cá Com Rang Mu?i Mè (Dry-Fried Anchovies with Salt and Sesame)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice or congee (cháo)', note: 'the primary vehicle for cá com rang mu?i mè' },
