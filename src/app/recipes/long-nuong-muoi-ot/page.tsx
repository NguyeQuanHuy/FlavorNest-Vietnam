...
const recipe: RecipeData = {
    ...
    title: 'Lòng Nu?ng Mu?i ?t (Grilled Pork Intestine with Salt and Chili)',
    ...
    intro: `Lòng nu?ng mu?i ?t is the dish that separates the curious from the committed. It is pork intestine — specifically the small intestine, thoroughly cleaned, the inner surface scraped until it loses its characteristic odor, then marinated and grilled over charcoal until it chars at the edges and the collagen inside becomes soft and yielding. The outside is crisp from the fire; the inside is silky from the fat and connective tissue. Eaten with mu?i ?t — salt ground with fresh chili and a squeeze of lime — it is one of the great Vietnamese street food experiences. The technique is simple. The cleaning step requires patience. The result is worth it. This recipe includes full cleaning instructions for first-time cooks and a restaurant shortcut for those with access to a Vietnamese butcher who sells pre-cleaned intestine.`,
    ingredientSections: [
        {
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 1, name: 'bundle fresh herbs', note: 'Vietnamese coriander (rau ram), perilla (tía tô), mint' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Arrange grilled intestine on a plate with fresh herbs, bean sprouts, and lime wedges alongside. Place mu?i ?t dipping sauce on the side — each diner dips the intestine into the salt-chili-lime mixture and eats with herbs. The herbs are not garnish: wrap a piece of intestine in a perilla leaf with a few mint leaves, dip, eat. This is the correct way.',
            tip: 'Lòng nu?ng is a beer food. Cold Hà N?i or Saigon beer alongside is not optional — the carbonation cuts through the fat in a way that nothing else does.',
        },
    ],
};
