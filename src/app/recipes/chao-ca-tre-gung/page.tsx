...
const recipe: RecipeData = {
    ...
    title: 'Cháo Cá Trê G?ng (Catfish and Ginger Congee)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 50, unit: 'g', name: 'old ginger (g?ng già)', note: '5 slices, smashed — for the stock' },
