...
const recipe: RecipeData = {
    slug: 'banh-pia',
    title: `Sóc Trang Flaky Durian Pastry`,
    subtitle: `Bánh Pía — Teochew spiral-layered pastry from Sóc Trang, filled with salted egg yolk, durian paste, and mung bean.`,
    category: 'DESSERT',
    difficulty: 'Hard',
    totalTime: '5 hrs',
    rating: 4.9,
    ...
    intro: `Bánh pía is Sóc Trang's most famous export — a round, spiral-layered pastry with a paper-thin flaky crust that shatters on the first bite and a dense, aromatic filling of mung bean paste enriched with durian and sealed around a whole salted egg yolk. The name comes from the Teochew Chinese word for pastry (?, bing/pia), and the technique is entirely Teochew: a water dough wrapped around a lard-based oil dough, rolled and folded repeatedly to create dozens of flaky layers in a spiral cross-section.\n\nThe Teochew community arrived in Sóc Trang in the late nineteenth century, bringing this pastry tradition with them. What distinguished the Sóc Trang version from the original was the addition of durian — the Mekong Delta's abundance of Ri6 and Monthong durian made it the obvious enrichment for the mung bean filling. The salted egg yolk in the centre is the Chinese contribution: the yolk's salt cuts through the sweetness of the bean paste and its fat enriches every bite from the inside out.\n\nThe spiral on the cross-section — concentric rings of pale water dough and yellow lard dough — is the mark of quality. A good bánh pía shows eight to twelve visible layers when cut. A poor one shows three or four. This recipe produces twelve layers. It requires patience and cold hands. Lard is not optional.`,
    ingredientSections: [
        {
            title: `Water dough (v? nu?c)`,
            items: [
                { amount: 250, unit: 'g', name: `all-purpose flour`, note: `plus extra for dusting` },
                { amount: 80, unit: 'ml', name: `warm water` },
                { amount: 40, unit: 'g', name: `lard (m? heo)`, note: `room temperature — butter produces an inferior flake` },
                { amount: 30, unit: 'g', name: `icing sugar` },
                { amount: 0.25, unit: 'tsp', name: `salt` },
            ],
        },
        {
            title: `Oil dough (v? d?u)`,
            items: [
                { amount: 180, unit: 'g', name: `all-purpose flour` },
                { amount: 100, unit: 'g', name: `lard (m? heo)`, note: `cold — must be solid, not soft` },
            ],
        },
        {
            title: `Mung bean and durian filling`,
            items: [
                { amount: 300, unit: 'g', name: `split mung beans (d?u xanh cà), soaked 4 hrs` },
                { amount: 150, unit: 'g', name: `durian flesh (s?u riêng)`, note: `Ri6 or Monthong — fresh or frozen and thawed; no substitutes` },
        ...
        },
        {
            title: `Assembly`,
            items: [
                { amount: 12, name: `salted duck egg yolks (lòng d? tr?ng v?t mu?i)`, note: `raw — available at Asian grocers; soak in rice wine 5 min to remove gamey note` },
                { amount: 1, name: `egg yolk, beaten`, note: `for egg wash` },
                { amount: 1, unit: 'tbsp', name: `sesame seeds (mè tr?ng)`, note: `for top — optional but traditional` },
            ],
        },
    ],
    steps: [
        ...
        {
            title: `Cut and serve`,
            description: `Slice each bánh pía in half with a sharp serrated knife using a single sawing motion — do not press down, which crushes the layers. The cross-section should show eight to twelve concentric spiral rings of pale and yellow dough, the dense amber mung bean filling, and the orange salted egg yolk at the centre. Serve at room temperature. In Sóc Trang, bánh pía is eaten with hot Chinese tea — the slight bitterness of the tea cuts through the richness of the lard pastry and durian.`,
