...
const recipe: RecipeData = {
    slug: 'goi-sua',
    title: 'G?i S?a (Vietnamese Jellyfish Salad)',
    ...
    intro: `G?i s?a is the Vietnamese jellyfish salad — a dish that requires more trust from a first-time eater than almost any other, and delivers more reward. Prepared jellyfish has been processed (salted, then desalted and blanched) to remove the stinging cells and produce the texture that makes it worth eating: dense, chewy, with a clean oceanic freshness and a resistance between the teeth that is unique among edible ingredients. It is not gelatinous, not slippery, not what first-timers imagine. It is closest in texture to a firm, slightly chewy squid — but lighter and more neutral in flavor, which makes it an ideal canvas for the sharp, herb-forward Vietnamese dressing. G?i s?a is a coastal dish, most associated with the central coast provinces — Ðà N?ng, Qu?ng Nam, Phú Yên — where jellyfish are harvested in summer. Prepared jellyfish is available year-round at Vietnamese and Asian grocers, typically sold salted in bags or pre-rinsed and packaged. This recipe uses the prepared variety.`,
    ingredientSections: [
        {
            title: 'Salad',
            items: [
                { amount: 300, unit: 'g', name: 'prepared jellyfish (s?a)', note: 'salted or pre-rinsed from Asian grocery. Must be desalted before use — see step 1. Available refrigerated or in brine.' },
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'bunch Vietnamese coriander (rau ram)', note: 'leaves only — the defining herb for this salad' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'In a large bowl, combine the drained jellyfish, sliced pork, shrimp, cucumber, and all the herbs — rau ram, mint, and spring onion. Pour the dressing over and toss gently but thoroughly. Every ingredient should be coated. Taste and adjust seasoning.',
            tip: 'Assemble immediately before serving — g?i s?a softens quickly once dressed. The jellyfish releases moisture into the dressing within 15-20 minutes and the salad becomes watery. Dress and eat.',
        },
        {
