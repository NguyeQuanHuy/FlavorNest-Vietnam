...
const recipe: RecipeData = {
    ...
    intro: `Khổ qua rừng (Momordica charantia var. abbreviata) is the wild smaller cousin of the cultivated bitter melon — a thin-stemmed vine that grows in the forest edges, riverbanks, and fallow fields of the Mekong Delta and the southern highlands. Every part of it is used: the tiny bitter fruit (smaller than a thumb, intensely bitter), the young shoots, and most importantly the leaves, which carry a concentrated bitterness that the cultivated variety has largely lost through centuries of selective breeding toward milder flavour.\n\nLẩu lá khổ qua rừng is one of the most distinctively medicinal dishes in southern Vietnamese cooking — a hotpot where wild bitter melon leaves are the defining ingredient, added in continuous batches to a simmering pork rib broth throughout the meal. The bitterness of the leaves disperses into the broth progressively, building from mild in the first minutes to intensely bitter by the end. Southern Vietnamese cooking has a deep tradition of bitter-tasting foods as health foods (thuốc đắng dã tật — bitter medicine cures illness), and lẩu lá khổ qua rừng sits squarely in this tradition: it is simultaneously a meal and a tonic, eaten specifically when someone in the household is unwell, fatigued, or recovering from excess.\n\nThe dish is associated with the An Giang and Đồng Tháp highland-border regions, where the wild vine is collected by hand from the forest. In the Mekong Delta lowlands, it appears at weekend family meals as a seasonal dish when the vine is available. Outside Vietnam it is essentially unknown — the cultivated bitter melon (khổ qua) appears in Chinese and Southeast Asian cooking throughout the world, but the wild leaf preparation is specific to the southern Vietnamese tradition and has never been documented in English.`,
    ingredientSections: [
        {
            title: `Broth base`,
            items: [
