...
const recipe: RecipeData = {
    slug: 'de-nau-mit-non',
    title: 'Dê N?u Mít Non (Goat Braised with Young Jackfruit)',
    subtitle: 'Bone-in goat pieces braised with unripe green jackfruit in a lemongrass-galangal broth until both become tender — the jackfruit absorbing the goat fat and broth while contributing its own starchy, slightly astringent character that grounds the richness of the meat. The mountain dish of Son Hòa district, Phú Yên.',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tbsp', name: 'm?m nhi', note: 'the Phú Yên addition — adds depth to the braising liquid' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The galangal paste in dê n?u mít non needs the full 4-5 minutes of frying to develop its best character. Raw galangal has a sharp, almost medicinal harshness that disappears when properly cooked. At 4-5 minutes it becomes warm, complex, and specifically harmonious with goat and jackfruit.',
        },
        {
            title: 'Add jackfruit and braising liquid',
            description: 'Add the blanched jackfruit pieces directly to the pot with the seared goat. Pour water or stock around the sides. Add fish sauce, m?m nhi, sugar, star anise, and cinnamon. The liquid should come about two-thirds up the combined goat and jackfruit — not fully submerged, as both will release moisture during cooking. Bring to a boil.',
        ...
        },
        {
            ...
            tip: 'The tomato acidity in the last 20 minutes is the element that prevents dê n?u mít non from tasting heavy and starchy. The jackfruit thickens the broth significantly during cooking and the tomato provides the balancing note that keeps the dish light enough to eat a full bowl of.',
        },
        {
            title: 'Serve from the pot — highland style',
            description: 'Bring the pot directly to the table. Scatter rau ram, Vietnamese balm, and sliced spring onion over the surface. Grind black pepper generously. Serve with steamed rice and baguette alongside, lime wedges, and sliced chili. To eat: serve a piece of goat and two or three pieces of jackfruit in each bowl, ladle the thickened broth generously. The jackfruit and goat eaten together — one bite of each — is the combination the dish is built for. The baguette for mopping the jackfruit-thickened broth is the finest way to end each bowl.',
