...
const recipe: RecipeData = {
    slug: 'goi-tom-buoi',
    title: 'G?i Tôm Bu?i (Vietnamese Pomelo and Shrimp Salad)',
    subtitle: 'Pomelo segments torn into pieces and tossed with poached shrimp, pork belly, rau ram, crispy shallots, roasted peanuts, and a lime-fish sauce dressing that brightens the pomelo\'s natural bitterness into something extraordinary. The southern Vietnamese salad built around the fruit that is simultaneously the most subtle and the most complex in the Vietnamese orchard.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '35 min',
    rating: 4.9,
    ...
    intro: `G?i tôm bu?i is the pomelo salad of southern Vietnam — a preparation that uses bu?i (pomelo, the large citrus fruit that is the ancestor of the grapefruit) in the specific way that reveals what makes pomelo different from every other citrus fruit in Vietnamese cooking: it is simultaneously sweet, sour, and bitter, with a dry texture in the flesh that absorbs dressings rather than releasing liquid into them, and a fragrance that is more floral and complex than grapefruit. In g?i tôm bu?i, the pomelo segments are torn apart by hand into irregular pieces rather than cut — the tearing separates the individual juice sacs and produces a texture that is fluffy and absorbent rather than wet and slick. Poached shrimp and boiled pork belly provide the protein. Rau ram provides the sharp peppery herb note that is its defining character. Crispy fried shallots add crunch and sweetness. The dressing is the standard Vietnamese g?i dressing — lime juice, fish sauce, sugar, garlic, chili — but calibrated specifically for pomelo: less lime than for mango or papaya salad, because the pomelo already contributes significant citrus character, and a slightly larger amount of sugar to balance the fruit's natural bitterness. G?i tôm bu?i is a southern Vietnamese dish, associated particularly with the Mekong Delta and the coastal provinces where pomelo orchards are extensive — B?n Tre, Ti?n Giang, Vinh Long — and where the fruit is available in abundance from October through January. It is eaten as an appetizer at family gatherings, as a party dish, and as the salad that appears at Vietnamese T?t celebrations in the south alongside the richer meat dishes as a refreshing contrast.`,
    ingredientSections: [
        {
            title: 'Pomelo',
            items: [
                { amount: 1, name: 'large pomelo (bu?i)', note: 'about 1.2-1.5kg whole fruit. Choose a pomelo that feels heavy for its size with a fragrant skin. Pink-fleshed pomelo (bu?i da xanh) produces a more visually dramatic salad; white-fleshed pomelo has a cleaner, more subtle flavor.' },
            ],
        },
        {
            title: 'Proteins',
        ...
        },
        {
            title: 'Herbs',
            items: [
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)', note: 'leaves only — essential and used generously' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1.5, unit: 'tbsp', name: 'fresh lime juice', note: 'less than other g?i — the pomelo provides its own citrus acidity' },
                { amount: 2, unit: 'tbsp', name: 'sugar', note: 'slightly more than other g?i — balances the pomelo\'s natural bitterness' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 8, name: 'prawn crackers (bánh ph?ng tôm)', note: 'for scooping' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Combine fish sauce, lime juice, sugar, water, garlic, chili, and sesame oil. Stir until sugar dissolves. Taste alongside a piece of pomelo: the dressing should add savory depth and sweetness to the pomelo without competing with its natural citrus flavor. The less lime and extra sugar compared to standard g?i dressing is specifically for pomelo — adjust further based on the sweetness and bitterness of your specific fruit.',
            tip: 'Every pomelo is different — some are very sweet, some quite bitter, some with pronounced citrus acidity. Taste the pomelo first and calibrate the dressing to its specific character. This is the most important decision in g?i tôm bu?i and cannot be standardized.',
        },
        {
            title: 'Assemble gently — pomelo last',
            description: 'In a large wide bowl, combine the shrimp, pork slices, soaked shallots, rau ram, mint, and spring onion. Pour the dressing over and toss gently. Add the drained pomelo pieces last — fold them in with a lifting motion rather than tossing, to keep the fragile juice sac clusters intact. Every element should be lightly coated with dressing without the pomelo breaking down.',
        ...
        },
        {
            ...
            description: 'Transfer to a serving plate. Drizzle shallot oil over the surface. Top with crushed peanuts, crispy fried shallots, and sliced fresh chili — all added at the last moment to preserve crunch and color. Serve immediately with prawn crackers and lime wedges. G?i tôm bu?i should be served and eaten within 15-20 minutes of dressing — the pomelo continues to release moisture and the peanuts and shallots soften over time. This is a make-and-serve salad, not a make-ahead one.',
            tip: 'The visual of g?i tôm bu?i on the plate — the pale pomelo pieces, the pink shrimp, the golden peanuts and shallots, the dark green rau ram — is one of the most colorful in Vietnamese cooking. Present generously on a wide, flat plate where every element is visible.',
        },
    ],
};
