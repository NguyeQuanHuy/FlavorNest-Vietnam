...
const recipe: RecipeData = {
    ...
    title: 'Cá N?c H?p Cu?n Bánh Tráng Phú Yên (Steamed Mackerel Scad Wrapped in Rice Paper)',
    subtitle: 'Whole mackerel scad steamed over lemongrass until the flesh is silky and slightly sweet, eaten by pulling pieces from the bone at the table and wrapping in sesame rice crackers with rau ram, green mango, and cucumber — dipped in m?m nhi ginger sauce. The most sociable fish preparation in Phú Yên.',
    ...
    intro: `Cá n?c h?p cu?n bánh tráng is the communal fish preparation that appears at almost every Phú Yên family meal, weekend gathering, and seafood restaurant along the coast — a dish whose social character is as defining as its flavor. Cá n?c (mackerel scad, Decapterus spp.) are the abundant, affordable, deeply flavored fish of the central Vietnamese coast, caught in large quantities year-round and eaten in more preparations than perhaps any other single species in the province. The h?p (steaming) preparation preserves the fish's natural sweetness and produces a flesh that separates from the bone cleanly — important because the eating method requires the flesh to be pulled from the bone at the table by each diner, not pre-portioned in the kitchen. The cu?n bánh tráng (rice paper wrapping) element transforms a simple steamed fish into an interactive meal: the central plate holds the whole steamed fish, the table surrounds it with herbs, green mango, cucumber, and the sesame crackers from Tuy An, and each diner constructs their own wrap from the components available, dipping the assembled roll in the m?m nhi ginger sauce that completes everything. The specific character of the Phú Yên version comes from three elements: the sesame crackers (bánh tráng mè Tuy An) rather than plain rice paper for wrapping — the sesame adds a toasty dimension that rice paper alone lacks; the green mango included alongside the standard herbs — the sourness provides the contrast that the sweet steamed fish needs; and the m?m nhi dipping sauce that by this point in the Phú Yên series needs no further introduction. Together these three elements produce a version of steamed fish wrapping that is specifically identifiable as Phú Yên even if encountered outside the province.`,
    ingredientSections: [
        {
            title: 'Fish',
            items: [
                { amount: 4, name: 'whole fresh cá n?c (mackerel scad), 200-250g each', note: 'cleaned, scaled, gills removed. Slash the thickest part of each fish 2-3 times on each side — allows steam to penetrate to the bone and makes the flesh separate more cleanly.' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)' },
    ...
    steps: [
        {
            ...
            description: 'Scale and clean each cá n?c. Make 2-3 diagonal slashes on each side of each fish — cutting through the skin and into the flesh to the bone. These slashes serve two purposes: they allow the lemongrass-ginger steam to penetrate to the bone during steaming, and they allow the flesh to separate more cleanly from the bone when pulled at the table. Rinse and pat dry.',
            tip: 'The diagonal slashing of cá n?c is the specific preparation that distinguishes h?p cu?n bánh tráng from simply steaming the fish. The slashes must reach the bone — not deep enough to separate the fillets, but deep enough that the steam enters and the flesh pulls cleanly. Test: insert a chopstick into a slash — it should reach the bone.',
        },
        {
            title: 'Steam for exactly 10-12 minutes',
            description: 'Build the lemongrass steaming bath to a vigorous boil. Arrange the whole fish on the steaming rack — they can overlap slightly if necessary, as long as the steam can circulate. Cover tightly. Steam over maximum heat for 10-12 minutes. Cá n?c are done when: the flesh in the deepest slash has turned from translucent grey-white to opaque white; the eye has turned white and slightly protruding; the flesh pulls from the bone with light pressure from chopsticks.',
        ...
        },
        {
            ...
            description: 'Grate the fresh ginger to near-liquid consistency. Combine with m?m nhi, lime juice, sugar, warm water, and minced chili. The sauce for cá n?c cu?n should be slightly thinner than the version used for crustaceans — the fish is more delicate and the sauce should coat without overwhelming. Divide into individual small bowls, one per diner.',
            tip: 'Individual dipping bowls for cá n?c cu?n bánh tráng are important because each diner wraps and dips at their own pace throughout the meal. A shared bowl becomes quickly diluted from the repeated dipping of wet fish and cracker combinations.',
        },
        {
            ...
            tip: 'The communal table arrangement for cá n?c h?p cu?n bánh tráng is part of the dish\'s identity — it requires the physical proximity of multiple people reaching across each other, sharing components, commenting on each other\'s wraps. A Phú Yên family does not eat this dish in silence or separately.',
        },
        {
        ...
        },
        {
            ...
            description: 'Pull a piece of fish from the bone — use the pre-cut slashes as separation guides. Place on a sesame cracker. Add green mango, cucumber, rau ram, mint, and perilla. Scatter a few crushed peanuts. Roll loosely — the cracker is firm enough to hold the assembly without collapsing. Dip the assembled roll edge-first into the m?m nhi ginger sauce. Eat in one or two bites. Add a raw lá é leaf between rolls if available. Repeat until the fish is gone. Use a cracker to mop the fish plate for any remaining fish juices.',
            tip: 'The green mango in the cá n?c cu?n wrap is the component that most clearly marks this as Phú Yên rather than generic Vietnamese fish wrapping. The assertive sourness of unripe green mango against the sweet steamed fish is a contrast specific to this province\'s approach. Without it the wrap is pleasant; with it the wrap is complete.',
        },
    ],
};
