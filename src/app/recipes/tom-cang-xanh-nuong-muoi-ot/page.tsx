...
const recipe: RecipeData = {
    ...
    title: 'Tôm Càng Xanh Nu?ng Mu?i ?t (Mekong Giant Freshwater Prawn Grilled with Chili Salt)',
    subtitle: 'The giant freshwater prawns of the Mekong Delta — longer than a hand, with claws the size of a finger — split, coated in chili-salt paste, and grilled over charcoal until the shells turn vivid blue-red and the sweet river flesh inside caramelizes at the edges. The flagship seafood of the C?u Long.',
    ...
    ingredientSections: [
        ...
        {
            title: 'Mekong dipping sauce (nu?c ch?m ki?u mi?n Tây)',
            items: [
