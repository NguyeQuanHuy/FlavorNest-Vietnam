...
const recipe: RecipeData = {
    ...
    subtitle:
        'Gà Kho S? ?t — chicken thighs braised with a small mountain of minced lemongrass and bird\'s eye chilli until the sauce clings like glaze.',
    ...
    intro:
        'Central Vietnamese cooking has its own devoted following, and this is one of the dishes that explains why. Where the Northern gà kho g?ng leans on ginger and restraint, the Central version turns up every dial: more lemongrass, more chilli, more fish sauce, cooked down until the sauce is almost a paste. The kitchen ends up smelling like a Hue market at sunrise.',
    ingredientSections: [
        {
            title: 'Chicken',
            items: [
