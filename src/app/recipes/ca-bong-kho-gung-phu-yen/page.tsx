...
const recipe: RecipeData = {
    ...
    title: 'Cá Bống Kho Gừng Phú Yên (Phú Yên River Goby Braised with Ginger)',
    ...
    intro: `Cá bống kho gừng is the river goby braise of Phú Yên's inland communities — a preparation that uses cá bống (goby fish, primarily Rhinogobius and Glossogobius species) from the mountain streams and rivers of the province's interior: the Sông Ba, the Sông Kỳ Lộ, and the smaller tributary streams that flow from the Central Highlands down through Sơn Hòa and Đồng Xuân toward the coast. Cá bống are small — rarely exceeding 10-12cm — with a dense, firm flesh and a specific flavor that differs from both marine fish and larger freshwater species: slightly sweet, slightly earthy in the way of clear mountain water fish, with none of the muddy character of fish from lowland or stagnant water. The kho gừng preparation is the dominant cooking method for cá bống throughout Phú Yên because the small size of the fish makes it ideally suited to the concentrating, caramelizing kho technique — the small fish absorb the fish sauce and ginger caramel completely during the 30-40 minute braise, becoming intensely flavored throughout rather than merely on the surface. Old ginger (gừng già) is used in generous quantity — more per fish weight than in any other kho preparation — because the slightly gamey undertone of freshwater fish needs more ginger to harmonize it than pork or marine fish requires. After 40 minutes of braising and reduction, the cá bống are dark, sticky, intensely savory from the reduced fish sauce, warm from the old ginger heat, and caramelized from the dark caramel base. They are eaten with plain white rice in the way that the most intensely seasoned Vietnamese kho dishes always are: one small piece of fish at a time, placed over a mound of plain rice, the concentrated sauce soaking downward into the grains.`,
    ingredientSections: [
        {
            title: 'River gobies',
            items: [
                { amount: 500, unit: 'g', name: 'fresh cá bống (river gobies)', note: 'cleaned, scaled, heads left on — the heads contribute gelatin and flavor to the kho. If using larger gobies (over 8cm): slash each side once to allow the kho sauce to penetrate. Available at Vietnamese markets specializing in freshwater fish. Substitute: any small freshwater fish 8-12cm — small catfish, small tilapia, or whitebait.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 80, unit: 'g', name: 'old ginger (gừng già)', note: 'peeled and cut into thick matchsticks — this is the defining quantity, more generous per fish weight than any other kho' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice', note: 'plain, hot — the only accompaniment cá bống kho needs' },
    ...
    steps: [
        {
            ...
            tip: 'The turmeric pre-marination for cá bống is more important than for marine fish — freshwater fish, especially from mountain streams, can have a faint earthy-grassy smell that turmeric and ginger together transform into something pleasant rather than something to notice. This is the preparation step that makes cá bống kho gừng smell of ginger and caramel rather than of river.',
        },
        {
            title: 'Build the dark caramel',
            description: 'In a clay pot over medium heat, add oil and sugar. Leave until the edges begin to melt. Swirl gently to an even deep amber — darker than for seafood kho, approaching the near-black caramel used for vịt kho gừng. Add 2 tablespoons of water carefully — it will spit aggressively. Swirl until dissolved. The caramel for cá bống kho should be as dark as possible without burning — the fish is small and will take the caramel color completely.',
            tip: 'The darkest possible caramel without burning is the target for cá bống kho gừng. Small river gobies absorb the caramel completely during the braise — a pale caramel produces a pale, flat kho; a dark caramel produces the deeply colored, deeply flavored result that makes this dish remarkable for such small fish.',
        },
        {
            title: 'Fry the ginger in the caramel',
            description: 'Add the ginger matchsticks, smashed garlic, and halved shallots directly to the hot dark caramel. They will sizzle immediately in the caramel residue. Fry for 2 minutes until the ginger begins to caramelize at the edges. The combination of dark caramel and caramelized old ginger produces the specific aromatic foundation that defines cá bống kho Phú Yên — deep, warm, slightly burnt at the edges in a way that is specifically right for this dish.',
        ...
        },
        {
            ...
            tip: 'The "almost black in the darkest spots" appearance of correctly made cá bống kho is not burning — it is concentrated caramelization of the fish surface proteins combined with the dark caramel base. New cooks often pull the pot too early when the fish starts looking dark. The correct endpoint is darker than most kho preparations, reflecting both the dark caramel and the concentrated fish sauce reduction.',
        },
        {
            ...
            tip: 'The bones of cá bống after 40 minutes of kho braising are soft enough to eat — the small vertebrae and rib bones have been partially broken down by the long acid-salt-heat exposure. Phú Yên river communities eat cá bống kho gừng whole — fish, bones, and all — with nothing wasted. This is both economical and, after 40 minutes of braising in dark caramel, genuinely pleasant.',
        },
    ],
};
