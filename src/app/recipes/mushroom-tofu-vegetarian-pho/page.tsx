...
const recipe: RecipeData = {
    ...
    intro:
        'Ph? chay is not pho with the meat removed — it is its own tradition, refined over centuries in the Buddhist kitchens of Hu? and Ðà L?t. Three mushrooms stand in for bones and brisket: shiitake for depth, king oyster for texture, straw mushrooms for softness. The spice profile stays pure pho.',
    ingredientSections: [
        {
            title: 'Broth',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, name: 'black cardamom pods', note: 'th?o qu?, lightly crushed' },
