...
const recipe: RecipeData = {
    slug: 'sup-lo-xao',
    title: 'Súp Lo Xào (Vietnamese Stir-Fried Cauliflower)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 100, unit: 'g', name: 'broccoli florets', note: 'for the mixed súp lo xanh version' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a plate immediately — never leave in the wok. Scatter spring onion, fresh chili, and freshly ground black pepper. Serve with steamed rice. Súp lo xào is at its best immediately after cooking — cauliflower softens quickly from residual heat and the golden color fades within minutes.',
