...
const recipe: RecipeData = {
    ...
    subtitle:
        'Ð?u Hu S?t Cà — golden-fried tofu simmered in a sweet-savoury tomato and spring onion sauce.',
    category: 'VEGETARIAN',
    difficulty: 'Easy',
    totalTime: '20 min',
    rating: 4.7,
    ...
    intro:
        'Ð?u s?t cà is the dish that converts tofu sceptics. The secret is treating it like meat — fried hard first so the outside turns custardy-crisp, then simmered just long enough to drink in the tomato sauce without going soggy. In Northern families it is on the table at least once a week, often without anyone planning it.',
    ingredientSections: [
        {
            title: 'Tofu',
            items: [
