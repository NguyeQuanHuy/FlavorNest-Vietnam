...
const recipe: RecipeData = {
    ...
    title: 'Bồ Câu Hấp Mắm Nhĩ Phú Yên (Phú Yên Steamed Pigeon with Premium Fish Sauce)',
    subtitle: 'Whole pigeon steamed over Vietnamese beer with lemongrass and ginger — the same aromatic bath used for Phú Yên\'s finest seafood — served with the mắm nhĩ and microplane-grated ginger dipping sauce that transforms the rich, dark pigeon flesh into something specific to the central coast.',
    ...
    intro: `Bồ câu hấp mắm nhĩ Phú Yên is the preparation that demonstrates the province's cooking philosophy most clearly: take the finest available ingredient, apply the simplest technique, and pair it with the condiment that only Phú Yên produces. The technique is the beer-lemongrass steaming that coastal Phú Yên families apply to their finest seafood — cua huỳnh đế, ghẹ, tôm hùm — transferred here to pigeon, the bird that Vietnamese-Chinese tonic cooking holds in the highest regard. The transfer of a seafood steaming technique to pigeon is not arbitrary: steaming is the method that best preserves the delicate, specific flavor of a high-quality protein, whether that protein comes from the sea or from a rooftop pigeon coop, and the beer-lemongrass bath produces an aromatic steam that perfumes the flesh from all directions simultaneously during cooking. The pigeon's dark, rich flesh — significantly more mineral and iron-rich than chicken — responds to steaming in a way that produces the most clearly flavored result: none of the depth of the pigeon is diluted by braising liquid, none is masked by caramelization from roasting, and none is lost to the water when boiled. What emerges from the steamer after 20 minutes is a pigeon that tastes entirely of itself plus the lemongrass and ginger that the steam has driven into the flesh. The mắm nhĩ dipping sauce — the same preparation used alongside steamed crab and steamed lobster — provides the aromatic and umami dimension that the deliberately unseasoned pigeon requires and that no other dipping preparation delivers with the same effect.`,
    ingredientSections: [
        {
            title: 'Pigeon',
            items: [
                { amount: 2, name: 'whole pigeons (bồ câu / squab), 400-500g each', note: 'cleaned — squab (young pigeon) preferred for its more tender, milder flesh. Blanch briefly before steaming.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 30, unit: 'g', name: 'fresh ginger', note: 'microplane-grated to almost liquid paste — the same technique as for ghẹ hấp sả mắm nhĩ' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The steaming liquid for bồ câu hấp is even more valuable than the equivalent liquid from seafood steaming — the pigeon drippings that fall into the beer-lemongrass bath during 20 minutes of steaming produce a broth with the specific richness of pigeon and the aromatic freshness of the Phú Yên steaming method together.',
        },
        {
            title: 'Make the mắm nhĩ ginger sauce',
            description: 'Grate fresh ginger on the finest available grater until it reaches an almost liquid paste consistency. Combine with mắm nhĩ, fresh lime juice, sugar, warm water, and optional chili. Stir to combine. Taste: the mắm nhĩ depth should arrive first, followed by the lime brightness, then the ginger warmth building slightly. This is the same sauce used for ghẹ hấp and tôm hùm — applied here to pigeon for the first time in the Phú Yên culinary logic.',
            tip: 'The application of the mắm nhĩ ginger sauce — developed for Phú Yên\'s finest steamed seafood — to pigeon is the creative move that makes bồ câu hấp mắm nhĩ a specifically Phú Yên dish rather than merely a steamed pigeon preparation. The sauce transforms the pigeon eating experience in the same way it transforms crab or lobster: it provides the aromatic dimension that the simple steaming deliberately omits.',
        },
        {
            title: 'Carve and serve',
            description: 'Carve each pigeon: remove the legs first, then the wings, then split the breast down the center. Arrange on a plate — the skin should be pale golden, the flesh visible at the cut surfaces a deep, dark purple-brown. Scatter shredded kaffir lime leaves, rau răm, and sliced spring onion. Pour the reserved cavity juices over the arranged pieces. Serve with the mắm nhĩ ginger sauce, the fragrant steaming broth in small cups, steamed rice, and lime wedges.',
