...
const recipe: RecipeData = {
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 3, unit: 'tbsp', name: 'fish sauce', note: 'Phú Qu?c brand preferred' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'black cardamom pod', note: 'th?o qu? — crack open' },
        ...
        },
        {
            ...
            items: [
                { amount: 600, unit: 'g', name: 'fresh flat rice noodles (bánh ph?)', note: 'or 400g dried — soak 30 min first' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The char gives ph? its characteristic sweet smokiness. Under-charred aromatics produce a flat, thin broth. You want genuine blackening, not just browning.',
        },
        {
        ...
        },
        {
            ...
            tip: 'A sharp knife and semi-frozen beef is the only way to achieve true ph?-thin slices at home. Fully thawed beef will slip and shred under the knife.',
        },
        {
            title: 'Cook the noodles',
            description: 'Bring a separate pot of water to a full boil. For fresh bánh ph?: blanch for 30 seconds, drain. For dried noodles: cook according to package directions (usually 5-6 minutes), drain and rinse briefly with cold water. Divide the noodles among 4 deep bowls — each bowl needs a generous portion, the noodles are half the dish.',
