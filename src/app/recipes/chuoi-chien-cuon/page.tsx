...
const recipe: RecipeData = {
    ...
    title: 'Chuối Chiên Cuộn (Crispy Fried Banana Rolls)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'brown sugar (đường nâu)', note: 'sprinkled inside the roll — deepens the caramel during frying' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, unit: 'tbsp', name: 'sweetened condensed milk (sữa đặc)', note: 'the Vietnamese street food option — drizzled generously' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The tight rolling of chuối chiên cuộn is more important than for savory rolls because the banana inside contracts slightly during frying as its moisture evaporates. A tightly rolled wrapper maintains contact with the banana surface throughout the frying period and produces an evenly caramelized result. A loosely rolled wrapper develops gaps between the wrapper and the banana, producing an uneven, partly hollow result.',
        },
        {
            ...
            tip: 'The 180°C frying temperature for chuối chiên cuộn is slightly higher than the 175°C used for nem rán because the sugar content of the banana filling requires faster, hotter frying to caramelize the interior without over-cooking the wrapper exterior. At 175°C, the banana takes too long to heat through and the wrapper can over-brown before the interior has caramelized.',
        },
        {
