...
const recipe: RecipeData = {
    ...
    subtitle: `Bánh Rế — Phan Thiết's shredded sweet potato and cassava fried into a lacy, brittle disc sweetened with palm sugar and sesame.`,
    category: 'DESSERT',
    difficulty: 'Easy',
    totalTime: '45 min',
    rating: 4.8,
    ...
    steps: [
        ...
        },
        {
            ...
            description: `Bánh rế is served at room temperature, stacked in a tower on a plate or wrapped individually in paper. In Phan Thiết, vendors wrap each disc in a small square of newspaper, which absorbs any residual oil and keeps the wafer isolated from humidity. Eat within 2 hours of frying — beyond that, atmospheric moisture begins to soften the caramelised sugar and the wafer loses its snap. Do not refrigerate — cold and condensation destroy the texture within minutes. If making in advance, store in an airtight tin at room temperature for up to 24 hours with a sheet of silica gel if available.`,
            tip: `The newspaper wrapping method used by Phan Thiết vendors is functional, not nostalgic. The slight ink-and-paper smell that transfers to the wafer surface is considered part of the street food experience by locals. At home, greaseproof paper achieves the same oil-absorption without the ink. The wrapping is only for transport — bánh rế eaten unwrapped, directly from the pan, is always better than the wrapped version.`,
        },
    ],
};
