...
const recipe: RecipeData = {
    ...
    title: 'Dê H?p Mu?i Hoa Tiêu (Goat Steamed with Sichuan Pepper Salt)',
    subtitle: 'Young goat pieces salted with coarse sea salt and Sichuan peppercorns then steamed over lemongrass and ginger until the flesh is silky and juicy — served with the m?m nhi and microplane-grated ginger dipping sauce that the coastal Phú Yên fishing families use for every premium steamed protein.',
    ...
    intro: `Dê h?p mu?i hoa tiêu is the steamed goat preparation of Phú Yên — a dish that applies the same philosophy as gà h?p mu?i ki?u Hoa (Chinese-style salt-steamed chicken) but with specific adaptations for goat and for the ingredients available on the central Vietnamese coast. The preparation is one of the most restrained in the entire Vietnamese goat repertoire: the only seasoning applied externally is a mixture of coarse sea salt and Sichuan peppercorns (hoa tiêu) that is rubbed over and into every surface of the goat pieces, which are then steamed over a fragrant bath of lemongrass, ginger, and beer until the flesh is completely cooked but retains its juice. The Sichuan peppercorn is the ingredient that distinguishes this preparation from plain salt-steamed goat: its specific numbing-citrus character (different from the heat of bird's eye chili or the warmth of black pepper) provides an aromatic counterpoint to the goat's mineral depth without competing with it. The numbing quality of hoa tiêu mellows significantly during steaming — what remains is the citrus-aromatic note and a faint tingle rather than the aggressive numbing of the raw peppercorn. The dipping sauce is the m?m nhi-ginger preparation used throughout Phú Yên's premium steamed seafood — the first-press fish sauce thinned with lime juice and microplane-grated ginger — transferred here to goat, where it works equally well as it does with the flower crab and slipper lobster preparations that more commonly accompany it. Dê h?p mu?i hoa tiêu is the Phú Yên preparation that best demonstrates the province's willingness to apply coastal seafood techniques to mountain ingredients — a culinary cross-fertilization specific to a province where the sea and the highlands are never more than 50km apart.`,
    ingredientSections: [
        {
            title: 'Goat',
            items: [
                { amount: 900, unit: 'g', name: 'bone-in goat pieces (dê ch?t mi?ng)', note: 'young goat — ribs, shoulder, and neck pieces 4-5cm. Fresh, not frozen.' },
            ],
        },
        {
            title: 'Mu?i hoa tiêu (Sichuan pepper salt)',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch Vietnamese balm (rau kinh gi?i)', note: 'the essential goat herb' },
    ...
    steps: [
        {
            ...
            tip: 'Toasting the Sichuan peppercorns before grinding is the step that develops their specific aromatic character. Raw Sichuan peppercorns are intensely numbing and harsh; toasted Sichuan peppercorns are aromatic, citrus-forward, and the numbing quality mellows. For dê h?p, the toasted character is what you want — the numbing should be a background note, not a dominant sensation.',
        },
        {
            title: 'Salt the goat — minimum 1 hour',
            description: 'Pat the goat pieces completely dry. Rub the mu?i hoa tiêu mixture firmly over every surface — into the bone-flesh joints, between ribs, over the fat. The salt should be pressed into the meat rather than sitting on the surface. Place on a rack at room temperature for 1 hour, or uncovered in the refrigerator for up to 8 hours. The salt draws moisture, then reabsorbs — seasoning the meat from within rather than merely coating the exterior.',
            tip: 'The salting period for dê h?p is longer than for chicken or seafood because goat is denser and the salt penetrates more slowly. One hour is the minimum — the Sichuan peppercorn aroma needs this time to begin penetrating the surface of the meat as well. An 8-hour refrigerator salt is significantly better than a 1-hour room temperature rest.',
        },
        {
        ...
        },
        {
            ...
            description: 'Grate the fresh ginger on the finest available grater — a microplane produces the almost-liquid paste that distributes through the sauce completely. Combine with m?m nhi, fresh lime juice, sugar, and warm water. Add minced chili if using. The sauce should arrive in sequence on the palate: m?m nhi depth first, then lime brightness, then ginger heat that builds slightly. This is the same sauce used for gh? h?p s? m?m nhi — the Phú Yên steamed protein sauce applied equally to crab and goat.',
            tip: 'Applying the same m?m nhi ginger sauce to both steamed crab and steamed goat is the deliberate cross-cuisine move of Phú Yên coastal-mountain cooking. The province uses its finest condiment for its finest ingredients regardless of whether those ingredients come from the sea or the hillside.',
        },
        {
            title: 'Plate and serve',
            description: 'Transfer the steamed goat to a serving plate. Scatter shredded kaffir lime leaves, rau ram, Vietnamese balm, and spring onion over the surface. The Vietnamese balm (rau kinh gi?i) specifically — its menthol-lemon character is the herb that makes steamed goat sing in a way that cilantro or mint alone does not. Serve the m?m nhi ginger sauce in individual small bowls. Steamed rice alongside. To eat: dip each piece in the m?m nhi sauce, eat with Vietnamese balm between bites.',
            tip: 'The reserved steaming liquid below the goat rack — now a fragrant broth of beer, lemongrass, ginger, and goat drippings — should be strained and seasoned as a small soup to serve alongside. The goat fat that has rendered into the steaming liquid and the aromatic compounds from the lemongrass combine into a broth that is worth serving. Nothing from dê h?p should be discarded.',
        },
    ],
};
