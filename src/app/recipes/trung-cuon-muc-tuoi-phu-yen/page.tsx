...
const recipe: RecipeData = {
    ...
    title: 'Trứng Cuộn Mực Tươi Phú Yên (Phú Yên Fresh Squid Egg Roll)',
    subtitle: 'A thin egg sheet rolled around a filling of fresh squid stir-fried with lemongrass, chili, and mắm nhĩ — the Phú Yên egg roll where the squid filling is cooked with the province\'s four-stalk lemongrass proportion and the egg wrapper is seasoned with mắm nhĩ before rolling.',
    ...
    intro: `Trứng cuộn mực tươi Phú Yên is the fresh squid egg roll of the province — a preparation that takes the trứng cuộn (rolled egg) format that appears throughout Vietnamese and East Asian cooking and fills it with mực tươi (fresh squid) cooked specifically in the Phú Yên way: with four stalks of lemongrass, bird's eye chili, and mắm nhĩ as the primary aromatics and seasoning. The mực (squid) available along the Phú Yên coast — particularly the fresh market squid from the Tuy Hòa fishing harbor and the smaller inshore squid from the rocky coast near Mũi Điện — is prized for its specific sweetness and firm, clean-tasting flesh that the province's fishermen describe as tasting of the specific cold upwelling water that flows along the central Vietnamese coast. Stir-fried briefly with lemongrass and chili in a hot wok, this squid caramelizes at its edges, stays sweet and tender at the center, and carries the four-stalk lemongrass aromatics that make it identifiably Phú Yên in character. The egg wrapper — beaten with mắm nhĩ and fried as a thin sheet in a flat pan — provides the neutral, silky vehicle for this filling without competing with the squid's character. The rolling is done while the egg sheet is still warm and pliable, with the hot squid filling inside warming the egg from within and helping it seal cleanly. Sliced on the diagonal and served with muối lá é alongside, trứng cuộn mực tươi Phú Yên brings the province's signature condiment to its most refined egg preparation — the lá é salt against the lemongrass-squid filling wrapped in the mắm nhĩ egg sheet producing the complete Phú Yên flavor profile in a single diagonal slice.`,
    ingredientSections: [
        {
            title: 'Egg wrapper',
            items: [
                { amount: 4, name: 'large eggs' },
                { amount: 1, unit: 'tbsp', name: 'mắm nhĩ', note: 'beaten into the eggs — seasons the wrapper with the province\'s fish sauce' },
        ...
        },
        {
            ...
            items: [
                { amount: 250, unit: 'g', name: 'fresh squid (mực tươi)', note: 'cleaned, bodies cut into rings, tentacles left whole. Very fresh — squid that is not fresh smells strongly and toughens badly when cooked.' },
                ...
                { amount: 1.5, unit: 'tbsp', name: 'mắm nhĩ', note: 'primary seasoning for the filling' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'small bunch rau răm', note: 'leaves only — mixed into the filling before rolling' },
    ...
    steps: [
        {
            ...
            description: 'Heat oil in a wok over maximum heat until smoking. Add lemongrass, garlic, and shallots — fry 60 seconds until golden. Add minced and sliced chili. Add the fresh squid rings and tentacles — they will spit aggressively in the hot wok. Stir-fry over maximum heat for exactly 90 seconds — squid toughens rapidly and 90 seconds at high heat is the window between tender and rubbery. Add mắm nhĩ, sugar, and black pepper in the final 20 seconds. Add spring onion and sesame oil. Remove from heat. Fold in rau răm leaves. The filling should be fragrant, slightly saucy, and the squid just cooked through.',
        ...
        },
        {
            ...
            description: 'Place the squid filling across the center of the still-warm egg wrapper — a line of filling from one side to the other, leaving 2cm border on the near and far edges. Scatter a few extra rau răm leaves over the filling. Roll the near edge of the wrapper over the filling, pressing gently to seal. Continue rolling to complete the cylinder. The warm, slightly sticky egg surface will seal the roll without needing any additional binding.',
