...
const recipe: RecipeData = {
    slug: 'de-ham-sa-gung',
    title: 'Dê H?m S? G?ng (Slow-Braised Goat with Lemongrass and Ginger)',
    ...
    intro: `Dê h?m s? g?ng is the Vietnamese goat braise — the preparation that takes the most challenging domestic meat and, through two hours of low, covered heat in an aromatic liquid of lemongrass, galangal, ginger, and yellow rice wine, produces something that is simultaneously deeply savory, intensely fragrant, and fall-from-the-bone tender. The technique is h?m — the Vietnamese slow braise in which meat, aromatics, and a small amount of liquid are sealed in a clay pot or heavy casserole and cooked at the lowest possible temperature, building pressure gradually, driving the aromatics into the meat from all directions simultaneously. Goat responds to h?m better than to any other cooking method: the connective tissue that makes young goat slightly chewy when grilled becomes gelatin after 90-120 minutes of moist heat, the fat renders and bastes the lean muscle from within, and the gamey character that divides opinion at higher temperatures mellows to a savory, almost lamb-like depth at slow-braise temperatures. The specific aromatic combination for dê h?m — lemongrass, galangal, fresh ginger, fresh turmeric if available, dried chili — is the Vietnamese goat trinity, calibrated to harmonize with the meat rather than mask it. The yellow rice wine (ru?u vàng) added to the braise is the element that accelerates the tenderizing process and adds the warm, slightly malty background note that separates Vietnamese goat braise from Chinese braised goat or Indian goat curry. By the time the clay pot comes to the table, the kitchen has been fragrant for two hours, the meat pulls from the bone with chopsticks, and the broth poured over rice is one of the finest things Vietnamese slow cooking produces.`,
    ingredientSections: [
        {
            title: 'Goat',
            items: [
                { amount: 1.2, unit: 'kg', name: 'bone-in goat pieces (dê ch?t mi?ng)', note: 'shoulder, ribs, and neck — bone-in cuts produce the most gelatin and the richest broth. Ask the butcher to chop into 5-6cm pieces. Young goat under 8 months produces the most tender result.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 40, unit: 'g', name: 'fresh galangal (ri?ng)', note: 'peeled and minced to paste — the essential goat aromatic' },
                { amount: 40, unit: 'g', name: 'fresh ginger', note: 'peeled and minced' },
                { amount: 20, unit: 'g', name: 'fresh turmeric (ngh? tuoi)', note: 'peeled and minced — if available. Substitute: 1 tsp turmeric powder.' },
        ...
        },
        {
            ...
            items: [
                { amount: 100, unit: 'ml', name: 'yellow rice wine (ru?u vàng) or Shaoxing wine', note: 'the accelerating tenderizing element — do not substitute with white wine, the flavor is different' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'small bunch Vietnamese balm (rau kinh gi?i)', note: 'the herb specifically suited to braised goat — its menthol note complements the richness' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The 90-minute undisturbed cooking is the discipline of h?m. Every time the lid is lifted, the pressure environment collapses and the temperature drops. One unnecessary opening adds 15-20 minutes to the cooking time. Trust the process and check only at 90 minutes.',
        },
        {
        ...
        },
        {
            ...
            tip: 'Vietnamese balm (rau kinh gi?i) served alongside dê h?m is the herb pairing that most people outside Vietnam have not encountered with goat. Its specific menthol-lemon character complements braised goat in a way that cilantro or mint alone does not. If available, use it generously as a table herb rather than a garnish.',
        },
    ],
};
