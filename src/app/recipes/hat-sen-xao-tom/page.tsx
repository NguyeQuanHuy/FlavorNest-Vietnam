...
const recipe: RecipeData = {
    ...
    title: 'H?t Sen Xào Tôm (Stir-Fried Lotus Seeds with Shrimp)',
    ...
    intro: `H?t sen xào tôm is one of the quieter dishes in Vietnamese cooking — not loud with chili, not deep with fermentation, not complex with competing aromatics. It is a dish built on the natural sweetness of fresh lotus seeds and the clean brininess of shrimp, brought together with garlic, oyster sauce, and spring onion in a hot wok. Lotus seeds (h?t sen) occupy a specific place in Vietnamese culinary thinking: they are simultaneously an ingredient and a tonic, eaten for their purported calming properties and their association with purity — the lotus grows in muddy water and produces something immaculate, which is why it appears throughout Vietnamese culture from Buddhist temples to royal cuisine to grandmother's cooking. The seeds themselves have a texture that changes significantly with cooking time: briefly stir-fried, they are slightly firm with a faint starchy crunch; cooked a little longer, they become tender and yielding with a clean, mildly sweet flavor that absorbs whatever it is cooked with. Paired with shrimp, the combination is one of the most delicate in Vietnamese home cooking — delicate enough that the seasoning must be restrained, the heat must be controlled, and the timing must be precise. H?t sen xào tôm appears at family meals alongside richer dishes as a palate-cleansing contrast, at vegetarian temple meals with the shrimp replaced by firm tofu or mushrooms, and in the cuisine of Hu? specifically, where lotus is not merely an ingredient but an emblem of the imperial city's identity.`,
    ingredientSections: [
        {
            title: 'Main ingredients',
            items: [
                { amount: 300, unit: 'g', name: 'fresh lotus seeds (h?t sen tuoi)', note: 'shelled and with the bitter green embryo (tâm sen) removed — press each seed and the embryo pops out. Available fresh in summer at Vietnamese markets. Dried lotus seeds (soaked 4 hours) or vacuum-packed cooked lotus seeds both work with adjusted timing.' },
        ...
        },
        {
            ...
            items: [
                { amount: 100, unit: 'g', name: 'snow peas (d?u hà lan)', note: 'adds color and crunch — a modern addition common in restaurant versions' },
