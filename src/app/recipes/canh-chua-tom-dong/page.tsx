...
const recipe: RecipeData = {
    ...
    title: 'Canh Chua Tôm Đồng (Mekong Sour Soup with Freshwater Shrimp)',
    subtitle: 'The Mekong Delta version of canh chua — a clear tamarind broth with small freshwater field shrimp, water lily stems, bean sprouts, tomato, pineapple, and the fresh herbs of the delta — lighter than the snakehead fish version and more intensely flavored from the tiny, sweet tôm đồng.',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 6, name: 'okra (đậu bắp)', note: 'trimmed and halved — adds natural thickening' },
            ],
        },
        {
            title: 'Seasoning',
    ...
    steps: [
        ...
        {
            title: 'Add the tôm đồng',
            description: 'Add the fresh field shrimp to the simmering broth. They cook very fast — 90 seconds to 2 minutes for small tôm đồng. The shrimp turn from translucent grey to pink-orange throughout when done. Their small size means they cook almost simultaneously — watch carefully and remove from heat the moment they are uniformly pink. Over-cooked tôm đồng tighten and lose their characteristic sweetness.',
            tip: 'Tôm đồng are the fastest-cooking element in the soup. Everything else should be timed so the shrimp go in last, at the final 2 minutes. Adding them too early produces tough, over-cooked shrimp in a soup that still needs more time to develop.',
        },
        {
