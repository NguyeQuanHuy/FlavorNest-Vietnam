    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice', note: 'or bánh tráng nướng (toasted crackers)' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'The salt and sugar mixture on the mackerel surface interacts with the sun heat differently from plain salt — the sugar contributes to a slight caramelization of the surface proteins during drying that produces a more golden, more intensely flavored exterior when grilled. This small addition distinguishes cá thu một nắng from simply salted and dried mackerel.',
        },
        {
            title: 'Grill skin-side down over medium-hot charcoal',
            description: 'Build the charcoal fire to medium-hot — slightly less intense than for bò một nắng because the dried mackerel charred exterior can go from caramelized to burned in under a minute at very high heat. Place the dried mackerel fillets skin-side down on the grill. The dried skin will immediately begin to char and caramelize. Grill without moving for 4-5 minutes until the skin is deeply charred and the fish is about 60% cooked through from the skin side.',
            tip: 'The skin of cá thu một nắng chars significantly faster than fresh mackerel skin because the drying has removed surface moisture. At medium-hot charcoal, the skin goes from raw to perfectly charred in 4-5 minutes. Monitor carefully from the 3-minute mark — the difference between perfect char and burnt skin for dried mackerel is about 60 seconds.',
        },
        {
            ...
            tip: 'The shorter total grilling time for cá thu một nắng compared to fresh mackerel reflects the partial "cooking" effect of the one-day drying process. The proteins have already been partially denatured by the salt and the heat of the sun — less time on the charcoal is required to complete the cooking.',
        },
        {
            title: 'Pound the muối lá é',
            description: 'Pound lá é leaves with salt, pepper, sugar, and chili until intensely fragrant and green. For cá thu một nắng specifically, the muối lá é should be slightly more assertive in its lá é character than for the delicate preparations earlier in the series — the intensely flavored dried mackerel needs a condiment with sufficient presence to complement rather than disappear against it.',
            tip: 'The pairing of muối lá é with cá thu một nắng is the fish version of the same pairing with bò một nắng — the sun-dried, concentrated protein needing the wild citrus-pepper-herbal character of lá é salt to complete it. The parallel between the beef and fish preparations is intentional: Phú Yên applies the same drying philosophy and the same condiment across species.',
        },
        {
            title: 'Serve and eat',
            description: 'Transfer the grilled mackerel to a plate. The skin should be shatteringly charred, the flesh deeply golden-brown. Scatter rau răm and serve with muối lá é, sesame crackers, julienned green mango, fresh lá é leaves, lime wedges, and steamed rice. To eat: break pieces of fish from the fillet with chopsticks or fingers — the dried, grilled flesh separates in flakes — place on a sesame cracker with green mango and rau răm, dip in lime-squeezed muối lá é.',
            tip: 'The green mango alongside cá thu một nắng serves the same role as the mango alongside bò một nắng — its sharp sourness cuts through the rich, concentrated fish fat and provides the acid brightness that the preparation\'s salt and char character needs to feel complete. The parallel is exact: same sun philosophy, same condiment, same fruit accompaniment. Different species, same Phú Yên logic.',
        },
    ],
};
