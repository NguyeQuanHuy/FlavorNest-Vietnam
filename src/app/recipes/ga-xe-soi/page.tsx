...
const recipe: RecipeData = {
    slug: 'ga-xe-soi',
    title: 'Gà Xé S?i (Vietnamese Shredded Chicken)',
    ...
    intro: `Gà xé s?i — shredded chicken — appears across Vietnamese cooking in more contexts than any other protein preparation. It is the topping on com gà H?i An, the filling in bánh mì gà, the protein in bún gà, the salad base in g?i gà, the garnish on cháo gà. The technique is simple: poach a whole chicken gently until just cooked, rest it completely, then tear the meat along the muscle fibers into long strands rather than cutting. The tearing produces a texture — slightly frayed, with more surface area — that absorbs dressings and sauces more completely than cut chicken. A Vietnamese grandmother would say the torn chicken tastes better than sliced chicken, and she would be correct. This recipe covers the base preparation — poached and dressed gà xé s?i as eaten in central Vietnam, with lemongrass, fresh ginger, and rau ram — plus the broth produced as a byproduct, which is one of the best light chicken soups you will make.`,
    ingredientSections: [
        {
            title: 'Poaching',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch Vietnamese coriander (rau ram)', note: 'leaves only — the essential herb. Substitute: perilla or mint if unavailable.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The ice bath is not optional for gà xé s?i. Without it the skin is soft and the meat is slightly overcooked from residual heat. The contrast of cold-rested chicken against the room temperature dressing is also part of the dish.',
        },
        {
