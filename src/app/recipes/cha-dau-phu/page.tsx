...
const recipe: RecipeData = {
    slug: 'cha-dau-phu',
    title: 'Ch? Ð?u Ph? (Vietnamese Tofu Patties)',
    subtitle: 'Firm tofu mashed with wood ear mushrooms, glass noodles, carrot, and seasoning, shaped into patties and pan-fried until golden outside and soft inside — the vegetarian ch? that appears on every Vietnamese family table.',
    category: 'VEGETARIAN',
    difficulty: 'Easy',
    totalTime: '35 min',
    rating: 4.8,
    ...
    intro: `Ch? d?u ph? is the tofu patty that Vietnamese cooks make when they want a vegetarian protein dish that is satisfying rather than merely adequate. Unlike plain fried tofu, ch? d?u ph? has texture, structure, and the savory depth that comes from combining pressed tofu with wood ear mushrooms, glass noodles, and aromatics. The mixture is shaped into oval patties or rounds, then pan-fried in neutral oil until the outside develops a golden, slightly crispy crust while the inside stays soft and cohesive. It is eaten as a side dish with rice, used as a sandwich filling in bánh mì chay (vegetarian bánh mì), or served alongside a dipping sauce of soy sauce, ginger, and chili. Ch? d?u ph? is the dish that demonstrates the Vietnamese capacity for making tofu genuinely delicious through technique and combination — not by hiding what it is, but by building on what it naturally offers.`,
    ingredientSections: [
        {
            title: 'Patty mixture',
            items: [
                { amount: 400, unit: 'g', name: 'firm tofu (d?u ph? c?ng)', note: 'pressed dry — wrap in cloth and press under weight for 20 minutes minimum. Water content is the enemy of a cohesive patty.' },
                { amount: 20, unit: 'g', name: 'dried wood ear mushrooms (m?c nhi)', note: 'soaked in warm water 20 minutes, drained, excess water squeezed out, finely chopped' },
                { amount: 30, unit: 'g', name: 'dried glass noodles (mi?n)', note: 'soaked in cold water 10 minutes, drained, cut into 2cm pieces' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Drain on paper towels briefly. Serve hot with the ginger-soy dipping sauce alongside. Ch? d?u ph? can also be served at room temperature — it holds its texture well as it cools. Uses: eaten as a side dish with rice, used as a protein in bánh mì chay, or added to a noodle bowl. The dipping sauce: combine soy sauce, rice vinegar, sugar, water, ginger, and chili — taste and adjust.',
            tip: 'Ch? d?u ph? stores well in the refrigerator for 3 days. Reheat in a lightly oiled pan for 2 minutes per side — do not microwave, which makes them rubbery.',
        },
    ],
};
