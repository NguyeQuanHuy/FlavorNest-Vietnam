...
const recipe: RecipeData = {
    ...
    title: 'Bánh Bông Lan Tr?ng Mu?i (Vietnamese Salted Egg Lava Cake)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 80, unit: 'g', name: 'cake flour (b?t bánh)', note: 'lower protein than all-purpose — produces softer crumb. Sift before using.' },
        ...
        {
            title: 'Salted egg lava custard (nhân tr?ng mu?i ch?y)',
            items: [
                { amount: 6, name: 'salted duck egg yolks (lòng d? tr?ng v?t mu?i)', note: 'from pre-salted duck eggs — available at Asian grocers, often sold cooked in vacuum packs. If raw: steam 15 minutes first.' },
                { amount: 80, unit: 'g', name: 'unsalted butter', note: 'room temperature — cut into cubes' },
                { amount: 60, unit: 'g', name: 'icing sugar (du?ng b?t)', note: 'sifted — not granulated sugar which produces graininess' },
                { amount: 60, unit: 'ml', name: 'evaporated milk (s?a d?c không du?ng)', note: 'full-fat evaporated milk, not sweetened condensed milk' },
                { amount: 20, unit: 'g', name: 'milk powder (s?a b?t)', note: 'adds body and richness to the custard' },
