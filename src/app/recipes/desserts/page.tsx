...
const DESSERTS: Dessert[] = [
    ...
    },
    {
        ...
        description:'A blended drink of fresh pennywort and mung bean mixed with coconut water, smooth, green, and naturally refreshing.',
        story:'A tropical cooling remedy often enjoyed on hot days, balancing herbal freshness with creamy coconut sweetness.',
        prepTime:'15 min',
        cookTime:'30 min',
        totalTime:'45 min',
        servings:2,
