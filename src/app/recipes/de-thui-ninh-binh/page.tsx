...
const recipe: RecipeData = {
    ...
    ingredientSections: [
        ...
        {
            title: 'M?m tôm chanh (the essential dipping sauce)',
            items: [
                { amount: 4, unit: 'tbsp', name: 'fermented shrimp paste (m?m tôm)', note: 'northern Vietnamese style — lighter purple, slightly milder than southern versions' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch Vietnamese balm (rau kinh gi?i)', note: 'the essential herb for dê thui' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The overnight uncovered refrigeration for the home oven version is the step that most closely replicates the air-drying effect of the fire preparation. The skin surface becomes papery and dry, then shatters when the high heat hits it at the end. This technique is identical to the ba ch? quay skin preparation.',
        },
        {
        ...
        {
            title: 'Make the m?m tôm chanh',
            description: 'Place the m?m tôm in a bowl. Add lime juice gradually — the paste will lighten in color and foam slightly as the acid reacts with the fermented paste. Add sugar and stir until dissolved. Add minced chili, garlic, and warm water to reach dipping consistency. Taste: the m?m tôm chanh for dê thui should be assertively pungent, clearly lime-bright, and slightly sweet. It should smell dramatic — this is correct. The pungency mellows against the neutral, fatty goat skin.',
            tip: 'The m?m tôm chanh for dê thui is more intensely flavored than the version served with bún riêu or bánh da cua — the sauce needs to provide all the seasoning complexity that the unseasoned goat skin lacks. Make it assertive rather than restrained.',
        },
        {
            title: 'Carve and serve',
            description: 'For the whole goat: carve at the table — the crispy skin sections first, then the leg meat, then the rib sections. The skin should shatter when cut. For the oven version: rest 10 minutes, then slice through the skin and flesh. Arrange on a large plate. Serve the m?m tôm chanh in individual bowls. Set out all wrapping herbs, lettuce, cucumber, rice paper, and vermicelli. To eat: tear a piece of crispy skin and lean meat, place on a lettuce leaf or rice paper with herbs, wrap loosely, dip in m?m tôm chanh. Eat immediately — the skin softens within minutes of being cut.',
            tip: 'The eating ritual of dê thui Ninh Bình is communal and unhurried — the whole goat arrives at the center of the table, diners pull pieces from the carcass or receive carved portions, wrap in herbs and lettuce, dip in the m?m tôm chanh, and eat slowly over several hours. This is weekend eating, celebration eating, eating that is inseparable from the occasion.',
        },
    ],
};
