...
const recipe: RecipeData = {
    slug: 'trau-gac-bep',
    title: 'Trâu Gác B?p (Vietnamese Smoked Buffalo Jerky)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 30, unit: 'g', name: 'fresh galangal (ri?ng)', note: 'peeled and minced. Substitute: fresh ginger if unavailable, though flavor differs.' },
                { amount: 1, unit: 'tbsp', name: 'mac khen pepper (h?t m?c khén)', note: 'Sichuan-like mountain pepper from NW Vietnam — available at Vietnamese specialty stores. Substitute: Sichuan pepper at half the quantity.' },
