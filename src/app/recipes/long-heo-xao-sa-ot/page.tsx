...
const recipe: RecipeData = {
    ...
    title: 'Lòng Heo Xào Sả Ớt (Pork Offal Stir-Fried with Lemongrass and Chili)',
    subtitle: 'Pork intestine, liver, heart, and crispy caul fat stir-fried at maximum heat with finely minced lemongrass, fresh chili, and garlic — each organ cleaned, blanched, and cooked to its own ideal texture before the final wok toss. The Phú Yên nhậu dish that tests the cook and rewards the brave.',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 150, unit: 'g', name: 'pork stomach (dạ dày heo)', note: 'cleaned and blanched until no smell remains, sliced into 3cm pieces — optional' },
                { amount: 100, unit: 'g', name: 'caul fat (mỡ chài)', note: 'the lacy fat membrane — fried separately until crackling, added at the very end' },
            ],
        },
        {
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer the stir-fried offal to a serving plate. Immediately scatter the fried caul fat over the top — it goes on at the last possible moment to preserve its crunch. Add rau răm and extra chili. Serve immediately with steamed rice, lime wedges, and cold beer. The complete eating experience: the chewy intestine, the silky tender liver, the firm heart, the crackling caul fat — all perfumed with the Phú Yên lemongrass — is the textural complexity that makes lòng heo the most demanding and most rewarding Vietnamese offal dish.',
