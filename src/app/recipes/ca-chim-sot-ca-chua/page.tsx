...
const recipe: RecipeData = {
    ...
    title: 'Cá Chim S?t Cà Chua (Pomfret in Tomato Sauce)',
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Bring the pan to the table. Scatter the remaining fresh dill, sliced chili, and spring onion over the fish. Serve with lime wedges and steamed rice. The sauce should be spooned generously over the rice. Cá chim s?t cà chua is a shared dish — the whole fish is placed at the center of the table and each diner serves themselves.',
