...
const recipe: RecipeData = {
    ...
    title: 'Tôm Nu?ng Mu?i ?t (Charcoal-Grilled Shrimp with Chili Salt)',
    subtitle: 'Large whole shrimp coated in a paste of salt, chili, lemongrass, and garlic then grilled over charcoal until the shells char and the seasoning caramelizes into the shrimp — served with mu?i tiêu chanh and cold beer at the end of the day.',
    ...
    intro: `Tôm nu?ng mu?i ?t is the grilled shrimp of Vietnamese coastal cooking — the preparation that beach restaurants from S?m Son to Phú Qu?c serve on every terrace with a view of the water, and that beachside food vendors grill over portable charcoal fires at the edge of the sand. The technique is simple in principle and demanding in detail: the shrimp are coated in a dry-wet paste of salt, fresh chili, minced lemongrass, garlic, and a small amount of oil — just enough to carry the aromatics and help the paste adhere to the shells — then placed over hot charcoal and grilled without moving until the shells char on the bottom, the paste caramelizes, and the shrimp are turned once for the final 2-3 minutes. The char on the shell is not burning — it is the concentrated caramelization of the salt and chili paste that has been pushed into the shell surface by the direct heat of the charcoal. The shrimp flesh inside steams slightly in its own moisture, protected by the charring shell, and remains remarkably juicy despite the high heat. Tôm nu?ng mu?i ?t is eaten with the shells on, peeled at the table by each diner, with the charred seasoning on the shell providing the seasoning for the flesh underneath. The mu?i tiêu chanh — salt, pepper, lime — served alongside is dipped into after peeling. The combination of the char, the fresh lime, and the coarse salt is the definitive coastal Vietnamese shrimp experience. The charcoal is not optional — this is a dish that gas and oven cooking approximate but cannot replicate.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
                { amount: 800, unit: 'g', name: 'large fresh shrimp, whole (tôm tuoi c? l?n)', note: 'heads on, shells on. Large is better than medium for grilling — they withstand the charcoal heat better and have more flesh to justify the preparation. 15-20 count per 500g.' },
            ],
        },
        {
            title: 'Mu?i ?t coating paste',
            items: [
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 1, name: 'bunch rau ram (Vietnamese coriander)', note: 'eaten between shrimp' },
    ...
    steps: [
        {
            title: 'Make the mu?i ?t paste and coat the shrimp',
            description: 'Combine salt, minced bird\'s eye chili, minced red chili, lemongrass paste, garlic, sugar, turmeric, and oil. Work into a thick, fragrant paste. Rinse the shrimp and pat completely dry. Coat each shrimp generously with the mu?i ?t paste — press it onto every surface including the underside and the head. The paste should be thick enough to cling to the shell without running. Leave for 15 minutes while the charcoal heats.',
        ...
        {
            title: 'Make the mu?i tiêu chanh at the table',
