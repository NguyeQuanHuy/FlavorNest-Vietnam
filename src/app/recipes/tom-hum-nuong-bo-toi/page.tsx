...
const recipe: RecipeData = {
    ...
    title: 'Tôm Hùm Nu?ng Bo T?i (Phú Yên Grilled Lobster with Garlic Butter)',
    subtitle: 'Live spiny lobster from the waters off Hòn Y?n island, halved and grilled over charcoal with a compound butter of garlic, lemongrass, and kaffir lime leaf until the shell chars and the butter bastes the flesh from above. The premium seafood of Phú Yên — the dish that the island boats bring in at dawn and the restaurants serve by noon.',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: 'mu?i tiêu chanh', note: 'salt, coarse pepper, lime squeezed at the table — the primary dipping sauce for Phú Yên lobster' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The final 2-3 minutes flesh-side down is the caramelization stage that produces the golden, slightly charred surface on the flesh that makes grilled lobster visually and texturally different from steamed. The specific char marks from the grill are the visual signature of tôm hùm nu?ng.',
        },
        {
            title: 'Plate and serve with both dipping sauces',
            description: 'Transfer the grilled lobster halves to a plate, shell-side down, flesh facing up. Scatter finely shredded kaffir lime leaves, sliced spring onion, and fresh chili over the flesh. Serve immediately with both dipping sauces — the mu?i tiêu chanh and the ginger soy — in individual small bowls, rice or baguette alongside, and lime wedges. The butter that has pooled in the shell cavity is the best element: spoon it over rice or soak up with bread.',
