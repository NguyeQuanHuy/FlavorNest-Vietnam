...
const recipe: RecipeData = {
    slug: 'cua-hap-bia-sa',
    title: 'Cua Hấp Bia Sả (Beer-Steamed Crab with Lemongrass)',
    subtitle: 'Live mud crab or blue swimmer crab steamed over Vietnamese lager beer with lemongrass, ginger, and kaffir lime leaf until the shell turns brilliant orange and the sweet white flesh inside is just set — served with muối tiêu chanh and the instruction to eat with your hands.',
    ...
    intro: `Cua hấp bia sả is the steamed crab preparation that appears on every coastal seafood restaurant menu in Vietnam and on every table where freshness matters most. The technique is identical to tôm hấp bia — Vietnamese beer provides the steaming liquid, the lemongrass and ginger perfume the steam — but the application to whole crab produces results that are specific to this crustacean: the thick shell of a live mud crab (cua bùn) or blue swimmer crab (cua biển) conducts heat slowly and evenly, protecting the sweet flesh inside from direct heat while the aromatic steam penetrates through the leg joints and the underside. The result is crab meat that is simultaneously perfectly cooked and deeply fragrant — the lemongrass character present throughout the flesh rather than only on the surface. Cua hấp bia sả is the Vietnamese preparation that most clearly demonstrates why live crab is worth seeking: the sweetness of the flesh, the flavor of the roe when present, and the texture of properly steamed versus pre-cooked crab are different enough that they constitute different eating experiences. The steaming time is the critical variable — too short and the flesh is translucent and soft at the joints; too long and the flesh tightens, shrinks from the shell, and loses the moisture that makes fresh crab worth eating. Eight to twelve minutes, depending on the crab's weight, and nothing more.`,
    ingredientSections: [
        {
            title: 'Crab',
            items: [
                { amount: 2, name: 'live mud crabs or blue swimmer crabs (cua bùn / cua biển)', note: '500-700g each. Live is essential — pre-cooked crabs steamed a second time lose their moisture and flavor completely. If only one crab available, the recipe scales down directly.' },
            ],
        },
        {
            title: 'Beer steaming bath',
            items: [
                { amount: 660, unit: 'ml', name: 'Vietnamese lager beer (Saigon, Tiger, or 333)', note: '2 cans — light lager only. The mild malt and CO₂ carry the lemongrass aromatics more effectively than water.' },
    ...
    steps: [
        ...
        {
            title: 'Make the muối tiêu chanh',
            description: 'Place salt and coarsely ground black pepper on individual small plates — one per diner. Leave the limes uncut. Squeeze the lime directly over the salt-pepper at the moment of eating — the citrus oil from the lime skin is released in the act of squeezing and is the aromatic element that makes muối tiêu chanh work. The dipping salt should be freshly made at the table, not pre-mixed.',
            tip: 'For cua hấp specifically, the muối tiêu chanh should have slightly more pepper than for shrimp — crab flesh is sweeter and more neutral than shrimp and benefits from a more assertive pepper note in the dipping salt.',
        },
        {
            title: 'Crack, eat, and serve',
            description: 'Transfer the steamed crabs to a large plate or board. Scatter shredded kaffir lime leaves, rau răm, and sliced chili over the top. Serve with the muối tiêu chanh, lime wedges, finger bowls, and a crab cracker for the claws. To eat: remove the top shell, scoop out the roe and crab butter with a spoon — these are eaten first. Pull the legs and claws. Crack the claws with the cracker. Dip all flesh in the muối tiêu chanh. Eat with rau răm between pieces. The reserved steaming liquid in the pot is a fragrant broth — season and serve in small cups alongside.',
