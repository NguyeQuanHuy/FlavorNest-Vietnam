...
const recipe: RecipeData = {
    ...
    title: 'G?i Ngó Sen Tôm Th?t (Lotus Root Salad with Shrimp and Pork)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Herbs',
            items: [
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)', note: 'leaves only — the essential herb for this salad' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 8, name: 'prawn crackers (bánh ph?ng tôm)', note: 'for scooping — traditional accompaniment' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Combine fish sauce, lime juice, sugar, and water in a small bowl. Stir until the sugar dissolves completely. Add minced garlic and chili. Taste: it should be a balanced sweet-sour-salty combination with clean heat. For g?i ngó sen specifically, the dressing should be slightly sweeter than standard nu?c ch?m — the lotus root has a subtle starchiness that responds well to a touch more sweetness.',
        ...
        },
        {
            ...
            description: 'In a large wide bowl, combine the drained lotus root, sliced pork, halved shrimp, and all the herbs — rau ram, mint, culantro if using, and spring onion. Pour the dressing over and toss gently to coat everything evenly. The lotus root should be the visual feature — try to keep the slices intact and visible rather than broken up. Taste and adjust — add more lime if flat, more sugar if too sharp.',
        ...
        },
        {
            ...
            description: 'Arrange the dressed salad on a serving plate. Drizzle the shallot-infused oil over the top — it adds a final layer of aromatic depth. Scatter the crushed peanuts and crispy fried shallots over everything at the last moment. Add sliced fresh chili for color. Serve with prawn crackers arranged around the plate for scooping. Serve immediately — g?i ngó sen holds up slightly longer than mango or papaya salads (the lotus root is more stable) but is best within 20 minutes of dressing.',
