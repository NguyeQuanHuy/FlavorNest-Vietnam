...
const recipe: RecipeData = {
    ...
    title: 'G?i Bò B?p Phú Yên (Phú Yên Beef Shank Salad)',
    subtitle: 'Beef shank simmered until the collagen renders and the meat becomes dense and yielding, sliced thin and tossed with Vietnamese coriander, ginger, lemongrass, roasted peanuts, and a lime-fish sauce dressing — served with sesame rice crackers and the mu?i lá é that appears throughout Phú Yên cooking.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)', note: 'leaves only — the essential herb, used generously' },
        ...
        {
            title: 'Mu?i lá é (Phú Yên litsea leaf salt)',
            items: [
                { amount: 15, unit: 'g', name: 'fresh lá é leaves', note: 'or substitute: 5 kaffir lime leaves + 5 rau ram leaves' },
    ...
    steps: [
        {
            ...
            tip: 'The shank must be genuinely tender — not just cooked through. Under-cooked bò b?p is tough and the collagen is still rubbery. The test: try to pull the muscle groups apart with two forks. They should separate easily when the shank is ready. If resistance, simmer 20 more minutes.',
        },
        {
            title: 'Cool completely before slicing',
            description: 'Remove the cooked shank from the broth and cool to room temperature — then refrigerate for minimum 2 hours, ideally overnight. Cold bò b?p slices cleanly and precisely; warm bò b?p shreds and tears. The collagen surrounding the meat sets in the refrigerator into a firmer, more stable matrix that allows the thin, clean slices the salad requires. Slice against the grain into rounds 3-4mm thick when fully cold.',
            tip: 'The overnight refrigeration is the step that separates a properly prepared g?i bò b?p from a rushed one. Cold bò b?p sliced at 3mm is distinctly different from warm bò b?p torn apart — the texture in the final salad is firmer, the presentation is cleaner, and the dressing absorption is more controlled.',
        },
        {
        ...
        },
        {
            ...
            description: 'Combine fish sauce, lime juice, sugar, water, garlic, chili, and sesame oil. Stir until sugar dissolves. Taste alongside a slice of the cold beef — the dressing should be bright and balanced, with the lime clearly present and the sesame oil adding a warm background note. For g?i bò b?p specifically, the dressing should have slightly more acid than for seafood salads — the dense beef absorbs it and the lime note needs to persist through the protein.',
            tip: 'The sesame oil in g?i bò b?p dressing is more important than in seafood g?i. The warm nuttiness of sesame bridges the bold beef and the sharp rau ram in a way that a purely fish sauce-lime dressing cannot.',
        },
        {
            title: 'Assemble — the bóp method',
            description: 'Combine the cold beef slices, finely sliced lemongrass, julienned ginger, soaked-and-drained shallots, and rau ram leaves in a wide bowl. Pour the dressing over. Using your hands, gently knead and fold the salad — the bóp technique used throughout Phú Yên salads — so the dressing penetrates the beef slices and the herbs bruise slightly and release their oils. Work for about 1 minute. Taste and adjust.',
            tip: 'The bóp technique on beef is gentler than on chicken — bò b?p slices are firm but can break if handled too aggressively. Fold and press rather than squeeze. The goal is to drive the dressing into the surfaces of each slice, not to compress the meat.',
        },
        {
            title: 'Plate and serve the Phú Yên way',
            description: 'Transfer to a serving plate. Top with crushed peanuts, crispy fried shallots, and toasted sesame seeds — all added last to preserve crunch. Make the mu?i lá é: pound lá é leaves with salt and pepper until the salt turns fragrant and green. Add sugar. Squeeze lime at the table. Arrange sesame crackers around the plate. To eat: lay a piece of beef on a sesame cracker with rau ram, dip in the lime-squeezed mu?i lá é, eat immediately.',
            tip: 'The mu?i lá é is not interchangeable with plain salt or nu?c ch?m for this dish. The litsea leaf in the salt provides the aromatic counterpoint to the dense beef that is specifically Phú Yên — it is the same herb that appears in gà h?p lá é and gà nu?ng m?i. The province uses it throughout its cooking as a signature flavor that ties its dishes together.',
        },
    ],
};
