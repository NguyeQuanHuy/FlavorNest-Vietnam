...
const INGREDIENTS = {
    broth: [
        ...
        { name: 'black cardamom (th?o qu?)', amount: 1, unit: 'pod', note: 'optional but ideal' },
...
const recipeSchema = {
    ...
    '@type': 'Recipe',
    name: 'Authentic Hanoi Beef Pho (Ph? Bò)',
                    ...
                    <div style={{ maxWidth: 900, margin: '0 auto' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20 }}>
                            {[
                                ...
                                { icon: '???', title: 'Bare simmer only', body: 'If the surface is bubbling actively, the heat is too high. You want a barely-trembling surface for 10 hours straight.' },
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        {[
                            ...
                            },
                            {
                                ...
                                a: 'Yes, but the broth will lack one specific note — a smoky, faintly camphor quality that black cardamom (th?o qu?) brings. If you can find it at an Asian grocer, get a small bag. Half a pod per pot is enough. Without it, increase the cinnamon slightly.',
                            },
                            {
