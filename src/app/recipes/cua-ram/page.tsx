...
const recipe: RecipeData = {
    ...
    intro: `Cua ram is what Vietnamese coastal cooks do with small crabs — the kind that are too small to justify the effort of cracking open for the meat inside but too good to discard. The technique is the same one applied to tôm rim (caramelized shrimp) and mực chiên mắm (fish sauce squid): fry the seafood until the shell is crispy and partially edible, then toss in a fish sauce caramel that lacquers the surface. With small crabs (under 8cm carapace width), the shell becomes thin and crispy enough through deep-frying to be eaten entirely — legs, claws, body shell and all. The meat inside has already absorbed the frying heat and the caramel penetrates through the thin shell into the flesh. Cua ram is associated specifically with coastal central Vietnam — Đà Nẵng, Hội An, and the beach towns of the central coast — where small rock crabs and mud crabs are caught in quantity and sold cheaply at morning markets. It is beer food in its purest form: messy, aromatic, eaten with fingers at a plastic table while the sea breeze comes in.`,
    ingredientSections: [
        {
            title: 'Crabs',
            items: [
                { amount: 800, unit: 'g', name: 'small whole crabs (cua nhỏ)', note: 'carapace width 5-8cm. Small rock crabs, small mud crabs, or blue crabs. Must be small enough that the shell becomes edible when fried. Large crabs do not work for this dish.' },
