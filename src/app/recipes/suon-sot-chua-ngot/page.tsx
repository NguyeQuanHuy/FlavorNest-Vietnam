...
const recipe: RecipeData = {
    ...
    title: 'Su?n S?t Chua Ng?t (Vietnamese Sweet and Sour Pork Ribs)',
    ...
    intro: `Su?n s?t chua ng?t is the Vietnamese sweet and sour rib dish that most Vietnamese families have eaten since childhood — at birthday dinners, T?t feasts, and weekday dinners alike. It is not the gloopy, fluorescent-orange sweet and sour of Chinese-American takeaway. It is a Vietnamese interpretation: brighter, fresher, with the specific sweet-sour-savory balance that Vietnamese cooking executes so reliably. The sourness comes from rice vinegar and fresh pineapple rather than the artificial citric acid of processed sauces. The sweetness is sugar and the natural pineapple sugar — not corn syrup. The savory depth comes from fish sauce rather than MSG. The ribs are fried first until genuinely golden — not battered, not coated, just the rendered crispy fat and caramelized pork surface — then tossed in the hot sauce at the end so the glaze coats each rib without softening the fried exterior completely. Su?n s?t chua ng?t is universally loved in Vietnam — children eat it enthusiastically, adults eat it nostalgically, and anyone making it for the first time is surprised that something this good comes together in under an hour.`,
    ingredientSections: [
        {
            title: 'Ribs and marinade',
            items: [
                { amount: 800, unit: 'g', name: 'pork spare ribs (su?n heo)', note: 'cut into individual ribs, or ask butcher to cut into 4-5cm pieces through the bone. Baby back ribs work but spare ribs have more fat and flavor.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a serving plate, arranging the ribs with the pineapple and capsicum pieces visible. Scatter spring onion, chili, and sesame seeds over the top. Serve immediately with steamed jasmine rice — the sauce dripping from the ribs onto the rice is one of the great Vietnamese dinner pleasures. Su?n s?t chua ng?t reheats well the next day.',
            tip: 'Su?n s?t chua ng?t is best eaten the day it is made — the ribs retain some crispiness on the first day. Reheated the next day the ribs are fully softened by the sauce, which is a different but equally good texture. Both are correct.',
        },
    ],
};
