...
const recipe: RecipeData = {
    slug: 'vit-kho-gung',
    title: 'V?t Kho G?ng (Duck Braised with Ginger)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 100, unit: 'g', name: 'old ginger (g?ng già)', note: 'peeled and cut into thick matchsticks 5mm wide — this is the defining quantity. Do not reduce.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'In a wide, heavy pot over medium heat, add oil and sugar. Leave undisturbed until the sugar melts at the edges. Swirl gently until the caramel reaches a deep amber — darker than for seafood kho, approaching the color of dark tea. Add 2 tablespoons of water carefully — it will spit aggressively. Swirl until the caramel dissolves into a dark liquid. This is the color foundation of v?t kho g?ng.',
        ...
        },
        {
            ...
            description: 'When the sauce has reduced to a thick, dark glaze that coats the duck pieces heavily, add the spring onion pieces and toss briefly. Grind black pepper generously over the pot. The finished v?t kho g?ng: dark, glossy, fragrant with old ginger warmth, with the ginger matchsticks visible and soft throughout. Serve directly from the pot with steamed rice, cucumber slices, and cilantro. Ladle the thick kho sauce generously over the rice — this is the most important element of the meal.',
            tip: 'The kho sauce spooned over plain hot rice and eaten slowly is the rainy-day ritual that v?t kho g?ng is made for. The concentration of fish sauce, caramel, duck fat, and old ginger in the thick sauce, absorbed into the rice beneath — this is the bowl that Vietnamese people who grew up with this dish describe when they describe home.',
        },
    ],
};
