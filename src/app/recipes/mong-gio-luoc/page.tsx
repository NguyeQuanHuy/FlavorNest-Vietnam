...
const recipe: RecipeData = {
    slug: 'mong-gio-luoc',
    title: 'Móng Giò Lu?c (Boiled Pork Trotters)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch rau ram (Vietnamese coriander)', note: 'or fresh herb plate' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Using a sharp heavy knife or cleaver, chop the trotters into serving pieces — through the bone if necessary. Arrange on a plate. Surround with sliced cucumber and fresh herbs. Serve the dipping sauce in small individual bowls alongside. To eat: dip each piece of trotter completely in the ginger-vinegar sauce, add a sprig of rau ram, eat together. The rau ram is not garnish — its sharp, peppery flavor is the herb counterpoint to the rich collagen.',
