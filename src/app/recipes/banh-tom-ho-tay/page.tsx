...
const recipe: RecipeData = {
    ...
    title: 'Bánh Tôm Hồ Tây (West Lake Shrimp Fritters)',
    subtitle: 'Whole shrimp pressed into a seasoned sweet potato and rice flour batter and deep-fried until the sweet potato shreds turn golden and crackling around the shrimp — the Hanoi specialty of West Lake that has been eaten at the same few restaurants for sixty years, with cold beer and the specific nước chấm of the north.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '45 min',
    rating: 4.9,
    ...
    intro: `Bánh tôm Hồ Tây is the shrimp fritter that belongs specifically to the western shore of West Lake in Hanoi — to the stretch of road along Thanh Niên where a handful of restaurants have been serving this specific preparation for longer than most of their current customers have been alive. The dish is deceptively simple in description: shrimp in a batter, deep-fried. The reality is more specific. The batter contains shredded sweet potato (khoai lang) that surrounds the whole shrimp, with the shrimp tail and body protruding from the sweet potato in a way that is both functional and visually distinctive. When fried, the sweet potato shreds become thin, golden, slightly sweet, and crackling — a texture that is completely different from either a smooth batter coating or a thick breading. The shrimp inside steams in its own moisture, protected by the sweet potato exterior, and remains juicy and sweet while the outside shatters. The specific character of Hồ Tây bánh tôm comes from the freshness of the lake shrimp historically used — small, intensely sweet shrimp from West Lake itself, a variety that is now rarely available and has been replaced by farmed shrimp without most diners noticing the change — and from the nước chấm served alongside, which is the northern version: lighter, less sweet, with rice vinegar rather than lime, and sliced green papaya in the bowl for crunch. Bánh tôm Hồ Tây is eaten standing up at the lakeside restaurants, looking at the water, with cold Hà Nội beer, in a combination that is one of the specific pleasures of being in Hanoi.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 80, unit: 'g', name: 'rice flour (bột gạo)', note: 'binds the sweet potato shreds together and adds crispiness' },
        ...
        {
            title: 'Northern-style nước chấm Hồ Tây',
            items: [
                ...
                { amount: 100, unit: 'g', name: 'green papaya', note: 'finely shredded and added to the dipping bowl — the Hồ Tây specific addition' },
            ],
        },
        {
            title: 'To serve',
            items: [
                ...
                { amount: 200, unit: 'g', name: 'dried rice vermicelli', note: 'cooked and cooled — served alongside in the Hồ Tây restaurant style' },
    ...
    steps: [
        {
            ...
            tip: 'The tail left on serves as a handle when eating bánh tôm — the diner picks up the fritter by the tail, wraps it in lettuce, and dips it in the nước chấm. Do not remove the tail.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The shrimp tail protruding from the end of the fritter is the visual signature of bánh tôm Hồ Tây. It is both practical (the handle for eating) and aesthetic. Make sure the tail is clearly visible and not buried in batter.',
        },
        {
