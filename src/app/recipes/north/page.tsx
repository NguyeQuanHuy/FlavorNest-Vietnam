...
const RECIPES: Recipe[] = [
    ...
    },
    {
        ...
        description: "Hanoi's most celebrated dish — snakehead fish marinated in turmeric and galangal, sizzled tableside in a pan overflowing with dill and spring onion. Eaten with rice vermicelli, roasted peanuts and shrimp paste. A recipe guarded jealously on Ch? Cá Street for 150 years.",
    ...
    },
    {
        ...
        subtitle: 'Banh com',
        image: '/images/recipes/banh-xoi-xanh.jpg',
        difficulty: 'Hard', time: '2 hrs',
    ...
    },
    {
        ...
        subtitle: 'Banh duc',
        image: '/images/recipes/banh-duc.jpg',
        difficulty: 'Easy', time: '1 hr',
        rating: '4.2', reviews: 156, cal: 200, tag: 'Snack and Chill', tagColor: '#0284C7',
        description: "A traditional Vietnamese rice cake with a soft, silky texture, served either sweet or savory with peanuts, minced pork, and fish sauce.",
        tags: ['Rice flour', 'Limewater', 'Peanuts', 'Salt', 'Minced pork'],
    },
]
        ...
        <main style={{ minHeight: '100vh', background: '#FAFAF7', fontFamily: "'DM Sans', system-ui, sans-serif", color: '#2D1A0E' }}>
            <style>{`
                * { box-sizing: border-box; }
                .r-card { background: white; border: 1px solid rgba(75,46,26,0.08); border-radius: 4px; overflow: hidden; text-decoration: none; display: block; transition: box-shadow 0.2s, border-color 0.2s; }
            ...
            <section style={{ background: 'linear-gradient(135deg, #FEF3E2 0%, #FDEAC8 55%, #F5EDE3 100%)', padding: '88px 24px 48px', position: 'relative', overflow: 'hidden' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'start' }}>
                    <div>
                        ...
                        <div style={{ position: 'relative', maxWidth: 560, margin: '0 0 36px' }}>
                            ...
                            <p style={{
                                ...
                                From the <span style={{ color: '#D97706', fontWeight: 600, fontStyle: 'normal' }}>dawn ph? stalls of Hanoi</span> to the <span style={{ color: '#D97706', fontWeight: 600, fontStyle: 'normal' }}>smoky bún ch? of Lê Van Huu street</span> — Northern Vietnamese cuisine is defined by restraint, clarity, and the quiet confidence of a thousand-year capital.
                            </p>
                        </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <VietnamMap region="north" size={220} />
                    </div>
                </div>
            </section>
            ...
            <section style={{ borderTop: '1px solid rgba(75,46,26,0.08)', padding: '64px 32px 88px' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 48 }}>
                        <VietnamMap region="north" size={200} />
                    </div>
                </div>
            </section>
        </main>
