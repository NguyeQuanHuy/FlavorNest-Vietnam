...
const recipe: RecipeData = {
    ...
    title: 'Cá Com Kho Tiêu (Anchovies Braised with Black Pepper)',
    ...
    intro: `Cá com kho tiêu is the black pepper anchovy braise — a preparation that applies the kho technique to cá com (fresh anchovies, Engraulis japonicus or similar species) and produces one of the most intensely flavored and most immediately addictive fish kho preparations in the Vietnamese repertoire. Cá com in Vietnam refers to the small, silver anchovies caught in enormous quantities along the central and southern coasts — the same fish that, dried and fermented with salt, produces the fish sauce (nu?c m?m) and shrimp paste (m?m ru?c) that underpin Vietnamese cooking. Eaten fresh, the anchovy carries a naturally concentrated flavor that exceeds most other fish of its size: a specific deep marine savory character from its high oil content, a slight metallic note from the same iodine-rich blood that makes it so suitable for fermentation, and a sweetness when fresh that disappears entirely in the preserved versions. When these naturally umami-rich fresh anchovies are braised in dark sugar caramel with fish sauce, black pepper, and ginger, the concentration of flavors that results is extraordinary — the natural glutamates and inosinates in the anchovy flesh interact with the fish sauce's similar compounds during the reduction, producing a kho sauce that is more deeply savory per spoonful than almost any other preparation of equivalent ingredients. The black pepper in cá com kho tiêu is used in the same deliberately generous quantity as in m?c kho tiêu — the boldest spice in Vietnamese kho cooking applied to the boldest-flavored small fish. Together they produce the specific combination of deep marine savory and assertive pepper warmth that makes cá com kho tiêu the fish kho that Vietnamese people describe as an com nh?t — the one that most compellingly demands rice, the one that most clearly demonstrates why the kho technique exists.`,
    ingredientSections: [
        {
            title: 'Anchovies',
            items: [
                { amount: 400, unit: 'g', name: 'fresh anchovies (cá com tuoi)', note: 'cleaned — heads removed, gutted. Rinse and pat dry. Fresh anchovies from Asian fish markets. If unavailable, use fresh sardines or small smelts.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 40, unit: 'g', name: 'old ginger (g?ng già)', note: 'cut into fine matchsticks' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice', note: 'plain and hot — the only thing cá com kho tiêu needs alongside' },
