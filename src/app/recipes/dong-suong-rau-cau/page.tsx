...
const recipe: RecipeData = {
    ...
    title: 'Ðông Suong / Th?ch Rau Câu (Vietnamese Agar Jelly)',
    ...
    intro: `Ðông suong — also called th?ch rau câu or suong sá — is the jelly dessert that every Vietnamese person over the age of ten has eaten at a family gathering, a birthday party, a T?t feast, or straight from a tray on a hot afternoon. It is made from agar agar, a plant-based gelling agent derived from red seaweed, which sets firmer than gelatin, has a clean satisfying snap when sliced, and holds its shape at room temperature without melting. Coconut milk, pandan juice, coffee, fruit juice — anything can flavor it. This recipe gives you the master technique and three of the best versions to start with.`,
    ingredientSections: [
        {
