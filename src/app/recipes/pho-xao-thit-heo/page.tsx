...
const recipe: RecipeData = {
    ...
    intro: `Bánh ph? xào th?t heo is a simple Vietnamese stir-fried noodle dish made with flat rice noodles, pork, and a savory sauce.
    ...
    ingredientSections: [
        {
            ...
            items: [
                { amount: 250, unit: 'g', name: 'flat rice noodles (bánh ph?)' },
