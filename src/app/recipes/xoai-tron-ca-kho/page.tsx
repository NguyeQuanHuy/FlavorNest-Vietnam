...
const recipe: RecipeData = {
    ...
    subtitle: 'Xoài tr?n cá khô — chua giòn, m?n bùi, cay n?ng, an là ghi?n.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '20 min',
    rating: 4.9,
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 150, unit: 'g', name: 'dried fish (cá khô)', note: 'cá du?i, cá ch? vàng, or cá thác lác khô — shredded or left in small pieces' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 20, unit: 'g', name: 'Vietnamese coriander (rau ram)', note: 'leaves only; substitute with Thai basil or mint' },
