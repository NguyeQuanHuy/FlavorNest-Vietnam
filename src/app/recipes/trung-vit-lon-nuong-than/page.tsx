...
const recipe: RecipeData = {
    ...
    title: 'Trứng Vịt Lộn Nướng Than Phú Yên (Charcoal-Grilled Balut with Lá É Salt)',
    subtitle: 'Balut — fertilized duck eggs at 16-18 days — grilled directly on hardwood charcoal until the shell chars and the contents inside cook from the conducted heat, served upright with muối lá é and rau răm. The Tuy Hòa street preparation that applies the province\'s fire-and-salt philosophy to its most divisive ingredient.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '20 min',
    rating: 4.8,
    ...
    intro: `Trứng vịt lộn nướng than is the grilled balut of Phú Yên — a street preparation that takes the fertilized duck egg that is one of the most discussed and debated foods in Vietnamese cuisine and cooks it in a way that is specific to the central coast. Balut — trứng vịt lộn in Vietnamese — is a fertilized duck egg that has been incubated for 16-18 days, at which point the developing duckling inside has reached a stage where it has formed distinct components: a broth beneath the membrane, the solidified egg white, the yolk, and the partially developed duckling with its soft bones, beak beginning to form, and small but visible feathers. Boiled balut is the standard preparation throughout Vietnam — the egg cracked at the small end, the broth sipped first from the shell, then the contents eaten with rau răm and muối tiêu chanh. Grilled balut is the Phú Yên street variation: the whole uncracked egg placed directly on hot charcoal for 8-10 minutes, where the shell chars and the heat conducts through the shell and cooks the contents from the outside in rather than from the inside out as in boiling. The result is a balut where the broth inside has partially reduced and concentrated from the charcoal heat, the white is firmer with a slight char character from the extended cooking, and the duckling has developed a specific texture from the dry heat that boiling does not produce. In Tuy Hòa, this preparation is sold at evening street stalls from 5pm onward — the vendor with a small charcoal fire, a basket of eggs, and a bottle of muối lá é is a specific fixture of the city's street food landscape. The muối lá é for trứng vịt lộn nướng is the condiment that most clearly makes this Phú Yên rather than generic Vietnamese balut: the wild citrus-pepper character of litsea cubeba against the rich, concentrated egg and duckling is a pairing that exists nowhere else and that residents of the province consider obvious.`,
    ingredientSections: [
        {
            title: 'Balut',
            items: [
                { amount: 8, name: 'balut (trứng vịt lộn)', note: '16-18 day fertilized duck eggs — available at Vietnamese grocery stores and Asian markets. The 16-18 day stage has the most flavor and the most developed but still tender duckling. Refrigerate until ready to grill — take out 20 minutes before grilling to approach room temperature.' },
            ],
        },
        {
            title: 'Charcoal',
        ...
        {
            title: 'Muối lá é Phú Yên — the eighth and most surprising application',
            items: [
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'large bunch Vietnamese coriander (rau răm)', note: 'generous amount — rau răm with balut is one of the most established pairings in Vietnamese street food' },
                { amount: 1, name: 'bunch fresh lá é leaves', note: 'for eating raw alongside — amplifies the muối lá é character' },
    ...
    steps: [
        {
            ...
            description: 'Balut at 16-18 days contains a partially developed duckling inside the egg — this is the ingredient and it should not be a surprise when the egg is opened. The contents of a balut: a layer of clear broth beneath the air sac at the top; the solidified egg white forming the lower half; the orange-yellow yolk; and the duckling in the upper half, with soft, edible bones, a small beak, and beginning feather development. All of this is eaten. The rau răm and the muối lá é exist specifically to accompany all of these components — each has a different texture and flavor and needs the herbs and salt to complete it.',
        ...
        },
        {
            ...
            description: 'Pound lá é leaves with salt, pepper, sugar, and chili until intensely green and fragrant. For trứng vịt lộn the muối lá é should be slightly saltier than for other preparations — the rich egg and duckling content needs more salt contact per bite. Transfer to individual small plates. Squeeze lime at the table.',
            tip: 'Muối lá é with balut is the pairing that most surprises people who know both ingredients separately. The wild citrus-camphor character of lá é against the concentrated egg and duckling richness produces a combination that is more harmonious than muối tiêu chanh against the same ingredients — the lá é complexity matches the complexity of the balut rather than simply seasoning it.',
        },
        {
            title: 'Serve upright and eat in sequence',
            description: 'Place each charred egg in a small cup or folded paper holder — small end up, the traditional balut orientation. The diner cracks the small end of the shell with a spoon. The correct eating sequence: sip the hot broth from the shell first — it is the most fragrant and the hottest element, and it seasons the palate for everything that follows. Then eat the white with muối lá é and rau răm. Then the yolk. Then the duckling with rau răm and fresh lá é leaf. The sequence is traditional and produces the best eating experience in this specific order.',
            tip: 'The duckling portion of grilled balut has a specific texture from the charcoal heat — slightly firmer and more concentrated than boiled balut duckling. The soft bones are edible and contribute their mineral character. Eat with a generous piece of rau răm and a raw lá é leaf simultaneously — the herb combination alongside the duckling is the specific Tuy Hòa street food experience that cannot be replicated without both herbs.',
        },
        {
            title: 'The complete Tuy Hòa street experience',
            description: 'Grilled balut in Tuy Hòa is eaten standing or perched on a low plastic stool at the evening stall, with cold beer or sugarcane juice, in the company of other people eating the same thing. The muối lá é is in a small glass bottle on the stall table — poured rather than spooned, in the generous quantities the stall vendor applies automatically. This context is part of the dish. At home: small stools, cold beer, the muối lá é in a small bottle, eaten quickly while the eggs are still hot from the charcoal.',
