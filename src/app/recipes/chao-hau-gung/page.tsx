...
const recipe: RecipeData = {
    slug: 'chao-hau-gung',
    title: 'Cháo Hàu G?ng (Oyster and Ginger Congee)',
    ...
    intro: `Cháo hàu g?ng is the oyster and ginger congee of the central Vietnamese coast — a preparation that belongs to the same category of restorative morning food as cháo cá trê g?ng and cháo ?ch Singapore, but that achieves something specific and irreplaceable through the use of oyster rather than freshwater protein: a broth base that is simultaneously briny and sweet in a way that only oysters produce, a porridge that carries the specific character of the sea through every spoonful, and a finishing element — the fresh oysters poached for exactly 90 seconds in the completed porridge — that provides the most delicate and the most directly marine eating experience of any congee in the collection. The oyster liquor stock that forms the base of cháo hàu g?ng is the preparation's most important and most often skipped element: the liquid retained when shucking fresh oysters, combined with a small amount of water and ginger, produces a stock that is more intensely flavored than any oyster powder or bottled oyster sauce at a fraction of the cost, because the fresh oyster liquor carries the live, vibrant marine character that preserved oyster products cannot replicate. Cooked into rice porridge, this stock produces a bowl that smells of the sea before the oysters themselves are added — the rice absorbing the brine and sweetness of the fresh liquor in a way that makes each grain specifically, unmistakably coastal. The ginger in cháo hàu g?ng appears in the same three-form approach as in cháo cá trê g?ng: cooked into the stock, minced into the porridge, and raw-julienned over each bowl. The ginger's specific role with oysters is slightly different from its role with catfish — where it reduces the freshwater gamey character, with oysters it provides the warm, clean aromatic counterpoint that prevents the marine brininess from feeling heavy or one-dimensional.`,
    ingredientSections: [
        {
            title: 'Oysters and stock',
            items: [
                { amount: 500, unit: 'g', name: 'fresh oysters, shucked (hàu tuoi)', note: 'retain all oyster liquor separately. Divide: 200g for the stock base, 300g for the fresh topping poached at service.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Cháo hàu g?ng eaten at the coastal oyster restaurants of Cam Ranh or Sông C?u — where the oyster raft is visible from the table and the oysters arrive from the water to the kitchen in minutes — is a fundamentally different experience from the same bowl made with day-old oysters from an inland market. The freshness window for oyster congee is narrower than for any other preparation in the collection. This is the bowl that most rewards sourcing effort.',
        },
    ],
};
