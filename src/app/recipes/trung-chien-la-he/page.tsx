...
const recipe: RecipeData = {
    ...
    title: 'Tr?ng Chiên Lá H? (Fried Egg with Garlic Chives)',
    ...
    intro: `Tr?ng chiên lá h? is the garlic chive omelette of southern Vietnamese everyday cooking — a dish so simple that it barely qualifies as a recipe and yet so specifically satisfying that it appears on dinner tables across the south several times a week, whenever the question "what should we make?" is answered by whatever is in the refrigerator and the time available is less than ten minutes. Lá h? — garlic chives, Allium tuberosum — are the flat-leafed, garlicky-oniony herb that appears throughout Vietnamese and Chinese cooking, with a flavor that is simultaneously more pungent than spring onion and less sharp than raw garlic, providing a specific aromatic character that neither substitute produces. The southern Vietnamese version of this dish is fried in more oil than most Western omelette recipes use — enough oil that the egg batter floats slightly in the pan rather than lying flat against it, which produces the specific texture that defines tr?ng chiên lá h?: edges that blister into a lacework of crispy, oily bubbles while the center remains soft and barely set. This contrast between the blistered crispy edge and the soft center is not accidental — it is the specific result that the generous oil quantity produces and that less oil cannot achieve. The fish sauce beaten into the eggs before frying is the seasoning that makes this Vietnamese rather than Chinese or generic: a small amount, just enough to season without making the egg taste of fish sauce, producing the specific savory depth that Vietnamese fried eggs carry and that salt alone does not provide. Tr?ng chiên lá h? is eaten with plain steamed rice and whatever else is on the table — it is a supporting dish, never the centerpiece, and yet it is the dish that many Vietnamese people would choose as their last meal if pressed.`,
    ingredientSections: [
        {
            title: 'Omelette',
            items: [
                { amount: 4, name: 'large eggs' },
                { amount: 80, unit: 'g', name: 'fresh garlic chives (lá h?)', note: 'cut into 3cm pieces — stems and leaves included. Garlic chives are flat-leafed with a garlicky-onion character. Substitute: spring onion greens if unavailable, though the character is different.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The test for correct oil temperature for tr?ng chiên lá h?: dip a chopstick into the egg batter and touch it to the oil surface. If it sizzles immediately and a small bubble of egg puffs and crisps within 3 seconds, the oil is at the correct temperature. If it sizzles weakly or slowly, wait 30 more seconds.',
        },
        {
        ...
        },
        {
            ...
            tip: 'Tr?ng chiên lá h? must be eaten immediately — within 3 minutes of leaving the pan. The crispy blistered edge softens quickly from the retained steam of the soft center. The experience of eating it at its peak — the shattering crispy edge against the soft inside — is a completely different dish from the same omelette eaten 10 minutes later. Cook it last, eat it first.',
        },
    ],
};
