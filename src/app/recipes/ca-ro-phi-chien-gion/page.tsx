...
const recipe: RecipeData = {
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Place the fried tilapia on a serving plate. Drizzle the warm garlic-shallot oil over the surface. Scatter the fried garlic and shallot pieces and sliced spring onion over the fish. Serve the nu?c m?m t?i ?t in individual dipping bowls. The full herb plate alongside with cucumber, mint, rau ram, perilla, and lime. Steamed rice in individual bowls. To eat: use chopsticks to pull pieces of flesh from the bone — starting from the scored sections where the flesh separates most cleanly — dip in the nu?c m?m t?i ?t, eat with a leaf of herb and a mouthful of rice.',
