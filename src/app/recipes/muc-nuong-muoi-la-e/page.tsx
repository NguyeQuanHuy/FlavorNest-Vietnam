...
const recipe: RecipeData = {
    ...
    title: 'M?c Nu?ng Mu?i Lá É Phú Yên (Phú Yên Charcoal Squid with Litsea Leaf Salt)',
    ...
    steps: [
        ...
        {
            title: 'Pound mu?i lá é and serve the Phú Yên way',
            description: 'Pound lá é leaves with salt, pepper, sugar, and chili until intensely green and fragrant. Transfer to individual plates. Squeeze lime at the table. Slice the grilled squid into 2cm pieces on the diagonal. Arrange on a plate with tentacle clusters alongside. Serve with mu?i lá é, sesame crackers, fresh lá é leaves, green mango julienne, and rau ram. The Phú Yên ritual: squid piece on cracker, raw lá é leaf under the squid, edge-dipped in lime-squeezed mu?i lá é, eaten in one bite. The same assembly that has appeared throughout the Phú Yên series reaches its fullest expression here — the wild lá é character against the clean marine sweetness of charcoal-grilled fresh squid is the pairing that most clearly demonstrates why this condiment exists.',
