...
const recipe: RecipeData = {
    ...
    title: 'Cá Rô Phi Kho T? (Tilapia Braised in Clay Pot)',
    subtitle: 'Tilapia sections caramelized in dark sugar then braised in a clay pot with old ginger, fresh turmeric, and fish sauce until the sauce reduces to a thick, dark glaze — the everyday Vietnamese kho that is simpler than catfish kho t? and more forgiving, producing a deeply flavored result in 25-30 minutes with ingredients always in the pantry.',
    ...
    intro: `Cá rô phi kho t? is the tilapia clay pot braise — the weeknight version of kho t? that uses tilapia's affordability, availability, and forgiving lean flesh to produce the specific dark, concentrated sauce of the kho technique in less time and with less technique than the catfish or pork versions require. Kho t? — braising in a clay pot (t?) until the sauce reduces to a glaze — is one of the most fundamental techniques in Vietnamese home cooking, and cá rô phi is the fish that Vietnamese families return to most reliably for the weeknight kho because the firm white flesh holds together during the braising period without breaking apart, absorbs the caramel and fish sauce seasoning through the scored surface during cooking, and provides a neutral backdrop for the ginger and black pepper that are the aromatics which most specifically define this preparation. The ginger in cá rô phi kho t? is old ginger — g?ng già — and it is used in a quantity that seems generous but is calibrated specifically for the mild, clean flavor of tilapia: where catfish kho t? uses 60g of ginger per 700g of fish, tilapia kho t? uses a similar proportion because the ginger is doing more of the aromatic work against a milder fish. The fresh turmeric that appears in the marinade and the braise is the element that gives cá rô phi kho t? its specific golden color — the deep mahogany of the caramel shot through with the gold of the turmeric produces the visual character that makes the dish recognizable at a glance. Black pepper, added both during braising and freshly ground over the finished dish, is the spice that most clearly defines Vietnamese fish kho as distinct from pork or egg kho — its heat against the sweet caramel-fish sauce combination and the warm ginger is the specific character of this preparation at its most Vietnamese.`,
    ingredientSections: [
        {
            title: 'Tilapia',
            items: [
                { amount: 700, unit: 'g', name: 'tilapia sections (cá rô phi ch?t khúc)', note: 'bone-in, 5-6cm sections. Score each section once on each exposed side — allows sauce penetration during braising.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 60, unit: 'g', name: 'old ginger (g?ng già)', note: 'peeled, cut into thick matchsticks' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The same very dark caramel for both tilapia and catfish kho t? is the approach that produces visually similar and similarly complex results from two different proteins. A lighter caramel produces flat-tasting, pale kho regardless of the fish used.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The finishing black pepper on cá rô phi kho t? should be genuinely generous — a full teaspoon freshly ground over the surface of the pot before it goes to the table. Vietnamese fish kho is specifically a pepper-forward preparation where the heat of black pepper against the sweet caramel-fish sauce provides the tension that makes the dish interesting rather than merely sweet and savory.',
        },
    ],
};
