...
const recipe: RecipeData = {
    ...
    intro: `Hủ tiếu Sa Đéc is the noodle soup that the Mekong Delta is most proud of — and the one it argues about the most. Sa Đéc (now Đồng Tháp province) has been producing hủ tiếu noodles since the early twentieth century, when Teochew Chinese settlers brought the craft of sun-drying fresh rice noodles on bamboo racks along the river. The result is a noodle unlike any other in Vietnam: white, slightly translucent, with a firm-elastic bite that holds texture even after ten minutes in hot broth.\n\nThe broth is built on pork bones and dried squid simmered for two to three hours until completely clear — a point of local pride. No clouding, no shortcuts. It is seasoned with fish sauce, rock sugar, and dried shrimp for a sweetness that is distinctly southern but never cloying. Toppings are layered: sliced pork, pork liver, quail eggs, shrimp, and a spoonful of pork lard that melts silently into the bowl.\n\nUnlike hủ tiếu Nam Vang (Phnom Penh style) which shares many ingredients, Sa Đéc's version stays lighter, the broth thinner, the seasoning more restrained. It is a soup for people who believe the noodle should be the star.`,
    ingredientSections: [
        {
            title: `For the clear pork broth`,
            items: [
                { amount: 1, unit: 'kg', name: `pork bones (xương heo)`, note: `blanched and rinsed` },
                { amount: 200, unit: 'g', name: `dried squid (mực khô)`, note: `lightly toasted in dry pan 2 min` },
                { amount: 50, unit: 'g', name: `dried shrimp (tôm khô)`, note: `soaked 15 min` },
                { amount: 2, name: `medium onions, halved and charred` },
                { amount: 30, unit: 'g', name: `rock sugar (đường phèn)` },
        ...
        },
        {
            ...
            items: [
                { amount: 300, unit: 'g', name: `pork shoulder (thịt nạc vai)`, note: `simmered whole 25 min, sliced thin` },
                ...
                { amount: 8, name: `quail eggs (trứng cút)`, note: `hard-boiled, peeled, halved` },
                { amount: 2, unit: 'tbsp', name: `rendered pork lard (mỡ hành)`, note: `or substitute fried shallot oil` },
        ...
        },
        {
            title: `Noodles`,
            items: [
                { amount: 500, unit: 'g', name: `Sa Đéc dried hủ tiếu noodles`, note: `soak in cold water 30 min, blanch 20 seconds — do NOT boil long` },
            ],
        },
        {
            title: `Herb plate and condiments`,
            items: [
                { amount: 150, unit: 'g', name: `bean sprouts (giá đỗ)`, note: `raw — served on the side, not cooked` },
                { amount: 1, name: `bunch garlic chives (hẹ)`, note: `cut 3 cm` },
                { amount: 1, name: `bunch sawtooth coriander (ngò gai)` },
                { amount: 2, name: `limes, wedged` },
                { amount: 3, name: `bird's eye chili, sliced` },
                { amount: 1, unit: 'tbsp', name: `hoisin sauce (tương hoisin)`, note: `served on side for dipping` },
                { amount: 1, unit: 'tbsp', name: `chili oil or sa tế` },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: `The clarity of hủ tiếu Sa Đéc broth is a point of local identity. If the broth clouds, reduce heat further. Never cover the pot while simmering — steam condensation drips back and muddies the surface.`,
        },
        {
