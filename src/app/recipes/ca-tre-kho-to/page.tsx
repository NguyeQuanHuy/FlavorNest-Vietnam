...
const recipe: RecipeData = {
    slug: 'ca-tre-kho-to',
    title: 'Cá Trê Kho T? (Catfish Braised in Clay Pot)',
    ...
    intro: `Cá trê kho t? is the clay pot braised catfish of the Mekong Delta — one of the most essential kho dishes in the southern Vietnamese home cooking repertoire and one that demonstrates what the kho technique achieves with a fatty freshwater fish specifically. Kho t? — kho in a clay pot (t?) — is distinguished from kho in a metal pot by the way the clay distributes heat: more evenly, more gently, and with the specific character that the unglazed clay contributes to the braise as the sauce reduces and concentrates against its porous walls. Cá trê (walking catfish, Clarias batrachus) is the specific fish that the Mekong Delta kho t? tradition is built around because the catfish carries more internal fat than most freshwater fish of its size — fat that renders during the long braise and enriches the caramel-fish sauce reduction into something darker, more complex, and more deeply savory than the same preparation with a leaner fish would produce. The Mekong Delta version uses palm sugar (du?ng th?t n?t) rather than white sugar for the caramel — the palm sugar's specific molasses-caramel character produces a darker, more complex caramel that gives cá trê kho t? its characteristic deep mahogany color and its slight bittersweet background note. Coconut water (nu?c d?a) is used as part of the braising liquid rather than plain water — in the Mekong Delta where coconut palms grow in every household yard, the addition of fresh coconut water to kho preparations is as natural as using water would be elsewhere, and its specific sweetness and subtle coconut character becomes an integrated element of the finished sauce rather than an identifiable additive. Fresh turmeric grated into the braise provides the golden color and earthy fragrance that defines the dish's visual character — the mahogany of the caramel shot through with the gold of the turmeric.`,
    ingredientSections: [
        {
            title: 'Catfish',
            items: [
                { amount: 700, unit: 'g', name: 'catfish sections (cá trê ch?t khúc)', note: 'bone-in, 5-6cm sections. Pre-cleaned from market. The skin of the catfish is left on — it renders its fat into the kho sauce during braising.' },
        ...
        },
        {
            title: 'Kho base',
            items: [
                { amount: 2, unit: 'tbsp', name: 'palm sugar (du?ng th?t n?t)', note: 'the Mekong Delta caramel — darker and more complex than white sugar. Substitute: dark brown sugar.' },
                { amount: 1, unit: 'tbsp', name: 'white sugar', note: 'combined with palm sugar for the caramel' },
                { amount: 2, unit: 'tbsp', name: 'neutral oil' },
                { amount: 60, unit: 'g', name: 'old ginger (g?ng già)', note: 'peeled and cut into thick matchsticks — generous quantity for catfish' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Skin-side down first for catfish kho t? is the technique that produces the most caramelized, most complexly flavored skin surface — the skin fat renders into the caramel during the 2-minute sear and creates a layer of caramelized fat that adheres to the skin throughout the braising period.',
        },
        {
            title: 'Add coconut water and braise — 30-35 minutes',
            description: 'Pour the coconut water, additional water, fish sauce, dark soy, and black pepper around the catfish sections. Bring to a boil, reduce to the lowest simmer. Cover loosely — a lid with a small gap, or place a chopstick under the lid. Braise for 30-35 minutes, turning the fish once at 20 minutes very gently — catfish sections can break apart during the braise. The sauce will reduce progressively from liquid to the thick, dark glaze that defines kho t?.',
