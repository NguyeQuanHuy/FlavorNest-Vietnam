...
const recipe: RecipeData = {
    ...
    title: 'Gà H?p Mu?i Ki?u Hoa (Chinese-Style Salt-Steamed Chicken)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 0.5, unit: 'tsp', name: 'five-spice powder (ngu v? huong)', note: 'rubbed inside the cavity only — a very small amount perfumes the interior without dominating' },
