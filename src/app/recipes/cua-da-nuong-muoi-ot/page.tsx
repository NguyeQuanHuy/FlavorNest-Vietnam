...
const recipe: RecipeData = {
    ...
    title: 'Cua Đá Nướng Muối Ớt (Phú Yên Rock Crab Grilled with Chili Salt)',
    subtitle: 'Wild rock crabs harvested from the basalt columns of Gành Đá Đĩa and the rocky outcrops along the Phú Yên coast, coated in chili-salt paste and grilled directly on the coals until the shell chars and the intense, mineral-sweet rock crab flesh inside caramelizes at the edges.',
    ...
    ingredientSections: [
        ...
        {
            title: 'Muối lá é — the Phú Yên coastal dipping salt',
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Place the coated rock crabs shell-side down directly on the glowing charcoal surface. They will sizzle immediately and the paste will begin caramelizing on contact. Grill for 5-6 minutes without moving — the paste chars onto the shell and the shell chars onto the coals in a way that produces the specific black-and-caramel exterior of cua đá nướng. Using tongs, flip the crabs for 3-4 more minutes flesh-side down directly on the coals. The crabs are done when the shell is deeply charred throughout and one leg pulled away cleanly from a large crab.',
            tip: 'The black char from direct coal contact is the desired result — not accidental burning. The bottom of the rock crab shell will be genuinely blackened from the coal contact, which concentrates the caramelized paste and transfers the hardwood fragrance directly into the flesh. This char is what makes cua đá nướng taste unlike any other grilled crab preparation.',
        },
        {
            title: 'Make the muối lá é and rest briefly',
            ...
            tip: 'The muối lá é for cua đá specifically is the connection to the landscape — the litsea leaf that grows on the rocky hillsides above the coast where the crabs are found, pounded with the sea salt from the same coast. This is the Phú Yên terroir argument made edible.',
        },
        {
            title: 'Serve from the coal with nothing added',
            description: 'Transfer the charred rock crabs directly to a wooden board or plate — do not add garnish that would obscure the visual of the coal-blackened shell. Scatter only rau răm and fresh lá é leaves. Serve the muối lá é with lime wedges alongside. To eat: crack the coal-blackened shell with a spoon or fingers — it comes apart more easily than the raw shell due to the charring. The flesh inside should be completely white, slightly caramelized at the edges where it was in contact with the shell during cooking, and mineral-sweet throughout. Dip in the lime-squeezed muối lá é. Eat with a raw lá é leaf.',
            tip: 'The visual presentation of cua đá nướng muối ớt is intentionally stark — blackened shells on a plain wooden board. Do not add color or decoration. The charred crab and the green lá é leaves are the complete visual. Anything more is a distraction from what the dish is.',
        },
    ],
};
