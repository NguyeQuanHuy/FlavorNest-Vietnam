...
const recipe: RecipeData = {
    ...
    title: 'Ð?u Ph? Chiên Ròn (Vietnamese Crispy Fried Tofu)',
    ...
    ingredientSections: [
        ...
        {
            title: 'Scallion oil (d?u hành) — optional but recommended',
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Ð?u ph? chiên ròn is the foundation for two other Vietnamese dishes: d?u hu s?t cà (simmered in tomato sauce) and d?u hu chiên s? (tossed with lemongrass). The frying technique in this recipe applies to both.',
        },
    ],
};
