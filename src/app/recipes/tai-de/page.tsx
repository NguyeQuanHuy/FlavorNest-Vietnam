...
const recipe: RecipeData = {
    ...
    intro: `Tái dê is the Vietnamese raw-cured goat salad — a preparation in the tradition of g?i tôm s?ng and bò tái chanh where the protein is cured by citric acid rather than cooked by heat, and where the freshness of the ingredient is both the prerequisite and the proof of quality. Tái means slightly cooked or cured — the same word used for bò tái in ph?, where thin slices of raw beef are placed in the bowl and cooked by the boiling broth. In tái dê the curing agent is fresh lime juice combined with fish sauce, which denatures the surface proteins of the thinly sliced goat and produces a texture that is between raw and cooked — firm on the outside, still pink in the center of each slice, with the raw goat's mineral, grassy character transformed by the acid into something cleaner and brighter. Tái dê is specifically the preparation that tests the quality of goat meat most completely: the lime curing removes none of the flavor and does nothing to mask inferior or old meat. The goat must be from a young animal (less than 8 months old produces the most tender, least gamey result), freshly slaughtered or purchased that day, and sliced at the last possible moment before curing. In the central Vietnamese provinces where tái dê is most commonly eaten — Khánh Hòa, Phú Yên, Bình Ð?nh — the dish is a nh?u classic: served cold at the beginning of a long drinking session, with rice crackers for scooping and cold beer for washing down, the lime brightness and the herb intensity providing the contrast that makes the first beer of the evening taste better.`,
    ingredientSections: [
        {
            title: 'Goat',
            items: [
                { amount: 400, unit: 'g', name: 'goat leg or loin meat (th?t dê dùi ho?c than)', note: 'from a young goat under 8 months — the meat should be pale pink, fine-grained, with minimal strong smell. Must be very fresh — purchased the same day or the previous evening at most.' },
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'very large bunch Vietnamese coriander (rau ram)', note: 'leaves only — the essential herb for goat, present in larger quantity than for any other g?i' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'In a wide bowl combine the drained cured goat, julienned ginger, paper-thin lemongrass rings, soaked shallots, rau ram, perilla, mint, and spring onion. Add the final dressing: fish sauce, remaining lime juice, sugar, sesame oil, black pepper, and the reserved curing liquid. Toss gently but thoroughly — the goat slices should remain intact, not shredded.',
            tip: 'Rau ram is the most important herb in tái dê — more important than in any other Vietnamese g?i. The peppery, slightly medicinal character of Vietnamese coriander is specifically what neutralizes any remaining gamey note in the goat and replaces it with a bright, herbal fragrance. Use it generously — this is not the dish to be restrained with rau ram.',
        },
        {
            title: 'Rest 3 minutes then plate',
            description: 'Leave the assembled salad to rest for 3 minutes — the dressing penetrates the herbs and aromatics and the flavors come together. Transfer to a serving plate. Top with crushed peanuts, crispy fried shallots, and toasted sesame seeds at the last moment. Scatter sliced chili and extra rau ram. Serve with sesame rice crackers and extra limes.',
            tip: 'The 3-minute rest after assembly is specific to tái dê — unlike seafood g?i which should be eaten the moment it is assembled, the slightly denser goat benefits from a few minutes for the lime and herbs to fully integrate. Beyond 10 minutes the salad begins to lose its freshness.',
        },
        {
            title: 'How to eat tái dê — the nh?u way',
            description: 'Spoon a generous amount of tái dê onto a sesame cracker. The salad should overflow the cracker slightly. Eat in one motion — the cracker crunching, the lime-bright goat, the peppery rau ram, the ginger heat, all simultaneously. Follow immediately with cold beer. Repeat. This is the central Vietnamese nh?u rhythm: one cracker, one bite, one sip of beer, conversation, repeat. Tái dê eaten slowly and carefully is not tái dê — it is eaten quickly, communally, and joyfully.',
            tip: 'The sesame cracker is not a vehicle — it is a structural element of the eating experience. The crunch of the cracker, the cold temperature of the lime-cured goat, the beer between bites: these three elements together produce the specific pleasure of tái dê as a nh?u dish. Serve with crackers as large as available and pile the goat high.',
        },
    ],
};
