...
const recipe: RecipeData = {
    ...
    subtitle: `Dông Nu?ng — Ninh Thu?n's sand-dwelling lizard grilled over charcoal with lemongrass and salt, eaten whole with green mango salad.`,
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '1 hr',
    rating: 4.8,
    ...
    intro: `Dông (Leiolepis belliana — the butterfly agama, also called the sand digger or banded gliding lizard) is a herbivorous lizard that lives in burrows in the dry sandy coastal plains of Ninh Thu?n and Bình Thu?n provinces — the driest, most arid region of Vietnam, where the red sand dunes run to the sea and rainfall averages less than 700mm per year. The dông is the signature wild food of this landscape: it feeds on wild herbs and flowers that grow in the sandy soil, its flesh is consequently aromatic and faintly herbal, and its fat — accumulated during the dry season when food is abundant — renders during grilling into a pale, fragrant oil that bastes the meat from within.\n\nDông nu?ng is the simplest and most traditional preparation: the cleaned lizard is stuffed with bruised lemongrass, rubbed with salt and turmeric, and grilled whole over charcoal until the skin is crisp and mahogany-coloured and the fat has rendered completely. It is eaten entire — skin, small bones, and all — torn apart with the hands at the table and dipped in mu?i ?t xanh (green chili salt) or a simple fish sauce and lime dipping sauce. The eating is tactile and unhurried.\n\nNinh Thu?n's Cham and Raglai communities have hunted dông for centuries. The lizard is caught at dawn when it emerges from its burrow to warm itself — a long wire hook inserted into the burrow entrance is the traditional method. Today, dông is also farmed in Ninh Thu?n and Bình Thu?n on small family operations, and the farmed dông is available in markets in Phan Rang year-round. Outside Vietnam, this ingredient is undocumented in any English culinary source.`,
    ingredientSections: [
        {
            title: `The lizard`,
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            description: `Remove from the grill and rest on a wooden board for 5 minutes. Do not cover — the skin crisps further as steam escapes during resting. Bring to the table whole on the board or a large plate lined with banana leaf. Remove the kitchen twine if used. In Ninh Thuan, dông nu?ng is served whole and torn apart communally at the table — there is no pre-portioning. Each person tears a section: leg, tail, body — skin and small bones eaten together. The crispy turmeric skin is the first thing taken.`,
        },
        {
