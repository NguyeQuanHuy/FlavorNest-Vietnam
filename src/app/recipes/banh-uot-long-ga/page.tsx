...
const recipe: RecipeData = {
    ...
    title: 'Bánh Ướt Lòng Gà (Huế Steamed Rice Rolls with Chicken Offal)',
    subtitle: 'Silky steamed rice paper rolls served with stir-fried chicken offal — gizzard, liver, heart, and intestine — in a lemongrass-chili oil, with crispy shallots and the specific Huế dipping sauce that makes every element complete. The morning dish of the imperial city.',
    ...
    intro: `Bánh ướt lòng gà is the Huế breakfast that street food vendors set up before dawn and sell out of by 9am. Bánh ướt — steamed rice paper rolls — are the silky, almost translucent rice sheets that form the base: smooth, slightly chewy, with a clean rice flavor that serves as the neutral canvas for what goes on top. Lòng gà is the entirety of chicken offal: gizzard, liver, heart, and intestine, each cleaned and prepared separately and then briefly stir-fried with lemongrass, chili, and garlic until each organ is perfectly cooked to its own ideal texture — the gizzard chewy and slightly firm, the liver soft and just barely cooked through, the heart tender, the intestine silky with a faint minerality. The combination is placed over the rice rolls with crispy fried shallots, shallot oil, and fresh herbs. The dipping sauce is the Huế version of nước chấm — lighter, more herb-forward than southern versions, with the specific balance of the imperial city's cuisine where no single flavor element is allowed to dominate. Bánh ướt lòng gà is not a dish for every palate — it requires genuine curiosity about offal and the openness to eat organs prepared in a way that makes their individual characters clear rather than hiding them. For those willing to engage with it, it is one of the great breakfast dishes of Vietnam.`,
    ingredientSections: [
        {
            title: 'Bánh ướt (steamed rice rolls)',
            items: [
                { amount: 200, unit: 'g', name: 'rice flour (bột gạo)', note: 'fine white rice flour — not glutinous' },
                { amount: 30, unit: 'g', name: 'tapioca starch (bột năng)', note: 'adds elasticity and the silky texture' },
        ...
        },
        {
            ...
            items: [
                { amount: 200, unit: 'g', name: 'chicken gizzards (mề gà)', note: 'cleaned, silverskin removed, scored shallowly and sliced thin' },
                ...
                { amount: 150, unit: 'g', name: 'chicken intestine (ruột gà)', note: 'cleaned thoroughly — buy pre-cleaned from Vietnamese butcher. Optional but traditional.' },
        ...
        {
            title: 'Huế dipping sauce (nước chấm Huế)',
            items: [
                ...
                { amount: 1, unit: 'tsp', name: 'chili oil (dầu ớt)', note: 'the Huế addition — a few drops of chili oil added to the sauce for color and heat' },
            ],
        },
    ],
    steps: [
        ...
        {
            title: 'Make the Huế dipping sauce',
            description: 'Combine fish sauce, lime juice, sugar, and water. Stir until sugar dissolves. Add minced garlic and chili. Add a few drops of chili oil — this is the Huế-specific element that gives the sauce its orange tint and extra heat dimension. Taste: the Huế version should be slightly lighter and more acidic than southern nước chấm, with the chili oil adding warmth rather than sharp heat.',
            tip: 'The chili oil in Huế nước chấm is not the same as fresh chili heat. It adds a background warmth and color that is different from the sharp front-of-palate heat of fresh bird\'s eye chili. Both are present in the authentic version.',
        },
        {
            title: 'Assemble and serve',
            description: 'Arrange 3-4 steamed rice sheets on each plate, slightly overlapping. Spoon the stir-fried offal generously over the sheets. Drizzle shallot oil over everything. Top with crispy fried shallots, sliced spring onion, and cilantro. Serve the Huế dipping sauce in individual small bowls alongside. To eat: tear a piece of rice sheet with the offal on top, dip into the sauce, eat. The silky rice paper, the chewy gizzard, the soft liver, and the sharp dipping sauce in each bite is the complete bánh ướt lòng gà experience.',
            tip: 'Serve immediately after assembling — the rice sheets absorb the shallot oil and begin to stick to the plate within minutes. Bánh ướt lòng gà is a dish that must be eaten the moment it is plated.',
        },
    ],
};
