...
const recipe: RecipeData = {
    ...
    intro: `G?i cua is the Vietnamese crab salad — a dish that requires the best crab you can find and does almost nothing to obscure it. The crab meat is lightly dressed in a lime-fish sauce vinaigrette with just enough acidity to brighten its natural sweetness without overwhelming it. The shredded green mango or young coconut adds crunch and tartness. The fresh herbs — rau ram, mint, and culantro if available — add the herbal depth that turns dressed crab meat into a complete dish. G?i cua is associated particularly with the coastal provinces of central and southern Vietnam — Nha Trang, Phú Qu?c, Vung Tàu — where fresh crab is harvested daily and the morning market has piles of mud crabs and blue swimmer crabs still moving. The version from Nha Trang uses crab from the Khánh Hòa coast specifically, with young coconut as the crunchy element instead of mango. The version from the Mekong Delta uses river crab with more herbs and less mango. This recipe covers the central coast version — mud crab or blue swimmer, green mango, and a bright, herb-forward dressing.`,
    ingredientSections: [
        {
            title: 'Crab',
            items: [
                { amount: 500, unit: 'g', name: 'fresh cooked crab meat (th?t cua)', note: 'from 2 medium mud crabs or blue swimmer crabs, steamed and picked. Or 500g good-quality fresh crab meat from a fishmonger — never canned.' },
                { amount: 2, name: 'medium mud crabs or blue swimmer crabs', note: 'if cooking yourself: steam for 12-15 minutes, cool, pick the meat. Reserve any crab roe (g?ch cua) — mix into the dressing.' },
            ],
        },
        {
            title: 'Salad',
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tbsp', name: 'crab roe (g?ch cua)', note: 'if available — stirred into the dressing for extra depth' },
            ],
        },
        {
            title: 'To serve',
            items: [
                { amount: 8, name: 'prawn crackers or bánh ph?ng tôm', note: 'for scooping' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Arrange on a serving plate. Top generously with crushed peanuts and fried shallots. Serve immediately with prawn crackers and lime wedges. G?i cua must be eaten within 15-20 minutes of dressing — the crab and mango both release moisture quickly and the salad becomes watery if left.',
