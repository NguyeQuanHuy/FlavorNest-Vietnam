...
const recipe: RecipeData = {
    slug: 'goi-coc',
    title: 'G?i Cóc (Vietnamese Hog Plum Salad)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 3, name: 'bird\'s eye chilies', note: 'thinly sliced — g?i cóc should be spicy' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tbsp', name: 'sugar', note: 'less sugar than other g?i — the cóc sourness should remain dominant' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'G?i cóc dressing is the least acidic of all Vietnamese salad dressings because the ingredient provides all the acid. Calibrate the dressing against the actual sourness of your specific cóc.',
        },
        {
            title: 'Combine everything',
            description: 'In a large bowl, combine sliced cóc, soaked-and-dried shrimp, sliced chili, rau ram leaves, and spring onion. Pour the dressing over. Add a small amount of the chili salt paste. Toss to coat. Taste and adjust — it should be bracingly sour, savory from the fish sauce, sweet from the sugar, hot from the chili, and fragrant from the rau ram.',
        ...
        },
        {
            ...
            description: 'Transfer to a plate. Top with crushed peanuts and fried shallots. Serve immediately. G?i cóc is eaten as it is — no crackers needed, no elaborate presentation. It is direct food: pick up a piece of cóc with the dried shrimp and peanuts, eat, repeat. The sourness is the point. Serve with extra lime wedges and chili salt on the side for those who want more of either.',
            tip: 'The experience of eating g?i cóc for the first time — the immediate, almost aggressive sourness that makes the salivary glands respond before the food is even chewed — is one of the most distinctive sensory experiences in Vietnamese street food. Warn first-timers and watch their expression.',
        },
    ],
};
