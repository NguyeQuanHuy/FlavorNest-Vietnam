...
const recipe: RecipeData = {
    ...
    title: 'Canh H?t Sen Su?n Non (Lotus Seed and Pork Rib Soup)',
    subtitle: 'Baby pork ribs simmered until the collagen melts into a clear, golden broth with lotus seeds that have been cooked until just tender — the restorative soup of Hu? that Vietnamese grandmothers make when someone needs nourishment rather than excitement.',
    ...
    intro: `Canh h?t sen su?n non sits in the category of Vietnamese soups that are eaten as medicine before they are eaten as food. Lotus seeds (h?t sen) appear throughout Vietnamese traditional medicine as a tonic for the nerves, the heart, and the sleep — their mild, slightly sweet flavor and the faint bitterness of the embryo (which must be removed before cooking) are associated with calm, with clarity, with the cooling of internal heat. The pork ribs provide the collagen and the savory depth that transforms what would otherwise be a sparse medicinal preparation into a genuinely satisfying soup. Together, lotus seeds and pork ribs have been simmered in Vietnamese kitchens — particularly Hu? kitchens, where lotus is not merely an ingredient but a cultural identity — for generations, producing a clear broth that is simultaneously light and deeply nourishing. Canh h?t sen su?n non requires no technique beyond patience: blanching the ribs, simmering long enough for the broth to develop body, adding the lotus seeds at the right stage so they cook through without disintegrating. The result is a soup of extraordinary gentleness — clean, slightly sweet, with the soft pork collagen making the broth silky and the lotus seeds providing a starchy, yielding texture that no other ingredient replicates. It is the soup served to someone recovering from illness, to a mother after childbirth, to an elder who needs something warm and unchallenging. It is also simply a very good soup to eat on a quiet evening with rice.`,
    ingredientSections: [
        {
            title: 'Main',
            items: [
                { amount: 600, unit: 'g', name: 'baby pork ribs (su?n non)', note: 'cut into 4cm pieces through the bone by the butcher. Baby ribs have more gelatin than adult ribs and produce a silkier broth.' },
                { amount: 200, unit: 'g', name: 'fresh lotus seeds (h?t sen tuoi)', note: 'embryo removed from each seed — press each seed and the green bitter embryo pops out. Dried lotus seeds (soaked 4 hours) or vacuum-packed work with adjusted timing.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Canh h?t sen su?n non should not taste assertively of anything — no single element should dominate. If the fish sauce is too forward, add a small splash of water. If the broth tastes flat, a few more drops of fish sauce. The balance is subtle by design.',
        },
        {
