...
const RECIPES: Recipe[] = [
    ...
    },
    {
        ...
        type: 'Signature', difficulty: 'Hard', time: '15 min',
    ...
    },
    {
        ...
        subtitle: 'Trà Đá',
        image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=900&q=80',
        type: 'Everyday', difficulty: 'Easy', time: '5 min',
    ...
    },
    {
        ...
        type: 'Modern', difficulty: 'Easy', time: '10 min',
    ...
    },
    {
        ...
        type: 'Refreshing', difficulty: 'Easy', time: '10 min',
    ...
    },
    {
        ...
        type: 'Street Juice', difficulty: 'Easy', time: '5 min',
    ...
    },
    {
        ...
        type: 'Natural', difficulty: 'Easy', time: '2 min',
            ...
            <section style={{ background: 'linear-gradient(135deg, #FEF3E2 0%, #FDEAC8 55%, #F5EDE3 100%)', padding: '120px 24px 72px', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap' }}>
                        {[['☕', `${RECIPES.length}`, 'Recipes'], ['⏱', '5 min', 'Quickest'], ['🌏', '3', 'Regions'], ['⭐', '4.8', 'Avg Rating']].map(([icon, val, lbl]) => (
                            <div key={lbl}>
