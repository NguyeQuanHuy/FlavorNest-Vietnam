...
const recipe: RecipeData = {
    ...
    title: 'Trứng Hấp Thịt Băm (Steamed Egg with Minced Pork)',
    subtitle: 'Eggs beaten with minced pork, wood ear mushrooms, glass noodles, and spring onion then steamed until silky and just set — the northern Vietnamese family dish that appears on weekday dinner tables from Hà Nội to Vinh, eaten over plain rice with the natural cooking juices spooned over.',
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The warm water beaten into the eggs is the technique that produces the silky, slightly loose texture of trứng hấp thịt băm rather than a dense, firm steamed egg. The water ratio — 3 tablespoons per 4 eggs — is calibrated for this texture. More water produces a looser, almost custard-like result; less produces a firmer, more omelette-like result.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The natural cooking juices beneath and around the steamed egg are not a byproduct — they are a deliberate element of trứng hấp thịt băm that should be distributed to every diner. Spooning these juices over plain rice and eating them before the egg itself is the correct sequence: it seasons the rice for the egg that follows.',
        },
    ],
};
