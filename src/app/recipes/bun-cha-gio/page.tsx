...
const recipe: RecipeData = {
    slug: 'bun-cha-gio',
    title: 'Crispy Spring Roll Vermicelli (Bún Ch? Giò)',
    subtitle:
        'Bún Ch? Giò — a satisfying bowl of crispy, golden-fried spring rolls layered over cool rice vermicelli, fresh herbs, and a classic sweet and tangy dipping sauce.',
    ...
    intro:
        'Bún Ch? Giò is the perfect harmony of temperatures and textures. It brings together the hot, shattering crunch of deep-fried spring rolls with the refreshing coolness of rice noodles and raw vegetables. Unlike many noodle soups, this is a "dry" noodle dish, where the soul lies in the Nu?c Ch?m—the iconic Vietnamese dressing that ties the savory pork filling and the garden-fresh herbs into one vibrant, addictive meal.',
    ingredientSections: [
        {
            title: 'Crispy Spring Rolls (Ch? Giò)',
            items: [
