...
const recipe: RecipeData = {
    ...
    intro: `Lẩu thả is Phan Thiết's most distinctive communal meal — a dish that does not translate cleanly into any other Vietnamese culinary category. The name means literally "hotpot of dropping": a simmering pot of clear fish broth sits at the centre of the table, and each diner rolls their own small rice paper roll (nem) filled with fresh shrimp, pork belly, and herbs, then drops (thả) it directly into the hot broth to cook briefly before eating. The roll softens and swells in the broth over 60 to 90 seconds, the shrimp cooks through, the herbs inside perfume the liquid, and the roll is retrieved, dipped in muoi ot xanh (green chili salt), and eaten with a mouthful of raw vegetables.\n\nWhat makes lẩu thả structurally unique is that it combines two formats — the individual roll of gỏi cuốn and the communal broth of lẩu — into a single dish where the act of rolling and dropping is itself part of the meal's rhythm. There is no fixed order of eating. Diners roll at different speeds. The broth accumulates flavour from successive rolls throughout the meal, becoming progressively richer as shrimp and herb flavours leach into it. By the end of the meal the broth is a different liquid than it was at the start — a soup that has been seasoned by the eating itself.\n\nLẩu thả is specific to Bình Thuận province. It appears in restaurants along Nguyễn Đình Chiểu street in Mũi Né and at beachside establishments in Phan Thiết's fishing quarter. Outside Bình Thuận it is almost unknown. In English it has never been documented.`,
    ingredientSections: [
        {
            title: `Clear fish broth (nước lẩu)`,
            items: [
                ...
                { amount: 2.5, unit: 'tbsp', name: `fish sauce (nước mắm Phan Thiết)`, note: `40°N preferred` },
                { amount: 1, unit: 'tsp', name: `salt` },
                { amount: 2.5, unit: 'L', name: `water` },
            ],
        },
        {
            title: `Roll fillings (nhân cuốn) — per person`,
            items: [
                { amount: 200, unit: 'g', name: `fresh medium shrimp (tôm tươi)`, note: `peeled, deveined, left whole — they cook inside the roll in the broth` },
                { amount: 150, unit: 'g', name: `pork belly (ba chỉ heo)`, note: `boiled 20 min, cooled, sliced thin 3mm` },
                ...
                { amount: 1, name: `bunch garlic chives (hẹ)`, note: `tied around the outside of the roll as a seal` },
            ],
        },
        {
            title: `Rice paper (bánh tráng)`,
            items: [
                { amount: 20, name: `round rice paper sheets (bánh tráng mỏng)`, note: `22–24 cm diameter, thin — briefly dipped in warm water 3 seconds to soften just enough to roll without cracking` },
            ],
        },
        {
            title: `Muối ớt xanh (green chili salt — the essential dip)`,
            items: [
    ...
    steps: [
        ...
        },
        {
            ...
            description: `Retrieve the roll and place in your personal bowl. Dip one end into muối ớt xanh — rotate to coat the side and tip. Eat in two bites alongside raw bean sprouts and a leaf of lettuce or perilla. Take a pinch of shredded green mango between rolls to reset the palate. Roll the next nem while the previous one is in the broth. The rhythm of lẩu thả — roll, drop, eat, roll — is the meal. By the halfway point the broth will have darkened slightly and become sweeter and more aromatic from accumulated shrimp and herb flavour. In Phan Thiết, this mid-meal broth is ladled into small cups and drunk alongside the rolls as it develops.`,
        },
        {
            title: `Finish with the enriched broth`,
            description: `When all the rolls have been eaten, the remaining broth in the pot is now a light shrimp and herb consommé — seasoned by the meal itself. Add any remaining raw shrimp directly to the broth and cook 2 minutes. Taste and adjust with a small amount of fish sauce if needed. Ladle into bowls and drink as a closing soup course with the last of the raw vegetables. In Phan Thiết restaurants, this final broth drinking is not optional — the waiter brings small bowls automatically when the last roll is retrieved.`,
            tip: `The progression of the broth from light fish stock to shrimp-herb consommé over the course of the meal is the most philosophically interesting element of lẩu thả — it is a dish that seasons itself through the act of eating. The final broth bears no resemblance to the starting broth and is considered its own reward. Do not drain or discard it.`,
        },
    ],
};
