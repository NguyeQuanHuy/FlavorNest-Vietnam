...
const recipe: RecipeData = {
    slug: 'ga-nuong-moi',
    title: 'Gà Nu?ng M?i (Phú Yên Whole-Fire Chicken)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Fire setup',
            items: [
                { amount: 1, unit: 'kg', name: 'hardwood charcoal', note: 'not briquettes — hardwood charcoal burns hotter, cleaner, and produces the specific aromatic smoke of gà nu?ng m?i. Lychee wood, longan wood, or any dense hardwood.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice or bánh tráng nu?ng (grilled rice crackers)' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Hardwood charcoal burns significantly hotter and cleaner than briquettes and is not optional for gà nu?ng m?i. Briquettes produce a lower, less clean heat and the chemical binders in cheaper briquettes contribute off-flavors to unmediated chicken — particularly noticeable in a preparation with no marinade to mask them.',
        },
        {
            ...
            tip: 'Control flare-ups by moving the chicken to the indirect zone temporarily — do not spray with water, which cools the fire and produces steam rather than dry heat. A spray of water on gà nu?ng m?i is the equivalent of steaming the skin after you have worked to dry it.',
        },
        {
            ...
            tip: 'The covering of the grill during the indirect phase is what separates gà nu?ng m?i cooked on a covered kettle grill from one cooked on an open grill. The covered environment creates a convection effect that cooks the top of the chicken from the heated air — more similar to a real fire where the chicken is surrounded by flame on all sides.',
        },
        {
