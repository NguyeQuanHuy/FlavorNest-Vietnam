...
const recipe: RecipeData = {
    ...
    title: 'Bít T?t Vi?t Nam (Vietnamese Steak with Brown Sauce)',
    ...
    ingredientSections: [
        ...
        {
            title: 'Vietnamese brown sauce (s?t nâu)',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'light soy sauce or maggi seasoning', note: 'drizzled over the salad — the Vietnamese bít t?t salad dressing' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'The butter added off the heat is the technique that produces a restaurant-quality s?t nâu. Butter added to simmering sauce breaks and separates — butter swirled into a sauce pulled from the heat emulsifies and produces the glossy, silky finish specific to Vietnamese brown sauce.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The cold pâté against the hot steak and sizzling plate is the temperature contrast specific to bít t?t Vi?t Nam. Do not warm the pâté. The contrast between the cold, smooth pâté and the charred, hot beef is intentional and essential to the eating experience.',
        },
        {
            title: 'How to eat Vietnamese steak',
            description: 'Cut the steak into bite-sized pieces on the sizzling plate. Drag each piece through the brown sauce pooling on the plate. Eat a piece of steak with a piece of egg, a smear of pâté from the baguette, and a bite of the tomato-cucumber salad. The baguette is used to mop — drag it through the sauce, the egg yolk, and any pâté remaining on the plate. This is the correct sequence and the one Vietnamese bít t?t diners follow instinctively.',
            tip: 'The final mopping of the plate with the baguette — scraping up the combined drippings of brown sauce, egg yolk, and butter — is the part that Vietnamese people describe as the best part of bít t?t. Leave enough bread for this purpose.',
        },
    ],
};
