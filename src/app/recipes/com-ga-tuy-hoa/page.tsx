...
const recipe: RecipeData = {
    slug: 'com-ga-tuy-hoa',
    title: 'Com Gà Tuy Hòa (Tuy Hòa Chicken Rice)',
    ...
    intro: `Com gà Tuy Hòa is the chicken rice of Phú Yên's provincial capital — a preparation that shares its basic architecture with com gà H?i An but differs in specific and important ways that people from both cities will defend fiercely. In Tuy Hòa, the rice is cooked in chicken broth with a generous amount of turmeric that turns every grain golden, and with lemongrass that perfumes the broth absorbed by the rice during cooking. The chicken is shredded and tossed not merely with Vietnamese coriander and spring onion as in H?i An, but with thinly sliced red onion that has been briefly soaked in ice water to remove its sharpness — the onion contributes a clean bite that the H?i An version does not have. The dipping sauce in Tuy Hòa is lighter and contains a specific addition: a spoonful of the turmeric-golden chicken fat skimmed from the cooking liquid, which makes the sauce simultaneously brighter and richer. The clear chicken broth is served separately, in a small bowl, with sliced spring onion and white pepper — it is a palate cleanser between bites of the rich chicken rice rather than a soup. Com gà Tuy Hòa is the lunch that the town eats at the same small shops that have been serving it for forty years, in the hours between 10am and 1pm when the chicken is fresh from the morning market and the rice has been cooked at dawn. It is one of the dishes that Phú Yên people miss most when they leave, and one that most food travelers to the province encounter only if they know to look for it.`,
    ingredientSections: [
        {
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1.5, unit: 'tsp', name: 'turmeric powder', note: 'the defining color of Tuy Hòa com gà — more turmeric than H?i An version' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The ratio of 400g rice to 600ml broth produces the slightly drier, more separate grain texture of Tuy Hòa com gà. H?i An version is slightly wetter. The Tuy Hòa rice should have distinct grains that do not clump when plated.',
        },
        {
        ...
        },
        {
            ...
            description: 'While the chicken is still warm, remove all the skin (set aside — it can be crisped separately). Pull the meat from the bones in long strands, tearing along the muscle grain. In a large bowl, combine the shredded chicken with the soaked red onion, rau ram leaves, sliced spring onion, sesame oil, fish sauce, sugar, and white pepper. Toss gently but thoroughly. Taste and adjust. The chicken topping should taste bright, herby, and slightly nutty from the sesame oil.',
        ...
        },
        {
            ...
            description: 'Combine fish sauce, lime juice, sugar, and water. Stir until sugar dissolves. Add garlic and chili. Add the reserved golden chicken fat — it will float on the surface and add a rich, golden sheen to the sauce. Stir before each use as the fat separates. The Tuy Hòa dipping sauce should taste slightly richer and more complex than standard nu?c ch?m — the chicken fat is the element that creates this character.',
        ...
        },
        {
            ...
            tip: 'The correct way to eat com gà Tuy Hòa: a spoonful of rice, a piece of chicken, a dip in the sauce, then a sip of the clear broth as a palate cleanser. The broth between bites resets the palate for the next mouthful of seasoned rice and dressed chicken. This rhythm is specific to Tuy Hòa and makes the meal last longer and taste better than eating the components separately.',
        },
    ],
};
