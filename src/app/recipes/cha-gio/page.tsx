...
const recipe: RecipeData = {
    slug: 'cha-gio',
    title: 'Ch? Giò (Southern Vietnamese Crispy Spring Rolls)',
    ...
    intro: `Ch? giò is the southern Vietnamese fried spring roll — one of the most widely recognized Vietnamese dishes internationally and one of the most frequently misunderstood in the details that make it specifically southern and specifically Vietnamese rather than generically Asian fried roll. The preparation is known by different names in different parts of Vietnam: ch? giò in the south, nem rán in the north, and spring roll in the international Vietnamese restaurant vocabulary — and these name differences reflect genuine preparation differences that go beyond regional naming conventions. The southern ch? giò uses rice paper (bánh tráng) as its wrapper rather than the wheat-based wrappers used in northern nem rán and in most other Asian fried roll preparations. Rice paper produces a dramatically different fried exterior: where wheat wrappers fry to a smooth, uniformly golden surface, rice paper creates the characteristic bubbled, shatteringly crispy exterior of ch? giò — hundreds of small air pockets between the translucent rice paper layers, each pocket creating a separate crispy surface area, producing a roll that shatters into delicate fragments on the first bite rather than yielding gradually. The filling also differs from northern nem rán in the addition of taro (khoai môn): grated or minced taro provides a specific starchy texture in the cooked filling that is lighter and more specifically savory than the carrot or jicama used in other versions, and it absorbs the pork and shrimp flavors during the brief cooking period inside the frying roll in a way that binds the filling without making it dense. Ch? giò is eaten wrapped in a lettuce leaf with fresh herbs and dipped in nu?c ch?m — the eating method that moderates the richness of the fried roll with the freshness of the herbs and the brightness of the dipping sauce.`,
    ingredientSections: [
        {
            title: 'Filling',
            items: [
                { amount: 250, unit: 'g', name: 'minced pork (th?t heo bam)', note: '20% fat — the fat keeps the filling moist inside the fried roll' },
    ...
    steps: [
        {
            ...
            tip: 'The grated taro in ch? giò filling absorbs moisture from the pork and shrimp during the resting period and becomes slightly sticky — this is the property that helps bind the filling together inside the roll during frying. Under-rested filling with ungelled taro is looser and more prone to shifting during rolling and frying.',
        },
        {
            ...
            tip: 'The 1-2 second water dip for rice paper before rolling ch? giò is the most critical and most frequently over-done step. Over-wetted rice paper becomes sticky, tears easily, and produces rolls that seal improperly and open during frying. Under-wetted rice paper cracks during rolling. The correct hydration: the paper is pliable but still has slight resistance when bent — it will continue softening for 30 seconds after dipping, reaching perfect pliability just as rolling is complete.',
        },
        {
            title: 'Roll tightly — the technique that produces the shatter',
            description: 'Place 2 tablespoons of filling in a log shape across the lower third of the moistened rice paper. Fold the bottom edge over the filling. Fold both sides inward. Roll forward firmly and tightly — the roll should be as tight as possible without tearing the rice paper. Brush the final edge with beaten egg yolk and press to seal. The tight rolling is what produces the characteristic bubbled exterior: the tightly rolled rice paper layers trap air between them during frying, and these air pockets become the bubbles that make ch? giò visually distinctive.',
            tip: 'The tighter the roll, the more dramatic the bubble texture during frying. A loosely rolled ch? giò fries to a smooth, pale surface with few bubbles. A tightly rolled ch? giò fries to a deeply bubbled, irregular surface with hundreds of tiny air pockets. The shatter on first bite — the defining quality of great ch? giò — comes from these air pockets: each one is a separately crispy surface that breaks independently.',
        },
        {
            ...
            tip: 'The two-stage frying for ch? giò — 170°C for filling, 185°C for crust — is the technique used by experienced Vietnamese home cooks and restaurant kitchens to achieve both a cooked interior and a maximally crispy exterior. Single-stage high-temperature frying browns the exterior before the filling is cooked; single-stage low-temperature frying cooks the filling but produces a pale, soft exterior.',
        },
        {
            title: 'Serve with the full herb plate',
            description: 'Place the hot ch? giò on a serving plate. The surface should be: deeply golden, heavily bubbled with the characteristic rice paper texture, and shattering audibly when tapped with a finger. Serve with the full herb plate, lettuce wrapping leaves, bean sprouts, cucumber, and nu?c ch?m. The eating: place one ch? giò on a lettuce leaf, add mint, rau ram, perilla, and cucumber, roll loosely, dip the end in nu?c ch?m and bite. The crunch of the rice paper, the fresh herbs, and the bright dipping sauce in the same bite is the complete ch? giò experience.',
            tip: 'The specific lettuce-herb wrap for ch? giò is not optional garnish but the eating method the preparation is designed for. A ch? giò eaten alone without herbs is simply a fried roll. A ch? giò wrapped in lettuce with rau ram and mint and dipped in nu?c ch?m is specifically ch? giò — the herb freshness and the bright acidity of the sauce are the elements that make the rich, fried roll a balanced and endlessly eatable preparation rather than a heavy one.',
        },
    ],
};
