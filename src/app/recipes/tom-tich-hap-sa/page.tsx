...
const recipe: RecipeData = {
    ...
    title: 'Tôm Tích H?p S? (Steamed Mantis Shrimp with Lemongrass)',
    subtitle: 'Live mantis shrimp steamed over a fragrant bath of lemongrass, ginger, and beer until the shells turn from grey-green to brilliant orange and the sweet, dense flesh inside is just set — served with mu?i tiêu chanh and the instruction to eat with your hands and not worry about your clothes.',
    ...
    intro: `Tôm tích — mantis shrimp, also called tôm thuy?n (boat shrimp) in Phú Yên for the way their segmented bodies resemble a small boat — is the crustacean that regular diners from outside Vietnam encounter with confusion and local diners from the coast eat with the automatic competence of long practice. Mantis shrimp are not true shrimp: they are stomatopods, a separate order with a body plan unlike any common crustacean, famous in marine biology for their extraordinary eyes and for the striking appendages (the dactyl clubs) with which they can strike with the force of a bullet. In Phú Yên, they are famous for their flavor: the flesh is white, dense, and sweet in a way that is simultaneously like lobster and like crab but specifically neither — richer than shrimp, more delicate than crab, with a particular oceanic sweetness that the central Vietnamese coast produces and that the steaming preparation preserves completely. Tôm tích h?p s? is the simplest and most honest preparation: live mantis shrimp over a boiling bath of lemongrass, ginger, and Vietnamese beer, covered tightly for 6-8 minutes until the shells turn from the muted grey-green of live mantis shrimp to the brilliant coral-orange that indicates they are perfectly cooked. The dipping salt is mu?i tiêu chanh — coarse salt, freshly ground black pepper, lime squeezed at the table. The eating is manual and slightly messy: the sharp edges of the mantis shrimp shell require technique to open without cutting the fingers, which coastal Phú Yên diners have learned from childhood and visitors learn through trial and several small cuts.`,
    ingredientSections: [
        {
            title: 'Mantis shrimp',
            items: [
                { amount: 1, unit: 'kg', name: 'fresh mantis shrimp (tôm tích / tôm thuy?n)', note: 'live or very recently killed — the freshness is detectable in mantis shrimp more than in almost any other seafood. Available at Vietnamese and Asian seafood markets. Choose active, moving mantis shrimp with intact shells.' },
            ],
        },
        {
            title: 'Steaming bath',
            items: [
                ...
                { amount: 330, unit: 'ml', name: 'Vietnamese beer (Saigon or Tiger)', note: 'one can or bottle — the CO2 and alcohol carry the lemongrass aromatics into the steam' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 1, name: 'bunch rau ram (Vietnamese coriander)', note: 'eaten between mantis shrimp' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The beer adds a specific aromatic character to the steam — the CO2 and mild malt volatilize and carry the lemongrass compounds more effectively than water alone. This is the same technique used for tôm h?p bia and produces the same aromatic result with the specific flavor of mantis shrimp.',
        },
        {
