...
const recipe: RecipeData = {
    slug: 'goi-du-du',
    title: 'G?i Ðu Ð? (Vietnamese Green Papaya Salad)',
    ...
    intro: `G?i du d? is the Vietnamese green papaya salad — related to the more internationally famous Thai som tam but distinct in character. Where the Thai version is pounded in a mortar and carries a direct, aggressive heat, the Vietnamese version is tossed rather than pounded, lighter in its seasoning, and relies on the freshness of the herbs as much as the papaya itself. The papaya provides crunch and a mild tartness. The herbs — Vietnamese coriander, mint, perilla — provide fragrance and complexity. The shrimp and pork provide protein and savory depth. The dressing ties everything together with the classic Vietnamese sweet-sour-salty balance. G?i du d? is a summer salad in the truest sense: light enough to eat in heat, flavored enough to be satisfying, assembled in minutes once the papaya is shredded. The key is the papaya: it must be genuinely unripe — rock hard, pale green-white inside, with absolutely no sweetness. Any ripeness produces a salad that is soft and flat-tasting.`,
    ingredientSections: [
        {
            title: 'Salad base',
            items: [
                { amount: 400, unit: 'g', name: 'green papaya (du d? xanh)', note: 'peeled, seeded, and finely shredded — must be rock-hard and unripe. About half a medium papaya.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Assemble immediately before serving. G?i du d? softens quickly once dressed — it should be eaten within 15-20 minutes of tossing.',
        },
        {
