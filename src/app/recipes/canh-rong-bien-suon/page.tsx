...
const recipe: RecipeData = {
    ...
    title: 'Canh Rong Bi?n H?m Su?n (Seaweed and Pork Rib Tonic Soup)',
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Seaweed',
            items: [
                { amount: 40, unit: 'g', name: 'dried wakame seaweed (rong bi?n khô)', note: 'soaked in cold water 10 minutes, drained. Added in the final 15 minutes.' },
            ],
        },
        {
            title: 'Tonic additions',
            items: [
                { amount: 200, unit: 'g', name: 'silken tofu (d?u ph? non)', note: 'cut into 3cm cubes — added in the final 10 minutes' },
                { amount: 20, unit: 'g', name: 'dried wolfberries (k? t? / goji berries)', note: 'soaked briefly, added in the final 10 minutes' },
                { amount: 10, unit: 'g', name: 'dried red dates (táo d?)', note: '5-6 dates, pitted — added with the ribs for the full simmering time' },
            ],
        },
        {
            title: 'Seasoning',
