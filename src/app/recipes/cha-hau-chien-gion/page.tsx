...
const recipe: RecipeData = {
    ...
    title: 'Ch? Hàu Chiên Giòn (Crispy Fried Oyster Cakes)',
    ...
    intro: `Ch? hàu chiên giòn is the fried oyster cake of central Vietnamese coastal cooking — a preparation that sits in the same category as the Taiwanese oyster omelette (???, ô-á-chian) and the Korean haemul pajeon but arrives at its own specific character through the specific Vietnamese preparation: a rice flour batter rather than wheat flour or sweet potato starch, a higher oyster-to-batter ratio than most Asian fried oyster preparations, and the specific combination of bean sprouts and spring onion that makes the interior of each cake simultaneously crispy, creamy, and fresh. The preparation appears at markets and seafood restaurants throughout the central coastal provinces — Qu?ng Nam, Qu?ng Ngãi, Bình Ð?nh, and Phú Yên — where fresh oysters are both abundant and affordable, and where the combination of available cooking equipment (a flat pan, some oil, and a charcoal or gas flame) and the available ingredient (the day's fresh oyster harvest) produces this specific dish. Ch? hàu chiên giòn differs from the Taiwanese oyster omelette in its use of rice flour rather than sweet potato starch — the rice flour produces a crisper, less chewy result that shatters when bitten rather than stretching. It differs from the Korean seafood pancake in its smaller individual size (each cake is 8-10cm across, one per diner rather than one shared pancake) and in its significantly higher cooking oil quantity — the Vietnamese version is fried in enough oil that the cake essentially deep-fries in its own portion rather than pan-frying, which is the technique that produces the specific shattering crispiness of the exterior that makes ch? hàu chiên giòn what it is.`,
    ingredientSections: [
        {
            title: 'Batter',
            items: [
                { amount: 100, unit: 'g', name: 'rice flour (b?t g?o)', note: 'produces the shatteringly crispy exterior — not wheat flour' },
                { amount: 30, unit: 'g', name: 'tapioca starch (b?t nang)', note: 'added to the rice flour — gives extra crispiness and slight chew' },
        ...
        },
        {
            title: 'Filling',
            items: [
                { amount: 300, unit: 'g', name: 'fresh oysters (hàu tuoi)', note: 'shucked, drained of excess liquor — patted dry. Kept whole or halved if very large.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Frying ch? hàu one or two at a time rather than crowding the pan is the technique that produces the individual crispy cakes rather than a merged mass. Each cake needs its own oil contact area to develop the shattering exterior. Crowded cakes steam each other rather than frying individually.',
        },
        {
            ...
            tip: 'The slightly liquid interior around the oysters in a correctly fried ch? hàu is not undercooking — it is the oyster juice that has released during the frying time and pooled within the cake. This liquid is the most intensely flavored element of the cake interior and is why the ratio of oysters to batter must be high enough for the oyster juice to create this effect.',
        },
        {
            title: 'Serve with herbs and dipping sauce',
            description: 'Place the hot cakes on a serving plate. Make the dipping sauce: combine fish sauce, lime juice, sugar, water, garlic, and chili. Serve alongside the full herb plate: rau ram, mint, perilla, butter lettuce leaves, and cucumber. To eat: place a cake in a lettuce leaf, add herbs and cucumber, fold loosely, dip in the nu?c ch?m. Or eat directly with chopsticks, using the herbs between bites. The cakes must be eaten immediately — they lose their shattering crust within 5 minutes of leaving the oil.',
            tip: 'The lettuce-wrap eating style for ch? hàu chiên giòn is the central Vietnamese approach that makes the fried cake feel lighter and provides the fresh herb contrast that the rich, crispy oyster cake needs. The crispy cake, the fresh lettuce, the herbs, and the bright dipping sauce in each bite is the complete experience the preparation was designed for.',
        },
    ],
};
