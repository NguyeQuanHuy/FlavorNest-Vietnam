...
const recipe: RecipeData = {
    slug: 'chao-dau-xanh',
    title: 'Cháo Ð?u Xanh (Mung Bean Congee)',
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The raw ginger alongside each spoonful is the technique that transforms cháo d?u xanh from plain porridge to something genuinely good. Do not mix it in — take a small amount with each bite of congee.',
        },
    ],
};
