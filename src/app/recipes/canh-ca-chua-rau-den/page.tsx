...
const recipe: RecipeData = {
    ...
    intro: `Canh cá chua rau d?n is the sour fish soup of northern Vietnam — a preparation that is the direct northern counterpart to canh chua cá trê and canh chua cá rô phi of the Mekong Delta, and that demonstrates how differently the two culinary regions approach the same fundamental dish type. Where the Mekong sour fish soup uses tamarind as its primary souring agent, produces a deep orange broth colored by annatto oil and fresh turmeric, and includes the specific rau d?ng herbs of the waterway ecosystem (ngò om, bông súng, b?c hà), the northern version uses the tartness of ripe tomatoes cooked down into the broth as the primary souring agent — sometimes supplemented with a small amount of rice vinegar — produces a clear, lighter broth, and uses rau d?n (amaranth, Amaranthus tricolor) as its vegetable and visual defining element. Rau d?n is an annual leafy vegetable grown in northern Vietnamese gardens through the summer months, with red-veined leaves that release a deep red-purple pigment into the broth during cooking — coloring it in a way that is one of the most visually distinctive of any Vietnamese soup and that is responsible for canh cá chua rau d?n being the most recognizable northern sour soup by sight alone. The fish used in canh cá chua rau d?n is typically whatever is freshest and available — cá rô phi, cá tr?m, cá chép, or cá diêu h?ng (red tilapia) — but the northern cook's approach to the fish in this soup is different from the Mekong approach: the fish sections are added to the broth later and cooked for a shorter time, the broth being built primarily from tomatoes and aromatics rather than from a fish stock base, and the result being lighter and more broth-forward than the richer Mekong canh chua.`,
    ingredientSections: [
        {
            title: 'Fish',
            items: [
                { amount: 500, unit: 'g', name: 'freshwater fish sections', note: 'cá rô phi, cá tr?m c?, cá chép, or any firm-fleshed freshwater fish. Bone-in sections 5cm.' },
        ...
        {
            title: 'Rau d?n — the defining vegetable',
            items: [
                { amount: 300, unit: 'g', name: 'red amaranth leaves (rau d?n d?)', note: 'stems removed, leaves kept whole. The red variety produces the deepest color. Green amaranth can be used — less dramatic visually but same flavor.' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 2, name: 'stalks Vietnamese celery (c?n ta)', note: 'sliced — added at the end for the northern herb finish' },
            ],
        },
        {
    ...
    steps: [
        ...
        {
            title: 'Serve and eat',
            description: 'Ladle the deep reddish-purple soup into bowls. The visual of the finished canh cá chua rau d?n: deep burgundy-purple broth, orange-red tomato wedges, green spring onion and celery, white fish sections, and the golden shallot oil drizzled over the surface. Serve with rau ram, steamed rice, lime, and sliced chili. The flavors: clean, bright sourness from the tomato, the specific mild-bitter note of the amaranth, the savory fish, and the crispy shallot aromatic at the end of each spoonful.',
            tip: 'The mild, pleasant bitterness of the cooked amaranth leaves in canh cá chua rau d?n is the specific flavor note that distinguishes this northern soup from any southern preparation. Cooked amaranth provides a bitter dimension that no Mekong rau d?ng herb produces, and it is this bitterness — light, clean, not unpleasant — that makes the northern version a different eating experience from the southern despite the same basic structure.',
        },
    ],
};
