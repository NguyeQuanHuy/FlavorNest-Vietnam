...
const recipe: RecipeData = {
    ...
    title: 'Cháo Ếch Singapore (Singapore-Style Frog Congee)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tsp', name: 'freshly ground black pepper', note: 'coarsely ground — applied per bowl at the table. This is the defining element of cháo ếch Singapore. The quantity seems too much until you taste it.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The porridge for cháo ếch Singapore should be slightly thicker than standard Vietnamese cháo — the Saigon version sits closer to the original Singapore preparation where the congee is dense and creamy rather than thin and liquid. The consistency should coat a spoon thickly when lifted.',
        },
        {
            ...
            tip: 'The braised frog legs for cháo ếch Singapore are cooked separately from the porridge and placed over the bowl just before serving. This is the Singapore technique — the frog is never cooked directly in the porridge, which would make the congee cloudy and the frog overcooked by service time.',
        },
        {
            title: 'Assemble the bowl — the Singapore way',
            description: 'Ladle the hot porridge into deep bowls — generously, filling to about two-thirds. Place the braised frog legs on top of the porridge with a spoonful of their braising sauce. Drizzle shallot oil over the surface. Scatter crispy fried shallots, sliced spring onion, cilantro, and raw julienned ginger. Then: grind black pepper directly over the bowl — more than seems reasonable. In Singapore and at Saigon\'s cháo ếch shops, the pepper is applied in a quantity that produces a visible dark dusting over the entire surface of the bowl.',
            tip: 'The black pepper quantity for cháo ếch Singapore is not a seasoning addition — it is a primary flavor element. The pepper should be visible on the surface of the bowl. The combination of the delicate, slightly sweet frog porridge and the aggressive black pepper is the specific tension that makes this dish memorable.',
        },
        {
            ...
            tip: 'The raw ginger julienne on cháo ếch Singapore is not a garnish — it is the fresh element that the preparation needs to prevent the richness of the braised legs and the warmth of the black pepper from becoming too heavy. Eat a piece of ginger with every two or three spoonfuls of porridge.',
        },
    ],
};
