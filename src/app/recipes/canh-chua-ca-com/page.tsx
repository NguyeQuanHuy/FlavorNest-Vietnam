...
const recipe: RecipeData = {
    ...
    title: 'Canh Chua Cá Com (Sour Soup with Fresh Anchovies)',
    ...
    intro: `Canh chua cá com is the fresh anchovy sour soup — the lightest, fastest, and most delicate preparation in the canh chua series that has appeared throughout the FlavorNest collection in its Mekong catfish version (canh chua cá trê), its tilapia version (canh chua cá rô phi), and now in this central Vietnamese interpretation with fresh anchovies. The preparation differs from both previous versions in two fundamental ways: the fish itself is the most delicate protein that canh chua can accommodate, cooking through in 2-3 minutes in the simmering broth rather than the 6-10 minutes required for larger fish sections; and the souring agent is primarily tomato rather than tamarind, reflecting the central Vietnamese preference for tomato-sourced acidity in clear soups that also appeared in canh cá chua rau d?n. Fresh anchovies (cá com tuoi) in a sour broth produce a specific result that no other fish achieves in the same preparation: the high oil content of the anchovy enriches the tomato broth with a specific golden-orange color and a marine depth that lighter white fish cannot provide, while the small size of the fish means each mouthful contains a whole anchovy — head, bone, and flesh — that is soft enough to eat completely from the brief cooking in the acid-soured broth. The fresh dill (thì là) used in canh chua cá com is the herb that most clearly marks this as central Vietnamese rather than southern — dill appears in central Vietnamese fish cooking in a way it does not appear in the south, where ngò om, rau ram, and b?c hà define the sour soup herb palette. Fresh dill with sour tomato broth and fresh anchovy is the flavor combination that Vietnamese people from Ðà N?ng, Qu?ng Nam, and Hu? associate with home cooking — the specific aromatic signature of the central coastal kitchen at its most honest.`,
    ingredientSections: [
        {
            title: 'Fresh anchovies',
            items: [
                { amount: 400, unit: 'g', name: 'fresh whole anchovies (cá com tuoi)', note: 'cleaned — guts removed, heads left on. Rinsed and drained. The whole fish is eaten in the soup — head and fine bones softened by the acidic broth.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Heat oil in a small pan. Fry sliced shallots until golden and beginning to crisp. Keep warm. The fried shallot oil for canh chua cá com is poured over the finished soup at the table — the same technique as in all canh chua preparations in the collection. For the anchovy version, the shallot oil quantity is slightly more generous than for other versions, providing the aromatic richness that compensates for the lighter body of the anchovy compared to catfish or tilapia.',
            tip: 'The fried shallot oil as the universal finishing element of all Vietnamese canh chua — from Mekong catfish to northern rau d?n to central cá com — is the thread that connects all regional canh chua preparations into a single dish family. Everything else differs by region; the shallot oil stays constant.',
        },
        {
            title: 'Add fresh dill and serve',
            description: 'Ladle the soup into individual bowls. Place a generous amount of fresh dill directly in each bowl — the dill is never cooked in the broth, only wilted by the heat of the soup as it is poured over. Pour the fried shallot oil over each bowl. Scatter sliced red chili. The finished canh chua cá com: the orange-red tomato broth, the small whole anchovies visible throughout, the bright green dill wilting in the heat, the golden shallot oil on the surface. Serve with lime, steamed rice, and extra chili.',
