...
const recipe: RecipeData = {
    ...
    title: 'Ch? Ram Tôm Ð?t (Central Vietnamese Fried Shrimp Rolls)',
    subtitle: 'Seasoned shrimp paste wrapped in thin rice paper and deep-fried until the wrapper blisters and crackles — the Bình Ð?nh and Phú Yên street food that looks like a spring roll and tastes like nothing else.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '50 min',
    rating: 4.9,
    ...
    intro: `Ch? ram tôm d?t is the fried shrimp roll of the south-central coast — specifically the provinces of Bình Ð?nh, Phú Yên, and Qu?ng Ngãi — where tôm d?t (river or estuary shrimp, small and intensely sweet) are pounded into a paste with pork fat, lemongrass, and aromatics, wrapped in thin rice paper, and deep-fried until the wrapper blisters into hundreds of small golden bubbles. The result is a roll with two distinct textures: a shatteringly crisp, bubbly exterior and a dense, springy shrimp filling that is simultaneously sweet from the shrimp and savory from the fish sauce and garlic. Ch? ram is eaten as a street food snack, as an appetizer at family meals, and as the protein component in bún ch? ram — a noodle bowl unique to the central coast. The name distinguishes it from other fried rolls: ram means the blistered, bubble-covered exterior specific to this frying technique, where the rice paper is moistened slightly before wrapping so that bubbles form during frying rather than a flat crisp surface.`,
    ingredientSections: [
        {
            title: 'Shrimp filling',
            items: [
                { amount: 400, unit: 'g', name: 'fresh shrimp (tôm d?t / small estuary shrimp)', note: 'peeled and deveined. Small shrimp (50-60 per 500g) preferred — sweeter and more aromatic than large shrimp. Frozen small shrimp work.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Remove with a slotted spoon and drain on paper towels in a single layer. The rolls continue cooking from residual heat — serve within 5 minutes. Make the dipping sauce: combine fish sauce, lime juice, sugar, water, garlic, and chili. Serve ch? ram with the dipping sauce, lettuce leaves, and fresh herbs. The eating method: wrap a hot roll in a lettuce leaf with rau ram, dip completely in nu?c ch?m, eat in one or two bites.',
            tip: 'Ch? ram must be eaten immediately. The blistered crust loses its shatter within 10 minutes as it absorbs moisture from the filling. This is beach food, street food — eat it hot or not at all.',
        },
    ],
};
