...
const recipe: RecipeData = {
    slug: 'goi-canh-sen',
    title: 'G?i Cánh Sen (Lotus Petal Salad)',
    subtitle: 'Fresh lotus petals tossed with shrimp, pork, roasted peanuts, Vietnamese herbs, and a light lime-fish sauce dressing — the seasonal Hu? salad eaten only in the weeks the lotus blooms, and one of the most beautiful dishes in Vietnamese cuisine.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '40 min',
    rating: 4.9,
    ...
    intro: `G?i cánh sen is the lotus petal salad of Hu? — a dish so seasonal and so specific to its place of origin that most Vietnamese people outside the imperial city have never eaten it. It exists only in the six to eight weeks each summer when the lotus flowers of H? T?nh Tâm, H? T?nh Tâm, and the lotus ponds of the Hu? citadel are in full bloom, and only if you can reach the petals before they fall. The pink and white petals of the Vietnamese lotus (sen Hu?) are picked in the early morning before the heat opens them fully — petals harvested after 8am have lost the firm, slightly waxy texture that makes them usable in a salad. The petals themselves taste of almost nothing at first — a very faint floral note, a clean vegetal freshness — and this neutrality is precisely their value: they absorb the dressing without contributing sourness, sweetness, or bitterness of their own, while their texture — thin, slightly firm, with a beautiful translucence when held to light — creates a visual and sensory experience that no other salad ingredient can approach. Combined with shrimp, boiled pork, the sharp peppery note of rau ram, roasted peanuts, and a restrained lime-fish sauce dressing, g?i cánh sen is the salad that most clearly demonstrates Hu? cuisine's defining principle: beauty and restraint in equal measure. Outside Vietnam, lotus petals can occasionally be found at Vietnamese specialty markets during summer. Where they are unavailable, the recipe can be made with the closest substitute — very thin-petaled white roses, edible nasturtium, or the inner leaves of endive — but the result is categorically different. G?i cánh sen is a dish worth traveling to Hu? for.`,
    ingredientSections: [
        {
            title: 'Lotus petals',
            items: [
                { amount: 80, unit: 'g', name: 'fresh lotus petals (cánh sen tuoi)', note: 'pink or white Vietnamese lotus — harvested in the morning. Use the inner petals which are more tender. Available at Vietnamese markets in summer. Petals should be firm, not wilted.' },
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'bunch Vietnamese coriander (rau ram)', note: 'leaves only — the essential herb, its peppery heat is the main seasoning note in the salad' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bird\'s eye chili, minced', note: 'optional — Hu? style is mildly spiced to not compete with the petal fragrance' },
            ],
        },
        {
            title: 'To serve',
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Combine fish sauce, lime juice, sugar, and water. Stir until sugar dissolves. Add the minced garlic and chili if using. Taste: the dressing for g?i cánh sen should be noticeably lighter and less acidic than the dressing for g?i xoài or g?i bu?i — the lotus petals are delicate and a sharp dressing overwhelms their fragrance completely. The dressing should taste balanced and soft, not bright and punchy.',
            tip: 'This is the dressing where the restraint of Hu? cuisine is most clear. Where a Saigon g?i dressing might have 3 tablespoons of lime juice, g?i cánh sen needs 2. The lotus petal fragrance is real but faint — protect it.',
        },
        {
        ...
        },
        {
            ...
            description: 'In a wide bowl, combine the sliced pork, shrimp, julienned cucumber, rau ram, mint, and spring onion. Pour the dressing over and toss gently. Add the torn lotus petals last — fold them in with two spoons using a lifting motion, not tossing. The petals should be barely coated with dressing, not saturated. Taste and adjust.',
        ...
        },
        {
            ...
            description: 'Transfer to a serving plate. Top with crushed peanuts and crispy fried shallots, added at the last moment. Drizzle shallot oil lightly over the top. Arrange 4-6 whole lotus petals around the edge of the plate, unfurled and face-up — they function as both garnish and additional scooping vehicle. Serve immediately with prawn crackers and lime wedges. The complete plated g?i cánh sen — white and pink petals, orange-pink shrimp, golden peanuts and shallots, dark green rau ram — is one of the most beautiful plates in Vietnamese cooking.',
