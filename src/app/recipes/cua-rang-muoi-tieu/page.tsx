...
const recipe: RecipeData = {
    ...
    title: 'Cua Rang Muối Tiêu (Salt and Pepper Crab)',
    ...
    intro: `Cua rang muối tiêu is the Vietnamese salt and pepper crab — a preparation that applies the rang muối technique (dry-roasting in seasoned salt in a hot wok) to whole crab sections that have first been deep-fried to crisp the shell. It is the Vietnamese cousin of the Singaporean chilli crab and black pepper crab, but lighter, more aromatic from the lemongrass and kaffir lime leaf, and built on the rang muối technique rather than a sauce base. The result is a crab where the shell, partially crisped by deep-frying and then caramelized further in the dry wok with the salt and aromatics, becomes genuinely edible — the thin sections of the leg and claw shell in particular shatter between the teeth and contribute the concentrated caramelized seasoning to the flesh within. Cua rang muối tiêu is a dish of technique and timing: the oil must be hot enough to genuinely crisp the shell in 3-4 minutes without overcooking the flesh; the wok for the rang muối must be smoking to caramelize the aromatics onto the hot shell immediately; and the entire tossing stage must be completed in under 2 minutes before the shell loses its crispness from the moisture in the aromatics. These variables are manageable with attention and produce, when correctly executed, the most satisfying crab eating experience in Vietnamese seafood cooking — the combination of crispy shell, caramelized aromatic crust, and sweet crab flesh that Vietnamese coastal restaurants serve as their flagship preparation.`,
    ingredientSections: [
        {
            title: 'Crab',
            items: [
                { amount: 1, name: 'large mud crab or blue swimmer crab, 800g-1kg', note: 'live preferred — dispatched and cleaned before cooking. Or 2 smaller crabs at 400-500g each. Mud crab (cua bùn) has the most meat; blue swimmer (cua biển) has thinner shells that crisp more easily.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bowl warm water with lime', note: 'finger bowl — cua rang muối is eaten with hands' },
            ],
        },
    ],
    steps: [
        {
            ...
            tip: 'Cracking the claws slightly before frying is the technique that allows the seasoning to penetrate the claw meat during the rang muối step. A completely sealed claw only receives seasoning on the exterior; a lightly cracked claw allows the caramelized salt and aromatics to enter and season the flesh directly.',
        },
        {
            title: 'Dust and deep-fry the crab pieces',
            description: 'Pat the crab pieces completely dry. Dust lightly with cornstarch — shake off the excess. Heat oil to 180°C in a wok or deep pan. Fry the crab pieces in batches — do not crowd. Fry for 3-4 minutes until the shell turns bright orange-red and the thin sections of the leg shells feel slightly rigid rather than pliable. The crab is not fully cooked at this stage — the rang muối step finishes it. Drain on paper towels.',
            tip: 'The cornstarch dusting is what produces a shell that caramelizes in the rang muối step rather than merely coating in salt. The thin layer of starch on the shell surface provides the texture for the salt and aromatics to adhere to and caramelize onto. Without it the seasoning slides off.',
        },
        {
            title: 'The rang muối — maximum heat, maximum speed',
            ...
            tip: 'The 90-second rang muối is the moment everything comes together or falls apart. Maximum heat throughout — if the wok cools at any point, the salt and aromatics stop caramelizing and the dish loses its character. Prepare everything before the wok goes on the heat. There is no time during the rang muối step to reach for anything.',
        },
        {
