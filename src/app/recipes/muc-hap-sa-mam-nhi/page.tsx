...
const recipe: RecipeData = {
    ...
    title: 'Mực Hấp Sả Mắm Nhĩ Phú Yên (Phú Yên Steamed Squid with Lemongrass and Premium Fish Sauce)',
    subtitle: 'Whole squid steamed over beer and lemongrass for 6-8 minutes until the flesh is silky and barely set — served with the mắm nhĩ and microplane-grated ginger sauce that Phú Yên uses for every premium steamed protein, from lobster to pigeon to frog. The steaming technique that reveals squid at its most honest.',
    ...
    intro: `Mực hấp sả mắm nhĩ Phú Yên is the steamed squid preparation that completes the province's application of its coastal steaming philosophy to every significant protein in its repertoire. The technique — steaming over beer and lemongrass, serving with mắm nhĩ ginger dipping sauce, eating with sesame crackers and raw lá é — has now appeared in the FlavorNest Phú Yên series with crab, lobster, mantis shrimp, pigeon, frog, oysters, and top snails. Applied to squid, it produces the most delicate result in the series: squid flesh at the correct steaming doneness is more silky and more transparently itself than any other protein that Phú Yên steams, because the flesh is so lean and so fine-textured that the steam treatment shows every quality of the raw material without the buffer of fat or bone that protects coarser proteins from technique errors. Good squid steamed correctly tastes intensely, cleanly of the sea; mediocre squid steamed correctly tastes of very little. The preparation is therefore the most demanding in its raw material requirements and the most rewarding when the raw material is right — which, along the Phú Yên coast where the squid is pulled from clean, cold-water fishing grounds and arrives at the market the same morning, it routinely is. The steaming time for squid is 6-8 minutes — longer than the 30-second blanch of gỏi mực tươi because the whole squid tube retains its shape and the steam must penetrate through the entire thickness of the mantle wall to cook the flesh evenly throughout. This 6-8 minute window produces the specific silky-firm texture of correctly steamed whole squid that is specifically different from both the tender chewiness of stir-fried squid and the firmer bite of braised squid kho — a texture that exists only at this cooking method and this time.`,
    ingredientSections: [
        {
            title: 'Squid',
            items: [
                { amount: 600, unit: 'g', name: 'fresh whole squid (mực tươi)', note: 'medium size, 12-15cm body length — cleaned but left whole. Score the body tube lightly in crosshatch at 1cm intervals through the outer skin only.' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The shallots in the steaming bath for mực hấp is the same adaptation as for bồ câu hấp mắm nhĩ and ếch hấp mắm nhĩ — added for squid and birds and frogs but not for crustaceans. The shallot sweetness in the steam provides a gentle background note that complements the specific sweetness of these lighter proteins.',
        },
        {
        ...
        },
        {
            ...
            description: 'Grate fresh ginger on the finest available grater until near-liquid. Combine with mắm nhĩ, fresh lime juice, sugar, warm water, and minced chili. The mắm nhĩ ginger sauce for steamed squid should have slightly more ginger than the versions used for crustaceans — the more delicate squid flesh benefits from a slightly more assertive ginger note. This is the same sauce used throughout the Phú Yên steamed protein series, calibrated here for squid.',
            tip: 'The mắm nhĩ ginger sauce applied to every premium Phú Yên steamed protein — crab, lobster, pigeon, frog, snail, oyster, and now squid — demonstrates its universality more completely with each new application. The sauce works because it provides aromatic complexity and umami depth without competing with the specific character of the protein it accompanies. It frames; it never dominates.',
        },
        {
            title: 'Serve and complete the Phú Yên steamed series',
            description: 'Transfer the steamed squid to a serving plate. Scatter shredded kaffir lime leaves and sliced spring onion. Serve with mắm nhĩ ginger sauce in individual small bowls, sesame crackers, and fresh lá é leaves alongside. Reserve the steaming liquid — strain and serve in small cups alongside as a between-bite broth. To eat: slice the steamed squid body into rings at the table. Place a ring on a sesame cracker with a raw lá é leaf underneath, dip in lime-squeezed mắm nhĩ sauce. The same Phú Yên assembly for the same Phú Yên condiment, applied here to the province\'s most abundant coastal protein.',
            tip: 'The steaming liquid reserved from mực hấp sả mắm nhĩ is, like all the Phú Yên steaming liquids in the series, worth serving as a small alongside broth. Beer, lemongrass, shallot, and the natural drippings from the steamed squid produce a broth that is light, aromatic, and specifically of the coastal kitchen. Nothing from Phú Yên hấp preparations should be discarded.',
        },
    ],
};
