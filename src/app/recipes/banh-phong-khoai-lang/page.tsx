...
const recipe: RecipeData = {
    ...
    title: 'Bánh Ph?ng Khoai Lang Tím (Purple Sweet Potato Crackers)',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 250, unit: 'g', name: 'tapioca starch (b?t nang)', note: 'the primary starch for expansion' },
                { amount: 30, unit: 'g', name: 'glutinous rice flour (b?t n?p)', note: 'for cohesion' },
                { amount: 80, unit: 'ml', name: 'coconut milk (nu?c c?t d?a)', note: 'adds gentle richness and coconut fragrance' },
        ...
        },
        {
            ...
            items: [
                { amount: 4, unit: 'tbsp', name: 'sweet chili sauce (tuong ?t ng?t)', note: 'the sweetness of the sweet chili sauce complements the sweet potato character' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Bánh ph?ng khoai lang tím presented alongside bánh ph?ng tôm (shrimp crackers) on the same plate — the vivid purple alongside the pale gold — is the most visually striking cracker presentation in Vietnamese cooking and one that requires no other decoration to be beautiful. The contrast of the two natural colors is all the visual design the plate needs.',
        },
    ],
};
