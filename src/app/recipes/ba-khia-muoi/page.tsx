...
const recipe: RecipeData = {
    ...
    subtitle: `Ba Khía Mu?i — Cà Mau's three-striped field crab cured raw in salt brine, eaten with lime, garlic, and chili over broken rice.`,
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '72 hrs',
    rating: 4.8,
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 300, unit: 'g', name: `coarse sea salt (mu?i h?t)`, note: `non-iodised — iodised salt discolours the roe and affects flavour` },
        ...
        {
            title: `Dipping sauce (nu?c ch?m ba khía)`,
            items: [
                { amount: 3, unit: 'tbsp', name: `lime juice (nu?c c?t chanh)`, note: `fresh only — bottled lime juice flattens the sauce` },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: `bunch Vietnamese coriander (rau ram)`, note: `essential — cuts the richness of the roe` },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `The correct bite sequence at a Cà Mau table: roe first (eaten neat, or barely touched to the sauce), then body meat with sauce and a leaf of rau ram, then claws last with rice. The roe is the best part — do not dip it heavily or you lose the flavour.`,
        },
        {
