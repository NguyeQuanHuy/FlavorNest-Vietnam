...
const recipe: RecipeData = {
    ...
    ingredientSections: [
        ...
        },
        {
            title: 'Vegetables',
            items: [
                { amount: 150, unit: 'g', name: 'bạc hà taro stems (dọc mùng)', note: 'peeled and cut diagonally into 4cm pieces' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Ladle the soup into bowls or serve from a communal pot. Add bean sprouts raw — they wilt from the broth heat but retain a slight crunch. Place the ngò om and rau răm on individual plates beside each bowl. Each diner adds ngò om directly to their bowl and stirs it in immediately before eating — the contact with the hot sour broth releases the herb\'s specific cumin-rice paddy aroma into the steam that rises from the bowl. This aroma, rising from the bowl into the face of the person eating, is the smell of Mekong Delta canh chua.',
