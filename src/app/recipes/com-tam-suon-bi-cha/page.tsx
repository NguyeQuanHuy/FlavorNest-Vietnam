...
const recipe: RecipeData = {
    ...
    intro:
        'Com T?m Su?n Bì Ch? is a iconic Saigon dish featuring fragrant broken rice served with a smoky grilled pork chop, shredded pork skin, and a savory steamed egg meatloaf.',
ingredientSections: [
    {
        title: 'Broken Rice',
        items: [
