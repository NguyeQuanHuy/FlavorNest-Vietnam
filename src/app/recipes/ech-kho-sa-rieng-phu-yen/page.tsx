...
const recipe: RecipeData = {
    ...
    title: '?ch Kho S? Ri?ng Phú Yên (Phú Yên Frog Braised with Lemongrass and Galangal)',
    subtitle: 'Frog sections caramelized in dark sugar then braised in a clay pot with lemongrass, galangal, m?m nhi, and fresh chili until the sauce reduces to a dark, sticky glaze that clings — the Phú Yên kho that uses the three-aromatic combination specific to the province\'s inland frog cooking.',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 30, unit: 'g', name: 'fresh galangal (ri?ng)', note: 'minced to paste — the defining aromatic for Phú Yên ?ch kho' },
        ...
        },
        {
            ...
            items: [
                { amount: 3, unit: 'tbsp', name: 'm?m nhi (Phú Yên first-press fish sauce)', note: 'the defining seasoning of Phú Yên ?ch kho — more complex and sweeter than standard fish sauce' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The darker caramel for ?ch kho versus the slightly less dark caramel used for cá b?ng kho is a calibration: frog braised for 25-30 minutes needs more caramel color work than fish braised for 40 minutes. The caramel is doing the color work that time cannot do for the shorter-braised frog.',
        },
        {
