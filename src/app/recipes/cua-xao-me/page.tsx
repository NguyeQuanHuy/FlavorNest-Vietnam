    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 3, unit: 'tbsp', name: 'palm sugar (du?ng th?t n?t)', note: 'or brown sugar — palm sugar produces a deeper, more complex sweetness than white sugar' },
    ...
    steps: [
        {
            ...
            tip: 'The claw cracking for cua xào me should be slightly more generous than for rang mu?i — the tamarind sauce needs to penetrate the claw and coat the flesh inside, not just the exterior. One firm crack along the length of each claw creates the access point the sauce needs.',
        },
        {
            ...
            tip: 'The frying step for cua xào me serves a different purpose than for rang mu?i. For rang mu?i the shell must become genuinely crispy; for cua xào me the shell needs only to firm and color — the subsequent sauce toss will add more flavor than crunch.',
        },
        {
