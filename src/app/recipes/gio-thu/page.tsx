...
const recipe: RecipeData = {
    slug: 'gio-thu',
    title: 'Giò Thủ (Vietnamese Head Cheese)',
    subtitle: 'Pig head meat, ears, and tongue simmered until tender, mixed with wood ear mushrooms, glass noodles, and black pepper, then pressed tightly into banana leaf cylinders and chilled until the natural gelatin sets into a dense, sliceable terrine — the essential Tết preparation of northern Vietnam.',
    ...
    intro: `Giò thủ is the Vietnamese head cheese — the preparation that transforms the most underutilized parts of the pig (head meat, ears, tongue, and skin) into one of the most refined cold cuts in Vietnamese cooking. The name giò means sausage or processed meat, and thủ means head: giò from the head. It is made in large quantities in northern Vietnamese households in the week before Tết, shaped into cylinders wrapped in banana leaves and tied tightly with bamboo string, boiled until the natural gelatin in the pig's head has distributed through the mixture, then pressed under heavy weights overnight until the gelatin sets and the cylinder can be unwrapped, sliced, and eaten cold. The resulting slice is firm, glossy from the set gelatin, visibly studded with the dark pieces of wood ear mushroom and glass noodle, and tasting of concentrated pork, black pepper, and the specific earthy note of the wood ear. Giò thủ is not a dish that can be rushed or simplified — the pig's head (or ear, tongue, and skin combination that approximates it) must be cleaned, blanched, simmered, and seasoned carefully at each stage. The banana leaf wrapping is not decorative: it imparts a specific green fragrance to the giò during boiling that is part of its taste. The pressing must be firm enough that the gelatin sets without air pockets. These are the variables of a Tết preparation that Vietnamese grandmothers have managed with complete certainty for generations and that anyone making it for the first time should approach with patience and a willingness to practice. The result — cold slices of giò thủ alongside a bowl of hot phở or with pickled vegetables on the Tết table — is one of the most specific and irreplaceable tastes of Vietnamese New Year.`,
    ingredientSections: [
        {
            title: 'Pork',
            items: [
                ...
                { amount: 500, unit: 'g', name: 'pig tongue (lưỡi heo)', note: 'peeled after blanching — see step 2' },
                { amount: 300, unit: 'g', name: 'pig skin (da heo)', note: 'blanched and cut into thin strips — provides additional gelatin' },
                { amount: 300, unit: 'g', name: 'lean pork shoulder (thịt vai)', note: 'adds substance and meaty flavor to balance the collagen-rich head parts' },
            ],
        },
        {
        ...
        },
        {
            title: 'Mix-ins',
            items: [
                { amount: 40, unit: 'g', name: 'dried wood ear mushrooms (mộc nhĩ)', note: 'soaked 20 minutes, squeezed dry, finely julienned — the visual and textural signature of giò thủ' },
                { amount: 30, unit: 'g', name: 'dried glass noodles (miến)', note: 'soaked 10 minutes, cut into 3cm pieces' },
                { amount: 4, name: 'shallots', note: 'thinly sliced, fried until crispy in oil — stirred into the mixture' },
                { amount: 3, unit: 'tbsp', name: 'fish sauce' },
                { amount: 1, unit: 'tsp', name: 'sugar' },
                { amount: 2, unit: 'tsp', name: 'black pepper', note: 'coarsely ground — giò thủ should taste assertively of black pepper' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 3, unit: 'tbsp', name: 'pickled daikon and carrot (đồ chua)', note: 'the essential accompaniment' },
                { amount: 2, name: 'limes, cut in wedges' },
                { amount: 3, unit: 'tbsp', name: 'soy sauce or nước chấm', note: 'for dipping' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'Tight rolling and tight tying are what produce a giò thủ that slices cleanly rather than crumbling. Each tie should compress the leaf and the mixture inside — if the twine is loose the mixture expands unevenly during boiling and the cross-section looks messy.',
        },
        {
            title: 'Press overnight under heavy weight',
            description: 'Remove the cylinders from the boiling water. While still hot, wrap each cylinder in a cloth and place between two flat boards. Stack heavy weights on top — pots of water, books, anything that can apply sustained even pressure. Press at room temperature for 2 hours, then transfer to the refrigerator still under weight overnight. The pressing forces out any remaining air pockets and compresses the mixture as the gelatin sets. Unwrap the next day — the giò thủ should be firm, cylindrical, and slice cleanly with a sharp knife.',
            tip: 'The pressing is as important as the boiling. Un-pressed giò thủ has air pockets and a loose texture that crumbles when sliced. Pressed giò thủ is dense, holds together completely, and has the characteristic firm, almost waxy cross-section of the authentic product.',
        },
    ],
};
