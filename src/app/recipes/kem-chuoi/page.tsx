...
const recipe: RecipeData = {
    ...
    intro:
        'Kem chu?i is the ice cream of Saigon\'s alleyways — sold from styrofoam boxes by vendors who have been making the same recipe for decades. There is no churning, no special equipment, no eggs. Just ripe bananas blended with sweetened coconut milk, poured into moulds, and frozen. The magic is in the toppings: crushed roasted peanuts and toasted shredded coconut pressed into the surface before the final freeze. Each bite is cold, creamy, sweet, and faintly salty from the peanuts.',
    ingredientSections: [
        {
            title: 'Ice cream base',
            items: [
                { amount: 4, name: 'ripe bananas (chu?i s? preferred)', note: 'the riper the sweeter' },
    ...
    steps: [
        ...
        },
        {
            ...
            description:
                'Mix crushed peanuts and toasted coconut in a shallow bowl. Remove semi-frozen kem chu?i from moulds briefly and roll the surface in the peanut-coconut mixture, pressing gently so it adheres. Return to moulds or lay on a lined tray.',
            tip: 'If using paper cups, tear the cup away at this stage, coat, then re-wrap loosely in cling film before the final freeze.',
        },
        {
            title: 'Final freeze',
            description:
                'Return to freezer for at least 4 more hours, ideally overnight. Serve straight from the freezer — kem chu?i melts quickly in warm weather.',
        },
    ],
};
