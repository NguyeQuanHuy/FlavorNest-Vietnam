...
const recipe: RecipeData = {
    ...
    intro: `Bánh h?i cháo lòng is a traditional Vietnamese breakfast set combining two contrasting textures: delicate woven rice vermicelli (bánh h?i) and a warm, rich pork offal porridge (cháo lòng).

The bánh h?i is soft, airy, and lightly brushed with scallion oil, while the cháo lòng is hearty, aromatic, and made from pork organs simmered until tender. Together, they create a balanced meal — light yet deeply satisfying.
...
Often served in central and southern Vietnam, this dish is commonly enjoyed in the morning with fresh herbs, fried shallots, and dipping fish sauce.`,
    ...
    ingredientSections: [
        {
            title: 'Bánh h?i',
            items: [
                { amount: 400, unit: 'g', name: 'rice vermicelli sheets (bánh h?i)' },
    ...
    steps: [
        ...
        {
            title: 'Prepare bánh h?i',
            description: 'Steam or warm the rice vermicelli sheets. Brush lightly with scallion oil and a pinch of salt.',
        },
        {
            title: 'Assemble and serve',
            description: 'Serve bánh h?i on one plate and hot cháo lòng in a bowl. Add fried shallots, herbs, and dipping fish sauce on the side.',
        },
    ],
};
