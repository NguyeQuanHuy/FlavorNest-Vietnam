...
const recipe: RecipeData = {
    ...
    title: 'Cá Cơm Chiên Giòn Muối Ớt (Crispy Fried Anchovies with Chili Salt)',
    ...
    intro: `Cá cơm chiên giòn muối ớt is the crispy fried anchovy preparation of Vietnamese coastal cooking — a dish that applies the bone-crisping deep-fry technique (the same principle as cá trê chiên sả ớt and chim cút chiên giòn) to the smallest fish in the Vietnamese repertoire, producing a result where the entire anchovy — head, tail, spine, and all bones — becomes genuinely crunchy and edible, and where the combined effect of thirty anchovies eaten bones-and-all in one sitting provides a mineral, intensely savory experience that no other preparation achieves. The bone-eating quality of correctly fried whole anchovies is the preparation's defining pleasure: at 185°C for 3-4 minutes, the small bones of the anchovy (already thin and calcium-rich) dry and crisp completely, producing a crunch that is simultaneously the crunch of the rice flour coating, the crunch of the fried skin, and the crunch of the minerally-flavored bone beneath — three crunches occurring simultaneously in each bite. The salt-chili finish applied after frying follows the same fry-then-toss logic as cá trê chiên sả ớt: the fish is fried first for maximum crispiness, then tossed briefly in caramelized garlic and a muối ớt mixture that adheres to the oily fried surface without softening it. Cá cơm chiên giòn is typically eaten as a nhậu dish — a snack alongside cold beer — or as a side at family meals where its intense flavor and crispy texture provide the specific contrast to the plainer elements of a Vietnamese dinner spread. The kumquat (tắc) dipping option — squeezing a whole small kumquat over a handful of the fried anchovies and eating them together — is the specifically central Vietnamese serving tradition that provides the citrus brightness that balances the intense savory-salty character of the fried fish.`,
    ingredientSections: [
        {
            title: 'Anchovies',
            items: [
                { amount: 400, unit: 'g', name: 'fresh whole anchovies (cá cơm tươi)', note: 'cleaned — guts removed, heads optionally kept (the head is edible when fried). Rinsed and completely dried.' },
        ...
        },
        {
            ...
            items: [
                { amount: 80, unit: 'g', name: 'rice flour (bột gạo)', note: 'produces the shatteringly crispy result' },
                { amount: 20, unit: 'g', name: 'cornstarch (bột bắp)', note: 'extra crispiness' },
        ...
        {
            title: 'Muối ớt finishing mixture',
            items: [
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 8, name: 'kumquats (tắc)', note: 'halved — the traditional central Vietnamese accompaniment for fried anchovies. Squeeze directly over the fish.' },
                { amount: 2, name: 'limes, extra', note: 'if kumquats unavailable' },
                { amount: 1, name: 'bunch Vietnamese coriander (rau răm)' },
                { amount: 4, unit: 'portions', name: 'steamed jasmine rice', note: 'or eat without rice as pure nhậu' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            description: 'Heat oil in a wok. Fry sliced garlic until golden. Add all chilies and fry 15 seconds. Add the fried anchovies. Scatter the muối ớt mixture over the fish while tossing — it adheres to the oily fried surface immediately. Toss for 30-45 seconds total. Remove from heat. The toss must be brief enough that the wok heat and the steam from the garlic do not soften the crispy coating.',
        ...
        },
        {
            ...
            description: 'Transfer to a serving plate in a loose pile — not compacted, which traps steam and softens the coating. Scatter rau răm. Serve with halved kumquats alongside. The eating: pick up 4-5 anchovies at once, squeeze half a kumquat directly over them, eat in one motion — the entire fish, bones included, in two or three bites. The kumquat\'s specific tart-sweet flavor against the intensely salty, crunchy, garlicky anchovy is the combination that makes this preparation specifically central Vietnamese rather than generically fried fish.',
            tip: 'The kumquat rather than lime for cá cơm chiên giòn is the specifically central Vietnamese serving choice that most clearly marks the preparation\'s regional identity. Kumquat\'s higher sugar-to-acid ratio than lime and its specific bitter-sweet skin character produce a different interaction with the salty fried fish than lime\'s sharper, cleaner acidity. If kumquats are unavailable, use calamansi as the closest substitute — not lime, which changes the flavor pairing significantly.',
        },
    ],
};
