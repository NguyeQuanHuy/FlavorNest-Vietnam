...
const recipe: RecipeData = {
    ...
    title: 'Gà Tần Thuốc Bắc (Vietnamese Herbal Chicken Braise)',
    ...
    intro: `Gà tần thuốc bắc is the Vietnamese herbal chicken that sits at the intersection of food and medicine — a small whole chicken slowly braised in a clay pot with a selection of Chinese medicinal herbs and dried fruits that have been used in Vietnamese cooking for centuries. Tần means to braise slowly in a covered vessel with minimal liquid; thuốc bắc means northern medicine, referring to the traditional Chinese medicinal herb tradition that has deeply influenced Vietnamese cooking, particularly in Huế and among the ethnic Chinese communities of Vietnam. The herbs in gà tần thuốc bắc are not decorative: astragalus root (hoàng kỳ) is a tonic herb associated with energy and immune function. Red dates (táo đỏ) add sweetness and are used throughout Vietnamese medicine as a blood tonic. Goji berries (kỷ tử) add color and their specific nutritional character. Longan flesh (long nhãn) contributes sweetness and calm. Lotus seeds (hạt sen) appear for their association with clarity and rest. Together, simmered in the chicken's own juices with ginger and the minimum of water, they produce a broth that is dark amber, slightly sweet, aromatic in a way that is neither herb nor medicine but specifically itself. Gà tần thuốc bắc is made for a sick family member, for a mother who has just given birth, for a father who has been working too hard, for anyone who needs to eat something that will repair rather than merely sustain. It is also simply very delicious, which is perhaps the most important thing about it.`,
    ingredientSections: [
        {
            title: 'Chicken',
            items: [
                { amount: 1, name: 'small whole chicken (800g-1kg)', note: 'ideally a young hen (gà mái tơ) or bantam chicken — the smaller size cooks more evenly in the clay pot and the flavor is more concentrated. A Cornish hen is an excellent substitute.' },
        ...
        },
        {
            ...
            items: [
                { amount: 20, unit: 'g', name: 'astragalus root slices (hoàng kỳ)', note: 'dried, available at Vietnamese or Chinese herbal shops and some Asian grocers' },
                { amount: 8, name: 'red dates (táo đỏ / jujubes)', note: 'dried — pitted or whole. Adds sweetness and color.' },
                { amount: 2, unit: 'tbsp', name: 'goji berries (kỷ tử / wolfberries)', note: 'dried — soaked 10 minutes and drained before adding' },
                { amount: 30, unit: 'g', name: 'dried longan flesh (long nhãn)', note: 'or 8 fresh longan, peeled and pitted' },
                { amount: 50, unit: 'g', name: 'fresh lotus seeds (hạt sen)', note: 'embryo removed. Or dried, soaked 2 hours.' },
                { amount: 3, name: 'slices dong quai root (đương quy)', note: 'optional — a warming tonic herb with a distinctive anise-adjacent aroma. Use sparingly.' },
        ...
        },
        {
            ...
            items: [
                { amount: 400, unit: 'ml', name: 'water', note: 'just enough to come halfway up the chicken — gà tần is a semi-dry braise, not a soup' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'Stuffing some aromatics inside the cavity is what gives gà tần its characteristic fragrance that penetrates the meat fully rather than existing only in the broth. The herbs outside the chicken flavor the liquid; the herbs inside flavor the flesh.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The lowest possible heat for the longest possible time is the principle of tần cooking. High heat produces a cloudy broth and stringy, overcooked chicken. Barely simmering produces a clear, dark amber broth and chicken that is falling-off-the-bone tender.',
        },
        {
