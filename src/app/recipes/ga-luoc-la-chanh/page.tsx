...
const recipe: RecipeData = {
    ...
    title: 'Gà Lu?c Lá Chanh (Vietnamese Poached Chicken with Kaffir Lime Leaf)',
    ...
    ingredientSections: [
        ...
        {
            title: 'Kaffir lime leaf oil (d?u lá chanh)',
            items: [
        ...
        {
            title: 'Mu?i lá chanh (kaffir lime dipping salt)',
            items: [
