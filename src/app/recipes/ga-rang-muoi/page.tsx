...
const recipe: RecipeData = {
    slug: 'ga-rang-muoi',
    title: 'Gà Rang Mu?i (Vietnamese Salt-Roasted Chicken)',
    ...
    intro: `Gà rang mu?i — salt-roasted chicken — is the Vietnamese technique where salt is not just a seasoning but the cooking medium itself. Coarse salt is heated in a wok until extremely hot, then chicken pieces are buried in and roasted in the hot salt, covered, until the skin is crispy and the meat is cooked through from the radiant heat of the salt surrounding it on all sides. The aromatics — lemongrass, kaffir lime leaves, fresh chili — are mixed into the hot salt before the chicken goes in, so that they perfume the steam created inside the salt crust during cooking. The result is chicken with a deeply savory, fragrant exterior — the salt has drawn moisture from the skin and replaced it with the concentrated aromatic character of the herbs — and a juicy, tender interior cooked gently from all sides rather than from one hot surface. Gà rang mu?i is associated with the central and southern Vietnamese restaurant tradition but made easily at home with a large wok, coarse salt, and patience. The salt is reusable — after cooking, it is poured out, cooled, and stored for the next batch. Vietnamese households that cook gà rang mu?i regularly keep a dedicated container of aromatic salt that improves with each use as the herb oils accumulate.`,
    ingredientSections: [
        {
            title: 'Chicken',
            items: [
        ...
        {
            title: 'Dipping sauce (mu?i tiêu chanh)',
            items: [
