...
const recipe: RecipeData = {
    slug: 'muc-chien-mam',
    title: 'M?c Chiên M?m (Crispy Squid in Fish Sauce Caramel)',
    ...
    intro: `M?c chiên m?m is the Vietnamese squid preparation that most clearly shows the influence of the fish sauce caramel technique — the same method used in gà chiên nu?c m?m, applied to squid with results that are, if anything, even more spectacular. The squid is first fried in a light rice flour batter that produces an extremely crispy exterior, then immediately tossed in a hot fish sauce caramel that clings to the crust and caramelizes further from the residual heat of the freshly fried squid. The timing of this tossing — the squid must be hot when it hits the glaze — is everything. Cold fried squid absorbs the glaze instead of being coated by it, producing a soggy result. Hot squid coated in hot glaze produces a lacquered surface that stays crisp for several minutes. M?c chiên m?m is beer food, shared-plate food, the dish that a Vietnamese restaurant table orders first and finishes before the mains arrive. The fish sauce caramel takes 4 minutes to make. The squid fries in 3. The entire dish is done in under 40 minutes, most of which is preparation.`,
    ingredientSections: [
        {
            title: 'Squid and batter',
            items: [
                { amount: 600, unit: 'g', name: 'fresh squid (m?c)', note: 'cleaned and cut into rings 1.5cm wide, tentacles kept whole. Medium squid (15-18cm body) is ideal.' },
                { amount: 80, unit: 'g', name: 'rice flour (b?t g?o)', note: 'produces crispier result than wheat flour' },
                { amount: 30, unit: 'g', name: 'cornstarch (b?t b?p)', note: 'mixed with rice flour — the combination is the crispiest coating possible' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Transfer to a plate in a single layer — never stack or the steam softens the crust. Scatter spring onion and extra chili. Serve with lime wedges. M?c chiên m?m is at its best in the first 10 minutes — the crust remains crisp, the glaze is still sticky and warm. This is beer food: serve with cold lager and eat immediately.',
