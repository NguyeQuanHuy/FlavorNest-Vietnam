...
const recipe: RecipeData = {
    slug: 'tre-binh-dinh',
    title: `Bình Ð?nh Fermented Pork Ear Roll`,
    subtitle: `Tré Bình Ð?nh — Spiced pork ear and skin fermented in galangal, toasted rice powder, and garlic, wrapped in banana leaf and cured 3 days.`,
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '96 hrs',
    rating: 4.8,
    ...
    intro: `Tré is Bình Ð?nh's most distinctive preserved meat — a fermented roll made from shredded pork ear, pork skin, and lean pork, spiced with galangal (ri?ng), toasted rice powder, garlic, and chili, then wrapped tightly in a double layer of banana leaf and left to cure at room temperature for three to four days. The result is something between a salami and a pickle: firm, slightly sour from lactic acid fermentation, intensely aromatic with galangal, and with a texture built from the contrast between the gelatinous skin, the cartilage of the ear, and the lean meat.\n\nTré is Central Vietnamese food in the purest sense — a preservation technique born from the need to use the entire pig, developed in a region with a hot climate that demanded curing rather than refrigeration. Every family in Quy Nhon and the surrounding districts has its own ratio. The galangal quantity is the variable that divides households: some use enough to make the roll visibly yellow-orange, others use a more restrained hand. This recipe uses the traditional Bình Ð?nh ratio — prominent galangal, not overwhelming.\n\nTré is eaten at room temperature as part of a larger meal, sliced through the banana leaf and served with rice crackers (bánh tráng), raw vegetables, and a dipping sauce. It appears on every T?t table in Bình Ð?nh and is the defining dish of the province's gio ch? (charcuterie) tradition alongside nem ch? Bình Ð?nh. Outside Vietnam, it is almost entirely undocumented in English.`,
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 200, unit: 'g', name: `lean pork (th?t n?c)`, note: `boiled 15 min, cooled and hand-shredded along the grain` },
            ],
        },
        {
            title: `Spice and curing mix`,
            items: [
                { amount: 60, unit: 'g', name: `fresh galangal (ri?ng tuoi)`, note: `peeled and minced to a fine paste — galangal, not ginger; the two are not interchangeable` },
                { amount: 3, unit: 'tbsp', name: `toasted rice powder (thính g?o)`, note: `dry-toast raw rice in a pan until golden, grind coarse — this is the fermentation medium` },
                { amount: 8, name: `garlic cloves, minced to paste` },
                { amount: 2, unit: 'tsp', name: `chili flakes (?t b?t)` },
                { amount: 1.5, unit: 'tbsp', name: `fish sauce (nu?c m?m)` },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: `If fresh galangal is unavailable in Germany — check Vietnamese or Thai grocery stores, or Asien-Markt chains — use 2 tbsp galangal powder (b?t ri?ng) as a substitute. The flavour will be less vivid but acceptable. Ginger is not a substitute; its flavour profile produces a completely different and incorrect result.`,
        },
        {
        ...
        },
        {
            ...
            tip: `The tightness of the wrap is critical. Loose wrapping allows air in, which causes mould rather than lactic fermentation. Press the filling firmly as you roll and tie the twine snugly. Traditional Bình Ð?nh tré makers press the rolls under a heavy board for the first hour to compress the filling.`,
        },
        {
        ...
        {
            title: `Serve and eat`,
            description: `Slice the roll through the banana leaf with a sharp knife — the leaf holds the shape during cutting. Unwrap individual slices at the table. Arrange slices on a plate alongside rice crackers, butter lettuce, and rau ram. Make the dipping sauce by combining fish sauce, lime juice, sugar, garlic, and chili until sugar dissolves. In Bình Ð?nh, tré is eaten by wrapping a slice in lettuce with rau ram and a piece of broken rice cracker, then dipping the entire wrap in the sauce. The cracker provides crunch; the herb cuts the richness of the pork skin; the sauce balances the fermented sourness.`,
