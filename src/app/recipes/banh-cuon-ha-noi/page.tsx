...
const recipe: RecipeData = {
    ...
    title: 'Bánh Cu?n Hà N?i (Hanoi Steamed Rice Rolls)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 300, unit: 'g', name: 'minced pork (th?t heo b?m)', note: '20% fat content — lean pork makes a dry filling' },
                { amount: 30, unit: 'g', name: 'dried wood ear mushrooms (m?c nhi)', note: 'soaked 20 minutes until fully rehydrated, squeezed dry, finely chopped — their crunch is the point' },
        ...
        {
            title: 'Dipping broth (nu?c ch?m bánh cu?n)',
            items: [
                { amount: 4, unit: 'tbsp', name: 'fish sauce' },
                { amount: 2, unit: 'tbsp', name: 'rice vinegar', note: 'the Hanoi bánh cu?n addition — gives the dipping broth a cleaner edge than lime alone' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch rau kinh gi?i (Vietnamese balm / lemon balm)', note: 'the Hanoi-specific herb for bánh cu?n — slightly citrusy, minty. Substitute: perilla and mint combined.' },
                { amount: 200, unit: 'g', name: 'ch? l?a (Vietnamese steamed pork roll)', note: 'thinly sliced — served alongside in the traditional Hanoi version' },
            ],
        },
    ],
    steps: [
        {
            ...
            tip: 'Using the soaking water in the batter is the traditional northern technique that adds a faint natural sourness to the sheets — the slight fermentation of the overnight soak carries through. A bánh cu?n made with fresh water only tastes different, flatter. Do not discard the soaking water.',
        },
        {
        ...
        },
        {
            ...
            description: 'Place the sheet on an oiled wooden board or plate. Spoon a line of filling along the center of the lower third. Fold the bottom edge up over the filling, then roll forward into a cylinder. Slice into 3-4 pieces. Arrange on a plate. Drizzle warm shallot oil generously over the rolls. Top with crispy fried shallots. Serve with dipping broth in individual bowls, cucumber slices, bean sprouts, rau kinh gi?i, and sliced ch? l?a alongside.',
            tip: 'Rolls should be served immediately as they are made — bánh cu?n left to sit dries out and the sheets become tough. The traditional street vendor serves each roll the moment it comes off the cloth. At home, serve in rounds of 4-6 rolls, eat them, then make the next round.',
        },
    ],
};
