...
const recipe: RecipeData = {
    ...
    title: 'Tôm Sú Nu?ng Mu?i ?t Sông C?u (Sông C?u Black Tiger Prawns Grilled with Chili Salt)',
    subtitle: 'Large black tiger prawns from the Sông C?u lagoon coated in a chili-salt paste and grilled over hardwood charcoal until the shells char and the paste caramelizes — served with the mu?i lá é dipping salt that is specific to Phú Yên and available nowhere else.',
    ...
    intro: `Tôm sú nu?ng mu?i ?t Sông C?u is the grilled prawn preparation that defines the seafood eating of Sông C?u town — the fishing port at the northern end of Phú Yên province where the tôm sú (black tiger prawn, Penaeus monodon) are farmed in the protected waters of Cù Mông lagoon and the Xuân Ðài bay, producing prawns of exceptional size and sweetness. Sông C?u tôm sú are a specific product: the combination of the lagoon's water conditions — warm, with specific mineral content from the surrounding hills — and the traditional farming practices of the Sông C?u fisher families produces prawns that are notably sweeter and have a firmer texture than tiger prawns from other growing regions. They are sold at the morning market in Sông C?u from 5am, when the boats come in, and the restaurants along the waterfront cook them in the preparation that shows them most clearly: the charcoal grill with the chili-salt paste that caramelizes onto the shell and, through the shell, perfumes the flesh. The mu?i lá é that accompanies this dish is the distinguishing element that places it specifically in Phú Yên: the pounded salt of litsea cubeba leaves that appears throughout the province's cooking, from gà h?p lá é to gà nu?ng m?i to this prawn preparation. Its specific citrus-pepper-wild fragrance against the sweet caramelized prawn and the saltiness of the sea is the combination that Sông C?u seafood is eaten with, and that no other dipping preparation replicates.`,
    ingredientSections: [
        {
            title: 'Prawns',
            items: [
                { amount: 800, unit: 'g', name: 'large black tiger prawns (tôm sú c? l?n)', note: 'heads on, shells on. 8-12 count per 500g — large enough that the flesh inside has substance after the shell chars. Sông C?u prawns if available; any large fresh tiger prawns otherwise.' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 4, name: 'bird\'s eye chilies', note: 'minced — Sông C?u preparation is spicier than most coastal versions' },
        ...
        },
        {
            ...
            items: [
                { amount: 20, unit: 'g', name: 'fresh lá é leaves (litsea cubeba)', note: 'the defining dipping salt of Phú Yên. Substitute if unavailable: 6 kaffir lime leaves + 6 rau ram leaves pounded with the salt.' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 1, name: 'bunch rau ram', note: 'leaves only — eaten between prawns' },
    ...
    steps: [
        {
            ...
            tip: 'The scissors cut along the back is the preparation technique specific to nu?ng mu?i ?t — it allows the paste to season the flesh through the opening while the shell remains intact to protect and concentrate heat during grilling. Prawns prepared this way are more evenly seasoned than whole uncut prawns.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The mu?i lá é for tôm sú is pounded slightly coarser than for chicken — the texture contrast of slightly grainy salt against the smooth prawn flesh is part of the eating experience. Do not pound to a completely uniform paste.',
        },
        {
            title: 'Build and heat the charcoal fire',
            description: 'Light hardwood charcoal and wait until fully ashed over — 25-30 minutes. The fire for tôm sú should be medium-hot: intense enough to char the shell and caramelize the paste in 4-5 minutes per side, not so hot that the paste burns before the flesh cooks. The Sông C?u method: grill the prawns close to the coals — 10-12cm — for fast charring with good heat penetration into the thick flesh.',
        ...
        {
            title: 'Serve and eat the Sông C?u way',
            description: 'Transfer immediately to a plate. Scatter spring onion and extra lá é leaves. Serve with the mu?i lá é in individual plates, lime wedges for squeezing, rau ram, and sesame crackers. The Sông C?u eating method: squeeze lime over the mu?i lá é. Pick up a prawn, peel the shell (it comes away easily after grilling), eat the flesh dipped in the mu?i lá é with a leaf of rau ram. The charred paste clinging to the inside of the shell is sucked off before discarding. Eat quickly while hot.',
