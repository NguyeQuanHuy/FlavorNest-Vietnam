...
const recipe: RecipeData = {
    ...
    subtitle: 'G?i xoài râu b?ch tu?c — dai giòn, chua cay, tuoi mát, d?y cá tính.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '35 min',
    rating: 4.9,
    ...
    ingredientSections: [
        {
            title: 'B?ch tu?c',
            items: [
                { amount: 400, unit: 'g', name: 'fresh octopus tentacles (râu b?ch tu?c)', note: 'cleaned; or use whole small octopus cut into pieces' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 20, unit: 'g', name: 'Vietnamese coriander (rau ram)', note: 'leaves only' },
