...
const recipe: RecipeData = {
    ...
    subtitle: 'Lươn xào lăn — thơm nghệ sả, đậm đà, dai ngọt.',
    ...
    ingredientSections: [
        {
            title: 'Lươn',
            items: [
                { amount: 600, unit: 'g', name: 'fresh eel (lươn)', note: 'cleaned, gutted, cut into 5cm pieces — ask the fishmonger to do this; or use frozen eel, fully thawed and patted dry' },
