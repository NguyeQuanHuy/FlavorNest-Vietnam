...
const recipe: RecipeData = {
    ...
    title: '?ch H?p G?ng Hành (Steamed Frog with Ginger and Spring Onion)',
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The smoking oil is the temperature that produces the sizzle-and-bloom of the aromatics in the signature moment of this preparation. Oil that is merely hot produces a muted, flat response from the ginger and spring onion. Oil at 210°C produces the dramatic sizzle and the immediate release of volatile oils that fills the room with the specific h?p g?ng hành fragrance.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The sauce pooled in the steaming plate — a combination of the Shaoxing wine, the frog juices, the dressing sauce, and the hot oil that has collected — is the most complex liquid in the preparation. Spoon it over rice between every piece of frog. At the end, use rice to clean the plate of this sauce. Nothing from ?ch h?p g?ng hành should be wasted.',
        },
    ],
};
