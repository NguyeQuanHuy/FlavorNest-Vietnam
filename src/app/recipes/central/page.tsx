...
export default function CentralCuisinePage() {
    ...
    return (
        <main style={{ minHeight: '100vh', background: '#FAFAF7', fontFamily: "'DM Sans', system-ui, sans-serif", color: '#2D1A0E' }}>
            ...
            {/* ── HERO ── */}
            <section style={{ background: 'linear-gradient(135deg, #FEF3E2 0%, #FDEAC8 55%, #F5EDE3 100%)', padding: '64px 24px 32px', position: 'relative', overflow: 'hidden', maxWidth: 1200, margin: '32px auto', borderRadius: 32 }}>
