...
const recipe: RecipeData = {
    slug: 'banh-can',
    title: 'Bánh Can (Vietnamese Mini Rice Cakes in Clay Molds)',
    ...
    intro: `Bánh can is the mini rice cake of Phan Rang — the capital of Ninh Thu?n province on the south-central coast, where the dish originated with the Cham people before spreading to Ðà L?t, Nha Trang, and Phan Thi?t, each city developing its own variation. The cakes are cooked in a specific piece of equipment: a heavy clay tray with round indentations, sitting over charcoal, each hole filled with rice batter and covered with a clay lid until the bottom crisps against the hot clay while the top steams to a soft, almost custardy finish. That dual texture — crisp base, tender center — is the entire identity of bánh can, and it is why the dish is often confused with but is fundamentally different from bánh kh?t: bánh kh?t is fried in oil and fully crispy; bánh can is cooked dry on clay and half-steamed. The batter is pure rice — soaked overnight and traditionally ground fresh, with a portion of cooked rice blended in, which is the secret to the airy interior. The toppings go on while the batter is still wet: a quail egg cracked into the center, a shrimp, a piece of squid, or nothing at all for the original plain version. The cakes are pried out in pairs, sandwiched together, and served swimming in spring onion oil with a bowl of diluted fish sauce, green mango, and — in the Phan Rang style — a side of xíu m?i meatballs or braised fish in the dipping bowl. Without the clay mold, a Dutch aebleskiver pan or Japanese takoyaki pan over low heat is the accepted home substitute.`,
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 150, unit: 'g', name: 'cooked rice (com ngu?i)', note: 'day-old cooked rice — the secret ingredient. Blended into the batter, it creates the airy, soft interior that rice flour alone cannot.' },
        ...
        },
        {
            title: 'Toppings',
            items: [
                { amount: 20, name: 'quail eggs (tr?ng cút)', note: 'the most popular topping — one cracked into each cake' },
        ...
        {
            title: 'Dipping sauce (nu?c m?m pha)',
            items: [
                { amount: 4, unit: 'tbsp', name: 'fish sauce' },
                { amount: 4, unit: 'tbsp', name: 'fresh lime juice' },
                { amount: 3, unit: 'tbsp', name: 'sugar' },
                { amount: 8, unit: 'tbsp', name: 'water', note: 'bánh can sauce is more diluted than standard nu?c ch?m — the cakes are dunked entirely, almost like a soup' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch fresh herbs', note: 'rau ram, mint, lettuce' },
                { amount: 50, unit: 'g', name: 'roasted peanuts', note: 'crushed — optional, Ðà L?t style' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'The cooked rice in the batter is the technique that separates real bánh can from rice-flour imitations. The pre-gelatinized starch creates steam pockets during cooking, producing the airy, soft center. Without it the cakes are dense and gummy.',
        },
        {
        ...
        },
        {
            ...
            description: 'Place the clay bánh can mold — or a takoyaki/aebleskiver pan — over medium-low heat and let it heat thoroughly for 5-10 minutes. The clay (or cast iron) must be evenly and deeply heated before the first batter goes in. Brush each indentation very lightly with oil — bánh can is traditionally cooked nearly dry; the crispness comes from the hot clay, not from frying. Test with a drop of batter: it should set within seconds with a gentle sizzle.',
        ...
        },
        {
            ...
            description: 'Loosen each cake with a thin spatula or the traditional metal pry tool and lift out. The Phan Rang serving style: press two cakes together face-to-face into a sandwich, place in a bowl, and spoon scallion oil generously over them. Stir the julienned green mango into the dipping sauce. Each diner takes a pair of cakes, dunks it entirely into their bowl of diluted fish sauce, and eats it dripping. Bánh can is eaten continuously as the cakes come off the mold — the cook eats last.',
            tip: 'Bánh can must be eaten within minutes — the crisp base softens fast under the scallion oil. This is why the dish is always cooked at the table or eaten standing at the vendor cart. Cook in rounds and serve each round immediately rather than accumulating a pile.',
        },
    ],
};
