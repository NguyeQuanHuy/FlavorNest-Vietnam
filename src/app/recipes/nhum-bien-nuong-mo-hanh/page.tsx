...
const recipe: RecipeData = {
    ...
    intro: `Nhum biển (sea urchin, Diadema setosum and Tripneustes gratilla) is the most prized shellfish of the south-central Vietnamese coast — harvested by free divers in the rocky reef zones around Phú Quốc, Côn Đảo, Bình Định, and most abundantly around the Lý Sơn island group off Quảng Ngãi, where the urchin harvest defines the island economy from March to August each year.\n\nNướng mỡ hành — grilled with spring onion oil — is the preparation that lets the urchin speak most directly. The urchin is opened at the table or at the grill, the interior rinsed briefly of any dark matter, and placed spine-side down on the charcoal grate. As the shell heats, the natural brine inside the urchin begins to simmer, gently poaching the orange roe (gonads) in their own liquor. At the moment the brine is visibly bubbling, hot mỡ hành is poured directly into the shell — the sizzle is immediate, the spring onion oil infuses the roe and the brine, and the entire shell becomes a self-contained cooking vessel delivering one of the most concentrated ocean flavours in Vietnamese cuisine.\n\nThe roe is eaten directly from the shell with a small spoon, or scooped onto a piece of grilled rice cracker. Nothing else is needed. On Lý Sơn island, nhum biển is eaten at the water's edge by the fishermen who dive for it, still wet from the sea.`,
    ingredientSections: [
        {
            title: `Sea urchin`,
            items: [
