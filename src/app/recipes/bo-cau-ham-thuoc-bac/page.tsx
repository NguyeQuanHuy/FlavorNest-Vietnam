...
const recipe: RecipeData = {
    ...
    title: 'B? Câu H?m Thu?c B?c (Pigeon Braised with Chinese Medicinal Herbs)',
    ...
    intro: `B? câu h?m thu?c b?c is the pigeon braise that Vietnamese-Chinese families make when someone in the household needs strengthening — after illness, after childbirth, during examination periods, or simply because the weather has turned cold and the body is asking for something with more depth than ordinary food provides. Thu?c b?c literally means northern medicine — the dried medicinal herbs, roots, and fruits of the Chinese pharmacopoeia that appear in Vietnamese cooking as much as in Vietnamese medicine, the line between food and medicine being less defined in this tradition than in Western cooking. The specific herbs used in b? câu h?m vary by household and by the specific tonic purpose — the version here uses the most accessible and most universally appreciated combination: goji berries (k? t?) for their sweetness and their antioxidant reputation; dried red dates (táo d?) for their specific honeyed sweetness and calming quality; dried longan flesh (long nhãn) for its mild sweetness and the specific depth it adds to braising liquids; fresh lotus seeds (h?t sen) for their starchiness and their gentle bitterness that balances the sweetness of the other herbs; and Shaoxing wine, which is not technically a herb but is as essential to the tonic character of the braise as any dried ingredient. The pigeon is the protein of choice for tonic cooking in both Vietnamese and Chinese traditions because pigeon meat is richer in protein and iron than chicken, has a specific dense, dark quality that chicken lacks, and produces a broth when braised that is darker and more complex than any chicken braise of equivalent simplicity. One pigeon per person is the serving size — not because the pigeon is large (it is not) but because the whole bird, eaten piece by piece over the course of the meal with the tonic broth poured over rice, constitutes a complete and deeply satisfying experience.`,
    ingredientSections: [
        {
            title: 'Pigeon',
            items: [
                { amount: 2, name: 'whole pigeons (b? câu)', note: 'cleaned — about 400-500g each. Available at Vietnamese and Chinese markets. Squab (young pigeon) preferred — more tender and milder than older birds.' },
            ],
        },
        {
            title: 'Thu?c b?c (medicinal herbs)',
            items: [
                { amount: 3, unit: 'tbsp', name: 'goji berries (k? t?)', note: 'rinsed briefly' },
                { amount: 8, name: 'dried red dates (táo d?)', note: 'pitted or left whole — the pit can remain but pitting makes eating easier' },
                { amount: 20, unit: 'g', name: 'dried longan flesh (long nhãn)', note: 'adds the specific tonic sweetness' },
                { amount: 80, unit: 'g', name: 'fresh or dried lotus seeds (h?t sen)', note: 'embryo removed if using fresh. Dried: soaked 2 hours.' },
        ...
        },
        {
            ...
            items: [
                { amount: 100, unit: 'ml', name: 'Shaoxing wine (ru?u Thi?u Hung)', note: 'drinking-grade, not salted cooking wine' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The searing step after blanching is what distinguishes a restaurant-quality b? câu h?m from a home version that merely braises without searing. The caramelized skin gives the broth a richer color and a roasted depth that transforms the tonic broth from clean and sweet to complex and warming.',
        },
        {
        ...
        },
        {
            ...
            tip: 'Serving the pigeon whole rather than pre-portioned is the traditional and correct presentation for b? câu h?m thu?c b?c. The whole bird in the bowl is both more visually striking and more practical — the diner pulls pieces at their own pace, keeping the uneaten portions in the warm broth until ready.',
        },
    ],
};
