...
const recipe: RecipeData = {
    ...
    title: 'Giò Heo Hầm Măng Chua (Pork Hock Braised with Sour Bamboo Shoots)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                { amount: 400, unit: 'g', name: 'sour fermented bamboo shoots (măng chua)', note: 'available at Vietnamese grocery stores in jars or vacuum packs. Rinse once under cold water. Do not squeeze out all the sour liquid — some of the fermented character should remain. If unavailable: combine 300g canned bamboo shoots with 3 tbsp rice vinegar and leave 30 minutes. Different flavor but similar acidity.' },
            ],
        },
        {
    ...
    steps: [
        ...
        {
            title: 'Layer the măng chua and return the hock',
        ...
        },
        {
            ...
            tip: 'The sealed lid for the full cooking time is the principle of hầm cooking — the steam cannot escape and continuously bastes the upper portion of the hock while the lower portion braises in the liquid. Opening the lid even once disrupts this environment significantly and extends the cooking time.',
        },
        {
        ...
        },
        {
            ...
            tip: 'The braising liquid poured over rice is where the full complexity of giò heo hầm măng chua reveals itself — the lactic sourness of the bamboo, the pork gelatin, the lemongrass oil — all concentrated and absorbed into plain rice. Serve the liquid as generously as the meat.',
        },
    ],
};
