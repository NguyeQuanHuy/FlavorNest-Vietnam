...
const recipe: RecipeData = {
    ...
    subtitle:
        'Bánh Canh H? Phú Yên — thick chewy rice noodles in a clear pork and dried anchovy broth, finished with a generous handful of fresh garlic chives.',
    category: 'MAIN COURSE',
    difficulty: 'Medium',
    totalTime: '1 hr 30 min',
    rating: 4.9,
    baseServings: 4,
    heroImage: '/images/recipes/banh-canh-he.jpg',
    intro:
        'Bánh canh h? is the breakfast of Phú Yên, a fishing province on Vietnam\'s south-central coast. Unlike the more famous bánh canh cua of Saigon or bánh canh Tr?ng Bàng of Tây Ninh, the Phú Yên version is defined by two humble ingredients: dried anchovies (cá com khô) that lend the broth a whisper of the sea, and Vietnamese garlic chives (h?) sliced raw on top for a bright, pungent finish. Every Sunday morning my mother would start the broth before sunrise — pork bones, a handful of dried anchovies, and patience. By the time my siblings and I woke up, the kitchen smelled of the sea. She always said: "The chives go in last. Never cook them. They should still be alive when you taste them."',
    ingredientSections: [
        {
            title: 'For the broth',
            items: [
                { amount: 500, unit: 'g', name: 'pork neck bones', note: 'ask butcher for split bones' },
                { amount: 30, unit: 'g', name: 'dried anchovies (cá com khô)', note: 'small ones, heads removed' },
                ...
                { amount: 2, unit: 'tbsp', name: 'fish sauce', note: 'Phú Qu?c preferred' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 200, unit: 'g', name: 'fish cake (ch? cá)', note: 'sliced thin' },
        ...
        },
        {
            title: 'To finish',
            items: [
                { amount: 1, name: 'large bunch garlic chives (h?)', note: 'cut in 3cm lengths, raw' },
