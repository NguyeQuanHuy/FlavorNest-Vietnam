...
const recipe: RecipeData = {
    ...
    subtitle: 'The Mekong Delta sour soup built on tamarind broth with catfish, b?c hà taro stems, bean sprouts, tomato, pineapple, and the specific rau d?ng herbs of the delta — ngò om, rau ram, and bông súng water lily stems — that exist in this soup and nowhere else in Vietnamese cooking.',
    ...
    ingredientSections: [
        ...
        {
            title: 'Mekong rau d?ng vegetables',
            items: [
                { amount: 150, unit: 'g', name: 'b?c hà taro stems (d?c mùng)', note: 'peeled, cut diagonally into 4cm pieces. The spongy stem absorbs the sour broth and becomes the most satisfying textural element of the soup.' },
        ...
        {
            title: 'Essential rau d?ng herbs — non-negotiable',
            items: [
    ...
    steps: [
        ...
        {
            title: 'Add catfish and b?c hà',
            description: 'Add the catfish sections to the simmering sour broth. The catfish should be added to already-simmering broth, not to cold water — the immediate contact with hot acidic broth firms the exterior quickly and keeps the flesh in sections rather than breaking apart. Add the b?c hà taro stem pieces at the same time — they need the same cooking time as the catfish. Simmer for 8-10 minutes.',
            tip: 'The b?c hà taro stem absorbs the sour broth through its spongy interior structure during the 8-10 minute simmer, becoming saturated with the tamarind-pineapple-fish-sauce flavor from the inside out. A b?c hà piece bitten through in correctly made canh chua releases sour broth from its interior — this is the specific texture that makes it the most satisfying vegetable element of the soup.',
        },
        {
            title: 'Add bông súng and tomato',
            description: 'In the last 5 minutes, add the water lily stems (bông súng) and tomato wedges. Water lily stems need less cooking than b?c hà — they should retain a slight crunch when the soup is served. The tomatoes break down slightly into the broth during the final 5 minutes and add their color and secondary acidity. Taste the broth — adjust with fish sauce for salt, sugar for balance, or additional tamarind liquid for more sourness.',
            tip: 'The sequential addition of vegetables — b?c hà at the beginning, bông súng and tomato in the last 5 minutes, bean sprouts and herbs added raw at service — produces a soup where each vegetable is at its optimal texture simultaneously. A soup where all vegetables go in together produces some that are overcooked and some that are undercooked.',
        },
        {
        ...
        {
            title: 'Serve with raw rau d?ng — the correct way',
            description: 'Ladle the soup into a large communal pot or individual bowls. Add bean sprouts raw — they wilt from the soup heat in seconds and provide the crunch that the cooked vegetables do not. Place the ngò om, rau ram, and sliced spring onion on a herb plate alongside — each diner adds their own herbs directly to the bowl. Drizzle the fried garlic oil over the surface. Serve with steamed rice and sliced chili.',
