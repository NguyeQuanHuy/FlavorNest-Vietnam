...
const recipe: RecipeData = {
    ...
    intro: `Bánh canh bò Tuy Hòa is the beef noodle soup that Phú Yên's provincial capital has made its own — a preparation that exists nowhere else in quite this form, built from the intersection of thick tapioca noodles (bánh canh) and a beef bone broth that owes something to ph? in its aromatic spicing but is lighter, cleaner, and more specifically central Vietnamese in character. The broth is the foundation: beef bones simmered for hours with charred onion and ginger in the ph? tradition, but with a restrained hand on the spices — one cinnamon stick, two star anise, a piece of cardamom — so that the result is fragrant without being heavy. The toppings are what distinguish the Tuy Hòa version from similar soups elsewhere: braised beef brisket (bò b?p) that has been simmered separately in the broth until it slices cleanly and cleanly; thin slices of raw beef (bò tái) that cook in the hot broth in the bowl; and the m? hành — the spring onion oil that Tuy Hòa cooks apply in more generous quantities than anywhere else in Vietnam, so that the surface of each bowl is fragrant, golden, and slightly glossy. Bánh canh bò Tuy Hòa is a morning bowl, eaten at the small shops on Tr?n Hung Ð?o and Lê Du?n streets before 9am, from tables that are already occupied at 6:30am by people who have been eating here their entire lives. It is not a bowl that exists in the food media canon yet. This recipe is its first documentation in English.`,
    ingredientSections: [
        {
            title: 'Beef bone broth',
            items: [
                { amount: 1, unit: 'kg', name: 'beef marrow and knuckle bones (xuong bò)', note: 'blanched and rinsed before use' },
                { amount: 300, unit: 'g', name: 'beef brisket (th?t bò b?p)', note: 'added to the broth to braise — removed when tender and sliced for topping' },
                ...
                { amount: 1, name: 'black cardamom pod (th?o qu?)', note: 'lightly crushed — optional but adds depth specific to central Vietnamese beef broth' },
        ...
        {
            title: 'M? hành Tuy Hòa (essential — more generous than anywhere else)',
            items: [
                ...
                { amount: 4, unit: 'tbsp', name: 'crispy fried shallots', note: 'scattered over each bowl in addition to the m? hành' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 3, unit: 'tbsp', name: 'fermented shrimp paste (m?m ru?c)', note: 'served alongside in the Phú Yên style — optional but traditional' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            tip: 'Taste the broth before seasoning and assess the spice level. Central Vietnamese beef broth has noticeably less spice than ph? — more restrained, cleaner, letting the beef character be primary. If the spice is too prominent, dilute with a small amount of hot water.',
        },
        {
        ...
        {
            title: 'Make the m? hành — Tuy Hòa style',
            description: 'Slice 6 spring onions thinly and place in a heatproof bowl with salt. Heat 100ml of neutral oil until genuinely smoking — 210°C. Pour the smoking oil over the spring onion all at once. It will sizzle loudly and the onion will turn from raw green to cooked green in seconds. Stir immediately. This is significantly more m? hành than any other Vietnamese noodle soup uses — this is the Tuy Hòa quantity, and it is not an accident. The generous spring onion oil is the taste signature of the city.',
            tip: 'The quantity of m? hành in bánh canh bò Tuy Hòa is triple what most recipes specify. Local shops apply it so generously that the surface of each bowl is visibly golden with oil and fragrant with spring onion. Do not reduce the amount.',
        },
        {
            title: 'Assemble the bowl',
            description: 'Blanch fresh bánh canh noodles in boiling water for 2-3 minutes. Drain and place in deep bowls. Arrange sliced braised brisket over the noodles. Place raw beef slices on top — they will cook from the boiling broth. Ladle the boiling broth generously over everything — the raw beef should turn pink within 30-60 seconds. Spoon m? hành very generously over the surface. Scatter crispy fried shallots. Serve with bean sprouts, herbs, lime, chili, and m?m ru?c alongside.',
