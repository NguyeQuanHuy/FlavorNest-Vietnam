...
const recipe: RecipeData = {
    ...
    title: 'Tr?ng H?p Tôm Sông C?u Phú Yên (Phú Yên Steamed Egg Custard with Sông C?u Shrimp)',
    subtitle: 'Eggs beaten with m?m nhi, light stock, and microplane-grated ginger poured over fresh Sông C?u shrimp in a ceramic bowl and steamed at gentle heat until the custard sets silky-smooth around the barely-cooked shrimp — the Phú Yên steamed egg where the province\'s finest condiment meets its most prized shrimp.',
    ...
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 1.5, unit: 'tbsp', name: 'm?m nhi (Phú Yên first-press fish sauce)', note: 'the primary seasoning beaten into the custard' },
        ...
        {
            title: 'Sông C?u shrimp',
            items: [
                { amount: 200, unit: 'g', name: 'fresh Sông C?u shrimp or tiger prawns', note: 'peeled, deveined, tails left on. Medium size — 6-8 per bowl. Very fresh.' },
                { amount: 1, unit: 'tbsp', name: 'm?m nhi', note: 'for brief seasoning of the shrimp before placing in the bowl' },
                { amount: 0.5, unit: 'tsp', name: 'white pepper' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                { amount: 2, unit: 'tbsp', name: 'm?m nhi' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Remove the cover. Drizzle sesame oil and shallot-infused oil over the surface. Scatter sliced spring onion greens and freshly ground white pepper. The surface should be pale gold, smooth, and unblemished — the pink shrimp visible through the translucent custard. Serve the bowl directly at the table with the m?m nhi ginger dipping sauce, steamed rice, and lime wedges. To eat: spoon custard and shrimp together over rice, drizzle the m?m nhi sauce over each spoonful.',
            tip: 'The m?m nhi ginger sauce drizzled over each spoonful of custard — rather than the custard being dipped into the sauce — is the correct serving method for this preparation. The sauce amount should be enough to season each spoonful without pooling in the bowl and diluting the custard.',
        },
    ],
};
