...
const recipe: RecipeData = {
    slug: 'suon-nuong',
    title: 'Su?n Nu?ng (Vietnamese Grilled Pork Ribs)',
    ...
    intro: `Su?n nu?ng — Vietnamese grilled ribs — is the preparation that demonstrates most clearly how the Vietnamese approach to pork differs from every Western barbecue tradition. There is no rub, no smoke, no slow cook, no sauce applied during grilling. The entire flavor comes from the overnight marinade: lemongrass, fish sauce, garlic, shallots, sugar, and five-spice — a combination that penetrates the meat during the long marination and caramelizes on the surface during the fast, hot grill. The ribs are grilled at high heat, not low-and-slow — Vietnamese grilling is about caramelization and char, not smoke and collagen breakdown. The result is ribs that are tender from the marinade rather than from hours of slow cooking, with a surface that is sticky, deeply caramelized, and slightly charred at the bone ends. Su?n nu?ng is eaten with broken rice (com t?m), vermicelli (bún), or simply with steamed jasmine rice, a cucumber salad, and a bowl of nu?c ch?m. It is one of the defining dishes of Vietnamese street food and Vietnamese home cooking simultaneously.`,
    ingredientSections: [
        {
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Rest the grilled ribs for 5 minutes before serving — the juices redistribute and the caramelized glaze sets slightly. Arrange on a plate. Scatter spring onion and sliced chili. Serve immediately with cucumber batons, lime wedges, and steamed rice. The correct accompaniments for su?n nu?ng: broken rice absorbs the juices perfectly; nu?c ch?m to dip the cucumber; cold beer if available.',
