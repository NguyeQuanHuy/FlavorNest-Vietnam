...
const recipe: RecipeData = {
    ...
    subtitle: 'Thin-sliced young goat cured in fresh lime juice with lemongrass and galangal — served not with the fermented shrimp paste of northern versions but with mu?i lá é, the pounded litsea leaf salt of Phú Yên that transforms the lime-bright cured goat into something specific to the central coast.',
    category: 'APPETIZER',
    difficulty: 'Medium',
    totalTime: '40 min',
    rating: 4.9,
    ...
    intro: `Dê tái chanh Phú Yên is the central coast version of the lime-cured goat salad — related to tái dê from other central provinces but distinguished from every other version by the dipping condiment: mu?i lá é, the pounded salt of litsea cubeba leaves that is the province's signature flavor. Where Ninh Bình and Khánh Hòa versions of goat tái are eaten with m?m tôm (fermented shrimp paste thinned with lime), and where some southern versions use a simple fish sauce dipping sauce, Phú Yên's tái dê is served exclusively with mu?i lá é — the wild citrus-pepper-herbal salt that appears alongside every significant seafood and meat dish in the province. The difference is not subtle: m?m tôm provides pungency and umami depth; mu?i lá é provides a clean, aromatic brightness that is simultaneously more delicate and more specific. Against the mild, lime-cured goat, the mu?i lá é adds a dimension that the goat alone cannot produce and that no other dipping preparation replicates. Phú Yên's goats specifically — the local breed raised on the rocky hillsides of the coastal ranges and the limestone outcrops between Tuy Hòa and Sông C?u — are leaner and slightly more mineral in flavor than the Ninh Bình goats that have been grazed on lush delta grass. This difference in the meat's character is why the clean, non-pungent mu?i lá é works where the assertive m?m tôm might overwhelm: the Phú Yên goat needs a condiment that illuminates rather than obscures. The curing in dê tái chanh Phú Yên also uses a specific addition not found in other provincial versions: fresh galangal (ri?ng) is added to the lime curing liquid alongside the standard lemongrass, and the combination of citrus acid, lemongrass oil, and galangal heat produces a cured goat that tastes more complex than any single aromatic alone would produce.`,
    ingredientSections: [
        {
            title: 'Goat',
            items: [
                { amount: 400, unit: 'g', name: 'young goat leg or loin (th?t dê non Phú Yên)', note: 'from a goat under 6 months — the local Phú Yên breed is leaner and slightly more mineral than northern goat. Must be very fresh — same day purchase.' },
            ],
        },
        {
            ...
            items: [
                ...
                { amount: 2, unit: 'tbsp', name: 'm?m nhi (Phú Yên first-press fish sauce)', note: 'the province\'s premium fish sauce — adds umami depth to the curing liquid that regular fish sauce cannot approach' },
                { amount: 0.5, unit: 'tsp', name: 'sugar' },
                { amount: 2, name: 'lemongrass stalks', note: 'inner stalk, minced to paste — added to the curing liquid' },
                { amount: 20, unit: 'g', name: 'fresh galangal (ri?ng)', note: 'finely grated — the Phú Yên specific addition to the curing liquid. Adds a warm, piney heat that lime and lemongrass alone do not produce.' },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                { amount: 1, name: 'large bunch Vietnamese coriander (rau ram)', note: 'the dominant herb — Phú Yên quantities' },
        ...
        {
            title: 'Mu?i lá é Phú Yên — the defining dipping salt',
            items: [
                { amount: 25, unit: 'g', name: 'fresh lá é leaves (litsea cubeba)', note: 'the Phú Yên condiment that distinguishes this version from every other dê tái in Vietnam. Substitute: 8 kaffir lime leaves + 8 rau ram leaves pounded together.' },
    ...
    steps: [
        {
            ...
            description: 'Grate the fresh galangal on the finest available grater until it is almost a paste. Combine with lime juice, m?m nhi, sugar, and the lemongrass paste. Stir thoroughly — the galangal will not dissolve but will distribute through the liquid. Taste the curing liquid: it should be intensely lime-sharp with the lemongrass citrus note and the specific piney-warm character of the galangal clearly detectable. The m?m nhi should provide depth without being identifiable as fish sauce.',
        ...
        },
        {
            ...
            tip: 'For dê tái chanh specifically, the mu?i lá é should be pounded slightly coarser than for seafood — the texture of the salt crystals provides a counterpoint to the smooth, lime-cured goat surface. Ultra-fine mu?i lá é disappears against the meat; slightly coarse mu?i lá é is felt and tasted distinctly.',
        },
        {
        ...
        },
        {
            ...
            description: 'Leave the assembled salad to rest for 3 minutes. Transfer to a serving plate. Top with crushed peanuts, crispy fried shallots, and toasted sesame seeds at the last moment. Arrange the sesame rice crackers, cucumber batons, and a small bundle of fresh lá é leaves alongside. The visual of the salad plate: pale cured goat, dark green rau ram, golden peanuts and shallots, the raw lá é leaves alongside.',
