...
const recipe: RecipeData = {
    ...
    title: 'Chim Cút Nu?ng M?t Ong (Honey-Glazed Grilled Quail)',
    subtitle: 'Whole quail marinated in lemongrass, fish sauce, and five-spice then grilled over charcoal with repeated honey basting until the skin turns deep mahogany and shatters when bitten — the southern Vietnamese nh?u dish where a single bird disappears in four bites and the honey glaze makes cold beer taste better.',
    category: 'APPETIZER',
    difficulty: 'Easy',
    totalTime: '1 hr',
    rating: 4.9,
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, unit: 'tsp', name: 'five-spice powder (ngu v? huong)' },
    ...
    steps: [
        {
            ...
            tip: 'Spatchcocking the quail is the preparation that makes chim cút nu?ng m?t ong cook evenly and present beautifully. A whole unflattened quail grills unevenly — the breast overcooks before the thigh is done. Flattened, every surface is at equal distance from the heat.',
        },
        {
            ...
            tip: 'The glaze must be applied in layers — not all at once. Each layer is brushed on and allowed to caramelize before the next layer goes on. Three to four basting applications during grilling produce the deep mahogany lacquer that defines chim cút nu?ng m?t ong; one heavy application produces stickiness without depth of color.',
        },
        {
        ...
        },
        {
            ...
            description: 'Arrange the glazed quail on a plate with rau ram, mint, cucumber, and lime wedges. Serve the dipping sauce in individual small bowls. To eat: pick up a quail by the leg, bite through the lacquered skin at the breast — it should crack audibly. Work the breast meat free with the teeth. Then the thigh. Suck the bones clean. Dip each piece in the nu?c ch?m between bites. Eat with a leaf of rau ram. Drink beer. Repeat with the next quail.',
            tip: 'Chim cút nu?ng is specifically a hand-food — not because utensils do not exist but because the eating experience with hands is fundamentally different. The lacquered skin cracks more satisfyingly against the teeth than against a knife. The Vietnamese understand this, which is why the dish appears on tables where hands are used without self-consciousness.',
        },
    ],
};
