...
const recipe: RecipeData = {
    ...
    intro: `Cá tr?m kho c?n is the black carp and celery braise of northern Vietnam — a kho dish that is specifically Hà N?i and the Red River Delta in the same way that cá trê kho t? is specifically the Mekong Delta. Cá tr?m den (black carp, Mylopharyngodon piceus) is the large freshwater fish of the northern Vietnamese fish farming tradition — heavier and darker-fleshed than the grass carp (cá tr?m c?) that is more common in the south, with a denser muscle structure and a more pronounced freshwater mineral character that holds up to the long kho braising and concentrating process better than lighter fish. The two defining elements that make cá tr?m kho c?n specifically northern are the galangal — used more prominently than ginger in the northern kho tradition, reflecting the availability and long culinary history of galangal in the Red River Delta region — and the Vietnamese celery (c?n ta or c?n tây b?n d?a), which is different from the large-stalked Western celery: it is smaller, more intensely flavored, slightly bitter at the stems, and with a leaf character that is closer to the Chinese celery (??) that appears in Cantonese cooking. The Vietnamese celery added to the finished cá tr?m kho c?n in the final minutes provides an aromatic finishing note that is simultaneously herbal, slightly bitter, and specifically northern Vietnamese — the herb that most clearly marks this preparation as belonging to the cuisine above the H?i Vân Pass rather than below it.`,
    ingredientSections: [
        {
            title: 'Black carp',
            items: [
                { amount: 800, unit: 'g', name: 'black carp sections (cá tr?m den ch?t khúc)', note: 'bone-in, 5-6cm sections. Substitute: grass carp, large common carp, or any firm-fleshed freshwater fish.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 50, unit: 'g', name: 'fresh galangal (ri?ng)', note: 'cut into thick matchsticks — more prominent than ginger, the defining northern proportion' },
        ...
        },
        {
            ...
            items: [
                { amount: 100, unit: 'g', name: 'Vietnamese celery (c?n ta / c?n tây b?n d?a)', note: 'cut into 4cm pieces — both stems and leaves. Added in the final 5 minutes. Substitute: Chinese celery or the inner stalks of Western celery with leaves.' },
    ...
    steps: [
        ...
        },
        {
            ...
            description: 'Heat oil and sugar in a heavy pot or clay pot over medium heat until the caramel reaches a very dark amber. Add 2 tablespoons of water carefully. Swirl until dissolved. The caramel for cá tr?m kho must be darker than for mild white fish — the density and flavor of black carp requires a more robust caramel base to balance it.',
        ...
        },
        {
            ...
            tip: 'Black carp requires 30-35 minutes of kho braising — the same as catfish — because of its density. The rice wine in the braising liquid is the element that distinguishes northern fish kho from southern fish kho: it adds a specific depth and a slight fermented character that is specifically Hà N?i kitchen in character.',
        },
        {
            ...
            tip: 'The Vietnamese celery in cá tr?m kho c?n is not optional and not substitutable with plain spring onion — it is the herb that makes this preparation northern. Its slightly bitter, intensely herbal character against the sweet caramel-fish sauce-galangal combination is the specific flavor tension that defines the dish. Without it, the kho is good; with it, it is specifically cá tr?m kho c?n.',
        },
    ],
};
