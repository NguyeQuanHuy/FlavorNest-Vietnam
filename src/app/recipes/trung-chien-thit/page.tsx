...
const recipe: RecipeData = {
    ...
    intro: `Tr?ng chiên th?t is a classic Vietnamese home-style dish made from beaten eggs mixed with seasoned minced pork, then pan-fried until golden and fluffy.
