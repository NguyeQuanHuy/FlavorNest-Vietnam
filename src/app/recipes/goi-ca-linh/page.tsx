...
const recipe: RecipeData = {
    slug: 'goi-ca-linh',
    title: 'Gỏi Cá Linh (Mekong Anchovy Salad)',
    ...
    intro: `Gỏi cá linh is one of the most seasonal and place-specific dishes in Vietnamese cooking. Cá linh — a small freshwater fish related to the anchovy family — appears in the Mekong Delta only during the flood season (roughly August to November) when the Mekong overflows its banks and the fish ride the floodwaters upstream. For a few weeks, cá linh is everywhere in the delta — piled high in markets, cooked every way imaginable, eaten at every meal. Gỏi cá linh is the raw preparation: the tiny fish marinated in lime juice until the acid partially cooks the flesh, then tossed with a combination of fresh herbs, green mango, roasted peanuts, fried shallots, and a dressing of fish sauce and chili. The lime acid softens the bones of the small fish to the point where they are barely perceptible — eaten whole, bones and all. Outside the Mekong Delta, cá linh is difficult to find. This recipe uses fresh small anchovies or whitebait as a substitute — fish of similar size and fat content that behave the same way in the acid marinade.`,
    ingredientSections: [
        {
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'bunch Vietnamese coriander (rau răm)', note: 'leaves only — the essential herb for this salad' },
