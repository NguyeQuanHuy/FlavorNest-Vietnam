...
const recipe: RecipeData = {
    ...
    intro: `Trà chanh giã tay — hand-pounded lime tea — started as a single cart in Hanoi in late 2023, went viral on TikTok and Douyin, and within weeks had queues of fifty people waiting an hour to get a glass. The secret is not complicated: it is the Guangdong lime (chanh Qu?ng Ðông), a fragrant variety with thick skin and an aromatic oil that smells faintly of lemongrass and pomelo. When you pound the slices in a mortar, the essential oils release into the ice, perfuming the whole drink. Combined with strong black tea and honey instead of sugar syrup, the result is bright, floral, slightly bitter, and deeply refreshing. This recipe makes it at home in 15 minutes — no queue required.`,
    ingredientSections: [
        {
            title: 'The tea base',
            items: [
        ...
        },
        {
            ...
            items: [
                { amount: 2, name: 'Guangdong limes (chanh Qu?ng Ðông)', note: 'also sold as "perfume lime" or "nu?c hoa lime" at Asian grocers — the thick, oval, fragrant variety' },
