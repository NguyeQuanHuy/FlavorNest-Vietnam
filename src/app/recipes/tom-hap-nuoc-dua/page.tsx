...
const recipe: RecipeData = {
    ...
    title: 'Tôm Hấp Nước Dừa (Coconut Water-Steamed Shrimp)',
    ...
    intro: `Tôm hấp nước dừa is the southern variation of Vietnam's steamed shrimp canon — the version from Bến Tre, Tiền Giang, and the coconut provinces of the Mekong Delta where fresh coconut water is as available as tap water. The technique is identical to tôm hấp bia (beer-steamed shrimp) but the character of the steam is entirely different: coconut water produces a slightly sweet, tropical-scented steam that imparts a subtle sweetness to the shrimp that beer cannot. The pandan leaf added to the steaming bath adds a floral, vanilla-adjacent note that is quintessentially southern Vietnamese. The resulting shrimp taste of both the ocean they came from and the land they were cooked in — the brininess of fresh shrimp and the sweetness of coconut water in the same bite. Served with a ginger-lime dipping salt, the combination is one of the cleanest expressions of southern Vietnamese coastal cooking.`,
    ingredientSections: [
        {
            title: 'Shrimp',
            items: [
                { amount: 800, unit: 'g', name: 'fresh shrimp, whole (tôm tươi)', note: 'heads on, shells on. Medium to large. Must be fresh — this dish has nowhere to hide poor-quality shrimp.' },
            ],
        },
        {
            title: 'Steaming bath',
            items: [
                { amount: 500, unit: 'ml', name: 'fresh young coconut water (nước dừa tươi)', note: 'from a young green coconut, or packaged fresh (not flavored). The sweetness is essential — old coconut water or canned is inferior.' },
                { amount: 3, name: 'lemongrass stalks', note: 'bruised and cut into 5cm pieces' },
                { amount: 4, name: 'pandan leaves (lá dứa)', note: 'knotted — the southern Vietnamese aromatic. Fresh or frozen.' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'small bunch rau răm (Vietnamese coriander)', note: 'or mint' },
            ],
        },
    ],
    steps: [
        ...
        },
        {
            ...
            description: 'Combine salt, black pepper, and grated ginger on individual small plates. The ginger in this version (unlike the plain muối tiêu chanh) is specific to the coconut version — its sharpness creates contrast with the sweet coconut-perfumed shrimp. Squeeze lime juice over just before eating.',
        ...
        },
        {
            ...
            description: 'Transfer the steamed shrimp to a serving plate. Scatter spring onion and chili. Serve the ginger-lime salt and extra lime wedges alongside, with fresh rau răm. How to eat: pick up a shrimp, bite through shell and all — the thin shell of a fresh shrimp is edible and adds texture. Suck the head first if present. Dip in the ginger-lime salt between each shrimp.',
