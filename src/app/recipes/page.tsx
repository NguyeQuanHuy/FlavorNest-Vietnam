...
const LEGACY_CARDS: Array<{
    ...
    tags: string[];
        ...
        },
        {
            ...
            description: "Lemongrass-perfumed beef broth, thick round noodles, sliced beef shank and pork knuckle.",
        ...
        },
        {
            ...
            description: "A dish so unique it can only truly be made in Hoi An — thick ash-treated noodles with roasted pork.",
        ...
        },
        {
            ...
            description: "Wide turmeric-yellow noodles with just enough broth to coat — topped with shrimp, pork, quail eggs.",
        ...
        },
        {
            ...
            description: "Delicate steamed rice flour discs topped with dried shrimp, scallion oil and fish sauce.",
        ...
        },
        {
            ...
            description: "Tiny river clams over cold rice with peanuts, sesame, cracklings and fermented shrimp paste.",
            tags: ["Clams", "Rice", "Hue"],
        },
        {
        ...
        },
        {
            ...
            description: "Thick chewy noodles in a clear pork and dried anchovy broth, finished with fresh garlic chives.",
        ...
        },
        {
            ...
            description: "Free-range chicken stir-fried with fresh litsea leaves — a wild herb unique to the central highlands.",
        ...
        },
        {
            ...
            description: "Pork belly and eggs slow-braised in coconut water until the sauce turns deep amber and glossy.",
        ...
        },
        {
            ...
            description: "The broken rice that was once a poor man's meal is now Saigon's most beloved dish.",
        ...
        },
        {
            ...
            description: "Cold vermicelli, chargrilled pork, crispy spring roll, crushed peanuts and a flood of nuoc cham.",
        ...
        },
        {
            ...
            description: "A Saigon institution with Cambodian roots — clear pork broth with rice noodles, minced pork, prawns.",
        ...
        },
        {
            ...
            description: "Catfish braised in dark caramel with chilli and ginger in a clay pot — still sizzling when it arrives.",
        ...
        },
        {
            ...
            description: "Sour, spicy, lemongrass-scented broth filled with seafood, mushrooms and fresh vegetables.",
        ...
        },
        {
            ...
            description: "Tender beef cubes wok-tossed in butter and garlic until caramelised outside, pink inside.",
            tags: ["Beef", "Wok", "Quick"],
        },
        {
            slug: "lau-mam",
            ...
            description: "The boldest hot pot in Vietnam — fermented fish broth with eggplant, pork and fresh herbs.",
        ...
        },
        {
            ...
            description: "The greatest sandwich in the world — a shatteringly crisp baguette filled with pate, cha lua, pickled daikon.",
...
function inferRegion(category: string, slug: string): string {
    const northern = ['hanoi-beef-pho', 'pho-bo-ha-noi', 'bun-cha-hanoi', 'banh-cuon', 'xoi-xeo', 'cha-ca-la-vong', 'bun-thang'];
