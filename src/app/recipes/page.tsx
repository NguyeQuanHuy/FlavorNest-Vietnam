...
function RecipesInner() {
    ...
    // Sync local query when URL param changes
            ...
            <style>{`
                ...
                * { box-sizing: border-box; }
                .recipe-card {
                    ...
                    border: 1px solid rgba(75,46,26,0.07); transition: all 0.35s cubic-bezier(0.34,1.56,0.64,1);
            ...
            <div style={{ position: 'sticky', top: 72, zIndex: 40, background: 'rgba(250,250,247,0.96)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(75,46,26,0.07)', padding: '12px 20px' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: 8, overflowX: 'auto', alignItems: 'center', flexWrap: 'nowrap' }}>
                    ...
                    <div style={{ position: 'relative', flexShrink: 0 }}>
                        ...
                        />
                        {localQuery && (
                            <button onClick={clearSearch} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(75,46,26,0.4)', fontSize: 16, lineHeight: 1 }}>✕</button>
                        )}
                    </div>
...
export default function RecipesPage() {
    return (
        <Suspense fallback={
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#FAFAF7', fontFamily: 'system-ui' }}>
