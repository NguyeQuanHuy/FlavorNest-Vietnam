...
const recipe: RecipeData = {
    ...
    subtitle:
        'Southern Vietnam on a plate — golden Cát Hòa L?c mango beside warm coconut-soaked sticky rice.',
    category: 'DESSERT',
    difficulty: 'Easy',
    ...
    ingredientSections: [
        {
            title: 'Sticky rice',
            items: [
                { amount: 300, unit: 'g', name: 'glutinous rice (n?p cái hoa vàng)' },
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 2, name: 'ripe Cát Hòa L?c mangoes', note: 'or Ataulfo, Honey mango' },
