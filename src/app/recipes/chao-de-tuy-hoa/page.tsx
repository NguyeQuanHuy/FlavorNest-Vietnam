...
const recipe: RecipeData = {
    ...
    subtitle: 'Goat bone broth with medicinal herbs — ginger, galangal, star anise, and dried longan — simmered into a rice porridge and topped with tender shredded goat meat, crispy fried shallots, fresh ginger julienne, and rau răm. The Tuy Hòa morning bowl eaten at small shops before 9am.',
    ...
    ingredientSections: [
        ...
        {
            title: 'Thuốc bắc aromatics (medicinal herbs)',
            items: [
                { amount: 30, unit: 'g', name: 'dried longan flesh (long nhãn / long nhãn sấy)', note: 'adds subtle sweetness and the characteristic tonic note of Tuy Hòa cháo dê' },
                { amount: 2, name: 'star anise (hồi)', note: 'whole' },
                { amount: 1, name: 'cinnamon stick, 3cm' },
                { amount: 40, unit: 'g', name: 'fresh galangal (riềng)', note: '4 slices, lightly smashed' },
                { amount: 3, name: 'dried red dates (táo đỏ)', note: 'pitted — adds sweetness and the tonic quality' },
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 1, name: 'large bunch Vietnamese coriander (rau răm)', note: 'leaves only' },
