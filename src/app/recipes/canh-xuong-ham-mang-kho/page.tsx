...
const recipe: RecipeData = {
    ...
    title: 'Canh Xương Hầm Măng Khô (Pork Bone Soup with Dried Bamboo Shoots)',
    subtitle: 'Pork neck bones simmered for two hours with dried bamboo shoots that have been reconstituted and braised until tender — a deeply savory, slightly earthy soup that Vietnamese families make on cold days and for Tết celebrations.',
    ...
    intro: `Canh xương hầm măng khô is the soup that tastes of time. There is no shortcut for the two-hour simmer that extracts the collagen from pork neck bones and the complex, smoky-earthy flavor from dried bamboo shoots that have been reconstituted over 24 hours. The dried bamboo shoots — măng khô — are not the same ingredient as fresh or canned bamboo. Dried bamboo has been fermented slightly during the drying process, developing a depth of flavor — smoky, earthy, slightly funky — that fresh bamboo does not carry. When simmered with pork bones, the bamboo absorbs the richness of the pork while the pork absorbs the earthiness of the bamboo. The result is a broth of extraordinary complexity — one of the most satisfying winter soups in Vietnamese cooking. Canh xương hầm măng khô is a Tết dish in many northern families and an everyday cold-weather soup in homes throughout the country. The preparation time is long; the active cooking time is short; the result is disproportionately good.`,
    ingredientSections: [
        {
            title: 'Bones and pork',
            items: [
                { amount: 1, unit: 'kg', name: 'pork neck bones (xương cổ heo)', note: 'ask butcher to cut through the bone — chopped into 6-8cm sections. Or use spare ribs.' },
                { amount: 300, unit: 'g', name: 'pork belly (ba chỉ)', note: 'optional — adds richness and something to eat beyond the bones' },
        ...
        },
        {
            ...
            items: [
                { amount: 150, unit: 'g', name: 'dried bamboo shoots (măng khô)', note: 'the yellow-brown dried strips — NOT fresh or canned bamboo. Soak 24 hours before cooking (see step 1).' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The correct way to eat this soup: a spoonful of broth first to taste its full depth, then the bamboo (which should be completely tender and carrying the pork flavor), then the meat from the bones gnawed directly — canh xương is never eaten with cutlery.',
        },
    ],
};
