...
const recipe: RecipeData = {
    slug: 'muc-xao-sa-ot',
    title: 'Mực Xào Sả Ớt (Squid Stir-Fried with Lemongrass and Chili)',
    ...
    ingredientSections: [
        ...
        },
        {
            ...
            items: [
                ...
                { amount: 4, name: 'bird\'s eye chilies', note: 'minced — mực xào sả ớt should be genuinely spicy' },
    ...
    steps: [
        ...
        },
        {
            ...
            tip: 'The 60-90 second aromatic base for mực xào sả ớt is longer than for most wok preparations because the squid will be in the wok for such a short time that the aromatics must be fully developed before the protein arrives. In a preparation where the protein has 5-10 minutes in the wok, underdone aromatics can catch up; in a 90-second squid stir-fry, they cannot.',
        },
        {
