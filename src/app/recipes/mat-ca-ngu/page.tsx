...
const recipe: RecipeData = {
    slug: 'mat-ca-ngu',
    title: 'Mắt Cá Ngừ Kho (Braised Tuna Eye)',
    ...
    intro: `Mắt cá ngừ — tuna eye — is the cut that most Western fish buyers discard without thought and Vietnamese cooks prize above almost any other part of the fish. The eye socket of a large yellowfin or bigeye tuna is surrounded by thick gelatinous tissue, a layer of rich fatty flesh, and the eye itself — which contains a surprisingly clean, firm, lobster-like texture when cooked. The collagen in the surrounding tissue, when braised in the Vietnamese kho method (caramelized fish sauce, sugar, aromatics), dissolves into the braising liquid and creates a sauce of extraordinary body and richness. The flavor is the most concentrated expression of tuna possible — more intense than any steak, more complex than any fillet. Mắt cá ngừ is particularly associated with the central coast of Vietnam, where the tuna fishing industry is centered: Phú Yên, Bình Định, and Khánh Hòa provinces. In these coastal provinces, the eyes are sold separately at markets — coveted, never discarded. In Vietnamese fishmongers outside Vietnam, they can sometimes be found frozen. Ask specifically — they are often available but not displayed.`,
    ingredientSections: [
        {
            title: 'Main',
            items: [
                { amount: 4, name: 'tuna eye sections (mắt cá ngừ)', note: 'each section includes the eye plus surrounding tissue — about 150-200g each. Ask Vietnamese fishmonger specifically. Frozen acceptable.' },
                ...
                { amount: 1, unit: 'tbsp', name: 'caramel sauce (nước màu)', note: 'for the deep mahogany color' },
