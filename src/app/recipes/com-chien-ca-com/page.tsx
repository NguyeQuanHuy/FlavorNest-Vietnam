...
const recipe: RecipeData = {
    ...
    title: 'Com Chiên Cá Com (Anchovy Fried Rice)',
    ...
    intro: `Com chiên cá com is the anchovy fried rice — the Vietnamese fried rice preparation that uses dried anchovies (cá com khô) as both the primary protein and the primary seasoning element, producing a dish where the addition of fish sauce, soy sauce, or salt becomes unnecessary because the intensely savory dried anchovies provide all the salinity and umami that the fried rice requires. The dish belongs to the category of Vietnamese quick meals that skilled home cooks assemble in under 15 minutes from pantry ingredients: day-old rice, a jar of dried anchovies, eggs, garlic, and spring onion — the five ingredients that are almost always present in a Vietnamese kitchen — combined at maximum wok heat into a fried rice that is more specifically flavored and more satisfying than most restaurant versions made with more elaborate ingredients. The technique follows the standard Vietnamese com chiên structure: maximum heat, day-old rice that has dried slightly and separates grain by grain in the wok, egg scrambled in the hot oil before the rice goes in, and the aromatics and protein elements added in a specific sequence that ensures each element is at its best when the rice arrives. The specific adaptation for cá com is the frying of the dried anchovies at the beginning of the process — before the egg, before the rice — until they are golden and crispy in the wok oil, becoming the flavored oil that the subsequent ingredients cook in. This anchovy-infused wok oil is the preparation's foundation: it carries the marine-savory character of the anchovies into every grain of rice without additional seasoning, producing the specific depth of flavor that makes com chiên cá com different from other fried rice preparations that add protein on top of a separately seasoned rice.`,
    ingredientSections: [
        {
            ...
            items: [
                ...
                { amount: 60, unit: 'g', name: 'dried anchovies (cá com khô)', note: 'the small variety — 3-5cm. Checked for freshness. These provide all the seasoning for the fried rice.' },
