...
const recipe: RecipeData = {
    slug: 'muc-hap-sa',
    title: 'M?c H?p S? (Steamed Squid with Lemongrass)',
    ...
    intro: `M?c h?p s? is the Vietnamese seafood preparation that demonstrates how little needs to be done to fresh squid to make it extraordinary. The technique is pure restraint: squid cleaned but left whole, steamed over a fragrant bath of lemongrass, ginger, and sometimes beer, for exactly the right amount of time. Eight minutes for medium squid. Ten for large. One minute over and the squid is rubbery. One minute under and the texture is wrong in a different way. The lemongrass steam does not simply flavor the outside — it perfumes the flesh from within, so that each piece of squid carries the aromatic character of the steaming bath without any direct addition of seasoning. The dipping sauce — mu?i tiêu chanh, salt-pepper-lime — is not a condiment but the second half of the dish: the acid and salt that complete what the pure steaming leaves deliberately unfinished. M?c h?p s? is the dish that Vietnamese coastal cooks make when the squid is fresh enough to deserve respect.`,
    ingredientSections: [
        {
            title: 'Squid',
            items: [
                { amount: 800, unit: 'g', name: 'fresh squid (m?c)', note: 'medium size, whole — cleaned but kept whole or in large pieces. Freshness is everything; frozen squid produces acceptable but clearly inferior results.' },
            ],
        },
        {
            title: 'Steaming bath',
        ...
        },
        {
            title: 'To serve',
            items: [
                { amount: 1, name: 'bunch Vietnamese coriander (rau ram)', note: 'or mint and perilla' },
