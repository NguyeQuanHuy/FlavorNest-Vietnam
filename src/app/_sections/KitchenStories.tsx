...
const STORIES = [
    {
        ...
        excerpt: 'Phở is not a dish for the impatient. To achieve its mirror-clear broth, the cook must simmer beef bones for ten patient hours — while Hanoi still sleeps.',
    ...
    },
    {
        ...
        title: 'From Street to Table: Bún Chả',
    ...
    },
    {
        ...
        excerpt: "The Nguyễn emperors demanded every meal be a ceremony. Hue's royal kitchens prepared fifty dishes per sitting — each a meditation on colour, balance and meaning.",
