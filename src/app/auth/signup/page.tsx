            ...
            >
                <div style={{ textAlign: 'center', marginBottom: 32 }}>
                    ...
                    <p style={{ color: '#9B7B60', fontSize: 14, marginTop: 8 }}>
                        Join the nest and save your favorite recipes
                    </p>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                    ...
                    <span style={{ color: '#B09080', fontSize: 13 }}>or</span>
                    <div style={{ flex: 1, height: 1, background: '#E8D9C8' }} />
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#9B7B60' }}>
                    ...
                    <a href="/auth/signin" style={{ color: '#D97706', fontWeight: 600, textDecoration: 'none' }}>
                        Log in
                    </a>
                </p>
            </motion.div>
