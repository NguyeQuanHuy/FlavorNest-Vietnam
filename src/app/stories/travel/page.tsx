...
const GUIDES: Guide[] = [
    {
        ...
        mustTry: ['Phở tái chín at Phở Bát Đàn', 'Phở cuốn at Ngũ Xá street', 'Phở gà at any corner stall in Old Quarter'],
    ...
    },
    {
        ...
        mustTry: ['Bánh mì Huynh Hoa on Lê Thị Riêng', 'Bánh mì Phượng (the Hội An cousin)', 'Bánh mì trứng ốp la at any dawn cart'],
    ...
    },
    {
        ...
        mustTry: ['Cao lầu at Trương Minh Lượng (45 Trần Phú)', 'Cao lầu bà Bé at the covered market', 'Morning bowl at Cô Ba Hội An'],
    ...
    },
    {
        ...
        mustTry: ['Bún bò Mụ Rớt on Nguyễn Công Trứ', 'Bún bò at Đông Ba market at dawn', 'Version with chả cua (crab cake) added'],
    ...
    },
    {
        ...
        mustTry: ['Bánh xèo at Cần Thơ floating market stalls', 'Bánh xèo 46A in Sài Gòn (the Mekong version)', 'Hand-rolled with rau sống (raw vegetable plate)'],
    ...
    },
    {
        ...
        mustTry: ['Ghẹ rang muối (salt-roasted blue crab)', 'Mực một nắng (sun-dried squid, grilled over coals)', 'Bánh khọt Vũng Tàu — tiny coconut-rice cakes with shrimp'],
    ...
    },
    {
        ...
        mustTry: ['Cà phê sữa đá in any hillside garden café', 'Cà phê trứng (egg coffee) at Café Tùng', 'Strawberry wine + cà phê combo — very Đà Lạt'],
    ...
    },
    {
        ...
        mustTry: ['Bún thịt nướng at Như Lan on Hàm Nghi', 'Version with chả giò (crispy spring rolls)', 'Eaten standing at a Quận 1 market stall at noon'],
