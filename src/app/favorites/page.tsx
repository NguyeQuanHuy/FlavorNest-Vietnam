...
function RecipeCard({ recipe, index, isRemoving, onRemove }: RecipeCardProps) {
    ...
    const colors = DIFF_STYLES[recipe.difficulty]
    ...
    return (
        <motion.div
            ...
            transition={{
                layout: { duration: 0.35, ease: [0.22, 1, 0.36, 1] as any },
                default: { duration: 0.42, ease: [0.22, 1, 0.36, 1] as any, delay: index * 0.05 },
            }}
            ...
            >
                ...
                <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full border ${colors}`}>
                            {recipe.difficulty}
                        </span>
                    </div>
                </div>
